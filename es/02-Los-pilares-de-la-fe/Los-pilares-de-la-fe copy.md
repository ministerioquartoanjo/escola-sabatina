...
** ¿Cómo será el pueblo peculiar de Dios en la Tierra justo antes del regreso de Jesús? ** {clase = pregunta} ** Apocalipsis 14: 1,4,5 ** {clase = libroQ}  
...
** ¿Qué ordenó Dios al pueblo de Israel a través de Moisés? ** {clase = pregunta} ** Éxodo 25: 8,9,40 ** {clase = libroQ}  
...
** ¿Sigue vigente este santuario terrenal hoy después de la muerte de Jesucristo? ** {clase = pregunta} ** Mateo 27: 50,51 ** {clase = libroQ}  
...
** ¿Hay también un registro de nuestros pecados en el cielo? ** {clase = pregunta} ** Isaías 65: 6,7 ** {clase = libroQ}  
...
** ¿Cómo se purificaría el santuario y qué sucedería finalmente con los pecados de las personas depositadas allí? ** {clase = pregunta} ** Levítico 16: 9,10 ** {clase = libroQ}  
...
** Después de hacer expiación por las personas en el Santísimo Sacramento, ¿qué hizo el Sumo Sacerdote? ** {class = question} ** Levítico 16: 20,21 ** {class = bookQ}  
...
** ¿Cómo se acentúa la importancia del mensaje de la hora del juicio? ** {clase = pregunta} ** Apocalipsis 14: 6,7 ** {clase = libroQ}  
** Y vi a otro ángel volar por el cielo, y tenía el evangelio eterno, para proclamarlo a los que habitan en la tierra, y a toda la nación, tribu, lengua y pueblo. Diciendo a gran voz: Teme a Dios y dale gloria; porque ha llegado la hora de su juicio. Y adorad al que hizo los cielos, la tierra, el mar y las fuentes de agua. ** {class = versoQ} ** Apocalipsis 14: 6-7 ** {class = bookVerse}  

** Marque las declaraciones con V cuando sean verdaderas y F cuando sean falsas. **

a) () El uso del símbolo de un ángel volador representa un gran movimiento religioso.   
b) () No se enfatiza la importancia.   
c) () El mensaje a proclamar es el del juicio   
d) () El juicio ya ha comenzado.   
e) () Debemos prestar atención a la invitación y advertencia de Dios.   
f) () El juicio llevará mucho tiempo, no hay que apresurarse.   

** Frente al juicio investigador que ya está en marcha, ¿qué se nos recomienda hacer? ** {clase = pregunta} ** Apocalipsis 14: 7 ** {clase = libroQ}  
** Diciendo a gran voz: Teme a Dios y dale gloria; porque ha llegado la hora de su juicio. Y adorad al que hizo los cielos, la tierra, el mar y las fuentes de agua. ** {class = versoQ} ** Apocalipsis 14: 7 ** {class = bookVerse}
...
!!! cita de fondo
    Seguí mirando hasta que se colocaron tronos y se sentó el Anciano de Días; Su vestido era blanco como la nieve, y el cabello de su cabeza era como lana pura; Su trono era llamas de fuego y sus ruedas ardían en llamas. Un río de fuego fluyó y se fue ante Él; miles de miles le sirvieron, miríadas de miríadas estaban delante de él; se preparó el patio y se abrieron los libros. ** Daniel 7: 9,10 ** {clase = libro}

## Domingo

Al profeta Daniel se le presentó la visión del gran y solemne día, cuando el carácter y la vida de los hombres serían revisados ​​ante el Juez de toda la tierra, porque el hombre recibe el premio * "según sus obras" *. El Anciano de los Días es Dios Padre. El salmista dice: ** Antes que nacieran los montes y se formaran la tierra y el mundo, de eternidad en eternidad, Tú eres Dios ** {class = versoQ} ** (Salmos 90 : 2) ** {clase = bookVerse}. Es Él, la fuente de todo ser, de toda ley, quien debe presidir el Juicio. Y los santos ángeles, como ministros y testigos, en número de miles y miles, asisten a esta gran corte.

** ¿Qué hará Dios en el juicio? ** {clase = pregunta} ** Eclesiastés 12:14 ** {clase = libroQ}  
** Porque Dios llevará ante la justicia todas las obras, incluso las que estén encubiertas, sean buenas o malas. ** {class = versoQ} ** Eclesiastés 12:14 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) Dios investigará el caso de cada persona como si fuera único.   
b) Dios juzgará solo las cosas más importantes en cada caso.   
c) Dios no hará nada porque no habrá juicio.   
...
** ¿Cómo fue la escena del Juicio? ** {class = question} ** Daniel 7: 9,10 ** {class = bookQ}  
** Seguí mirando hasta que se colocaron tronos y se sentó el Anciano de Días; su vestido era blanco como la nieve, y el cabello de su cabeza era como lana pura; su trono era llamas de fuego, y sus ruedas ardían en llamas. Un río de fuego fluyó y se fue ante él; miles y miles le sirvieron, y miríadas de miríadas estaban ante él; se estableció el juicio y se abrieron los libros. ** {class = versoQ} ** Daniel 7: 9,10 ** {class = bookVerse}  

** Marque las declaraciones con V cuando sean verdaderas y F cuando sean falsas **

a) () La escena era de destrucción total.   
b) () Daniel, en visión, contempló la escena que ocurriría en el cielo a partir de 1844.   
c) () Daniel vio que la corte se acomodaba.   
d) () Los libros de cada persona fueron examinados ante Dios.   
e) () El Anciano que preside el Juicio es Dios mismo.   

** ¿Quién es el juez? ** {clase = pregunta} ** Juan 5:22; Hechos 17:31 ** {class = bookQ}  
** Y el Padre a nadie juzga, pero el Hijo ha confiado todo el juicio. ** {class = versoQ} ** John 5:22 ** {class = bookVerse}  
** Porque estableció un día en que juzgará al mundo con justicia, por medio de un hombre que destinó y creyó ante todos, resucitándolo de entre los muertos. ** {class = versoQ} ** Hechos 17:31 * * {class = bookVerse}  

** Marque la respuesta correcta: **  
a) En esta corte celestial, Dios confió el juicio a Su Hijo, Jesucristo.   
b) El juez es Dios mismo.   
c) Se encargará un juez de la Tierra.   

** ¿Quiénes son los testigos? ** {class = question} ** Apocalipsis 5:11 ** {class = bookQ}  
** Vi y escuché una voz de muchos ángeles alrededor del trono de seres vivientes y ancianos, cuyo número era de millones de millones y miles de miles ... ** {class = versoQ} ** Apocalipsis 5: 11 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) Los hombres son los testigos.   
b) Los ángeles son los testigos.   
c) Los santos de Dios son los testigos.   

!!! Nota ""
	 Los ángeles del Señor están siempre al lado de los fieles para protegerlos y, por tanto, contemplar como testigos, todos los escenarios de la vida de estas personas. Por lo tanto, son testigos oculares fieles de la corte de Dios. (Vea también: Daniel 7:10)

## Lunes

** Yo estaba mirando en mis visiones de la noche, y he aquí, uno vino con las nubes del cielo como el Hijo del Hombre, y fue al Anciano de Días, y se lo llevaron. gloria y reino, para que le sirvan pueblos, naciones y hombres de todas las lenguas; Su dominio es un dominio eterno, que no pasará, y Su reino nunca será destruido ** {clase = verso} ** Daniel 7: 13,14 ** {clase = libro}.
...
** ¿Quién es nuestro abogado defensor? ** {clase = pregunta} ** I Juan 2: 1 ** {clase = libroQ}  
** Hijitos míos, estas cosas les escribo para que no pequen. Sin embargo, si alguien peca, tenemos un abogado para con el Padre, Jesucristo, el Justo; ** {class = versoQ} ** I Juan 12: 1 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) Nuestro abogado es el ángel que nos acompañó aquí en la Tierra   
b) Cada uno elige su abogado.   
c) Jesucristo es nuestro abogado.   

!!! Nota ""
	 Jesucristo, además de ser el juez de la corte celestial, también es nuestro abogado. Defiéndenos ante el acusador.

** ¿Quién es el acusador? ** {class = question} ** Apocalipsis 12: 9-10 ** {class = bookQ}  
** Y el gran dragón, la serpiente antigua, que se llama diablo y Satanás, el seductor del mundo entero, fue arrojado, sí, fue arrojado a la tierra, y con él, sus ángeles ... porque el acusando a nuestros hermanos, el mismo que los acusa día y noche, ante nuestro Dios. ** {class = versoQ} ** Apocalipsis 12: 9,10 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) El acusador es Satanás.   
b) El acusador es juez.   
c) No hay acusador en este juicio.   

!!! Nota ""
	 Satanás nos acusa constantemente ante Dios. Cada acción incorrecta que tomamos es una excusa que le damos para acusarnos. Den gracias a Dios por tener a Cristo en el cielo como nuestro abogado para defendernos.
...
En el libro conmemorativo, se registran las buenas obras de los que temen al Señor y de los que recuerdan Su nombre. Allí se colocan tus palabras de fe y tus actos de amor. Cada tentación resistida, cada mal vencido, cada palabra de tierna piedad expresada, queda fielmente registrada. Como todo acto de sacrificio, todo sufrimiento y tristeza soportados por Cristo están marcados allí. ** ... recogiste mis lágrimas en tu piel; ¿No están escritos en tu libro? ** {class = versoQ} ** Salmo 56: 8 ** {class = book}. ** Porque Dios llevará ante la justicia todas las obras, incluso las que están ocultas, sean buenas o malas ** {clase = verso} ** Eclesiastés 12; 14 ** {clase = libro}. ** Les digo que toda palabra frívola que pronuncien los hombres, será contabilizada en el Día del Juicio;  
Los propósitos secretos del corazón y los motivos aparecen en el registro infalible, porque el Señor ** sacará a la luz las cosas ocultas de las tinieblas, pero también manifestará los designios de los corazones ** {class = versoQ} ** I Corintios 4: 5 * * {class = bookVerse}  

** ¿Cuándo está escrito el nombre de alguien en el libro de la vida? ** {clase = pregunta} ** Juan 5:24; Filipenses 4: 3 ** {class = bookQ}
** De cierto, de cierto les digo: el que oye mi palabra y cree al que me envió, tiene vida eterna; no entra en juicio, sino que ha pasado de muerte a vida. ** {class = versoQ} ** Juan 5 : 24 ** {clase = bookVerse}  
** A ti, fiel compañero de yugo, también te pido que los ayudes, porque juntos lucharon conmigo en el evangelio, también con Clemente y con los otros colaboradores míos, cuyos nombres se encuentran en el Libro de la Vida. ** {class = versoQ} ** Filipenses 4: 3 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) Cuando nacemos.   
b) Cuando entramos al servicio de Cristo   
c) Cuando nos bautizamos.   

Cuando entramos al servicio de Cristo, nos convertimos en portadores de la Vida Eterna y nuestros nombres están inscritos en el Libro de la Vida.

** ¿Quiénes serán juzgados? ** {clase = pregunta} ** I Pedro 4:17; II Corintios 5:10 ** {class = bookQ}  
** Porque ha llegado el momento de iniciar el juicio en la casa de Dios; ahora, si viene primero por nosotros, ¿cuál será el fin de aquellos que no obedecen el evangelio de Dios? ** {class = versoQ} ** I Pedro 4:17 ** {class = bookVerse}  
** Porque es importante que todos comparezcamos ante el tribunal de Cristo, para que cada uno reciba según el bien o el mal que haya hecho a través del cuerpo. ** {class = versoQ} ** II Corintios 5:10 ** { class = bookVerse}  
...
** ¿Los que no creen en Jesús serán juzgados en este tribunal? ** {clase = pregunta} ** Juan 3: 18,19 ** {clase = libroQ}  
** El que en él cree, no es condenado; el que no cree, ya ha sido condenado, porque no cree en el nombre del unigénito Hijo de Dios. ** {class = versoQ} ** John 3: 18,19 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) Sí b) No c) Solo algunos de los malvados.   

!!! Nota ""
	 El salario del pecado es muerte. La muerte pasó a todos los hombres por eso ... todos pecaron (** Romanos 6; 23; 5:12 ** {clase = libro}). Entonces, a menos que se sometan al guía espiritual de Jesús, están condenados. Por lo tanto, no necesitan que sus casos sean evaluados en el Juicio Investigador que comenzó en 1844. La Biblia revela que el caso de los malvados será tratado en otra ocasión, al final de los mil años, después de la venida de Jesús.

## Miércoles

Cuando se abren los libros de registro del Juicio, se revisan ante Dios las vidas de todos los que creyeron en Jesús. Comenzando por los primeros que vivieron en la Tierra, nuestro Abogado presenta los casos de cada generación sucesiva, terminando con los vivos. Se menciona cada nombre, cada caso se investiga a fondo. Se aceptan nombres y se rechazan los nombres. Cuando alguien tiene pecados que permanecen en los libros de registro, para los cuales no hubo arrepentimiento ni perdón, su nombre será omitido del libro de la vida y el relato de sus buenas obras se borrará del libro de memoria de Dios.

A todos aquellos que se han arrepentido verdaderamente del pecado y que, por fe, han reclamado la sangre de Jesucristo como su sacrificio expiatorio, se les ha agregado el perdón (apuesto) a su nombre en los libros del cielo; a medida que se conviertan en participantes de la justicia de Cristo, y si se descubre que su carácter está en armonía con la ley de Dios, sus pecados serán borrados y ellos mismos serán considerados dignos de la vida eterna.

** ¿Cómo se hace el juicio? ** {class = question} ** Apocalipsis 20:12 ** {class = bookQ}  
** También vi a los muertos, grandes y pequeños, de pie ante el trono. Luego se abrieron los libros. Se abrió otro libro, el Libro de la vida. Y los muertos fueron juzgados, según sus obras, según lo que estaba escrito en los libros. ** {class = versoQ} ** Apocalipsis 20:12 ** {class = bookVerse}  
...
c) () Si esta persona confesó sus pecados y aceptó a Jesús como su Salvador personal y busca vivir una vida santa y sin pecado en Cristo Jesús, será salvo.   
d) () A continuación, recibirá su recompensa basada en el libro de buenas obras (memorial).   
e) () Si esta persona no vive una vida digna de un cristiano, recibirá un salario por su pecado (muerte).   
f) () Si el nombre de la persona está en el Libro de la Vida, será salvo, no importa lo que hizo, porque aceptó a Jesús.   

!!! Nota ""
	 Cada tribunal tiene una ley por la que se juzgan los actos de quienes se presentan a juicio. La ley de Dios es el estándar por el cual el carácter y la vida de los hombres se medirán en el juicio. El sabio dice: ** Teme a Dios y guarda sus mandamientos; porque este es el deber de todo hombre. Porque Dios llevará toda la obra ante la justicia. ** {clase = verso} ** Eclesiastés 12: 13,14. ** {clase = libro}

El apóstol Santiago amonesta a sus hermanos: ** Habla y haz así, ya que deben ser juzgados por la ley de la libertad. ** {class = versoQ} ** Santiago 2:12 ** {class = bookVerse}  

** ¿Cuál es el estándar de juicio? ** {clase = pregunta} ** Santiago 2: 10-12 ** {clase = libroQ}  
** Porque cualquiera que guarda toda la ley, pero tropieza en un punto, se hace culpable de todos. Porque el que dijo: "No cometerás adulterio", también dijo: "No matarás". Ahora bien, si no cometes adulterio, sino matas, serás transgresor de la ley. Habla de tal manera y de tal manera que procedan como aquellos que serán juzgados por la ley de la libertad. ** {class = versoQ} ** Santiago 2: 10-12 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) La norma es la sinceridad de cada uno.   
b) La norma es la ley de Dios.   
c) Según lo que creían en su mente.   

## Jueves


** Si alguien aceptó a Cristo Jesús pero no le permitió hacer una transformación en su vida, superando sus pecados, ¿qué le pasará a la persona? ** {clase = pregunta} ** Éxodo 32:33; Salmo 69: 27-28 ** {class = bookQ}  
** Entonces el Señor le dijo a Moisés: Borraré de mi libro a todo el que pecare contra mí. ** {class = versoQ} ** Éxodo 32:33 ** {class = bookVerse}  
** Agrega iniquidad a la iniquidad, y no disfrutes de tu absolución. Ser borrado del Libro de los Vivientes y no tener registro con los justos. ** {class = versoQ} ** Salmo 69: 27,28 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) Su nombre será tachado del Libro de la Vida. La muerte será condenada.   
b) Tendrán otra oportunidad de arrepentirse.   
c) Disfrutarán de la absolución de Dios.   

!!! Nota ""
	 Cuando se analice el caso de esta persona que practica pecados contra Dios, su nombre será borrado del Libro de la Vida para siempre y se borrará el registro de los justos (memorial de buenas obras).

** ¿Qué decreto se hace al concluir el juicio? ** {clase = pregunta} ** Apocalipsis 22:11 ** {clase = libroQ}  
** Mantenga al injusto haciendo injusticia, mantenga al inmundo aún siendo inmundo; los justos continúan en la práctica de la justicia y el santo continúa santificándose. ** {class = versoQ} ** Apocalipsis 22:11 ** {class = bookVerse}  
...
c) () La sentencia final será revocable.   
d) () Cuando Cristo termine su obra, todos los casos serán sellados por la eternidad.   

** ¿Cuándo comenzó este juicio? ** {clase = pregunta} ** Daniel 8:14 ** {clase = libroQ}  
** Me dijo: Hasta dos mil trescientas tardes y mañanas; y el santuario será purificado. ** {class = versoQ} ** Daniel 8:14 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) Al finalizar las 2300 tardes y mañanas.   
b) Cuando Jesús regrese.   
c) Cuando cada uno muere.   

!!! Nota ""
	 Como vimos en los dos últimos estudios, la purificación del santuario fue una obra en la que cada caso fue analizado ante Dios y los pecados del pueblo arrepentido fueron borrados. Esta obra comenzó en el cielo el 22 de octubre de 1844.

## Viernes


Hemos visto hasta ahora que necesitamos un corazón puro para ser considerados aptos para la vida eterna en el Juicio del Cielo, pero el hecho es que hoy los hombres tienen un corazón inmundo. Y cuando ven que el mal se extiende entre ellos, muchos llegan a declarar como el patriarca Job: ** ¿Quién sacará al puro del inmundo? Nadie ** {clase = verso} ** Job 14: 4 ** {clase = libro}. Pero lo que es imposible para los hombres, es posible para Dios.

** ¿Qué prometió Dios hacer por aquellos que se arrepientan de sus pecados y se conviertan? ** {clase = pregunta} ** Hechos 3:19 ** {clase = libroQ}  
** Arrepiéntete, por tanto, y conviértete, para que tus pecados sean borrados, y así lleguen tiempos de refrigerio en la presencia del Señor. ** {class = versoQ} ** Hechos 3:19 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) Que los pecados fueran borrados.   
b) Que serían borrados de la presencia del Señor.   
c) Que no habría tiempos de enfriamiento.   

** ¿Cuál fue la petición de David cuando confesó su pecado a Dios? ** {clase = pregunta} ** Salmo 51: 1 ** {clase = libroQ}  
** Ten piedad de mí, oh Dios, conforme a tu misericordia; borra mis transgresiones, conforme a la multitud de tus misericordias. ** {class = versoQ} ** Salmo 51: 1 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) Que sea aniquilado ante Dios.   
b) Que Dios se apiade de él y borre sus pecados.   
c) Que Dios se apiade de sus transgresiones.   

!!! Nota ""
	 En la escena del juicio que estamos estudiando, desde la cual Daniel vio su comienzo en el Cielo, comenzó la obra de borrar los pecados de aquellos que se arrepintieron sinceramente y se convirtieron. El juicio comienza con la obra de limpiar el santuario. Ambos van juntos. Vimos que las 2300 tardes y mañanas terminaron en 1844, cuando comenzó la obra de purificación. Entonces concluimos que en esa misma fecha inició el Juzgado de Instrucción.
...
Jesús nos recibió como niños. Y como tal, espera que le confesemos como el padre de nuestra eternidad, autor de nuestra fe y motivo de nuestra esperanza. Si lo amamos y creemos en Él, ciertamente reconoceremos nuestra conexión con Cristo ante todas las personas con las que nos relacionamos. Y Jesús dijo: ** todo el que me confiese delante de los hombres, yo también confesaré delante de Mi Padre que está en los Cielos ** {class = versoQ} ** Mateo 10:32 ** {class = bookVerse}  
...
El juicio de Dios no cancela el evangelio. No cambia la enseñanza de que somos salvos por fe, en ella solo verifica quién tuvo verdadera fe para la salvación, y en ella perseveró hasta el fin.

** ¿Qué clase de personas entrarán en el reino de los cielos? ** {clase = pregunta} ** Mateo 7:21 ** {clase = libroQ}  
** No todo el que me dice: ¡Señor, Señor! entrará en el reino de los cielos, pero el que hace la voluntad de mi Padre que está en los cielos. ** {class = versoQ} ** Mateo 7:21 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) La clase de los que dicen: Señor, Señor.   
b) La clase de aquellos que hacen la voluntad de Dios.   
c) La clase que cree y no obedece.   

Desde que comenzó el juicio, en '1844', los casos de los que han muerto pasan ante Dios. En 2001, los vivos comenzaron a ser juzgados, Jesús declara que los santificados deben continuar siendo santificados cuando Él termine Su obra de juzgar. Entonces, necesitamos el poder de Jesús en nuestras vidas para luchar y superar toda falta de carácter a fin de estar limpios ante Él en Su venida. La Biblia dice que Jesús viene a buscar una iglesia pura, lista, perfecta y adornada para su esposo, que es Cristo. Los de este grupo siguen al Cordero dondequiera que va. Fueron comprados como primicias para Dios y para el Cordero. Y no se encontró error en su boca; porque son irreprensibles ante el trono de Dios. ¡Amén!
...
b) El mensaje del primer ángel habla de la necesidad de cuidar la salud.   
c) El mensaje del primer ángel habla del primer ángel en entrar al cielo.   

** ¿Qué representa el símbolo "" ángel "* en la profecía bíblica? ** {clase = pregunta} ** Gálatas 4:14 ** {clase = libroQ}  
** Y como mi enfermedad en la carne fue una tentación para ti, sin embargo, no me mostraste desprecio ni disgusto; más bien, me recibiste como un ángel de Dios, como Cristo Jesús mismo. ** {class = versoQ} ** Gálatas 4:14 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) Ángel representa un ser celestial.   
b) Ángel representa al mensajero.   
...
** ¿Hasta dónde llega el mensaje del Evangelio Eterno? ** {class = question} ** Mateo 24:14 ** {class = bookQ}  
** Y este evangelio del reino será predicado en todo el mundo, para testimonio a todas las naciones. Entonces llegará el fin. ** {class = versoQ} ** Mateo 24:14 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) Será predicado en toda la ciudad.   
b) Se predicará en todo el país.   
c) Se predicará en todo el mundo.   

** ¿Qué es el Evangelio Eterno? ** {class = question} ** Romanos 1:16 ** {class = bookQ}  
** Porque no me avergüenzo del evangelio, porque es poder de Dios para la salvación de todo aquel que cree, primero del judío y también del griego. ** {class = versoQ} ** Romanos 1:16 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) El verdadero evangelio, el evangelio eterno, es el poder de Dios para nuestra salvación.   
b) El Evangelio Eterno es un nombre simple.   
c) El Evangelio Eterno es poder de los hombres para nuestra salvación.   

** ¿Cómo entender la expresión "gran voz"? ** {clase = pregunta} ** Lucas 1: 41,42 ** {clase = libroQ}  
** Al escuchar este saludo de María, la niña se estremeció en el vientre; luego, Isabel fue poseída por el Espíritu Santo. Y exclamó a gran voz: ¡Bendita tú entre las mujeres, y bendito el fruto de tu vientre! ** {class = versoQ} ** Lucas 1: 41,42 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) Es cuando gritamos fuerte en la iglesia.   
b) Está hablando lleno del Espíritu de Dios.   
c) Es hablar en voz alta con los demás.   
...
** ¿Qué es temer a Dios, según la Biblia? ** {clase = pregunta} ** Eclesiastés 12: 13,14 ** {clase = libroQ}  
** De todo lo que se ha escuchado, la suma es: Teme a Dios y guarda sus mandamientos; porque este es el deber de todo hombre. Porque Dios llevará ante la justicia todas las obras, incluso las que están ocultas, sean buenas o malas. ** {class = versoQ} ** Eclesiastés 12: 13,14 ** {class = bookVerse}  
...
1. Qué comemos y bebemos
	- ** Por lo tanto, ya sea que coma o beba, o haga otra cosa, haga todo para la gloria de Dios. ** {class = versoQ} ** I Corintios 10:31 ** {class = book}
1. A través de nuestro cuerpo (vida)
	- ** ¿O no sabéis que vuestro cuerpo es templo del Espíritu Santo, que habita en vosotros, procedente de Dios, y que no sois vosotros mismos? Porque fuiste comprado a buen precio; glorifica, pues, a Dios en tu cuerpo y en tu espíritu, que son de Dios. ** {class = versoQ} ** 1 Corinthians 6: 19,20 ** {class = book}
1. Cuando reconocemos el sacrificio de Cristo
	- ** Y cuando Jesús clamó a gran voz, dijo: Padre, en tus manos encomiendo mi espíritu. Y dicho esto, expiró. Y el centurión, viendo lo que había sucedido, dio gloria a Dios, diciendo: En realidad, este hombre era justo. ** {class = versoQ} ** Lucas 23: 46-47 ** {class = book}
1. Cuando damos buenos frutos
	- ** En esto es glorificado mi Padre, que llevéis mucho fruto; y así seréis mis discípulos. ** {clase = versoQ} ** Juan 15: 8 ** {clase = libro}
1. Cuando hacemos la voluntad de Dios para nuestras vidas
	- ** Te glorifiqué en la tierra, habiendo realizado el trabajo que me diste que hiciera. ** {class = versoQ} ** John 17: 4 ** {class = book}
1. Cuando nos arrepentimos de nuestros pecados
	- ** Y los hombres se quemaron con gran calor, y blasfemaron el nombre de Dios, que tiene poder sobre estas plagas; y no se arrepintieron para darle gloria. ** {class = versoQ} ** Apocalipsis 16: 9 ** {class = book}
1. Cuando creemos implícitamente en Dios
	- ** Quien, en esperanza, creyó contra esperanza, tanto que llegó a ser padre de muchas naciones, según lo que se le dijo: Así será tu descendencia. Y sin debilitarse en la fe, no prestó atención a su propio cuerpo, ya adormecido, ya que tenía casi cien años, ni siquiera al adormecimiento del vientre de Sara. Y no dudó de la promesa de Dios por su incredulidad, pero fue fortalecido en la fe, dando gloria a Dios. ** {class = versoQ} ** Romanos 4: 18-20 ** {class = book}
...
** ¿Quién es a quien estamos invitados a adorar? ** {class = question} ** Apocalipsis 14: 7 ** {class = bookQ}  
** Diciendo en voz alta: Temed a Dios y dadle gloria, porque ha llegado la hora de su juicio; y adorad al que hizo el cielo y la tierra y el mar y las fuentes de agua. ** {class = versoQ} ** Apocalipsis 14: 7 ** {class = bookVerse}  
...
** ¿Quién es el Creador de todas las cosas? ** {class = question} ** Génesis 1: 1 ** {class = bookQ}  
** En el principio, Dios creó los cielos y la tierra. ** {class = versoQ} ** Génesis 1: 1 ** {class = bookVerse}  
...
Ver también: ** Génesis 2: 1-3; Éxodo 20: 10.11; Salmo 95: 3-6. ** {clase = libro}

** ¿Cuántos dioses hay? ** {clase = pregunta} ** I Corintios 8: 5,6 ** {clase = libroQ}  
** Porque, aunque también hay algunos que se llaman dioses, ya sea en el cielo o en la tierra, como hay muchos dioses y muchos señores, sin embargo, para nosotros hay un solo Dios, el Padre, de quien todas las cosas son y para quienes existimos; y un Señor, Jesucristo, para quien somos todas las cosas, y nosotros también para él. ** {class = versoQ} ** I Corintios 8: 5,6 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) Hay muchos dioses.   
b) Hay un solo Dios, el Padre.   
...
** En las palabras de Cristo, ¿quién es el único Dios? ** {clase = pregunta} ** Juan 17: 1,3 ** {clase = libroQ}  
** Habiendo dicho estas cosas, Jesús levantó los ojos al cielo y dijo: Padre, ha llegado la hora; glorifica a tu Hijo, para que el Hijo te glorifique a ti. Y la vida eterna es esta: haz que te conozcan a ti, el único Dios verdadero, ya Jesucristo, a quien enviaste. ** {class = versoQ} ** Juan 17: 1,3 ** {class = bookVerse}  
...
** ¿Existe realmente un solo Dios? ** {clase = pregunta} ** I Timoteo 1:17; 2: 5 ** {clase = bookQ}  
** Así, al Rey eterno, inmortal e invisible, un solo Dios, honor y gloria por los siglos de los siglos. ¡Amén! ** {class = versoQ} ** I Timoteo 1:17 ** {class = bookVerse}  
** Porque hay un solo Dios y un solo Mediador entre Dios y los hombres, Cristo Jesús, hombre. ** {class = versoQ} ** I Timoteo 2: 5 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) Hay un solo Dios como dice la Palabra de Dios.   
b) Hay dos: Dios Padre y Dios Hijo.   
c) Existe una trinidad compuesta por tres dioses.   

## Miércoles


** ¿Qué aprendemos del primer mandamiento de la Ley de Dios? ** {clase = pregunta} ** Éxodo 20: 3 ** {clase = libroQ}  
** No tendrás otros dioses delante de mí. ** {class = versoQ} ** Éxodo 20: 3 ** {class = bookVerse}  
...
c) () No importa a quién adorar, solo sé honesto   

** ¿Cuál es la consideración de Jesús del Padre en Apocalipsis? ** {clase = pregunta} ** Apocalipsis 3:12 ** {clase = libroQ}  
** Al ganador, lo convertiré en una columna en el santuario de mi Dios, y de allí nunca saldrá; También grabaré en ella el nombre de mi Dios, el nombre de la era de mi Dios, la nueva Jerusalén que desciende del cielo, de mi Dios, y mi nuevo nombre. ** {class = versoQ} ** Apocalipsis 3:12 ** {clase = bookVerse}  

** Marque la respuesta correcta: **  
a) Jesús considera a su padre como una trinidad.   
b) Jesús considera a su Padre digno de honor.   
c) Jesús considera que su Padre es su Dios.   
...
** Cuando Jesús preguntó a los discípulos qué pensaban las personas que era Él, ¿qué respondieron? ** {clase = pregunta} ** Mateo 16:14 ** {clase = libroQ}  
** Y ellos respondieron: Algunos dicen: Juan el Bautista; otros: Elias; y otros: Jeremías o uno de los profetas. ** {class = versoQ} ** Mateo 16:14 ** {class = bookVerse}  

a) Juan el Bautista o Elías.   
b) Juan el Bautista, Elías o Jeremías.   
c) Juan el Bautista, Elías, Jeremías o algún otro profeta.   

** Y cuando Jesús les preguntó qué pensaban que era Él, ¿qué respondieron los discípulos? ** {clase = pregunta} ** Mateo 16:16 ** {clase = libroQ}  
** Respondiendo a Simón Pedro, dijo: Tú eres el Cristo, el Hijo del Dios viviente. ** {class = versoQ} ** Mateo 16:16 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) Respondieron que no sabían.   
b) Pedro respondió que él era el Cristo, el Hijo de Dios.   
c) Respondieron que Él era Dios mismo.   

** ¿Cuál fue la respuesta de Jesús a Pedro cuando le respondió? ** {clase = pregunta} ** Mateo 16:17 ** {clase = libroQ}  
** Entonces Jesús le dijo: Bienaventurado eres, Simón Barjonas, porque no fue carne y sangre lo que te reveló, sino mi Padre que está en los cielos. ** {class = versoQ} ** Mateo 16:17 ** { class = bookVerse}  

** Marque la respuesta correcta: **  
a) Jesús dijo que Pedro estaba equivocado.   
b) Jesús dijo que Dios mismo le había revelado a Pedro que Él, Jesús, era el Hijo de Dios.   
c) Jesús le preguntó a Pedro de dónde había sacado esta idea.   

## Jueves


** ¿Quién amó al mundo dándonos a quién? ** {clase = pregunta} ** Juan 3:16 ** {clase = libroQ}  
** Porque tanto amó Dios al mundo que dio a su Hijo unigénito, para que todo el que crea en él no se pierda, sino que tenga vida eterna. ** {class = versoQ} ** John 3:16 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) Dios nos dio ángeles.   
b) Dios se dio a sí mismo por nosotros.   
c) Dios dio a su Hijo unigénito.   

!!! Nota ""
	 Cristo es el unigénito Hijo de Dios. La palabra * "unigénito" * significa * "unigénito (uni) engendrado (genito)" * Cristo es el unigénito Hijo de Dios. Los ángeles y los hombres son seres creados y no generados. (ver ** Juan 3:18; 1 Juan 4: 9 ** {clase = libro})
     
** Y aquí hay una voz del cielo que dice: Este es mi Hijo amado, en quien tengo complacencia ** {clase = verso} ** Mateo 3:17 ** {clase = libro}.   
** Seguía hablando, cuando una nube luminosa los envolvió; y he aquí, una voz vino de la nube, diciendo: Este es mi Hijo amado, en quien tengo complacencia; Lo escuché ** {class = versoQ} ** Mateo 17: 5 ** {class = bookVerse}  

** ¿Quién es la sabiduría de Dios? ** {clase = pregunta} ** I Corintios 1:24 ** {clase = libroQ}  
** Pero a los llamados, tanto judíos como griegos, predicamos a Cristo, el poder de Dios y la sabiduría de Dios. ** {class = versoQ} ** I Corintios 1:24 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) Cristo es la sabiduría de Dios.   
b) El ángel Gabriel es la sabiduría de Dios.   
c) El espíritu santo es la sabiduría de Dios.   

** ¿Qué dice la Biblia sobre el nacimiento de Cristo - Sabiduría de Dios, cómo se generó en el cielo? ** {class = question} ** Proverbios 8: 22-25 ** {class = bookQ}   
** El Señor me tuvo al principio de su obra, antes que sus obras más antiguas. Desde la eternidad fui establecido, desde el principio, antes del principio de la tierra. Antes de que hubiera abismos, yo nací, y aún antes de que hubiera fuentes cargadas de agua. Antes de que se establecieran las montañas, antes de que hubiera colinas, yo nací. ** {class = versoQ} ** Proverbios 8: 22-25 ** {class = bookVerse}  
...
** Después de decir que el único Dios es el Padre, ¿qué se dice que es Jesús? ** {clase = pregunta} ** I Corintios 8: 6 ** {clase = libroQ}  
** Sin embargo, para nosotros hay un solo Dios, el Padre, de quien son todas las cosas y para quien existimos; y un Señor, Jesucristo, para quien somos todas las cosas, y nosotros también para él. ** {class = versoQ} ** I Corintios 8: 6 ** {class = bookVerse}  
...
** ¿Se puede adorar a Jesús? ** {clase = pregunta} ** Hebreos 1: 6; Juan 5:23 ** {clase = libroQ}  
** Y nuevamente, al presentar al Primogénito al mundo, dice: Y todos los ángeles de Dios lo adoran. ** {class = versoQ} ** Hebreos 1: 6 ** {class = bookVerse}  
** Para que todos honren al Hijo como honran al Padre. El que no honra al Hijo, no honra al Padre que lo envió. ** {class = versoQ} ** Juan 5:23 ** {class = bookVerse }  

** Marque la respuesta correcta: **  
a) No, solo podemos adorar a Dios Padre.   
b) Sí, porque Dios mismo ordenó la adoración de Su Hijo Jesucristo.   
c) También podemos adorar a los santos y ángeles.   

## Viernes

** ¿La presencia de quién es digna de la presencia de quién? ** {clase = pregunta} ** Juan 14: 9; 1:18 ** {clase = bookQ}  
** Jesús le dijo: Felipe, hace tanto tiempo que estoy contigo y no me conoces. El que me ve, ve al Padre; ¿cómo dices: Muéstranos al Padre? ** {class = versoQ} ** Juan 14: 9 ** {class = bookVerse}  
** Nadie jamás ha visto a Dios; el Hijo unigénito, que está en el seno del Padre, es quien lo reveló. ** {class = versoQ} ** Juan 1:18 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) La presencia de Jesús es válida para la presencia de los ángeles de Dios.   
b) La presencia de Jesús es válida para la presencia del Padre.   
c) Solo la presencia de Jesús lo vale   

** ¿Es Cristo también el Creador? ** {clase = pregunta} ** Juan 1: 3 ** {clase = libroQ}  
** Todas las cosas se hicieron a través de él, y sin él, nada de lo que se hizo se hizo. ** {class = versoQ} ** John 1: 3 ** {class = bookVerse}  
...
La Biblia nos dice que todas las cosas fueron hechas por medio de Cristo, es decir, el Padre es el Creador y Jesús el ejecutor. (Vea también: ** Colosenses 1: 15-17; Hechos 2:22; Juan 5:30; 6:38 ** {clase = libro})

** QUIÉN O QUÉ ES EL ESPÍRITU SANTO **

** ¿De qué es llamado el Espíritu Santo? ** {clase = pregunta} ** Hechos 2:38; 10:45 ** {clase = bookQ}  
** Pedro les respondió: “Arrepiéntanse, y bautícese cada uno de ustedes en el nombre de Jesucristo para la remisión de sus pecados, y recibirán el don del Espíritu Santo. ** {class = versoQ} ** Hechos 2:38 ** {class = bookVerse}  
** Y los fieles que estaban circuncidados, que habían venido con Pedro, estaban asombrados, porque el don del Espíritu Santo también se derramaba sobre los gentiles. ** {class = versoQ} ** Hechos 10:45 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) El Espíritu Santo se llama * "don" *.   
b) El Espíritu Santo es la tercera persona de la trinidad en la Biblia.   
c) El Espíritu Santo se llama Dios.   

** ¿Qué nos es dado por medio del Espíritu Santo? ** {clase = pregunta} ** Hechos 1: 8 ** {clase = libroQ}  
** Pero recibirán poder cuando el Espíritu Santo venga sobre ustedes, y serán mis testigos tanto en Jerusalén como en toda Judea y Samaria y hasta los confines de la tierra. ** {class = versoQ} ** Hechos 1: 8 ** {class = bookVerse}  
...
** ¿Cuáles son las características del Espíritu Santo? ** {clase = pregunta} ** Juan 14: 16-18 ** {clase = libroQ}  
** Y oraré al Padre, y él les dará otro Consolador, para que permanezca con ustedes para siempre, el Espíritu de verdad, que el mundo no puede recibir, porque no lo ve ni lo conoce; pero lo conoces, porque vive contigo y estará en ti. No los dejaré huérfanos; Volveré contigo. ** {class = versoQ} ** Juan 14: 16-18 ** {class = bookVerse}  

** Marque las declaraciones con V cuando sean verdaderas y F cuando sean falsas. **

a) () Espíritu de verdad: Jesús es la verdad. ** Jesús les respondió: Yo soy el camino, la verdad y la vida ... ** {clase = versoQ} ** (Juan 14: 6) ** {clase = libro}   
b) () El mundo no conoce: El mundo no conoció a Jesús. ** El Verbo estaba en el mundo, el mundo fue hecho por Él, pero el mundo no lo conoció. ** {class = versoQ} ** (Juan 1:10) ** {class = book}   
c) () Habitaba con los discípulos: Jesús vivía con ellos en ese momento. ** El Verbo se hizo carne y habitó entre nosotros ... ** {clase = versoQ} ** (Juan 1:14) ** {clase = libro}   
d) () Sería en ellos: Jesús dijo que Él mismo estaría en los discípulos. ** En ese día sabrás que yo estoy en mi Padre, y tú en mí y yo en ti. ** {class = versoQ} ** (Juan 14:20) ** {class = book}   

!!! Nota ""
	 Todas las características que Cristo dio acerca del Espíritu Santo fueron las características de él mismo.

** ¿De quién es el Espíritu Santo? ** {clase = pregunta} ** 1 Pedro 1:11; Gálatas 4: 6; Romanos 8:14 ** {class = bookQ}  
** Investigando cuidadosamente, cuál es la ocasión o cuáles son las circunstancias oportunas, indicadas por el Espíritu de Cristo, quién estuvo en ellas ... ** {class = versoQ} ** I Pedro 1:11 ** {class = bookVerse}  
** Y porque son hijos, Dios envió el Espíritu de su Hijo a nuestros corazones, que clama: ¡Abba, Padre! ** {class = versoQ} ** Gálatas 4: 6 ** {class = bookVerse} ** Para todos los que son guiados por el Espíritu de Dios son hijos de Dios. ** {clase = verso} ** Romanos 8:14 ** {clase = libroVerso}  

** Marque la respuesta correcta: **  
a) El Espíritu Santo es el Espíritu de Dios y de Cristo. Proceda 'Ellos a nosotros.   
b) El Espíritu Santo es el espíritu de los profetas.   
c) El Espíritu Santo es la tercera persona de la trinidad.   

## Sábado


** ¿Cómo comunicó Jesús el Espíritu Santo acerca de los discípulos? ** {clase = pregunta} ** Juan 20:22 ** {clase = libroQ}  
** Y habiendo dicho esto, sopló sobre ellos y les dijo: Recibid el Espíritu Santo. ** {class = versoQ} ** John 202: 22 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) Jesús habló y vino.   
b) Jesús sopló sobre los discípulos el Espíritu Santo.   
c) Jesús impuso o impuso las manos sobre los discípulos.   

** ¿Es un ser personal independiente del Padre y de Cristo? ** {clase = pregunta} ** Juan 15:26 ** {clase = libroQ}  
** Sin embargo, cuando el Consolador, a quien yo os enviaré del Padre, el Espíritu de verdad, que procede de él, me dé testimonio; ** {class = versoQ} ** Juan 15:26 ** { class = bookVerse}  

** Marque la respuesta correcta: ** () Sí () No

** ¿Quién nos envía el Espíritu Santo? ** {clase = pregunta} ** Juan 16: 7 ** {clase = libroQ}  
** Pero les digo la verdad: ustedes deben ir, porque si yo no voy, el Consolador no vendrá por ustedes; pero si voy, te lo enviaré. ** {class = versoQ} ** Juan 16: 7 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) El Padre envía al Consolador, el Espíritu Santo.   
b) Los ángeles envían al Espíritu Santo.   
c) Cristo recibe el Espíritu Santo del Padre y nos envía este maravilloso regalo.   

** ¿Quién es el Espíritu Santo? ** {clase = pregunta} ** II Corintios 3:17 ** {clase = libroQ}  
** Ahora el Señor es el Espíritu; y donde está el Espíritu del Señor, hay libertad. ** {class = versoQ} ** II Corintios 3:17 ** {class = bookVerse}  

** Marque las declaraciones con V cuando sean verdaderas y F cuando sean falsas. **

a) () Jesús es nuestro Señor (** I Corintios 8: 6 ** {clase = libro}), y la Palabra dice que este Señor es el Espíritu.   
b) () A través del Espíritu se nos comunica la vida de Cristo (** Efesios 3: 16-17 ** {clase = libro}) y Cristo viene a vivir en nuestros corazones.   
c) () Jesús, Dios y el Espíritu Santo son todos uno y el mismo Dios.   

!!! Nota ""
    Vemos, por tanto, que hay un solo Dios, un Ser personal, espiritual, creador de todas las cosas, omnipotente, omnisciente y eterno; infinito en sabiduría, santidad, justicia, bondad, verdad y misericordia; inmutable; y presente en todas partes por su representante el Espíritu Santo.
    Que hay un Señor Jesucristo, el Hijo del Padre Eterno, por quien todas las cosas fueron creadas y por quien existen; que tomó la naturaleza del hombre para la redención de nuestra raza caída.
...
!!! cita de fondo
    Otro ángel lo siguió, el segundo, diciendo: Ha caído, ha caído la gran Babilonia, que ha hecho beber a todas las naciones del vino del furor de su prostitución. ** Apocalipsis 14: 6,7 ** {clase = libro}

## Domingo

Un ángel siguió al primero para enviar un mensaje a todos los habitantes de la Tierra. Esto nos muestra que el mensaje que trae este segundo ángel es adicional al primer mensaje. Para comprender el mensaje del segundo ángel, es necesario haber comprendido y aceptado el mensaje del primer ángel. Podemos comparar los mensajes con las etapas que se ganarán en una carrera antes de continuar.

Se vieron varios puntos importantes y que debemos tener en cuenta: el juicio en el cielo está en marcha, y debemos prepararnos para él, porque todos los que aceptamos a Jesús como nuestro Salvador y Señor, seremos juzgados; Dios espera que reconozcamos que Él es el único Dios verdadero, digno de adoración y ningún otro.
...
** ¿Qué dice el mensaje del segundo ángel? ** {clase = pregunta} ** Apocalipsis 14: 8; Isaías 21: 9 ** {class = bookQ}  
** Otro ángel siguió, el segundo, diciendo: Ha caído, ha caído la gran Babilonia, que ha hecho beber a todas las naciones del furor de su prostitución. ** {class = versoQ} ** Apocalipsis 14: 8 * * {class = bookVerse}  
** Aquí viene una tropa de hombres, caballeros de dos a dos. Entonces alzó la voz y dijo: Ha caído, ha caído Babilonia; y todas las imágenes escultóricas de sus dioses yacen destrozadas ** {class = versoQ} ** Isaías 21: 9 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) El mensaje del segundo ángel se refiere a una guerra que tendrá lugar.   
b) El mensaje del segundo ángel apunta a la caída de Babilonia en el tiempo del fin.   
c) El mensaje del segundo ángel nos pide que nos mantengamos alejados de la prostitución.   

!!! Nota ""
	 El mensaje del segundo ángel apunta a la caída de Babilonia.

** ¿Quién es la Babilonia moderna o también se la llama Madre Babilonia? ** {class = question} ** Apocalipsis 17: 4,5 ** {class = bookQ}  
** La mujer estaba vestida de púrpura y escarlata, y adornada con oro, piedras preciosas y perlas; y en su hermano tuve una copa de oro de abominaciones y la noticia de su fornicación; Y en su frente estaba escrito el nombre: Misterio, la gran Babilonia, la madre de las rameras y abominaciones de la tierra. ** {class = versoQ} ** Apocalipsis 17: 4,5 ** {class = bookVerse}

** Marque la respuesta correcta: **  
a) La Babilonia moderna se presenta como una mujer que se prostituye y es madre de otras mujeres prostitutas.   
b) La Babilonia moderna es Madonna.   
c) La Babilonia moderna es Estados Unidos.   

** ¿Qué representa "mujer" en la profecía bíblica? ** {clase = pregunta} ** Efesios 5:24 ** {clase = libroQ}  
** Sin embargo, así como la iglesia está sujeta a Cristo, también las mujeres están sumisas en todo a su esposo. ** {class = versoQ} ** Efesios 5:24 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) La mujer representa a una mujer.   
b) La mujer representa a la iglesia.   
c) La mujer en la profecía no representa nada.   

!!! Nota ""
	 La Biblia hace una comparación de las mujeres con la iglesia cuando se refiere a este término en la profecía. Por ejemplo, el esposo en el hogar es el representante de Cristo, mientras que la mujer es el representante de la Iglesia. Por lo tanto, tenemos una iglesia que se prostituye en el tiempo del fin como madre de otras iglesias que también se prostituyen.
...
** ¿Qué haría esta iglesia apóstata? ** {class = question} ** Apocalipsis 17: 6 ** {class = bookQ}  
** Entonces vi a la mujer ebria de la sangre de los santos y de la sangre de los testigos de Jesús; y cuando la vi, me quedé asombrado con gran asombro. ** {class = versoQ} ** Apocalipsis 17: 6 ** {class = bookVerse}  
...
** ¿Dónde se ubicaría la Babilonia moderna en el futuro? ** {class = question} ** Apocalipsis 17: 9 ** {class = bookQ}  
** Aquí está el sentido, que tiene sabiduría: las siete cabezas son siete colinas, sobre las cuales está sentada la mujer. ** {class = versoQ} ** Apocalipsis 17: 9 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) En Nueva York.   
b) En África.   
c) La mujer o la iglesia estaría ubicada en siete colinas.   

!!! Nota ""
	 Esta iglesia estaría * "sentada" * o ubicada en un lugar donde había siete colinas. La ciudad de Roma es conocida como la "ciudad de las siete colinas". En Roma se encuentra la sede mundial de la Iglesia Católica Apostólica Romana: el Vaticano. Esta iglesia en la Edad Media, mediante la llamada "santa inquisición", mató a más de cien millones de cristianos que no quisieron aceptar sus dogmas.

** ¿Qué dijo Jesús sobre el vino de comunión? ** {clase = pregunta} ** Lucas 22:20 ** {clase = libroQ}  
** De manera similar, después de la cena, tomó la copa, diciendo: Esta es la copa del nuevo pacto en mi sangre derramada por ti. ** {class = versoQ} ** Lucas 22:20 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) Jesús dijo que no hay nada de malo en tomar un poco de vino socialmente, porque Él mismo lo tomó en la Santa Cena.   
...
** ¿Qué le hizo la antigua Babilonia a todas las naciones? ** {clase = pregunta} ** Jeremías 51: 7 ** {clase = libroQ}  
** Babilonia era una copa de oro en la mano del SEÑOR, que embriagaba a toda la tierra; las naciones bebieron de su vino; así que las naciones se han vuelto locas. ** {class = versoQ} ** Jeremías 51: 7 ** {class = bookVerse}  
...
** ¿Cuál fue el efecto de esta actitud de apostasía? ** {clase = pregunta} ** Jeremías 51: 8 ** {clase = libroQ}  
** Babilonia cayó en un momento y fue arruinada; llora por ella, toma bálsamo para su dolor, tal vez se cure. ** {class = versoQ} ** Jeremías 51: 8 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) Cayó repentinamente y se arruinó.   
b) Lamentó y lloró por las naciones.   
c) Ella fue sanada de sus heridas.   

** ¿Qué prometió Dios que le haría a Babilonia? ** {clase = pregunta} ** Jeremías 51:24 ** {clase = libroQ}  
** Y pagaré a Babilonia y a todos los habitantes de Caldea, por toda la maldad que han hecho en Sion, a tus ojos, dice el SEÑOR. ** {class = versoQ} ** Jeremías 51:24 ** {class = bookVerse }  

** Marque la respuesta correcta: **  
a) Eso bendeciría a esta ciudad para siempre.   
b) Que Babilonia pagaría toda la maldad que había cometido.   
c) Que todavía tienes una oportunidad más.   

!!! Nota ""
	 Babilonia sería visitada con los juicios de Dios. Sería completamente destruido, a cambio de la maldad que había practicado, alejando a los hombres de Dios y reinando sobre las naciones en tiranía. De hecho, esta ciudad fue destruida y nunca se ha reconstruido hasta el día de hoy.
...
** En las visiones de Juan, ¿qué interpretación se le da a la mujer que se sienta sobre muchas aguas? ** {clase = pregunta} ** Apocalipsis17: 18 ** {clase = libroQ}  
** Y la mujer que viste es la gran ciudad que reina sobre los reyes de la tierra. ** {class = versoQ} ** Apocalipsis 17:18 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) La gran ciudad que reinó sobre los reyes de la tierra fue Roma.   
b) Una mujer que había sido lapidada por sus pecados.   
...
** En esa misma profecía, ¿qué es la Iglesia de Roma, el papado, designado como el símbolo de la antigua Babilonia? ** {clase = pregunta} ** Apocalipsis 17: 5. ** {clase = libroQ}  
** Y en su frente estaba escrito el nombre: Misterio, la gran Babilonia, la madre de las rameras y abominaciones de la tierra. ** {class = versoQ} ** Apocalipsis 17: 5 ** {class = bookVerse}  
...
** ¿Qué hace la Babilonia moderna en la profecía? ** {class = question} ** Apocalipsis 17: 2 ** {class = bookQ}  
** Con quienes se prostituyeron los reyes de la tierra; y, con el vino de su libertinaje, se emborracharon los que viven en la tierra. ** {class = versoQ} ** Apocalipsis 17: 2 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) Babilonia bebe vino.   
b) Babilonia se prostituye.   
c) Remojar a los habitantes de la Tierra.   

!!! Nota ""
	 La Iglesia de Roma se llama Babilonia y su religión fue una restauración de la religión de la antigua Babilonia. El vino babilónico se representa aquí como símbolo de falsas enseñanzas. La * "prostitución" * descrita en ** Apocalipsis 17: 2, ** {clase = libro} son verdades adulteradas que confunden a las personas al hacer que adoren lo que es falso. Todas las iglesias que existen hoy y aceptan dogmas y tradiciones católicas como la trinidad, la guarda del domingo y la inmortalidad del alma, son consideradas por la palabra de Dios como * "hijas de la ramera" *.

## Miércoles


** ¿Qué dijo Jesús sobre el vino de comunión? ** {clase = pregunta} ** Lucas 22:20. ** {clase = libroQ}  
** Del mismo modo, tomó la copa después de la cena, diciendo: Esta copa es el nuevo testamento en mi sangre, que por ti es derramada. ** {class = versoQ} ** Lucas 22:20 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) Que el pacto no necesitaba sangre.   
b) Que se renueve el pacto.   
c) Que el nuevo pacto se haría en Su sangre.   

** ¿Cuál es la enseñanza esencial del Nuevo Pacto? ** {class = question} ** Hebreos 8:10 ** {class = bookQ}  
** Porque este es el pacto que haré con la casa de Israel después de aquellos días, dice el Señor: Imprimiré mis leyes en tu mente, también las escribiré en tu corazón; y yo seré su Dios, y ellos serán mi pueblo. ** {class = versoQ} ** Hebreos 8:10 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) El Nuevo Pacto que Cristo hace con nosotros a través de Su sangre, debe imprimir en nuestras mentes y corazones la obediencia a Sus leyes, mientras que el moderno "vino de Babilonia" muestra que la Ley de Dios ha sido abolida.   
...
** Cuando Cristo así ministra la ley al corazón, ¿en qué se convierte? ** {clase = pregunta} ** Romanos 8: 2-4 ** {clase = libroQ}  
** Porque la ley del Espíritu de vida, en Cristo Jesús, me libró de la ley del pecado y de la muerte. Porque lo que era imposible para la ley, ya que estaba enfermo de la carne, Dios, enviando a su Hijo en semejanza de la carne del pecado, condenó al pecado en la carne por el pecado; Para que se cumpla en nosotros la justicia de la ley, que no andamos según la carne, sino según el Espíritu. ** {class = versoQ} ** Romanos 8: 2-4 ** {class = bookVerse}  

** Marque las declaraciones con V cuando sean verdaderas y F cuando sean falsas. **

a) () La ley es vida en nosotros por Cristo Jesús.   
b) () Jesús vino en carne de pecado para que yo pueda vencer   
c) () El pecado puede ser superado por todos.   
d) () El pecado puede ser vencido para aquellos que viven en el Espíritu con Cristo.   
e) () La ley está enferma y es inútil.   

** ¿Qué verdad confirma Jesús? ** {clase = pregunta} ** Juan 6:63 ** {clase = libroQ}  
** El espíritu es lo que da vida, la carne no usa nada; las palabras que te dije son espíritu y vida. ** {class = versoQ} ** John 6:63 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) Las palabras de Jesús son vida.   
b) La vida de Jesús fue una de palabras.   
c) Tengo que tener carne fuerte.   

** ¿Los hombres, guiados por Satanás, pusieron las doctrinas y tradiciones de los hombres en lugar de la palabra de Dios? ** {clase = pregunta} ** Marcos 7: 7-9 ** {clase = libroQ}  
** Y en vano me rinden culto, enseñando doctrinas que son preceptos de hombres. Al descuidar el mandamiento de Dios, mantienes la tradición de los hombres. Y les dijo: “Ustedes están correctamente rechazando el precepto de Dios de mantener su propia tradición. ** {class = versoQ} ** Marcos 7: 7-9 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) No, en todos los tiempos los hombres han sido fieles a Dios.   
b) Sí, invalidan los mandamientos de Dios al poner en práctica tradiciones y mandamientos de hombres.   
...
Hay dos copas que se presentan en la Palabra de Dios: la copa del Señor y la copa de Babilonia. El vino en la copa del Señor representa la verdad viva, "como la verdad está en Jesús"; el vino en la copa de Babilonia representa sus falsas doctrinas, el reemplazo de la Palabra viva y la ley de Dios por la tradición humana, y la unión ilícita que hizo entre la iglesia y el poder secular (político), para fortalecer su enseñanza.

Por eso mismo, aunque mantiene una forma de piedad, niega sin embargo su eficacia. La sustitución de la ley de Dios por la ley de la iglesia, en cumplimiento de la profecía de ** Daniel 7:25, ** {clase = libro} testifica de la completa subordinación de la Palabra de Dios a la autoridad de la iglesia.
...
** ¿Qué relación tiene la Iglesia de Roma con otras iglesias apóstatas? ** {class = question} ** Apocalipsis 17: 5 ** {class = bookQ}  
** Y en su frente estaba escrito el nombre: Misterio, la gran Babilonia, la madre de las rameras y abominaciones de la tierra. ** {class = versoQ} ** Apocalipsis 17: 5 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) Ella es la hermana de las rameras.   
b) Es madre de rameras.   
c) Ella es la hija de las rameras.   

!!! Nota ""
	 En el credo del Papa Pío IV, una declaración autorizada de la fe católica romana se encuentra en la siguiente declaración: * "Reconozco a la Santa Iglesia Católica como la madre y soberana de todas las iglesias". * Https://www1.folha.uol.com. br / fsp / mundo / ft0609200005.htm

Cuando las iglesias protestantes repudiaron el principio fundamental del protestantismo, dejando a un lado la autoridad de la Biblia y aceptando la tradición humana y la especulación en su lugar, adoptaron el principio fundamental de la Babilonia moderna y pueden ser llamadas hijas de Babilonia. Su caída se incluye entonces en la de Babilonia y requiere una proclamación de la caída de la Babilonia moderna.

Muchos representantes del protestantismo moderno han rechazado, de una forma u otra, muchas doctrinas fundamentales de la Biblia, tales como:

1. Creación en ideas literales
1. La caída del hombre
1. La doctrina bíblica del pecado
1. La infalibilidad de las Escrituras
1. La perfección de las Escrituras como regla de fe y práctica
1. ¿Qué es la divinidad de Cristo afirmada en la Biblia?
1. La resurrección de Cristo
1. La muerte de Jesús, su expiación en nuestro lugar
1. Salvación por gracia
1. Ley de Dios
1. El sábado de la creación
1. Un Dios el Padre
1. Mortalidad del alma y otros, etc.


!!! Nota ""
	 Aunque los líderes del protestantismo moderno no han adoptado oficialmente el credo de la Iglesia de Roma, y ​​no son una parte orgánica de esta corporación, todavía pertenecen a la misma clase en rechazar la autoridad de la Palabra de Dios, aceptando en cambio el producto de su propia argumentos. Hay tanta apostasía en un caso como en el otro y, por tanto, ambos deben ser incluidos en Babilonia, y ambos se verán involucrados, después de todo, en su caída.
...
** ¿Hasta dónde debe llegar la apostasía? ** {class = question} ** Apocalipsis 18: 2 ** {class = bookQ}  
** Entonces exclamó con voz potente, diciendo: ¡Cayó! La gran Babilonia cayó y se convirtió en morada de demonios, guarida de toda clase de espíritu inmundo y escondite de toda clase de ave inmunda y aborrecible. ** {class = versoQ} ** Apocalipsis 18: 2 ** {class = bookVerse}  
...
** ¿Qué invitación final hace Dios a su pueblo en Babilonia? ** {clase = pregunta} ** Apocalipsis 18: 4,5 ** {clase = libroQ}  
** Oí otra voz del cielo que decía: Apártate de ella, pueblo mío, no sea que seas cómplice de sus pecados y no seas partícipe de sus azotes; porque sus pecados se han acumulado hasta el cielo, y Dios se ha acordado de las malas acciones que realizó. ** {class = versoQ} ** Apocalipsis 18: 4,5 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) Dios te pide que ames a Babilonia como a ti mismo.   
b) Dios invita a todos los que son Su pueblo a dejar estas iglesias caídas y unirse al remanente de Dios (** Apocalipsis 12:17. ** {clase = libro})   
c) Dios nos pide que derribemos este falso sistema religioso.   

!!! Nota ""
	 Aquellos que escaparon de esta confusión doctrinal tienen una característica presentada en ** Apocalipsis 14:12 ... ** {clase = libro} ** "guardar sus mandamientos". ** {clase = verso} Quédate dentro de estas iglesias que predican el mentir, es correr el riesgo de recibir las plagas finales de la ira de Dios.

** ¿Cómo será la caída de la Babilonia moderna? ** {class = question} ** Apocalipsis 18:21 ** {class = bookQ}  
** Entonces un ángel fuerte levantó una piedra como una gran piedra de molino y la arrojó al mar, diciendo: Así, Babilonia, la gran ciudad, será arrojada con denuedo y nunca será hallada. ** {class = versoQ} ** Apocalipsis 18:21 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) Una roca del cielo, un meteoro, caerá sobre Babilonia.   
b) Babilonia se autodestruirá.   
c) Quedará totalmente destruido.   
...
** ¿Qué consejo y promesa dejó Jesús para aquellos que enfrentarán los peligros de la muerte por su fe? ** {clase = pregunta} ** Apocalipsis 2: 10,11; Mateo 10:28 ** {clase = libroQ}
** No temas ninguna de las cosas que sufrirás. He aquí, el diablo echará a algunos de vosotros en la cárcel para que seáis tentados; y tendrás una tribulación de diez días. Sé fiel hasta la muerte y te daré la corona de la vida. El que tenga oídos, escuche lo que el Espíritu dice a las iglesias: El que gane no recibirá el daño de la segunda muerte. ** {class = versoQ} ** Apocalipsis 2: 10,11 ** {class = bookVerse}  
** Y no temas a los que matan el cuerpo y no pueden matar el alma; temed más bien al que puede hacer que el alma y el cuerpo perezcan en el infierno. ** {class = versoQ} ** Mateo 10:28 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) Ser fiel hasta la muerte y recibir la corona de la vida.   
b) Matar a quienes los amenazaron.   
c) Para escapar de la persecución y guardar silencio.   

** ¿Qué canción de triunfo sigue a la caída de Babilonia? ** {clase = pregunta} ** Apocalipsis 19: 6,7 ** {clase = libroQ}  
** Y oí la voz de una gran multitud, y la voz de muchas aguas, y la voz de un gran trueno, que decía: ¡Aleluya! porque el Señor Dios Todopoderoso reina. Gocémonos y regocijémonos y démosle gloria; porque se acercan las bodas del Cordero y su esposa ya está lista. ** {class = versoQ} ** Apocalipsis 19: 6,7 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) ¡Lástima que cayó la gran ciudad!   
b) ¡Aleluya porque reina el Señor, Dios Todopoderoso!   
c) ¡Vamos a una fiesta de bodas!   
...
!!! cita de fondo
    A éstos les siguió otro ángel, el tercero, que decía en voz alta: Si alguno adora a la bestia y a su imagen y recibe su marca en la frente o en la mano ... ** Apocalipsis 14: 9-12 ** {clase = libro}

## Domingo

Un tercer ángel los siguió ... También el mensaje del tercer ángel es parte o completa los mensajes anteriores dados por el primer y segundo ángel. Los mensajes del primer, segundo y tercer ángel forman un todo; un evangelio eterno que será proclamado en el momento final de la historia de la tierra, antes de que Jesús regrese aquí para buscar a Su iglesia. Entonces, aceptar el evangelio del cielo significa aceptar el mensaje final traído por los tres ángeles. No hay forma de aceptar uno y rechazar otro. Es una experiencia progresiva.
...
** ¿Cómo podemos comparar el mensaje de los tres ángeles dado por las profecías de Apocalipsis? ** {clase = pregunta} ** II Pedro1: 19 ** {clase = libroQ}  
** Y tenemos, muy firmemente, la palabra de los profetas, a la que hacéis bien en estar atentos, como una luz que brilla en un lugar oscuro, hasta que amanece y la estrella del alba aparece en vuestros corazones ** { class = versoQ} ** II Pedro 1:19 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) Podemos compararlo con un camino que se estrecha cada vez más.   
...
** ¿El mensaje del tercer ángel hace una advertencia solemne contra qué apostasía? ** {class = question} ** Apocalipsis 14: 9 ** {class = bookQ}  
** Y el tercer ángel los siguió, diciendo a gran voz: Si alguno adora a la bestia y a su imagen, y recibe la marca en su frente o en su mano, ** {class = versoQ} ** Apocalipsis 14 : 9 ** {clase = bookVerse}  

** Marque la respuesta correcta: **  
a) El mensaje del tercer ángel advierte contra la adoración de imágenes.   
b) Es una advertencia solemne contra la adoración de la bestia, su imagen y su marca.   
c) El mensaje del tercer ángel advierte contra la adoración de marcas registradas y patentes.   

!!! Nota ""
	 El mensaje del tercer ángel es la última parte del evangelio enviado al mundo. La palabra evangelio significa buenas noticias. El tercer ángel se encarga de presentar la parte final de las buenas nuevas del Cielo enviadas al mundo. Es como el último capítulo de un libro. Presenta el resultado de todo y la solución del drama. Anuncia cuál será el fin de aquellos que rechazan las buenas nuevas del evangelio y da la característica de aquellos que aceptan advertencias y buenas nuevas en el tiempo del fin.

** ¿Cuál será la característica de quienes obedecen y aceptan el evangelio eterno dado por los tres ángeles? ** {clase = pregunta} ** Apocalipsis 14:12 ** {clase = libroQ}  
** Aquí está la paciencia de los santos; aquí están los que guardan los mandamientos de Dios y la fe en Jesús. ** {class = versoQ} ** Apocalipsis 14:12 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) Guardan los mandamientos de Dios y tienen la fe de Jesús.   
b) Guardan los mandamientos pero no tienen fe en Jesús.   
c) Tienen fe en el sacrificio de Jesús y por lo tanto no guardan los mandamientos de Dios.   

## Lunes


** ¿Cuál será la consecuencia de adorar a la bestia y su imagen y recibir su marca? ** {clase = pregunta} ** Apocalipsis 14:10 ** {clase = libroQ}  
** También beberá el vino de la ira de Dios, preparado, sin mezclar, de la copa de su ira, y será atormentado con fuego y azufre, delante de los santos ángeles y en la presencia del Cordero. ** {class = versoQ} ** Apocalipsis 14:10 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) Los adoradores de la bestia y su imagen recibirán la copa de la ira de Dios.   
...
** ¿Qué es el vino de la ira de Dios? ** {class = question} ** Apocalipsis 15: 1 ** {class = bookQ}  
** Vi otra gran y admirable señal en el cielo: siete ángeles teniendo los últimos siete azotes, porque con ellos se consumió la ira de Dios. ** {class = versoQ} ** Apocalipsis 15: 1 ** {class = bookVerse}  
...
** ¿Qué descripción se hace de la Bestia? ** {clase = pregunta} ** Apocalipsis 13: 1,2; Apocalipsis 17: 3 ** {class = bookQ}
** Vi una bestia emerger del mar que tenía diez cuernos y siete cabezas y, en los cuernos, diez diademas y, en las cabezas, nombres de blasfemia. ** {class = versoQ} ** Apocalipsis 13: 1,2 ** {class = bookVerse}  
** El ángel me transportó, en espíritu, a un desierto y vi a una mujer montada sobre una bestia escarlata, una bestia llena de nombres de blasfemia, con siete cabezas y diez cuernos. ** {class = versoQ} ** Apocalipsis 17: 3 ** {class = bookVerse}  
...
** ¿Qué representa el animal en la profecía en la Biblia? ** {clase = pregunta} ** Daniel 7: 17,23 ** {clase = libroQ}  
** Estos grandes animales, que son cuatro, son cuatro reyes, que se levantarán de la tierra. ** {class = versoQ} ** Daniel 7:17 ** {class = bookVerse}  
** Dijo así: El cuarto animal será el cuarto reino en la tierra, que será diferente de todos los reinos; y devorará toda la tierra, la hollará bajo sus pies y la hará pedazos. ** {class = versoQ} ** Daniel 7:23 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) Animal representa una criatura de Dios.   
b) Animal representa reino o rey.   
c) No lo sé.   

!!! Nota ""
	 Animal en la Biblia significa * "reino" * o * "rey" * ** (Daniel 7: 17,23). ** {clase = libro} La mujer (Iglesia Católica) está montada en este reino, es decir, ella gobierna sobre él . El reino sobre el que gobierna la Iglesia Católica es el Vaticano. En Apocalipsis encontramos algunas características que nos permiten identificarlo. Si es adorada, es un poder religioso. Se le permitió hacer la guerra a los santos y vencerlos ** (Apocalipsis 13: 5). ** {clase = libro} Por eso entendemos que él es un poder perseguidor de los santos de Dios. Y se le dio autoridad sobre toda la tribu, el pueblo, el idioma y la nación. ** Apocalipsis 13: 7 ** {clase = libro}. La bestia tenía autoridad sobre los reyes. Solo una potencia cumple todas las características aquí descritas; el papado medieval. Fue un poder religioso que persiguió y mató a los santos, a quienes llamó * "herejes" *, y tenía autoridad sobre reyes. El Papa tiene en su tiara la inscripción: 'VICARIVS FILII DEI', que significa Vicario, o sustituto del Hijo de Dios. Afirma ser el representante divino en la tierra. Pero ordena matar a los que no aceptan sus doctrinas. No es así como procedió Cristo; al contrario, dio su vida por quienes lo rechazaron.
...
** ¿Qué dicen las personas que adoran a la bestia, cuyos nombres no están escritos en el libro de la vida? ** {clase = pregunta} ** Apocalipsis 13: 4 ** {clase = libroQ}  
** Y adoraron al dragón porque dio su autoridad a la bestia; también adoraron a la bestia, diciendo: ¿Quién es como la bestia? ¿Quién puede luchar contra ella? ** {class = versoQ} ** Apocalipsis 13: 4 ** {class = bookVerse}  
...
** ¿Quién es el dragón que le dio poder y autoridad a la bestia? ** {clase = pregunta} ** Apocalipsis 12: 9 ** {clase = libroQ}  
** Y se precipitó el gran dragón, la serpiente antigua, que se llama Diablo y Satanás, que engaña al mundo entero; fue precipitado en la tierra, y sus ángeles fueron arrojados con él. ** {class = versoQ} ** Apocalipsis 12: 9 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) El dragón es un animal del desierto.   
b) El dragón es el diablo y Satanás.   
c) El dragón es una figura legendaria, que solo aparece en las fábulas.   

!!! Nota ""
	 Puede parecer extraño que la Palabra de Dios se refiera a un sistema religioso dirigido por el poder de Satanás y que la gran mayoría de los que dicen ser cristianos, aunque sean sinceros, estén adorando y adorando al enemigo, pero el mismo Jesús afirmó que su dios siglo es el mismo Satanás.

## Miércoles

El mensaje advierte de adorar a la bestia así como a su imagen. La imagen no es la persona, sino una copia fiel de él. En el sentido espiritual, Dios dice que la bestia tiene una imagen. Un poder que es una copia fiel del poder llamado * "bestia" *, pero que no es exactamente la bestia. Ya hemos visto en la historia que la bestia es el papado. También hemos visto que este símbolo de bestia representa la unión del poder religioso con el gobierno para poder perseguir y matar a los santos. La unión del poder * "religioso" * con el poder * "civil" * caracteriza lo que la Biblia llama la bestia.
...
** ¿El mensaje del tercer ángel también advierte sobre la adoración de qué? ** {clase = pregunta} ** Apocalipsis 14: 9 ** {clase = libroQ}  
** Y el tercer ángel los siguió, diciendo a gran voz: Si alguno adora a la bestia y a su imagen, y recibe la marca en su frente o en su mano. ** {class = versoQ} ** Apocalipsis 14 : 9 ** {clase = bookVerse}  

** Marque la respuesta correcta: **  
a) Imagen de la bestia.   
b) Las enseñanzas de la bestia.   
c) Las costumbres de la bestia.   

** ¿Qué pasará con los que adoran la imagen de la bestia? ** {clase = pregunta} ** Apocalipsis 14: 9,10 ** {clase = libroQ}  
...
** Marque la respuesta correcta: **  
a) Ve a la perdición.   
b) También beberán el vino de la ira de Dios.   
c) Serán como la bestia.   
...
** ¿Cómo debería ser nuestra adoración o servicio racional? ** {class = question} ** Romanos 12: 1 ** {class = bookQ}  
** Por tanto, hermanos, les ruego por la compasión de Dios que presenten sus cuerpos en sacrificio vivo, santo y agradable a Dios, que es su adoración racional. ** {class = versoQ} ** Romanos 12: 1 ** {class = bookVerse}  
...
!!! Nota ""
    Adorar a la bestia y su imagen está relacionado con aceptar el culto que promueven las iglesias. Jesús frecuentaba la casa de culto a Dios los sábados: ** Llegando a Nazaret, donde fue creado; entró en la sinagoga el sábado, según su costumbre, y se levantó para leer ** {clase = verso} ** (Lucas 4:16). ** {clase = libro} El papado, por el contrario, promueve la adoración a los domingos. Las iglesias protestantes de hoy hacen lo mismo. Por tanto, adorar a la bestia y su imagen está relacionado con el culto de los domingos.

** 13. ¿Cuál es el día para tener un servicio de adoración, según la Palabra de Dios? ** {clase = pregunta} ** Isaías 66:23 ** {clase = libroQ}  
** Y será que de una luna nueva a la siguiente, y de un sábado a otro, toda la carne vendrá a adorar ante mí, dice el Señor. ** {class = versoQ} ** Isaías 66:23 ** { class = bookVerse}  
...
** ¿Cómo quitará este sistema religioso el honor que pertenece solo a Dios? ** {clase = pregunta} ** Jeremías 10: 6 ** {clase = libroQ}  
** No hay nadie como tú, oh Señor; eres grandioso, y grandioso es el poder de tu nombre. ** {class = versoQ} ** Jeremías 10: 6 ** {class = bookVerse}  
...
c) La Palabra de Dios nos muestra que no hay nadie como Dios y que debemos adorarlo. Los adoradores de la bestia, diciendo que no hay nadie como él, van directamente contra Dios. (Vea también: ** Salmo 71:19; Salmos; 86: 8; Salmos 89: 6-8 ** {clase = libro})   

** ¿Cómo se refiere el apóstol Pablo a la bestia? ** {clase = pregunta} ** II Tesalonicenses 2: 3,4 ** {clase = libroQ}
** Nadie, de ninguna manera, te engaña, porque esto no sucederá sin la apostasía primero y sin que se revele el hombre de iniquidad, el hijo de perdición, que se opone y se levanta contra todo lo que se llama Dios u objeto. de adoración, hasta el punto de sentarse en el santuario de Dios, jactándose como si fuera Dios mismo. ** {class = versoQ} ** II Tesalonicenses 2: 3,4 ** {class = bookVerse}  
...
** ¿Qué les dio de beber Babilonia a todas las naciones? ** {clase = pregunta} ** Apocalipsis 14: 8 ** {clase = libroQ}  
** Y otro ángel lo siguió, diciendo: Cayó Babilonia, la gran ciudad, que hizo beber a todas las naciones del vino del furor de su prostitución. ** {class = versoQ} ** Apocalipsis 14: 8 ** { class = bookVerse}  

** Marque la respuesta correcta: **  
a) Dio una bebida fuerte.   
b) Dio una bebida mixta.   
c) Dio de beber el vino del furor de su prostitución.   

** ¿Qué tendrán que beber aquellos que aceptan las enseñanzas de Babilonia, rindiéndole así homenaje? ** {clase = pregunta} ** Apocalipsis 14:10 ** {clase = libroQ}  
** También beberá el vino de la ira de Dios, que se acostó, sin mezclar, en la copa de su ira; y será atormentado con fuego y azufre ante los santos ángeles y ante el Cordero. ** {class = versoQ} ** Apocalipsis 14:10 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) Vino de la ira de Dios.   
b) Vino de la prostitución.   
c) Bebida venenosa.   

!!! Nota ""
	 La copa de Dios, que contiene el nuevo pacto en la sangre de Jesús, y la copa del vino de la ira de Babilonia se ofrecen al mundo. Beber del primero, es decir, aceptar la enseñanza del verdadero evangelio, es recibir la vida eterna, pero beber el vino de Babilonia, es decir, aceptar el falso evangelio enseñado por el papado, resultará en beber el vino de la ira de Dios, de la copa de Su indignación. El verdadero evangelio significa vida eterna; el falso evangelio significa muerte eterna.

## Viernes


** ¿Bajo qué amenaza se impone el culto a la imagen de la bestia? ** {clase = pregunta} ** Apocalipsis 13:15 ** {clase = libroQ}  
** Y se le dio la oportunidad de comunicar aliento a la imagen de la bestia, para que no solo hablara la imagen, sino que también hiciera morir a los que no adoraban la imagen de la bestia. ** {class = versoQ} ** Apocalipsis 13:15 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) Todos los que no quieran someterse a la autoridad de la bestia oirán la voz de la bestia y caerán muertos.   
...
** ¿Qué medida universal se usará para obligar a todos a recibir la señal de la bestia? ** {class = question} ** Apocalipsis 13: 16,17 ** {class = bookQ}  
** A todos, los pequeños y los grandes, los ricos y los pobres, los libres y los esclavos, asegúrese de que se les dé una determinada marca en la mano derecha o en la frente, para que nadie pueda comprar ni vender, excepto el que tiene la marca, el nombre de la bestia o el número de su nombre. ** {class = versoQ} ** Apocalipsis 13: 16,17 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) A la gente se le dará un chip para que se vea obligada a adorar a la bestia.   
b) No se hará nada a los que no quieran adorar a la bestia.   
...
** ¿Qué poder opera realmente a través de la bestia que exige adoración? ** {clase = pregunta} ** Apocalipsis 13: 2 ** {clase = libroQ}  
** La bestia que vi era similar a un leopardo, con pies de oso y boca de león. Y el dragón le dio su poder, su trono y gran autoridad. ** {class = versoQ} ** Apocalipsis 13: 2 ** {class = bookVerse}  
...
** ¿Quién es el dragón? ** {class = question} ** Apocalipsis 12: 9 ** {class = bookQ}  
** Y el gran dragón, la serpiente antigua, que se llama diablo y Satanás, el seductor del mundo entero, fue arrojado, sí, fue arrojado a la tierra, y con él sus ángeles. ** {class = versoQ } ** Apocalipsis 12: 9 ** {class = bookVerse}  
...
** ¿Cuál fue la respuesta de Jesús a Satanás cuando lo intentó? ** {clase = pregunta} ** Lucas 4: 8 ** {clase = libroQ}  
** Pero Jesús le respondió: Está escrito: Adorarás al Señor tu Dios y solo a Él lo adorarás. ** {class = versoQ} ** Lucas 4: 8 ** {class = bookVerse}  
...
** ¿Cuántos cederán ante las afirmaciones de adoración de la bestia? ** {class = question} ** Apocalipsis 13: 8 ** {class = bookQ}   
** Y todos los moradores de la tierra la adorarán, aquellos cuyos nombres no fueron escritos en el Libro de la Vida del Cordero que fue inmolado desde la fundación del mundo. ** {class = versoQ} ** Apocalipsis 13: 8 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) Solo los menos informados.   
b) Todos cederán a los reclamos del culto a la bestia.   
c) Todos aquellos que no aceptaron verdaderamente que Jesús tuviera sus nombres escritos en el Libro de la Vida, serán engañados por la bestia.   

## Sábado

Para estudiar y meditar en familia:

** ¿A quién estamos llamados a adorar? ** {clase = pregunta} ** Apocalipsis 14: 7 ** {clase = libroQ}  
** Diciendo en voz alta: Temed a Dios y dadle gloria, porque ha llegado la hora de su juicio; y adorad al que hizo el cielo y la tierra y el mar y las fuentes de agua. ** {class = versoQ} ** Apocalipsis 14: 7 ** {class = bookVerse}  
...
** ¿Quién cantará el cántico de Moisés y el Cordero en el mar de vidrio? ** {class = question} ** Apocalipsis 15: 2-4 ** {class = bookQ}  
** Vi como un mar de vidrio mezclado con fuego, y los vencedores de la bestia, de su imagen y el número de su nombre, que estaban de pie en el mar de vidrio, teniendo arpas de Dios; ** {class = versoQ} ** Apocalipsis 15: 2-4 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) Los vencedores de la bestia y su imagen.   
b) Ganadores del Oscar.   
c) Los campeones de la Copa del Mundo.   
...
!!! cita de fondo
    Aquí está la perseverancia de los santos, los que guardan los mandamientos de Dios y la fe de Jesús. ** Apocalipsis 14:12 ** {clase = libro}
...
** ¿En quién se manifestó el amor de Dios por nosotros? ** {clase = pregunta} ** Juan 3:16 ** {clase = libroQ}  
** Porque tanto amó Dios al mundo que dio a su Hijo unigénito, para que todo el que crea en él no se pierda, sino que tenga vida eterna. ** {class = versoQ} ** John 3:16 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) El amor de Dios fue manifestado por nosotros al permitirnos vivir en el planeta tierra.   
...
** ¿Cómo debería manifestarse este amor en nosotros? ** {clase = pregunta} ** I Juan 4: 19,20 ** {clase = libroQ}  
** Nos encanta porque él nos amó primero. Si alguien dice: Amo a Dios y odio a su hermano, es un mentiroso; porque el que no ama a su hermano, a quien ve, no puede amar a Dios a quien no ve. ** {class = versoQ} ** I Juan 4: 19,20 ** {class = bookVerse}  
...
** ¿Cómo podemos pagar el amor de Dios? ** {clase = pregunta} ** Juan 14:15; I Juan 2: 4 ** {class = bookQ}  
** Si me amas, guardarás mis mandamientos. ** {class = versoQ} ** Juan 14:15 ** {class = bookVerse}  
** El que dice: Lo conozco y no guarda sus mandamientos es un mentiroso, y la verdad no está en él. ** {class = versoQ} ** I Juan 2: 4 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) Retribuimos el amor de Dios por nosotros haciendo buenas obras.   
b) Retribuimos el amor de Dios por nosotros ayudando a otros.   
c) Devolvemos el amor de Dios por nosotros cuando somos obedientes a sus mandamientos.   

** ¿Cuál es el mandamiento de Dios, según Jesús? ** {clase = pregunta} ** Juan 12:50 ** {clase = libroQ}  
** Y sé que tu mandamiento es vida eterna. Por tanto, las cosas que hablo, como el Padre me lo ha dicho, así hablo. ** {class = versoQ} ** John 12:50 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) El mandamiento de Dios es la vida eterna para todo aquel que acepta a Jesús como su Salvador personal.   
b) Jesús nos trajo la libertad, para que no tengamos que guardar sus mandamientos.   
c) El mandamiento de Dios es esclavitud, no debe guardarse.   

** ¿Qué expresa la ley o el mandato de Dios? ** {class = question} ** Romanos 7:12 ** {class = bookQ}  
** Por tanto, la ley es santa; y el mandamiento, santo, justo y bueno. ** {class = versoQ} ** Romanos 7:12 ** {class = bookVerse}  

** Marque las declaraciones con V cuando sean verdaderas y F cuando sean falsas. **

a) () Que Dios es santo, justo y bueno.   
b ) () Que la ley de Dios es una expresión exacta de Su carácter.   
c) () Que Dios es amor y el cumplimiento de la Ley es amor, por lo tanto, cuando caminamos en obediencia a la Ley de Dios, estamos siendo perfeccionados según el carácter de Dios.   
d) () Que Dios es un tirano al pedirnos que guardemos una ley que no hemos cumplido.   
...
** ¿Por qué debemos ser santos y perfectos? ** {clase = pregunta} ** Mateo 5:48; Levítico 19: 2 ** {clase = libroQ}  
** Por lo tanto, sean perfectos como su Padre celestial es perfecto. ** {class = versoQ} ** Mateo 5:48 ** {class = bookVerse}  
** Habla a toda la congregación de los hijos de Israel y diles: 'Seréis santos, porque yo, el Señor tu Dios, soy santo. ** {class = versoQ} ** Levítico 19: 2 ** {class = bookVerse }  
...
** ¿Cómo seremos perfectos ante Dios? ** {clase = pregunta} ** Génesis 17: 1; 5: 22-24 ** {clase = bookQ}  
** Cuando Abram alcanzó la edad de noventa y nueve años, el Señor se le apareció y le dijo: Yo soy el Dios Todopoderoso; camina en mi presencia y sé perfecto. ** {class = versoQ} ** Génesis 17: 1 ** {class = bookVerse}  
** Enoc caminó con Dios ... y ya no lo estaba, porque Dios lo tomó para sí mismo. ** {class = versoQ} ** Génesis 5: 22-24 ** {class = bookVerse}  
...
** ¿Para qué fue dada la ley? ** {clase = pregunta} ** Romanos 3:20; 7: 7 ** {clase = bookQ}  
** Ya que nadie será justificado ante él por las obras de la ley, porque por la ley viene el conocimiento pleno del pecado. ** {class = versoQ} ** Romanos 3:20 ** {class = bookVerse}  
** ¿Qué diremos entonces? ¿Es la ley un pecado? ¡De ningún modo! Pero yo no habría conocido el pecado si no fuera por la ley; porque no habría conocido la codicia si la ley no hubiera dicho: No codiciarás. ** {class = versoQ} ** Romanos 7: 7 ** {class = bookVerse}
...
** ¿Podemos agradar a Dios viviendo de acuerdo con nuestra propia voluntad? ** {class = question} ** Romanos 8: 7.8 ** {class = bookQ}  
** Por tanto, la inclinación de la carne es enemistad contra Dios, porque no está sujeta a la ley de Dios, ni siquiera puede estarlo. Por tanto, los que viven en la carne no pueden agradar a Dios. ** {class = versoQ} ** Romanos 8: 7,8 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) Sí, simplemente acepta a Jesús como tu Salvador y serás salvo.   
b) Sí, una vez salvo, siempre salvo.   
c) No, porque somos carnales y pecadores, nuestra naturaleza es contraria a la naturaleza divina que es santa. No estamos, por naturaleza, inclinados a la obediencia. Necesitamos un poder externo (externo), que no tenemos, para hacernos guardianes de la Ley.   
...
** ¿Qué poder necesitamos obtener para ser obedientes a la Ley de Dios? ** {clase = pregunta} ** Romanos 1: 4,5; 3: 26.31 ** {clase = bookQ}  
** ... Jesucristo, por quien vinimos a recibir gracia y apostolado por causa de su nombre, para la obediencia por fe, entre todos los gentiles. ** {class = versoQ} ** Romanos 1: 4,5 ** {class = bookVerse}  
** En vista de la manifestación de su justicia en el tiempo presente, para que él mismo sea justo y el que justifica al que tiene fe en Jesús. ** {class = versoQ} ** Romanos 3:26 ** {class = bookVerse}  
** ¿Entonces invalidamos la ley por la fe? ¡No, en absoluto! Más bien, confirmamos la ley. ** {class = versoQ} ** Romanos 3:31 ** {class = bookVerse}

** Marque la respuesta correcta: **  
a) Por la fe en Jesús recibimos la gracia vivificante. La gracia tiene el poder de hacernos obedientes. Esta gracia se obtiene solo a través de la fe en Jesús.   
b) El poder está dentro de ti, solo mira dentro de ti.   
c) Este negocio del poder no existe, es todo invento humano.   

** ¿Cuál es la base para guardar los mandamientos en el Antiguo y el Nuevo Testamento? ** {class = question} ** Génesis 15: 6 ** {class = bookQ}  
** Creyó en el Señor, y le fue contado por justicia. ** {class = versoQ} ** Génesis 15: 6 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) El fundamento para guardar los mandamientos es la fe.   
b) La base para guardar los mandamientos son las obras.   
c) La base para guardar los mandamientos son los mandamientos mismos.   

!!! Nota ""
	 La justicia de Dios fue imputada (dada) a Abraham no por cualquier buena obra que hubiera hecho, sino porque creyó, tuvo fe en que Dios podía hacer lo que pidió. La justicia es guardar los mandamientos de Dios (** Salmo 119: 172 ** {clase = libro}). Abraham se hizo obediente porque creyó, tuvo fe en Dios. (Ver también: ** Génesis 17: 1,2; Deuteronomio 6: 5, Romanos 1:17; 9: 32,33 ** {clase = libro})

** ¿Cuál es el Nuevo Pacto que Cristo quiere hacer con nosotros? ** {class = question} ** Hebreos 10: 15,16 ** {class = bookQ}  
** Y el Espíritu Santo también da testimonio de esto; porque, después de decir: Este es el pacto que haré con ellos después de aquellos días, dice el Señor: Pondré mis leyes en sus corazones y las escribiré en sus mentes. ** {class = versoQ} ** Hebreos 10: 15.16 ** {clase = bookVerse}  

** Marque la respuesta correcta: **  
a) En la nueva alianza Jesús nos ofrece la salvación al aceptar su nombre y eso nos basta.   
b) En el nuevo pacto hecho con nosotros mediante la sangre de Cristo, mediante el Espíritu Santo, Jesús escribe la ley en nuestro corazón y mente, es decir, mediante Su poder nos hace obedientes si nos sometemos a Él.   
c) El nuevo pacto no existe.   
...
** ¿Recibimos la ley cuando recibimos a Cristo? ** {class = question} ** Salmo 40: 7.8 ** {class = bookQ}  
** Entonces, dije: aquí estoy, en el rollo del libro está escrito sobre mí; Me gusta hacer tu voluntad, Dios mío; tu ley está dentro de mi corazón. ** {class = versoQ} ** Salmo 40: 7.8 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) No, la ley es una cosa y Jesús es otra.   
b) Sí, Jesús tenía la Ley en Su corazón. Él mismo dice: ** "He guardado los mandamientos de mi Padre" ** {clase = verso} ** (Juan 15:10). ** {clase = libro} Al permitir que Jesús viva en nosotros, estaremos trayendo nuestra vida su obediencia.   
c) No, porque solo estaremos guardando la ley de Dios en el cielo.   

** ¿Qué sucede cuando Cristo vive en nosotros? ** {class = question} ** Romanos 8: 10,14 ** {class = bookQ}  
** Sin embargo, si Cristo está en ti, el cuerpo está realmente muerto a causa del pecado, pero el espíritu es vida, debido a la justicia. "" Porque todos los que son guiados por el Espíritu de Dios son hijos de Dios. ** {class = versoQ} ** Romanos 8: 10,14 ** {class = bookVerse}  
...
** ¿Cómo vino Cristo a vivir en nosotros? ** {clase = pregunta} ** Efesios 3: 16,17; Apocalipsis 3:20 ** {class = bookQ}  
** Para que, según las riquezas de su gloria, os conceda ser fortalecidos con poder, por su Espíritu en el hombre interior; y así que Cristo more en tu corazón por fe, arraigado y cimentado en el amor. ** {class = versoQ} ** Efesios 3: 16,17 ** {class = bookVerse}  
** He aquí, estoy a la puerta y llamo; si alguien oye mi voz y abre la puerta, entraré en su casa y cenaré con él, y él conmigo. ** {class = versoQ} ** Apocalipsis 3:20 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) Por la fe en Cristo recibimos el Espíritu Santo en nosotros, y este Espíritu nos transmite la vida de Cristo.   
b) Cristo no puede vivir en nosotros, porque esto no puede suceder.   
c) No lo sé.   

** ¿Qué es la fe verdadera? ** {class = question} ** Apocalipsis 14:12 ** {class = bookQ}  
** Aquí está la perseverancia de los santos, aquellos que guardan los mandamientos de Dios y la fe de Jesús. ** {class = versoQ} ** Apocalipsis 14:12 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) La verdadera fe viene por las obras.   
b) La verdadera fe es la fe de Jesús. Esa es la fe perfecta. Al recibir a Jesús en nosotros, recibimos su fe misericordiosa.   
c) La verdadera fe es la fe en la Virgen María.   

** ¿Cómo se manifestó la fe de Jesús? ** {clase = pregunta} ** Juan 15:10; 6:38 ** {clase = bookQ}  
** Si guardas mis mandamientos, permanecerás en mi amor; así como he guardado los mandamientos de mi Padre y permanezco en su amor. ** {class = versoQ} ** John 15:10 ** {class = bookVerse}  
** Porque bajé del cielo, no para hacer mi propia voluntad, sino la voluntad del que me envió. ** {class = versoQ} ** John 6:38 ** {class = bookVerse}  
...
** ¿Qué dijo Jesús sobre sí mismo? ** {clase = pregunta} ** Juan 6: 57.63 ** {clase = libroQ}  
** Así como el Padre, que vive, me envió, y yo también vivo para el Padre, así el que me come vivirá. ** {class = versoQ} ** John 6:57 ** {class = bookVerse}  
** El espíritu es lo que acelera; la carne no usa nada; las palabras que les he hablado son espíritu y son vida. ** {class = versoQ} ** Juan 6:63 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) Necesitamos alimentarnos de Jesús todos los días para vivir para Él. Al estudiar las palabras de Jesús en la Biblia, aprenderemos.   
b) Jesús vino al mundo para que podamos tener comida.   
c) Jesús afirmó que la carne es inútil, por eso no podemos comer carne.   

** ¿Para qué nos comunica Jesús Su vida? ** {clase = pregunta} ** Efesios 2:10 ** {clase = libroQ}  
** Porque somos hechura suya, creados en Cristo Jesús para buenas obras, que Dios preparó de antemano para que camináramos. ** {class = versoQ} ** Efesios 2:10 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) Jesús nos comunica su vida para que tengamos vida.   
b) Jesús nos comunica su vida para que así como vivió en la práctica de las buenas obras, así también nosotros vivamos.   
c) No lo sé.   

** ¿Qué vio Juan en el cielo? ** {class = question} ** Apocalipsis 11:19 ** {class = bookQ}  
** Entonces se abrió el santuario de Dios, que está en los cielos, y se vio el arca de la alianza en su santuario, y sobrevinieron relámpagos, voces, truenos, terremotos y una gran descarga. ** {class = versoQ} ** Apocalipsis 11:19 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) Juan vio grandes nubes.   
b) Juan vio el Arca de la Alianza, en el cielo, en el santuario.   
c) Juan vio una gran multitud de ángeles.   

** ¿Qué había dentro del Arca de la Alianza? ** {clase = pregunta} ** Éxodo 25:21; Deuteronomio 10: 4,5 ** {clase = libroQ}  
** Colocarás el propiciatorio encima del arca; y pondrás el Testimonio dentro de él, que te daré. ** {class = versoQ} ** Éxodo 25:21 ** {class = bookVerse}  
** Entonces el Señor escribió en las tablas, según la primera Escritura, los diez mandamientos que les había dicho el día de la reunión, en el monte, en medio del fuego; y el SEÑOR me lo dio. Me volví, bajé del monte y puse las tablas en el arca que había hecho; y ahí están, como el SEÑOR me ordenó. ** {class = versoQ} ** Deuteronomio10: 4,5 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) Había mucho dinero dentro del arca.   
b) Dentro del Arca estaban los Diez Mandamientos, la santa Ley de Dios.   
c) No había nada dentro del arca.   

** ¿Quién escribió los Diez Mandamientos? ** {clase = pregunta} ** Éxodo 31:18; Deuteronomio 4:13 ** {class = bookQ}  
** Y habiendo terminado de hablarle en el monte Sinaí, le dio a Moisés las dos tablas del Testimonio, tablas de piedra, escritas por el dedo de Dios. ** {class = versoQ} ** Éxodo 31:18 ** {class = bookVerse}  
** Luego te anunció su pacto, que te prescribió, los Diez Mandamientos, y los escribió en dos tablas de piedra. ** {class = versoQ} ** Deuteronomio 4:13 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) Santos varones de Dios.   
...
** ¿Qué dice la ley de Dios? ** {clase = pregunta} ** Éxodo 20: 3-17 ** {clase = libroQ}  

3. ** No tendrás otros dioses delante de mí. ** {clase = verso}
4. ** No harás una escultura para ti mismo, ni ningún parecido con lo que está arriba en los cielos, ni abajo en la tierra, ni en las aguas debajo de la tierra. ** {class = verse}
5. ** No te inclinarás ni los servirás; porque yo, el Señor tu Dios, soy un Dios celoso, que visito la iniquidad de los padres en sus hijos, hasta la tercera y cuarta generación de los que me odian. ** {class = verse}
6. ** Y doy misericordia a miles de los que me aman y a los que guardan mis mandamientos. ** {class = verse}
7. ** No tomarás el nombre del Señor tu Dios en vano; porque el Señor no tendrá por inocente tomar su nombre en vano. ** {class = verse}
8. ** Recuerda el día de reposo para santificarlo. ** {class = verso}
9. ** Seis días trabajarás y harás todo tu trabajo. ** {class = verse}
10. ** Pero el séptimo día es el día de reposo del Señor tu Dios; no harás ningún trabajo, ni tú, ni tu hijo, ni tu hija, ni tu criado, ni tu criado, ni tu animal, ni tu extranjero, que está dentro de tus puertas. ** {class = verse}
11. ** Porque en seis días el Señor hizo los cielos y la tierra, el mar y todo lo que hay en ellos, y reposó el séptimo día; por tanto, el Señor bendijo el día de reposo y lo santificó. ** {class = verse}
12. ** Honra a tu padre y a tu madre, para que tus días se prolonguen en la tierra que el Señor tu Dios te da. ** {class = verse}
13. ** No matarás. ** {clase = verso}
14. ** No cometerás adulterio. ** {class = verse}
15. ** No robarás. ** {class = verse}
16. ** No dirás falso testimonio contra tu vecino. ** {class = verse}
...
** ¿Cómo se resume el contenido de las tablas de la ley? ** {clase = pregunta} ** Mateo 22: 36-40 ** {clase = libroQ}  
** Maestro, ¿cuál es el gran mandamiento de la ley? Jesús respondió: "Amarás al Señor tu Dios con todo tu corazón, con toda tu alma y con todo tu entendimiento. Este es el gran y primer mandamiento. La segunda, similar a ésta, es: Amarás a tu prójimo como a ti mismo. Las dos leyes y los profetas dependen de estos dos mandamientos. ** {class = versoQ} ** Mateo 22: 36-40 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) Amor por los hombres y los animales.   
b) Amor a Dios y a los amigos   
c) Amor a Dios y al prójimo.   
...
** ¿Cuál es la actitud de Jesús hacia la validez de la ley de Dios? ** {clase = pregunta} ** Mateo 5: 17,18; 19:17 ** {clase = bookQ}  
** No penséis que vine a derogar la Ley o los Profetas; No vine a revocar, vine a cumplir. Porque de cierto os digo que hasta que pasen el cielo y la tierra, ni una i ni una tilde aprobarán jamás la Ley, hasta que todo se haya cumplido. ** {class = versoQ} ** Mateo 5: 17,18 ** { class = bookVerse}  
** Jesús le respondió: ¿Por qué me preguntas acerca del bien? Bueno, solo hay uno. Sin embargo, si quieres entrar en la vida, guarda los mandamientos. ** {class = versoQ} ** Mateo 19:17 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) Jesús vino a cambiar la ley.   
b) Jesús vino a enseñarnos a guardar los mandamientos de Dios.   
c) Jesús no dijo nada sobre la Ley de Dios.   

!!! Nota ""
	 La Ley de Dios es eterna, como Dios es eterno. Es el estándar de santidad para nosotros entrar a la vida eterna.

** ¿Dios permite cambios en Su palabra o mandamientos? ** {class = question} ** Salmo 89:34 ** {class = bookQ}  
** No violaré mi pacto ni cambiaré lo que han dicho mis labios. ** {class = versoQ} ** Salmo 89:34 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) Nadie puede cambiar la Ley de Dios.   
b) Solo los líderes de la iglesia pueden cambiar la Ley de Dios.   
c) La Ley de Dios era solo para los judíos.   

La Ley de Dios nunca ha sido cambiada, ni lo será jamás.

** ¿Qué escribió Pablo sobre los mandamientos de Dios? ** {clase = pregunta} ** Romanos 3:31; 7:12 ** {clase = bookQ}  
** ¿Entonces invalidamos la ley por fe? ¡No, absolutamente! Más bien, confirmamos la ley. ** {class = versoQ} ** Romanos 3:31 ** {class = bookVerse}  
** Por lo tanto, la ley es santa y el mandamiento es santo, justo y bueno. ** {class = versoQ} ** Romanos 7:12 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) Los que tienen fe no necesitan obedecer los mandamientos de Dios.   
b) La Ley de Dios es buena, es para nuestra felicidad.   
c) Podemos anular la Ley de Dios si somos buenos.   
d) Mediante la fe en Cristo nos volvemos obedientes a la Ley de Dios.   

** ¿Qué pasaría en el futuro, según la Biblia, con la ley de Dios? ** {clase = pregunta} ** Daniel 8:12; 7:25 ** {clase = bookQ}  
** El ejército le fue entregado, con el diario, a causa de las transgresiones; y arrojó la verdad; y lo que hizo prosperó. ** {class = versoQ} ** Daniel 8:12 ** {class = bookVerse}  
** Hablará palabras contra el Altísimo, dañará a los santos del Altísimo y cambiará los tiempos y la ley; y los santos te serán entregados, por un tiempo, dos veces y medio tiempo. ** {class = versoQ} ** Daniel 7:25 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) La Ley de Dios sería respetada y guardada por todos.   
b) Surgiría un poder que haría un cambio audaz en la Ley de Dios, sin tener la autorización para hacerlo.   
c) Dios daría permiso para hacer cambios a su ley.   

## Sábado


** ¿Qué hicieron los hombres con la verdad de Dios? ** {class = question} ** Romanos 1:25 ** {class = bookQ}  
** Porque cambiaron la verdad de Dios en mentira, adorando y sirviendo a la criatura en lugar del Creador, quien es bendecido para siempre. ¡Amén! ** {class = versoQ} ** Romanos 1:25 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) Cambiaron el día de guardia que era sábado, colocando el domingo.   
b) Cuando guardamos el domingo agradamos a Dios.   
c) Quien observa el sábado adora a la criatura en lugar del Creador.   

** ¿Qué siguen muchos en lugar de los mandamientos de Dios? ** {clase = pregunta} ** Marcos 7: 6-9 ** {clase = libroQ}  
** Él les respondió: Hipócritas, Isaías profetizó acerca de ustedes, como está escrito: Este pueblo me honra con sus labios, pero su corazón está lejos de mí. Y en vano me rinden culto, enseñando doctrinas que son preceptos de hombres. Al descuidar el mandamiento de Dios, mantienes la tradición de los hombres. Y les dijo: "Ustedes están correctamente rechazando el precepto de Dios de mantener su propia tradición. ** {class = versoQ} ** Marcos 7: 6-9 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) Muchos piensan que adoran a Dios, pero obedecen a pastores y líderes con sus tradiciones.   
b) Cuando tratamos de adorar a Dios según nuestra propia voluntad, Él no recibe adoración, estamos adorando en vano.   
c) Cuando adoramos a Dios según Su voluntad y según Sus mandamientos, la adoración es válida.   
d) Todas las alternativas son correctas.   

** ¿Podemos guardar un mandamiento y rechazar otro? ** {clase = pregunta} ** Santiago 2: 10-12 ** {clase = libroQ}  
** Porque cualquiera que guarda toda la ley, pero tropieza en un punto, se hace culpable de todos. Porque el que dijo: "No cometerás adulterio", también dijo: "No matarás". Ahora bien, si no cometes adulterio, sino matas, serás transgresor de la ley. Habla de tal manera y de tal manera que procedan como aquellos que serán juzgados por la ley de la libertad. ** {class = versoQ} ** Santiago 2: 10-12 ** {class = bookVerse}  
...
b) No tenemos que preocuparnos por eso.   
c) Los pastores son los que deben explicarnos estas cosas, después de todo lo han estudiado y deben saber lo que dicen.   

** ¿Cuál es la característica del pueblo de Dios en el tiempo del fin? ** {clase = pregunta} ** Apocalipsis 14:12 ** {clase = libroQ}  
** Aquí está la perseverancia de los santos, aquellos que guardan los mandamientos de Dios y la fe de Jesús. ** {class = versoQ} ** Apocalipsis 14:12 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) Dios llama a su pueblo a decir que Jesús salva.   
...
** ¿Qué implica el "temer a Dios" de Apocalipsis 14: 7? ** {clase = pregunta} ** Eclesiastés 12:13 ** {clase = libroQ}  
** De todo lo que se ha escuchado, la suma es: Teme a Dios y guarda sus mandamientos; porque este es el deber de todo hombre. ** {class = versoQ} ** Eclesiastés 12:13 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) Temer a Dios implica tener miedo de Dios.   
b) El verdadero temor de Dios se manifiesta en la observancia de sus mandamientos. Este es nuestro deber.   
c) No involucra nada.   

** ¿Qué es más importante para Dios? ** {clase = pregunta} ** Hechos 5:29, Tito 1:14 ** {clase = libroQ}
** Entonces Pedro y los otros apóstoles dijeron: Es más importante obedecer a Dios que a los hombres. ** {class = versoQ} ** Hechos 5:29 ** {class = bookVerse}  
** Y no te preocupes por las fábulas judías, ni por los mandamientos de hombres desviados de la verdad. ** {class = versoQ} ** Tito 1:14 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) Lo que importa es la sinceridad   
b) Lo más importante es la obediencia a Dios.   
c) Lo más importante es obedecer a los pastores.   
...
!!! cita de fondo
    Hablas, pues, a los hijos de Israel, diciendo: Ciertamente guardaréis mis sábados; porque ésa es una señal entre tú y yo en tus generaciones; para que sepas que yo soy el Señor, que te santifico ** Éxodo 31:13 ** {clase = libro}

## Domingo

Cuando leemos en el libro de Apocalipsis 14:11, en el mensaje dado por el tercer ángel; observamos que quienes adoran a la bestia y su imagen e incluso quienes reciben la señal de su nombre no tienen descanso ni descanso. Por tanto, podemos decir que hay un reposo o reposo en las Escrituras preparado para el pueblo de Dios y que los malvados nunca tendrán.

Sabemos que los malvados son los que rechazan a Dios, el descanso que no tienen debe ser el descanso que Dios ofrece. 

El apóstol Pablo escribió en Hebreos: ** Queda un descanso sabático para el pueblo de Dios; porque en cierto lugar dijo así del séptimo día: Y reposó Dios en el séptimo día de todas sus obras; Porque el que entró en el reposo de Dios, también descansó de sus obras, así como Dios de Su ** {clase = verso} ** Hebreos 4: 9,4,10 ** {clase = libro}.

Entonces, entrar en el reposo de Dios es descansar de tus obras el sábado, tal como Él descansó.

** Al crear el mundo, ¿qué hizo Dios? ** {clase = pregunta} ** Génesis 2: 1-3 ** {clase = libroQ}  
** Así, pues, se acabaron los cielos y la tierra y todo su ejército. Y cuando Dios hubo terminado su obra en el séptimo día, que había hecho, descansó ese día de toda su obra que había hecho. Y Dios bendijo el séptimo día y lo santificó; porque en él reposó de toda la obra que, como Creador, había hecho. ** {class = versoQ} ** Génesis 2: 1-3 ** {class = bookVerse}  
...
** ¿Cuál es el cuarto mandamiento de la Ley de Dios? ** {clase = pregunta} ** Éxodo 20: 8-10 ** {clase = libroQ}  
** Acuérdate del día de reposo para santificarlo. Seis días trabajarás y harás todo tu trabajo. Pero el séptimo día es el día de reposo del Señor tu Dios; no harás ningún trabajo, ni tú, ni tu hijo, ni tu hija, ni tu criado, ni tu criado, ni tu animal, ni el forastero de tus puertas adentro ** {class = versoQ} ** Éxodo 20: 8-10 ** {class = bookVerse}  
...
** ¿Por qué Dios estableció el sábado? ** {clase = pregunta} ** Marcos 2: 27,28 ** {clase = libroQ}  
** Y añadió: El sábado fue establecido por causa del hombre, y no el hombre por causa del sábado; entonces el Hijo del Hombre es el Señor del sábado. ** {class = versoQ} ** Marcos 2: 27,28 ** {class = bookVerse}  
...
** ¿Se les dio el sábado solo a los judíos? ** {class = question} ** Isaías 56: 6,7 ** {class = bookQ}  
** A los extranjeros que vienen al Señor, para servirle y amar el nombre del Señor, siendo así sus siervos, sí, todos los que guardan el sábado, sin profanarlo, y abrazan mi pacto, yo también los llevaré a la mi santo monte y me regocijaré en mi casa de oración ... ** {class = versoQ} ** Isaías 56: 6,7 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) No, el sábado fue dado a todos, solo que la gente lo acepte.   
b) Sí, esto es cosa de judíos.   
c) Sí, solo para judíos ortodoxos.   

## Lunes


** ¿Que el sábado era una señal? ** {clase = pregunta} ** Ezequiel 20: 12.20 ** {clase = libroQ}  
** También les di mis sábados, como una señal entre ellos y yo, para que supieran que yo soy el Señor que los santifica. ** {class = versoQ} ** Ezequiel 20:12 ** {class = bookVerse}  
** Santifica mis sábados, porque serán una señal entre tú y yo, para que sepas que yo soy el Señor tu Dios. ** {class = versoQ} ** Ezequiel 20:20 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) El sábado no es una señal.   
...
** Hay tres características del sello de Dios que encontramos en los Diez Mandamientos. ** {clase = pregunta} ** Éxodo 20: 8-11 ** {clase = libroQ}  
** Acuérdate del día de reposo para santificarlo. Seis días trabajarás y harás todo tu trabajo. Pero el séptimo día es el día de reposo del Señor tu Dios; No harás obra alguna, ni tú, ni tu hijo, ni tu hija, ni tu siervo, ni tu siervo, ni tu animal, ni el extraño de tus puertas adentro, porque en seis días hizo el Señor de los cielos, la tierra, el mar y todo lo que hay en ellos, y en el séptimo día descansó, por lo que el Señor bendijo el día de reposo y lo santificó. ** {class = verseQ} ** Éxodo 20: 8- 10 ** {clase = bookVerse}  

** Marque las declaraciones con V cuando sean verdaderas y F cuando sean falsas **

a) () Nombre: Señor Dios.   
b) () Cargo: Creador.   
c) () Jurisdicción: Los cielos y la tierra.   
d) () No tiene atributos.   

!!! Nota ""
	 En el pasado, un rey selló sus leyes con su anillo que contenía sus tres atributos. El primero era su nombre, el segundo su cargo y el tercero su competencia territorial. Cuando la gente vio ese sello, ya reconoció al rey que hizo esa ley. El día de reposo es el sello de Dios, tiene su nombre (Dios), su posición (Creador) y su jurisdicción o competencia territorial (Los cielos y la tierra). Por eso el sábado se considera el sello de Dios.

** ¿Cuál fue la misión del Mesías con respecto a la ley de Dios? ** {clase = pregunta} ** Isaías 42:21, Mateo 5:17 ** {clase = libroQ}   
** Agradó al Señor, por causa de su propia justicia, ensanchar la ley y hacerla gloriosa. ** {class = versoQ} ** Isaías 42:21 ** {class = bookVerse}  
** No penséis que vine a derogar la Ley o los Profetas; No vine a revocar, vine a cumplir. ** {class = versoQ} ** Mateo 5:17 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) La misión del Mesías era abolir la ley.   
b) La misión del Mesías era magnificar la ley y hacerla gloriosa, es decir, cumplir la ley y dar ejemplo de cómo se hace.   
c) El Mesías vino con otro tipo de misión, ajena a la ley.   

** ¿Qué día estaba mirando Jesús? ** {class = question} ** Lucas 4:16 ** {class = bookQ}  
** Al ir a Nazaret, donde se crió, entró en la sinagoga un sábado, según su costumbre, y se levantó para leer. ** {class = versoQ} ** Lucas 4:16 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) Jesús tenía la costumbre de ir a la sinagoga los sábados.   
b) Jesús tenía la costumbre de ir a la sinagoga los domingos.   
c) Jesús tenía la costumbre de ir a la sinagoga todos los días.   

!!! Nota ""
	 La costumbre de Jesús era adorar o adorar a Dios en los días de reposo en la sinagoga, que era la iglesia del día. Si Jesús, quien es nuestro ejemplo, asistió a la sinagoga el sábado, ¿qué día debo asistir a la iglesia?

## Martes


** ¿Qué día guardaban los seguidores de Jesús? ** {class = question} ** Lucas 23: 54-56 ** {class = bookQ}  
** Era el día de la preparación y comenzaba el sábado. Las mujeres que habían venido de Galilea con Jesús lo siguieron, vieron el sepulcro y cómo el cuerpo había sido depositado allí. Luego, se retiraron a preparar aromas y bálsamos. Y el sábado descansaron según el mandamiento. ** {class = versoQ} ** Lucas 23: 54-56 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) Los discípulos de Jesús guardaban el domingo.   
b) Los discípulos de Jesús guardaron el sábado.   
c) Los discípulos de Jesús lo guardaban todos los días.   

** ¿Qué observará el pueblo de Dios en el tiempo del fin? ** {class = question} ** Apocalipsis 14:12 ** {class = bookQ}  
** Aquí está la perseverancia de los santos, aquellos que guardan los mandamientos de Dios y la fe de Jesús. ** {class = versoQ} ** Apocalipsis 14:12 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) El pueblo de Dios al final de los tiempos guardará los mandamientos de Dios y tendrá la fe de Jesús.   
...
** ¿Qué dice la Palabra de Dios sobre el que desprecia la ley o solo uno de los mandamientos que contiene? ** {clase = pregunta} ** Santiago 2:10; I Juan 2: 4 ** {class = bookQ}  
** Cualquiera que guarda toda la ley, pero tropieza en un punto, se hace culpable de todos. ** {class = versoQ} ** Santiago 2:10 ** {class = bookVerse}  
** El que dice: Lo conozco y no guarda sus mandamientos es un mentiroso, y la verdad no está en él. ** {class = versoQ} ** I Juan 2: 4 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) La palabra de Dios no dice nada sobre esto.   
b) La palabra de Dios dice que si despreciamos uno de los mandamientos, no observaremos nada.   
c) La palabra de Dios nos dice que podemos obedecer parcialmente.   

!!! Nota ""
	 La verdadera fe se manifiesta en la obediencia a todos los mandamientos de Dios.

## Miércoles

La obra de reforma del sábado que se llevará a cabo en los últimos tiempos está predicha en la profecía de Isaías: ** "Así dice el Señor: Guarda tu juicio y haz justicia, porque mi salvación está por venir, y la mía justicia para manifestar. Bienaventurado el hombre que hace esto, y el hijo de hombre que hace uso de él; que se guarda de profanar el día de reposo, y guarda su mano de hacer cualquier mal. "** {class = verse} ** Isaías 56: 1,2 ** {clase = libro}. ** "A los hijos de extranjeros que vienen al Señor para servirle y amar el nombre del Señor, siendo así sus siervos, todos los que guardan el día de reposo, sin profanarlo, y también los que abrazan mi pacto. Te llevaré a Mi santo monte, y te celebraré en Mi casa de oración ". ** {clase = verso} ** Isaías 56: 6,7 ** {clase = libro}. Estas palabras se aplican a la era cristiana, como se ve en el contexto: ** Así dice el Señor Jehová, que reúne a los dispersos de Israel: Aún reuniré a otros con los que ya se han unido a él. ** {clase = verso} ** (Isaías 56: 8). ** { class = book} Aquí está la prefiguración de la reunión de los gentiles por el evangelio. Y sobre aquellos que luego honran el sábado, se pronuncia una bendición.
...
** ¿Qué orden le da Dios en Isaías a su pueblo? ** {clase = pregunta} ** Isaías 58: 1 ** {clase = libroQ}  
** Clama a gran voz, no pares, alza tu voz como trompeta y anuncia mi transgresión a mi pueblo, y tus pecados a la casa de Jacob. ** {class = versoQ} ** Isaías 58: 1 * * {class = bookVerse}  

** Marque la respuesta correcta: **  
a) Anunciar al pueblo la venida del Señor   
b) Anuncie su transgresión al pueblo   
c) Anunciar a marchar a la guerra.   

!!! Nota ""
	 Dios envía un reproche a su pueblo y no a los impíos, porque a pesar de su desobediencia todavía: ** "Sin embargo, me buscan todos los días, se complacen en conocer mis caminos, como pueblo que practica la justicia, y no deja la ordenanza de su Dios ". ** {clase = verso} ** Isaías 58: 2 ** {clase = libro}

Lea atentamente el texto a continuación.

** Y los que procedan de ti construirán las ruinas antiguas; y levantarás los cimientos de generación en generación; y te llamarán reparador de roturas y restaurador de caminos para vivir. Si apartas tu pie del día de reposo para hacer tu voluntad en mi día santo, y llamas al día de reposo delicioso, y al día santo del Señor digno de honor, y lo honras al no seguir tus caminos ni al intentar hacer los tuyos. no hablarás tus propias palabras, entonces te deleitarás en el SEÑOR, y te haré cabalgar sobre las alturas de la tierra, y te sustentaré con la heredad de tu padre Jacob; porque la boca del SEÑOR lo dijo ** {class = versoQ} ** Isaías 58: 12-14 ** {class = bookVerse}  
...
c) () Dios promete gozo o deleite a quienes honran el sábado.   
d) () La infracción a la ley de Dios fue el cambio de sábado a domingo.   
e) () Puedo guardar cualquier día para el Señor, no tiene que ser sábado.   

## Jueves


** ¿Qué hizo Dios en el séptimo día? ** {clase = pregunta} ** Génesis 2: 3 ** {clase = libroQ}  
** Y Dios bendijo el séptimo día y lo santificó; porque en él descansó de toda la obra que, como Creador, había hecho. ** {class = versoQ} ** Génesis 2: 3 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) Bendecido, santificado y hecho un día de descanso.   
b) Realizó sus últimas obras creadas   
c) No hizo nada, fue al cielo.   

** ¿Cuándo comienza el sábado? ** {clase = pregunta} ** Levítico 23:32 ** {clase = libroQ}  
** El sábado de descanso solemne será tuyo; entonces afligirás tu alma; a las nueve del mes, de una tarde a otra, celebrarás tu sábado. ** {class = versoQ} ** Levítico 23:32 ** {class = bookVerse}  
...
** ¿Qué significa "tarde" en la Biblia? ** {clase = pregunta} ** Deuteronomio 16: 6 ** {clase = libroQ}  
** Si no está en el lugar que el Señor tu Dios elige para hacer habitar su nombre, sacrificarás la Pascua allí por la tarde, al atardecer, en el momento en que saliste de Egipto. ** {class = versoQ} * * Deuteronomio 16: 6 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) Significa puesta de sol.   
b) Significa el período del día después del mediodía.   
c) Significa la parte oscura de la noche.   

!!! Nota ""
	 Tarde significa puesta de sol en la Biblia. El sábado debe guardarse desde la puesta del sol del viernes hasta la puesta del sol del sábado.

** ¿Cuál es el día de preparación especial para el sábado? ** {clase = pregunta} ** Marcos 15:42 ** {clase = bookQ}  
** Al anochecer, ya que es el día de preparación, es decir, la víspera del sábado. ** {class = versoQ} ** Marcos 15:42 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) El día de preparación es el domingo.   
b) El día de preparación es el viernes, víspera del sábado.   
...
** ¿En qué día se debe preparar la comida del sábado? ** {class = question} ** Éxodo 16: 22-26 ** {class = bookQ}  
** Al sexto día tomaron pan doble, dos gomers para cada uno; y los líderes de la congregación vinieron y se lo dijeron a Moisés. Y él les dijo: Esto es lo que dijo el SEÑOR: Mañana es reposo, sábado santo del SEÑOR; lo que quieras cocinar en el horno, cocínalo, y lo que quieras cocinar en agua, cocínalo en agua; y separe lo que quede, guardándolo para la mañana siguiente. Y lo guardaron hasta la mañana siguiente, como había mandado Moisés; y no olía mal, ni daba animales. Entonces Moisés dijo: Cómelo hoy, porque el sábado es del Señor; hoy, no lo encontrará en el campo. ** {class = versoQ} ** Éxodo 16: 22-26 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) La comida debe prepararse el sábado.   
b) La comida debe prepararse el viernes, día de preparación.   
c) La comida debe prepararse el jueves.   

!!! Nota ""
	 En el plan de Dios para establecer el día de reposo, Él tiene un cuidado supremo incluso por las amas de casa y desea que también descansen de sus actividades. Por lo tanto, el viernes toda la comida debe prepararse dos veces, para que el sábado no estemos ocupados preparando comida y podamos dedicarnos únicamente al Señor.

## Viernes


** ¿En qué día reanudaron sus actividades Jesús y las mujeres que lo iban a enterrar? ** {clase = pregunta} ** Marcos 16: 1-6 ** {clase = libroQ}  
** Después del sábado, María Madalena, María, la mamá de Tiago y Salomé, compraron aromas para ir a embalsamarlo. Y muy temprano, el primer día de la semana, cuando salió el sol, fueron a la tumba. ** {class = versoQ} ** Marcos 16: 1-6 ** {class = bookVerse}  
...
** ¿Está bien tratar con cualquier tipo de comercio en sábado? ** {clase = pregunta} ** Nehemías 13: 16,17 ** {clase = libroQ}  
** También vivían en Jerusalén tirios que traían pescado y toda clase de bienes, que el sábado vendían a los hijos de Judá y en Jerusalén. Luché con los nobles de Judá y les dije: ¿Qué es este mal que hacéis, profanar el día de reposo? ** {class = versoQ} ** Nehemías 13: 16,17 ** {class = bookVerse}
...
!!! Nota ""
	 El comercio del sábado, incluso de alimentos, es condenado por la Palabra de Dios. Si es necesario comprar, debemos hacerlo antes del viernes. Comprar o hacer cualquier tipo de comercio en sábado es profanarlo. (Ver también: ** Jeremías 17: 24-27 ** {clase = libro})

** ¿Qué deberíamos comer el sábado? ** {class = question} ** Levítico 23: 3 ** {class = bookQ}  
** Seis días trabajarás, pero el séptimo será el día de reposo solemne, santa convocación; no harás ningún trabajo; es el día de reposo del SEÑOR en todas sus moradas. ** {class = versoQ} ** Levítico 23: 3 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) Adoración y adoración a Dios.   
b) Trabajos ordinarios como todos los días.   
...
** ¿Qué día fue Jesús a la iglesia (sinagoga)? ** {clase = pregunta} ** Lucas 4: 16,31 ** {clase = libroQ}  
** Al ir a Nazaret, donde se crió, entró en la sinagoga un sábado, según su costumbre, y se levantó a leer "Lucas 4:16" Y descendió a Capernaum, ciudad de Galilea, y les enseñó el sábado. . ** {clase = versoQ} ** Lucas 4:31 ** {clase = verso del libro}
...
!!! Nota ""
	 Jesús se congregó con el pueblo de Dios el sábado. Fue en ese día de una manera especial que Él enseñó la palabra ** Lucas 4: 17-21 ** {clase = libro}.

** ¿Cuál fue el otro tipo de actividad que Jesús realizó en sábado y que también deberíamos hacer nosotros? ** {class = question} ** John 9:14 ** {class = bookQ}  
** Y era sábado cuando Jesús hizo el barro y abrió los ojos. ** {class = versoQ} ** Juan 9:14 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) Jesús durmió durante el tiempo que no estuvo en la iglesia, ya que es un día de descanso.   
b) Jesús alivió a los que sufrían en su día. Visitó a los enfermos y los ayudó.   
c) Jesús debatió sus errores doctrinales con los líderes de la iglesia.   

** ¿Qué tipo de trabajo vamos a hacer el sábado? ** {clase = pregunta} ** Mateo 12:12 ** {clase = libroQ}  
** Ahora, ¿cuánto mejor es un hombre que una oveja? Por lo tanto, es lícito, los sábados, hacer el bien. ** {class = versoQ} ** Mateo 12:12 ** {class = bookVerse}

** Marque la respuesta correcta: **  
a) Debemos llevar las ovejas a pastar.   
b) Debemos hacer el bien a los necesitados, especialmente en sábado.   
c) Debemos dejar el trabajo para los necesitados para el sábado, para no perder el tiempo durante la semana.   
...
** ¿Qué día es el Señor Jesús? ** {class = question} ** Mateo 12: 8 ** {class = bookQ}  
** Porque el Hijo del Hombre es Señor del sábado ** {class = versoQ} ** Mateo 12: 8 ** {class = bookVerse}  
...
** ¿Qué hicieron los apóstoles en el día de reposo? ** {class = question}

** Marque las declaraciones con V cuando sean verdaderas y F cuando sean falsas **

a) () Predicaron la palabra - ** El sábado siguiente, casi toda la ciudad vino a escuchar la palabra de Dios. ** {class = versoQ} ** Hechos 13: 14-15,27,42,44 ** { class = libro}  
b) () Buscaban estar en medio de la naturaleza - ** El sábado salimos de la ciudad al lado del río, donde parecía haber un lugar de oración ... ** {class = versoQ} ** Hechos 16:13 ** {clase = libro}  
c) () Apartaron tiempo para orar y predicar - ** El sábado salimos de la ciudad junto al río, donde parecía haber un lugar de oración ... ** {class = versoQ} ** Hechos 16: 13 ** {clase = libro}  
d) () Compraron y vendieron.   

** ¿Cómo se debe santificar el sábado? ** {class = question} ** Isaías 58:13 ** {class = bookQ}  
** Si apartas tu pie de profanar el día de reposo y de cuidar tus propios intereses en mi día santo; si llamas al día de reposo un día delicioso y santo del Señor, digno de honor, y lo honras al no seguir tus caminos, no tener la intención de hacer tu propia voluntad o hablar palabras vanas. ** {class = versoQ} ** Isaías 58:13 ** {class = bookVerse}  
...
c) () Nuestras conversaciones deben ser tales que nos acerquen más a Dios.   
...
** ¿Qué debemos hacer el sábado? ** {class = question} ** Éxodo 20: 8-11 ** {class = bookQ}  
** Acuérdate del día de reposo para santificarlo. Seis días trabajarás y harás todo tu trabajo. Pero el séptimo día es el día de reposo del Señor tu Dios; no harás ningún trabajo, ni tú, ni tu hijo, ni tu hija, ni tu siervo, ni tu siervo, ni tu animal, ni el forastero de tus puertas adentro; porque en seis días el Señor hizo los cielos y la tierra, el mar y todo lo que hay en ellos, y reposó el séptimo día; por lo tanto, el Señor bendijo el día de reposo y lo santificó. ** {class = versoQ} ** Éxodo 20: 8-11 ** {class = bookVerse}  

** Marque las declaraciones con V cuando sean verdaderas y F cuando sean falsas **  
a) () Trabajo secular.   
b) () Pagar a otros para que hagan los trabajos que se supone que no debemos hacer por nosotros.   
c) () Actualizar lecturas, cartas y correspondencia.   
d) () Trabajo en equipo familiar.   
e) () Visitas a enfermos y afligidos.   
...
** ¿Cuánto tiempo se guardará el sábado? ** {class = question} ** Isaías 66: 22,23 ** {class = bookQ}  
** Porque como los cielos nuevos y la tierra nueva que yo hago, estarán delante de mí, dice el Señor, así será tu posteridad y tu nombre. Y será que, de una Fiesta de Luna Nueva a otra y de sábado a otro, toda la carne vendrá a adorar ante mí, dice el Señor. ** {class = versoQ} ** Isaías 66: 22,23 ** { class = bookVerse}  

** Marque la respuesta correcta: **  
a) Hasta que Jesús regrese.   
b) Incluso en la Tierra Nueva se guardará el sábado.   
c) El sábado era solo para judíos.   

!!! Nota ""
	 Cuando la tierra sea restaurada y el gobierno de Dios se establezca aquí, todos vendrán a adorar ante Dios en sábado.
...
!!! cita de fondo
    Si alguno adora a la bestia y a su imagen y recibe su marca en la frente o en la mano, también él beberá el vino de la ira de Dios, preparado, sin mezclar, de la copa de su ira. ** Apocalipsis 14: 9,10 ** {clase = libro}

## Domingo


** ¿Qué presenta la Biblia como el objetivo de una señal o sello? ** {clase = pregunta} ** Daniel 6: 8 ** {clase = libroQ}  
** Ahora pues, oh rey, confirma la prohibición y firma el edicto, para que no sea cambiado, según la ley de los medos y persas, que no puede ser revocada. ** {class = versoQ} ** Daniel 6 : 8 ** {clase = bookVerse}  

** Marque la respuesta correcta: **  
a) Definir quién es el autor, dar vigencia a la ley y evitar que se modifique.   
b) Haga los sobres y papeles más bonitos.   
c) Alerta a la gente.   

!!! Nota ""
	 Cuando el rey firmaba un decreto, éste adquiría autoridad y entraba en vigor. Era costumbre, en el pasado, que los reyes llevaran un anillo para este propósito, que contenía su nombre, iniciales o monograma. Jezabel, la esposa de Acab ** "escribió cartas en nombre de Acab y las selló con su sello" ** {clase = verso} (** 1 Reyes 21: 8 ** {clase = libro}). Se dice del decreto promulgado por Asuero, para la matanza de todos los judíos en el imperio persa, que ** "en el nombre del rey Asuero fue escrito, y con el anillo del rey fue sellado" ** {clase = verso} ** Ester 3:12 ** {clase = libro}

Para estar completo, un sello debe contener tres requisitos básicos:

I - EL NOMBRE DEL LEGISLADOR;  
II - CARGO, TITULO O AUTORIDAD OFICIAL; ASÍ COMO SU DERECHO A GOBERNAR;  
III - SU REINO, O LA EXTENSIÓN DE SU DOMINIO Y JURISDICCIÓN.  

** ¿Con qué está relacionado el sello de Dios? ** {clase = pregunta} ** Isaías. 8:16 ** {clase = bookQ}  
** Enciende el testimonio, sella la ley entre mis discípulos. ** {class = versoQ} ** Isaías 8:16 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) El sello de Dios está relacionado con Su Ley.   
b) El sello de Dios está relacionado con Su corazón.   
c) El sello de Dios está relacionado con Su testimonio.   

** ¿Muestra el primer mandamiento quién es el autor de la ley? ** {clase = pregunta} ** Éxodo 20: 3 ** {clase = libroQ}  
** No tendrás otros dioses delante de mí. ** {class = versoQ} ** Éxodo 20: 3 ** {class = bookVerse}  
...
** ¿El segundo, tercero, quinto, sexto, séptimo, octavo, noveno o décimo mandamientos indican quién es el autor del Decálogo? ** {clase = pregunta} ** Éxodo 20: 4; 7.22 ** {clase = bookQ}  
** No harás una escultura para ti, ni semejanza alguna con lo que está arriba en los cielos, ni abajo en la tierra, ni en las aguas debajo de la tierra. No te inclinarás ante ellos ni les servirás; porque yo, el Señor tu Dios, soy un Dios celoso, que visito la iniquidad de los padres en sus hijos, la tercera y cuarta generación de los que me odian. Y doy misericordia a miles de los que me aman y a los que guardan mis mandamientos. No tomarás el nombre del Señor tu Dios en vano; porque el SEÑOR no considerará inocente su nombre en vano. ** {class = versoQ} ** Éxodo 20: 4-7 ** {class = bookVerse}  
** Y el SEÑOR dijo a Moisés: Así dirás a los hijos de Israel: Habéis visto que os hablé desde el cielo ** {class = versoQ} ** Éxodo 20:22 ** {class = bookVerse}  
...
** ¿Cuál es el único mandamiento del Decálogo que revela el nombre, la autoridad y el dominio del Autor de esta ley? ** {clase = pregunta} ** Éxodo 20: 8-11 ** {clase = libroQ}  
** Acuérdate del día de reposo para santificarlo. Seis días trabajarás y harás todo tu trabajo. Pero el séptimo día es sábado para el SEÑOR tu Dios; no harás ningún trabajo, ni tú, ni tu hijo, ni tu hija, ni tu siervo, ni tu siervo, ni tu animal, ni tu extranjero que está dentro de tus puertas. Porque en seis días hizo Jehová los cielos y la tierra, el mar y todo lo que hay en ellos, y reposó el séptimo día; por tanto, el SEÑOR bendijo el día de reposo y lo santificó. ** {class = versoQ} ** Éxodo 20: 8-11 ** {class = bookVerse}  

** Marque las declaraciones con V cuando sean verdaderas y F cuando sean falsas **  
a) () El cuarto mandamiento solo revela al autor de esta ley.   
b) () El nombre del autor es el SEÑOR.   
c) () El atributo o cargo del Autor es CREADOR.   
d) () El dominio o jurisdicción es Cielo y Tierra.   
e) () El mandamiento del sábado contiene el sello de Dios.   
f) () Al recibir la verdad del sábado, recibo el sello de Dios.   
g) () Guardando el día de reposo tendré presente que Dios es el Creador de todas las cosas.   
h) () El sábado es la señal entre el Creador y sus criaturas obedientes.   
i) () El hombre nunca olvidará el sábado.   

!!! Nota ""
	 Si el sábado no fuera olvidado, no tendríamos ateos

** La Biblia dice que el sábado es una señal eterna entre Dios y Su pueblo, ¿por qué? ** {clase = pregunta} ** Éxodo 31:17 ** {clase = libroQ}  
** Entre los hijos de Israel y yo será una señal para siempre; porque en seis días el SEÑOR hizo los cielos y la tierra, y en el séptimo día descansó y fue restaurado. ** {class = versoQ} ** Éxodo 31:17 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) Porque Dios los amó.   
b) Porque fueron obedientes y fieles.   
c) Porque el único Dios verdadero es el Creador de todas las cosas.   

** El sábado es una señal ... ** {clase = pregunta} ** Ezequiel 20:20; Éxodo 31:13. ** {class = bookQ}   
** Hablas, pues, a los hijos de Israel, diciendo: Ciertamente guardarás mis sábados; porque ésa es una señal entre tú y yo en tus generaciones; para que sepáis que yo soy el Señor, que os santifico. ** {class = versoQ} ** Exodus 31:13 ** {class = bookVerse}  
** Y santifica mis sábados, y serán una señal entre tú y yo, para que sepas que yo soy el SEÑOR tu Dios. ** {class = versoQ} ** Ezequiel 20:20 ** {class = bookVerse}  

** Marque las declaraciones con V cuando sean verdaderas y F cuando sean falsas **  
a) () El sábado es una señal de que el Señor es nuestro Dios.   
b) () El sábado es la señal del poder creativo de Dios.   
c) () Dondequiera que se manifiesta el poder creador de Dios es en la creación o en la redención, el sábado revela esta señal.   
d) () Cada sábado nos recuerda el poder creador y redentor de Cristo.   
e) () El sábado pone fin a la historia del mal.   

!!! Nota ""
	 La creación o redención manifiesta el poder creativo de Dios. La redención es creación o recreación, volver a crear. Se necesita el mismo poder para redimir que para crear. "Fuimos creados en Cristo Jesús para buenas obras". ** Efesios 2:10. ** {clase = libro}
    Con cada nuevo sábado, Dios lo designa para recordar a Aquel que nos creó, y cuya gracia y poder santificador en nosotros obra para prepararnos para Su reino eterno.

## Martes

Lea el texto:

** Y después de estas cosas vi a cuatro ángeles que estaban en los cuatro ángulos de la tierra, sosteniendo los cuatro vientos de la tierra, para que ningún viento sople sobre la tierra, ni sobre el mar, ni contra ningún árbol. Y vi a otro ángel subir por el lado del sol naciente, y tenía el sello del Dios viviente; y clamó a gran voz a los cuatro ángeles, a quienes se les había dado el poder de dañar la tierra y el mar, diciendo: No dañéis la tierra, ni el mar, ni los árboles, hasta que hayamos marcado a los siervos de nuestro Dios en sus frentes. . Y oí el número de los nombrados, y había ciento cuarenta y cuatro mil nombrados, de todas las tribus de los hijos de Israel. ** {clase = verso} ** Apocalipsis 7: 1-4 ** {clase = libro}  
...
** El apóstol Juan vio a estos siervos que luego fueron sellados con el Cordero. ¿Qué tenían en la frente? ** {clase = pregunta} ** Apocalipsis 14: 1 ** {clase = libroQ}  
** Y miré, y he aquí, el Cordero estaba en el monte Sion, y con él ciento cuarenta y cuatro mil, que habían escrito el nombre de su Padre en sus frentes. ** {class = versoQ} ** Apocalipsis 14: 1 ** {clase = bookVerse}  

** Marque la respuesta correcta: **  
a) Escritos de donde proceden.   
b) Escribió el nombre del Cordero y Su Padre.   
c) Escriba el nombre donde se suponía que debían ir.   

!!! Nota ""
	 El sello de Dios y el nombre del Padre deben referirse a lo mismo. El sello es la señal o marca de la perfección, y el nombre de Dios es equivalente a Su carácter, que es la perfección. Y el sábado de Dios, observado como Dios manda que sea en santidad, es una señal de eso mismo, la perfección del carácter. Cuando este sello se ponga finalmente en el pueblo de Dios, será una prueba de que Su gracia y poder santificador han hecho su trabajo y los han calificado para el Cielo. En el mundo venidero, todos observarán el sábado y, por lo tanto, tendrán este sello o marca. de santificación, santidad y perfección de carácter. ** Isaías 66: 22,23 ** {clase = libro}

El sello de Dios se presenta puesto en la frente o en el centro de la razón. Es un acto voluntario, elegido por hombres que, aceptando la acción de Dios en ellos, les da: PERFECCIÓN, PROTECCIÓN y seguridad de ser PROPIEDAD especial de Dios. ** "Sin embargo, el fundamento de Dios permanece firme, llevando este sello: El Señor conoce a los que son suyos, y el que diga el nombre de Cristo se apartará de la iniquidad". ** {clase = verso} ** 2 Timoteo 2:19 ** {clase = libro}

** ¿Qué se dice sobre el carácter de los mencionados? ** {clase = pregunta} ** Apocalipsis 14: 5 ** {clase = libroQ}  
** Y no se encontró error en su boca; porque son irreprensibles ante el trono de Dios. ** {class = versoQ} ** Apocalipsis 14: 5 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) Que no se encontró mentira en tu boca.   
b) Que nunca más serán engañados.   
c) Que no pudieron ganar.   

** ¿Cómo se describe la iglesia Remanente? ** {class = question} ** Apocalipsis 14:12 ** {class = bookQ}  
** Aquí está la paciencia de los santos; aquí están los que guardan los mandamientos de Dios y la fe en Jesús. ** {class = versoQ} ** Apocalipsis 14:12 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) Esta iglesia fue derrotada por el dragón.   
...
** ¿Contra qué tres cosas advierte a los hombres el ángel de Apocalipsis 14? ** {clase = pregunta} ** Apocalipsis 14: 9 ** {clase = libroQ}  
** Y el tercer ángel los siguió, diciendo a gran voz: Si alguno adora a la bestia y a su imagen, y recibe la marca en su frente o en su mano. ** {class = versoQ} ** Apocalipsis 14 : 9 ** {clase = bookVerse}  

** Marque la respuesta correcta: **  
a) En contra de adorar a la bestia y su imagen y recibir su marca en la frente y la mano.   
b) Contra la bestia y sus colaboradores.   
c) Contra los grandes peligros de la vida urbana.   

## Miércoles


** ¿Cuáles son las características especiales de los que se presentan en el mensaje del tercer ángel en contraste con los adoradores de la bestia y su imagen? ** {clase = pregunta} ** Apocalipsis 14:12 ** {clase = libroQ}  
** Aquí está la paciencia de los santos; aquí están los que guardan los mandamientos de Dios y la fe en Jesús. ** {class = versoQ} ** Apocalipsis 14:12 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) Son los que integran la victoriosa iglesia de Dios.   
b) Guarde los mandamientos de Dios.   
c) No tienen características especiales.   

!!! Nota ""
	 Los que son fieles a los Diez Mandamientos de Dios se presentan en contraste con los que adoran a la bestia. Esto significa que la lucha será entre la ley de Dios y la ley de la bestia (o de los hombres).

** ¿Qué cambio audaz describe el profeta Daniel que haría la bestia en la Ley de Dios? ** {clase = pregunta} ** Daniel 7:25 ** {clase = libroQ}  
** Hablará palabras contra el Altísimo, dañará a los santos del Altísimo y cambiará los tiempos y la ley; y los santos te serán entregados, por un tiempo, dos veces y medio tiempo. ** {class = versoQ} ** Daniel 7:25 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) Cambiaría a los santos de las manos del Altísimo.   
b) Cambiaría la ley de Dios.   
c) Cambiar los horarios como quisieran.   

!!! Nota ""
	 La Palabra de Dios nos revela que el poder papal cambiaría la Ley de Dios y la lucha final involucrará a quienes no aceptan el cambio y deciden ser fieles a Dios frente a quienes aceptan el cambio y quieren imponerlo.
...
** ¿Qué no tienen los adoradores de la bestia y su imagen? ** {clase = pregunta} ** Apocalipsis 14:11 ** {clase = libroQ}  
** El humo de su tormento se eleva a través de los siglos, y no hay descanso, ni de día ni de noche, para los adoradores de la bestia y su imagen y para cualquiera que reciba la marca de su nombre. ** {class = versoQ} ** Apocalipsis 14:11 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) No hay descanso, ni de día ni de noche.   
b) No tiene derecho a efectuar este cambio.   
c) No hay ningún lugar donde quedarse con su doctrina.   

** ¿Qué descanso les falta a los adoradores de la bestia y su imagen? ** {clase = pregunta} ** Hebreos 4: 4,10; Éxodo 20: 8-10 ** {class = bookQ}  
** Porque, en cierto lugar, lo dijo acerca del séptimo día: Y Dios reposó, en el séptimo día, de todas las obras que había hecho. ** {class = versoQ} ** Hebreos 4: 4 ** {class = bookVerse}  
** Porque el que entró en el reposo de Dios, él mismo descansó de sus obras, como Dios de las suyas. ** {class = versoQ} ** Hebreos 4:10 ** {class = bookVerse}   
** Acuérdate del día de reposo para santificarlo. Seis días trabajarás y harás todo tu trabajo. Pero el séptimo día es el día de reposo del Señor tu Dios; no harás ningún trabajo, ni tú, ni tu hijo, ni tu hija, ni tu siervo, ni tu siervo, ni tu animal, ni el extraño de tus puertas adentro; ** {class = versoQ} * * Éxodo 20: 8-10 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) El reposo de Dios, el sábado del séptimo día.   
b) El resto del día, simplemente detenga mis actividades.   
c) El reposo de Dios, que es el primer día, domingo.   

!!! Nota ""
	 El día de reposo es el sábado, por lo que los desobedientes que no guarden el sábado no tendrán el privilegio de tener este reposo.

** ¿Qué dice la bestia que es su marca de autoridad? ** {class = question}
...
El papado considera su cambio del sábado del cuarto mandamiento como su señal de autoridad ** (Éxodo 20: 8) ** {clase = libro} al domingo. Se impondrá una ley de observancia del domingo en los Estados Unidos de América y más tarde en el mundo ** (Apocalipsis 13: 11-17), ** {class = book} y todos deberán guardar el domingo como una señal de la autoridad del Papa. .

** Si la señal de la bestia es la vigilia del domingo, ¿cuál sería la señal de Dios? ** {clase = pregunta} ** Ezequiel 20: 12,20 ** {clase = libroQ}  
** También les di mis sábados, como una señal entre ellos y yo, para que supieran que yo soy el Señor que los santifica ** {class = versoQ} ** Ezequiel 20:12 ** {class = bookVerse}  
** Santifica mis sábados, porque serán una señal entre mí en ti, para que sepas que yo soy el Señor tu Dios. ** {class = versoQ} ** Ezequiel 20:20 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) La señal de Dios es el primer día, el domingo.   
b) La señal de Dios es el sábado del séptimo día.   
c) La señal de Dios es el sexto día de la semana.   

!!! Nota ""
	 El sábado fue dado desde la creación del mundo para el hombre (ver ** Génesis 2: 1-3 ** {clase = libro}), fue guardado por Abraham (** Génesis 26: 5 ** {clase = libro }), y fue dado como un pacto perpetuo (para siempre) entre Dios y Su pueblo (** Éxodo 31: 16-17 ** {clase = libro}).

** ¿Contra qué advierte a los hombres el ángel de Apocalipsis 14? ** {clase = pregunta} ** Apocalipsis 14: 9 ** {clase = libroQ}  
** Y el tercer ángel los siguió, diciendo a gran voz: Si alguno adora a la bestia y a su imagen, y recibe la marca en su frente o en su mano ** {class = versoQ} ** Apocalipsis 14: 9 ** {clase = bookVerse}  

** Marque la respuesta correcta: **  
a) Contra la bestia, la imagen de la bestia y la marca de la bestia.   
b) Contra la imagen en la mano y en la frente   
c) Contra beber el vino de Dios.   
...
** ¿Qué poder debería imponer esta marca? ** {clase = pregunta} ** Apocalipsis 13: 11,16 ** {clase = libroQ}  
** Y vi otra bestia levantarse de la tierra, y tenía dos cuernos semejantes a los de un cordero; y habló como el dragón. ** {class = versoQ} ** Apocalipsis 13:11 ** {class = bookVerse}  
** Y haz que a todos, pequeños y grandes, ricos y pobres, libres y sirvientes, se les ponga una señal en la mano derecha o en la frente ** {class = versoQ} ** Apocalipsis 13:16 ** { class = bookVerse}  

** Marque la respuesta correcta: **  
a) La bestia que tenía dos cuernos similares a los del cordero y que hablaba como un dragón.   
b) El dragón.   
c) Satanás.   
...
** ¿Cuál será la actitud del dragón hacia el pueblo de Dios, el pueblo remanente, que guarda los mandamientos de Dios y tiene el testimonio de Jesús? ** {clase = pregunta} ** Apocalipsis 12:17 ** {clase = bookQ}  
** Y el dragón se enojó con la mujer, y fue a hacer guerra contra el resto de su simiente, los que guardan los mandamientos de Dios y tienen el testimonio de Jesucristo. ** {class = versoQ} ** Apocalipsis 12: 17 ** {clase = bookVerse}  

** Marque la respuesta correcta: **  
a) Decidió hacerse amigo de estas personas perseguidas.   
b) El dragón estaba enojado con este pueblo y fue a hacer la guerra contra la mujer.   
c) El dragón estaba enojado con la iglesia y fue a hacer la guerra contra los que guardan los mandamientos de Dios.   

!!! Nota ""
	 Remanente: lo que queda, resto, queda

## Sábado

Para meditar y estudiar en familia:

** ¿Cómo se impondrá este falso culto y marca? ** {class = question} ** Apocalipsis 13: 15-17 ** {class = bookQ}  
** Y se le concedió dar espíritu a la imagen de la bestia, para que la imagen de la bestia también hablara, y causara la muerte de todos los que no adoraban la imagen de la bestia. Y asegúrate de que a todos, pequeños y grandes, ricos y pobres, libres y sirvientes, se les ponga un cartel en la mano derecha, o en la frente, para que nadie pueda comprar ni vender, excepto el que tiene el cartel o el el nombre de la bestia, o el número de su nombre. ** {class = versoQ} ** Apocalipsis 13: 15-17 ** {class = bookVerse}  
...
c) () La marca en la mano tiene que ver con el trabajo en el día del Señor.   
d) () La marca en la frente tiene que ver con la aceptación del falso día de adoración y adoración (domingo).   

!!! Nota ""
	 Las naciones hablan a través de sus decretos y leyes

** ¿En qué logra finalmente la victoria el pueblo de Dios? ** {class = question} ** Apocalipsis 15: 2 ** {class = bookQ}  
** Y vi uno como un mar de vidrio mezclado con fuego; y también los que salieron victoriosos sobre la bestia, y su imagen, y su señal, y el número de su nombre, que estaban junto al mar de vidrio, y tenían las arpas de Dios. ** {class = versoQ} ** Apocalipsis 15: 2 ** {class = bookVerse}  
...
** ¿Aquellos que tienen la señal de Dios serán afectados por las plagas finales? ** {clase = pregunta} ** Ezequiel 9: 6; Apocalipsis 9: 4 ** {class = bookQ}  
** Mata a ancianos, jóvenes y vírgenes, niños y mujeres, hasta que sean exterminados; pero no te acerques a ningún hombre que tenga la señal; comienza en mi Santuario. ** {class = versoQ} ** Ezequiel 9: 6 ** {class = bookVerse}  
** Y se les dijo que no dañaran la hierba de la tierra, ni nada verde, ni ningún árbol, y solo a los hombres que no tienen la señal de Dios en la frente. ** {class = versoQ} ** Apocalipsis 9: 4 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) Sí b) No c) No lo sé.   

!!! Nota ""
	 Sobre los que son fieles al Señor y al santo sábado del Señor descansará la promesa dada en ** Salmo 91:10 ** {clase = libro} - ** "ninguna plaga vendrá a tu tienda". ** {clase = verso}
...
!!! cita de fondo
    Sepa que el que convierte al pecador al camino equivocado salvará su alma de la muerte y cubrirá multitud de pecados. ** Santiago 5:20 ** {clase = libro}

## Domingo

A menudo nos preguntamos qué sucede después de la muerte. Vemos que se dicen y predican muchas teorías, y a menudo parece difícil discernir entre lo que es verdad y lo que es falso. Nuestra seguridad es buscar esa verdad en la Biblia: la Palabra de Dios. Este tema de la muerte es poco estudiado en el medio cristiano, sin embargo, necesitamos entenderlo en profundidad, porque dentro de este tema encontramos la primera mentira predicada por Satanás en esta Tierra, y en este tema el enemigo de las almas concentra uno de sus últimos errores. en los días previos a la venida de Jesús a esta tierra para buscar a los suyos.

Al principio de la historia de la humanidad, Satanás comenzó sus esfuerzos por engañar a nuestra raza. El que había incitado a la rebelión en el Cielo deseaba guiar a los habitantes de la Tierra a unirse con él en una lucha contra el gobierno de Dios.
...
** ¿Cómo creó Dios al hombre? ** {class = question} ** Génesis 2: 7 ** {class = bookQ}  
** Entonces el Señor Dios formó al hombre del polvo de la tierra y sopló en su nariz aliento de vida, y el hombre se convirtió en alma viviente. ** {class = versoQ} ** Génesis 2: 7 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) Dios habló y apareció el hombre.   
b) A través de los monos   
c) Dios formó al hombre mediante la unión del polvo de la tierra + el aliento de vida = alma viviente.   

!!! Nota ""
	 Tenga en cuenta que el texto no dice que el hombre * "TIENE" * un alma, sino que "ES" un alma viviente. Un alma se forma por la unión del cuerpo (polvo de la tierra) con el aliento de vida. Mira cómo es la ecuación que forma el alma: `POLVO DE TIERRA (CUERPO) + FOLEGO DE VIDA = ALMA VIVA`

Por tanto, decir que tenemos un alma está mal, ya que somos un alma mientras el aliento de Dios permanezca en nosotros.

** ¿Dios hizo que el hombre muriera o viviera para siempre? ** {class = question} ** Génesis 2: 16,17 ** {class = bookQ}  
** Y el Señor Dios le dio este mandamiento: Comerás de todo árbol del huerto, pero del árbol de la ciencia del bien y del mal no comerás; porque el día que comas de él, seguramente morirás. ** {class = versoQ} ** Génesis 2: 16,17 ** {class = bookVerse}  
...
b) Dios hizo al hombre para vivir por siempre sin condiciones.   
c) Dios creó al hombre para ser un ser mortal, es decir, para morir algún día.   

!!! Nota ""
	 Dios había creado al hombre para que viviera eternamente en felicidad, pero había una condición: la obediencia perfecta. Al desobedecer, la consecuencia segura sería la muerte.
...
** 3. ¿Qué mentira introdujo Satanás, el seductor del mundo? ** {clase = pregunta} ** Génesis 3: 4; Apocalipsis 12: 9 ** {class = bookQ}  
** Entonces la serpiente le dijo a la mujer: Ciertamente no morirás. ** {class = versoQ} ** Génesis 3: 4 ** {class = bookVerse}  
** Y el gran dragón, la serpiente antigua, que se llama diablo y Satanás, el seductor del mundo entero, fue arrojado, sí, fue arrojado a la tierra, y con él sus ángeles. ** {class = versoQ } ** Apocalipsis 12: 9 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) La serpiente le dijo a la mujer que ella siempre sería hermosa.   
b) La serpiente le dijo a la mujer que si desobedecía no moriría.   
c) La serpiente no le dijo nada a la mujer porque la serpiente no habla.   

!!! Nota ""
	 Si Eva hubiera evitado discutir con el tentador, habría estado a salvo; pero se arriesgó a hablar con él y fue víctima de sus errores. Así es como muchos siguen derrotados. Dudan y discuten sobre los preceptos de Dios; y, en lugar de obedecer los mandatos divinos, aceptan las teorías humanas, que sólo disfrazan las trampas de Satanás. El primer sermón predicado por Satanás (la serpiente) fue que el hombre sería inmortal incluso en la desobediencia. Quería llevarnos desde el principio a creer en la inmortalidad en una vida de pecado.

** ¿Qué perdió Adán cuando pecó? ** {class = question} ** Romanos 5:12 ** {class = bookQ}  
** Por tanto, así como el pecado entró en el mundo por el pecado y la muerte por el pecado, así la muerte pasó a todos los hombres, por cuanto todos pecaron. ** {class = versoQ} ** Romanos 5:12 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) Adán perdió la compañía de Eva.   
b) Adán perdió la llave del jardín del Edén.   
c) Adán perdió la vida eterna.   

!!! Nota ""
	 La Biblia nos muestra claramente que Dios tenía razón al decir que el hombre (un alma viviente) moriría pecando.

** ¿Qué dice la Palabra de Dios que es la paga del pecado? ** {clase = pregunta} ** Romanos 6:23 ** {clase = libroQ}  
** Porque la paga del pecado es muerte, pero la dádiva de Dios es la vida eterna, en Cristo Jesús nuestro Señor. ** {class = versoQ} ** Romanos 6:23 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) La paga del pecado es vida eterna.   
b) La paga del pecado es muerte.   
c) La paga del pecado es un regalo gratuito de Dios.   

## Martes

La palabra * "espíritu" * de ** Eclesiastés 12: 7 ** {clase = libro} en el idioma original de la Biblia es * "ruash" *, que significa * "aliento de vida" *, aliento, aire. Cuando Dios nos quita el aliento (nos quita el aliento), ese aliento que nos había devuelto a Él, mientras el cuerpo que emergió del polvo, vuelve al polvo.

** ¿Qué le sucede a la persona (alma viviente) cuando muere? ** {clase = pregunta} ** Génesis 3:19; Eclesiastés 12: 7; Salmo 104: 29 ** {class = bookQ}  
** Con el sudor de tu rostro comerás tu pan, hasta que vuelvas a la tierra, porque de ella fuiste formado; porque eres polvo y al polvo volverás. ** {class = versoQ} ** Génesis 3:19 ** {class = bookVerse}  
** Y el polvo vuelve a la tierra, por así decirlo, y el espíritu vuelve a Dios, quien lo dio. ** {class = versoQ} ** Eclesiastés 12: 7 ** {class = bookVerse}  
** Si escondes tu rostro, se molestan; si les quitan el aliento, mueren y vuelven al polvo. ** {class = versoQ} ** Salmo 104: 29 ** {class = bookVerse}  
...
** ¿A dónde va la persona (alma viviente) después de la muerte? ** {clase = pregunta} ** Eclesiastés 9:10; Trabajo 7: 9,10 ** {clase = libroQ}  
** Todo lo que llegue a tu mano para hacer, hazlo según tus fuerzas, porque en la tumba, donde vas, no hay trabajo, no hay proyectos, no hay conocimiento, no hay sabiduría. ** {class = versoQ} * * Eclesiastés 9:10 ** {class = bookVerse}  
** A medida que la nube se aclara y pasa, el que desciende a la tumba nunca más se levantará. Nunca regresará a su hogar, ni el lugar donde vive lo conocerá. ** {class = versoQ} ** Job 7: 9,10 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) Cuando una persona muere, permanece en la tumba.   
b) Cuando una persona muere, va al cielo.   
c) Cuando una persona muere, se va al infierno.   

!!! Nota ""
	 Cuando morimos permanecemos en la tumba. La Biblia no dice que los muertos vayan más allá de esto.
...
Pero, ¿cómo entendió Adán, después de su pecado, el significado de las palabras: * "El día que comas de él, ciertamente morirás"? * ¿Pensaste que querían decir, como Satanás le había hecho creer, que debería ser llevado a una condición superior? de existencia? En ese caso, de hecho, se obtendría un gran bien con la transgresión, y Satanás demostraría ser un benefactor de la raza. Pero Adán no pensó que este fuera el significado de la sentencia divina. Dios declaró que, como castigo por su pecado, el hombre regresaría a la tierra de donde fue tomado: ** "Eres polvo, y en polvo te convertirás" ** {clase = verso} ** (Génesis 3:19). ** { class = book} Las palabras de Satanás: * "... tus ojos serán abiertos", * {class = verso} fueron verdaderas solo en este sentido: Después de que Adán y Eva desobedecieron a Dios, sus ojos se abrieron para discernir es una locura;

La inmortalidad, prometida al hombre bajo condición de obediencia, se perdió por la transgresión ... El único que le prometió a Adán la vida en desobediencia fue el gran engañador. Y la declaración de la serpiente a Eva, en el Edén - ** "Ciertamente no morirás" ** {clase = verso} - fue el primer sermón que se predicó sobre la inmortalidad del alma. Sin embargo, esta declaración, que se basa únicamente en la autoridad de Satanás, resuena desde los púlpitos de la cristiandad y la mayoría de la humanidad la recibe con tanta facilidad como nuestros primeros padres.

** ¿Son los hombres (almas vivientes) inmortales? ** {clase = pregunta} ** Ezequiel 18: 4,20; Isaías 51:12 ** {class = bookQ}  
** He aquí, todas las almas son mías; como el alma del padre, así es el alma del hijo; el alma que peca, morirá. ** {class = versoQ} ** Ezequiel 18: 4 ** {class = bookVerse}  
** El alma que pecare, morirá; el hijo no tomará la iniquidad del padre, ni el padre tomará la iniquidad del hijo; la justicia del justo será sobre él, y la maldad de los impíos caerá sobre él. ** {class = versoQ} ** Ezekiel 18:20 ** {class = bookVerse}  
** "Yo, yo soy el que te consuela; ¿quién entonces eres tú, que temes al hombre, que es mortal, o al hijo del hombre, que no es más que hierba? ** {class = versoQ} ** Isaías 51:12 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) Sí, los hombres son como ángeles.   
b) No, después de que Adán pecó, el hombre se convirtió en un ser mortal.   
c) Sí, los hombres son semidioses, inmortales.   

** ¿Qué saben los muertos? ** {clase = pregunta} ** Eclesiastés 9: 5,6 ** {clase = libroQ}  
** Porque los vivos saben que van a morir, pero los muertos no saben nada, ni tendrán recompensa, porque su recuerdo está en el olvido. El amor, el odio y la envidia por ellos ya perecieron; para siempre no tienen parte en nada que se haga bajo el sol. ** {class = versoQ} ** Eclesiastés 9: 5,6 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) Cuando los hombres mueren, no saben nada más, su recuerdo está en el olvido.   
b) Los hombres saben todo lo que les sucede a sus seres queridos aquí en la tierra.   
c) Los hombres solo saben lo que Dios les revela.   

** ¿Quién solo tiene inmortalidad? ** {clase = pregunta} ** I Timoteo 6:16 ** {clase = libroQ}  
** El único que tiene la inmortalidad, que vive en una luz inaccesible, a quien ningún hombre ha visto ni puede ver. A él honor y poder eterno. ¡Amén! ** {class = versoQ} ** I Timoteo 6:16 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) Solo los ángeles tienen inmortalidad.   
b) Solo Jesús tiene inmortalidad.   
c) Solo Dios tiene inmortalidad.   

** ¿Cómo puede el hombre mortal volverse inmortal de nuevo? ** {clase = pregunta} ** Juan 3:16; 17: 3 ** {clase = bookQ}  
** Porque tanto amó Dios al mundo que dio a su Hijo unigénito, para que todo el que crea en él no se pierda, mas tenga vida eterna ** {clase = verso} ** Juan 3:16 ** {clase = libro} 
** Y esta es la vida eterna: haz que te conozcan a ti, el único Dios verdadero, y a Jesucristo, a quien enviaste. ** {class = versoQ} ** Juan 17: 3 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) Solo podemos obtener la vida eterna a través del pensamiento positivo.   
b) Solo podemos obtener la vida eterna a través de Jesucristo, nuestro Salvador.   
c) No podemos obtener la vida eterna.   

## Jueves


** ¿Cuándo vuelve a tener el ser humano el derecho a la vida eterna? ** {clase = pregunta} ** Juan 5:24 ** {clase = libroQ}  
** De cierto, de cierto les digo: el que oye mi palabra y cree al que me envió, tiene vida eterna; no entra en juicio, sino que ha pasado de muerte a vida. ** {class = versoQ} ** Juan 5 : 24 ** {clase = bookVerse}  

** Marque la respuesta correcta: **  
a) Cuando los seres humanos creen en la palabra de Dios y aceptan a Jesucristo como su Señor y Salvador.   
b) Cuando los seres humanos hacen el bien a los demás.   
c) Cuando el ser humano encuentra su hombre interior.   

** ¿Cuándo dará Jesús esta vida eterna a los que creen? ** {class = question} ** I Corintios 15: 21-23 ** {class = bookQ}  
** Puesto que la muerte vino por un hombre, también por un hombre vino la resurrección de los muertos. Porque así como en Adán todos mueren, también todos serán vivificados en Cristo. Cada uno, sin embargo, en su propio orden: Cristo, las primicias; luego los que son de Cristo en su venida. ** {class = versoQ} ** I Corintios 15: 21-23 ** {class = bookVerse}  
...
** Mientras Jesús no viene, ¿dónde están los muertos? ** {clase = pregunta} ** Daniel 12: 2 ** {clase = libroQ}  
** Muchos de los que duermen en el polvo de la tierra resucitarán, algunos a la vida eterna y otros a la vergüenza y al horror eterno .; ** {class = versoQ} ** Daniel 12: 2 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) Y Cristo compara la muerte con el sueño, por lo que los muertos duermen en la tumba.   
b) Los muertos, hasta que venga Jesús, estarán esperando en el cielo.   
c) Los muertos, hasta que venga Jesús, estarán esperando en el infierno o en el purgatorio.   

!!! Nota ""
	 El profeta Daniel también comparó la muerte con el sueño. Todos los que murieron duermen profundamente en sus tumbas.

## Viernes

La Palabra de Dios enseña que los que murieron en Cristo, todos los que le fueron fieles, están durmiendo en sus tumbas hasta que Jesús regrese a esta tierra para darles vida eterna. La inmortalidad que tanto soñamos nos será dada cuando Jesús regrese si somos fieles a Él. Entonces y solo entonces el hombre se volverá inmortal. Los otros muertos serán resucitados después de los mil años en el cielo, para recibir la condenación del lago de fuego, la muerte eterna. Vea también ** Apocalipsis 20: 5,14,15. ** {class = book}

** ¿Cuánto tiempo permanecerán los muertos en Cristo durmiendo en la tumba? ** {clase = pregunta} ** Juan 5: 28,29; I Tesalonicenses 4:16 ** {class = bookQ}  
** No te maravilles de esto, porque viene la hora en que todos los que están en los sepulcros oirán su voz y saldrán: los que han hecho el bien, para la resurrección de vida; y los que hicieron lo malo, para la resurrección del juicio. ** {class = versoQ} ** Juan 5: 28,29 ** {class = bookVerse}  
** Porque el Señor mismo, dado su mandato, oyó la voz del arcángel, y la trompeta de Dios sonó, descenderá del cielo, y los muertos en Cristo resucitarán primero; ** {class = versoQ} ** I Tesalonicenses 4:16 ** {clase = bookVerse}  

** Marque la respuesta correcta: **  
a) Hasta que Jesús regrese y los despierte, es decir, los resucite.   
b) El tiempo que quiera Jesús.   
c) Después que las plagas hayan caído sobre la tierra.   

** ¿Cuál será la recompensa para aquellos que participen en la resurrección de los justos? ** {clase = pregunta} ** I Corintios 15: 51-53 ** {clase = libroQ}  
** He aquí, te digo un misterio: no todos dormiremos, pero todos seremos transformados, en un momento, en un abrir y cerrar de ojos, cuando resuene la última trompeta. Sonará la trompeta, los muertos resucitarán incorruptibles y seremos transformados. Porque es necesario que este cuerpo corruptible se vista de incorruptibilidad y que el cuerpo mortal se vista de inmortalidad. ** {class = versoQ} ** I Corintios 15: 51-53 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) La recompensa será un planeta para que cada persona viva.   
b) La recompensa será la inmortalidad y la incorruptibilidad.   
c) No habrá recompensa.   

## Sábado

Satanás tiene el poder de transfigurarse para engañar a la gente. Así que con él usó a la serpiente para hablar con Eva y engañarla en el huerto del Edén, hoy, finge ser parientes o amigos fallecidos con manifestaciones que no son más que obra del mismo Satanás y sus ángeles malignos que hacen señales para tratar de ayudarnos. truco.

** ¿Cuáles son las manifestaciones del espiritismo moderno en las que los muertos aparecen y hablan con la gente? ** {clase = pregunta} ** II Corintios 11:14 ** {clase = libroQ}  
** Y no es de extrañar, porque el mismo Satanás se convierte en un ángel de luz. ** {class = versoQ} ** II Corintios 11:14 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) Son nuestros familiares los que necesitan hablar con nosotros   
...
** ¿Cuál será el último gran engaño de Satanás antes del regreso de Jesús? ** {clase = pregunta} ** Apocalipsis 16: 13,14; 18:23 ** {clase = bookQ}  
** Entonces vi salir tres espíritus inmundos como ranas de la boca del dragón, de la boca de la bestia y de la boca del falso profeta; porque son espíritus de demonios, operadores de señales, y se vuelven a los reyes de todo el mundo para reunirlos para la batalla del gran Día del Dios Todopoderoso. ** {class = versoQ} ** Apocalipsis 16: 13.14 ** {clase = bookVerse}  
** Ni la luz de la lámpara alumbrará sobre ti; ni la voz de un novio o de una novia se oirá en ti, porque tus mercaderes eran los más grandes de la tierra, porque todas las naciones fueron seducidas por tu brujería. ** {class = versoQ} ** Apocalipsis 18:23 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) El gran engaño de Satanás vendrá a través del espiritismo, la brujería.   
b) El gran engaño de Satanás será el sello de la bestia, el chip en las manos de la gente.   
c) Satanás ya no tendrá ningún gran engaño.   

!!! Nota ""
	 Después de la caída, Satanás ordenó a sus ángeles que hicieran un esfuerzo especial para inculcar la creencia en la inmortalidad inherente al hombre; y, habiendo inducido a la gente a recibir este error, deberían llevarla a la conclusión de que el pecador viviría en un estado de miseria eterna. Ahora el príncipe de las tinieblas, actuando a través de sus agentes, representa a Dios como un tirano vengativo, declarando que sumerge en el infierno a todo el que no le agrada, y les hace sentir siempre su ira; y que, mientras sufre una angustia indecible y se retuerce en las llamas eternas, Su Creador los mira con satisfacción.
Así, el príncipe de los demonios reviste con sus propios atributos al Creador y Benefactor de la humanidad. La crueldad es satánica. Dios es amor: y todo lo que creó era puro, santo y hermoso, hasta que el primer gran rebelde introdujo el pecado.
...
!!! cita de fondo
    Cuando te digan: consulta a los nigromantes y a los aventureros, que gorjean y murmuran, ¿no consultará la gente a su Dios? ¿Se consultará a los muertos por los vivos? ** Isaías 8:19 ** {clase = libro}

## Domingo

La relación del mundo visible con el mundo invisible, el ministerio de los ángeles de Dios y la operación de los espíritus malignos, se revelan claramente en las Escrituras y se mezclan inseparablemente con la historia humana. Hay una tendencia creciente a no creer en la existencia de espíritus malignos, mientras que los santos ángeles que ** "ministran a los que heredarán la salvación" ** {clase = verso} ** (Hebreos 1:14), ** {class = book} son considerados por muchos como los espíritus de los muertos.

Antes de la creación del hombre, los ángeles ya existían, porque cuando se echaron los cimientos de la tierra, ** las estrellas del alba cantaban alabanzas y todos los hijos de Dios se regocijaban ** {clase = verso} ** Job: 38: 7 * * {clase = libro}. Después de la caída del hombre, se enviaron ángeles para proteger el árbol de la vida, y esto, antes de que muriera ningún ser humano. Los ángeles son superiores al hombre en la naturaleza, porque el salmista dice que el hombre fue hecho ** un poco menos que los ángeles ** {clase = verso} ** (Salmo 8: 5) ** {clase = libro}.
...
** ¿Existió esta doctrina en la antigüedad? ** {clase = pregunta} ** Levítico 19:31 ** {clase = libroQ}  
** No recurrirás a nigromantes o adivinos; no busque que estén contaminados por ellos. Yo soy el SEÑOR tu Dios. ** {class = versoQ} ** Levítico 19:31 ** {class = bookVerse}  
...
** ¿Sobre quién caerán los juicios de Dios? ** {clase = pregunta} ** Malaquías 3: 5 ** {clase = libroQ}  
** Vendré a ti para juzgarte; Seré un testigo rápido contra los hechiceros y los adúlteros, y contra los que juran en falso, y contra los que defraudan el salario del vendedor de periódicos, y oprimen a la viuda y al huérfano, y tuercen los derechos de los extranjeros y me temen, dice. el Señor de los ejércitos. ** {class = versoQ} ** Malaquías 3: 5 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) Sobre los descuidados.   
b) Sobre los brujos.   
c) Dios no enviará juicios contra nadie.   

## Lunes


El mismo nombre de brujería ahora se desprecia. La afirmación de que los hombres pueden mantener la comunicación con los espíritus malignos se considera una fábula de la Edad Media. Pero el Espiritismo, que tiene cientos de miles, sí, millones, que se ha abierto camino en los círculos científicos, invadido iglesias, y ha encontrado el favor de los cuerpos legislativos y hasta de las cortes de los reyes, este error colosal no es más que un avivamiento, bajo una nueva apariencia, de la brujería condenada y prohibida del pasado.

Los teólogos populares modernos enseñan que los muertos son admitidos en la presencia de Dios y los santos ángeles y son favorecidos con un conocimiento que supera con creces lo que tenían anteriormente. Y, mientras se ciernen sobre sus amigos en la Tierra, ¿por qué no se les permitiría comunicarse con él para advertirles contra el mal o consolarlos en la tristeza? ¿Y cómo pueden los que creen en el estado consciente de los muertos rechazar lo que les llega como luz divina transmitida por espíritus glorificados?
...
** ¿Deberíamos escuchar las enseñanzas de hechiceros y encantadores? ** {clase = pregunta} ** Jeremías 27: 9,10 ** {clase = libroQ}  
** No escuches a tus profetas y adivinos, a tus soñadores, a tus presagios y a tus encantadores, que te hablan ... Porque te profetizan mentiras para echarte de tu tierra, y para que yo expulsar y perecer. ** {class = versoQ} ** Jeremías 27: 9,10 ** {class = bookVerse}  
...
** ¿Cuál es el orden de Dios con respecto a los hechiceros y adivinos? ** {clase = pregunta} ** Éxodo 22:18; Levítico 20:27 ** {clase = libroQ}  
** La bruja no te dejará vivir. ** {class = versoQ} ** Éxodo 22:18 ** {class = bookVerse}  
** El hombre o la mujer que sea nigromante o hechicero será asesinado; serán apedreados; su sangre caerá sobre ellos. ** {class = versoQ} ** Levítico 20:27 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) Quien consultara a los muertos debe ser arrestado.   
b) Quien consultara a los muertos sería asesinado.   
c) Quien consultara a los muertos debería regresar a Egipto.   
...
** ¿Quién no heredará el Reino de Dios? ** {class = question} ** Gálatas 5: 20,21 ** {class = bookQ}  
...
b) Los que no van a la iglesia.   
c) Extranjeros, que no pertenecen al pueblo de Israel.   

** ¿Qué debemos hacer cuando nos invitan a consultar con espíritus y adivinos? ** {clase = pregunta} ** Isaías 8:19 ** {clase = libroQ}  
** Cuando te digan: Consulta a los nigromantes y adivinos, que gorjean y murmuran, ¿no consultará el pueblo a su Dios? ¿Se consultará a los muertos por los vivos? ** {class = versoQ} ** Isaías 8:19 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) Debemos consultar a nuestro Dios, porque Él es el único que conoce todas las cosas.   
b) Debemos ir con quienes nos inviten.   
c) Podemos ir pero no debemos pedir nada.   

** ¿Qué instrucción nos dio Dios, a través de Juan, al respecto? ** {clase = pregunta} ** I Juan 4: 1 ** {clase = libroQ}  
** Amados, no des crédito a ningún espíritu; más bien, prueba los espíritus si vienen de Dios, porque muchos falsos profetas han salido al mundo. ** {class = versoQ} ** I Juan 4: 1 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) No debemos escuchar a personas que no son cristianas.   
b) Debemos probar los espíritus para ver si vienen de Dios.   
c) Dios no nos dio instrucciones.   

** ¿Cómo deberíamos probar los espíritus? ** {clase = pregunta} ** Isaías 8:20 ** {clase = libroQ}  
** ¡A la ley y al testimonio! Si no hablan así, nunca verán la mañana. ** {class = versoQ} ** Isaías 8:20 ** {class = bookVerse}

** Marque la respuesta correcta: **  
a) Debemos comprobar si los espíritus son serios.   
b) Debemos verificar que lo que dicen los espíritus es como dice la Biblia, y que la gente vive de acuerdo con las enseñanzas de la Biblia.   
c) Debemos escuchar todo y verificar con los pastores de la iglesia para ver si lo que dicen es correcto.   

## Miércoles

Si no hubiera otra evidencia del verdadero carácter del Espiritismo, debería ser suficiente para el cristiano que los espíritus no hacen diferencia entre la justicia y el pecado, entre el más noble y puro de los apóstoles de Cristo y el más corrupto de los servidores de Satanás. Al representar a los hombres más humildes como si estuvieran en el cielo, siendo altamente exaltado allí, Satanás le dice al mundo: No importa cuán malvado seas, no importa si crees en Dios y en la Biblia o no. Viva como desee; El cielo es tu hogar.

Los espiritistas profesos declaran virtualmente: ** Todo el que hace el mal pasa por bien ante los ojos del Señor, y de ellos se agrada; o, ¿dónde está el Dios de juicio ** {clase = verso} ** Malaquías 2:17. ** {clase = libro}  

La Palabra de Dios dice: ** Ay de los que llaman al mal bien y al bien mal; que hacen de las tinieblas luz y luz, tinieblas! ** {class = versoQ} ** Isaías 5:20 ** {class = bookVerse}  

** Cuando un profeta o soñador se levanta entre el pueblo de Dios dando una señal o prodigio y diciendo que adoremos a otro * "dios" *, ¿qué debemos hacer? ** {clase = pregunta} ** Deuteronomio 13: 1 -4 ** {clase = bookQ}  
** Cuando un profeta o un soñador se levanta en medio de ti y te anuncia una señal o un prodigio, y ocurre la señal o el prodigio de que te hablé, y dice: Vamos tras otros dioses, que no conocías, y sírveles, no escucharás las palabras de ese profeta o soñador; porque el SEÑOR tu Dios te está probando para ver si amas al SEÑOR tu Dios con todo tu corazón y con toda tu alma. ** {class = versoQ} ** Deuteronomio 13: 1-4 ** { class = bookVerse}  
...
** ¿Saben algo los muertos? ** {clase = pregunta} ** Eclesiastés 9: 5 ** {clase = libroQ}  
** Porque los vivos saben que van a morir, pero los muertos no saben nada, ni tendrán recompensa, porque su memoria está en el olvido ** {class = versoQ} ** Eclesiastés 9: 5 ** {class = bookVerse}  
...
Vea también: ** Job 14: 20-21; Salmo 146: 4 ** {clase = libro}

** ¿Vuelven los muertos para comunicarse con los vivos? ** {clase = pregunta} ** Eclesiastés 9: 6 ** {clase = libroQ}  
** El amor, el odio y la envidia por ellos ya perecieron; para siempre no tienen parte en nada que se haga bajo el sol. ** {class = versoQ} ** Eclesiastés 9: 6 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) Sí b) No c) No lo sé.   

** Si los muertos no se comunican con los vivos, ¿quién realiza las señales atribuidas a nuestros amigos muertos? ** {clase = pregunta} ** Apocalipsis 16:14 ** {clase = libroQ}  
** Porque son espíritus demoníacos, operadores de signos y se dirigen a los reyes de todo el mundo para reunirlos para la batalla del gran Día del Dios Todopoderoso. ** {class = versoQ} ** Apocalipsis 16:14 ** {clase = bookVerse}  

** Marque la respuesta correcta: **  
a) Los ángeles de Satanás, el enemigo de Cristo y el nuestro.   
b) No es más que una farsa.   
c) Reyes y poderosos.   

!!! Nota ""
	 El enemigo de las almas se le aparece a las personas como uno de los muertos como si vivieran en otro lugar. Opera estas señales para tratar de engañarnos y llevarnos al error.

## Jueves

Satanás tiene el poder de hacer aparecer ante los hombres la apariencia de sus amigos fallecidos. La falsificación es perfecta; la expresión familiar, las palabras, el tono de voz, se reproducen con maravillosa precisión. Muchos se consuelan con la afirmación de que sus seres queridos están disfrutando de la dicha celestial; y, sin sospecha de peligro, escuchan ** "espíritus engañadores y doctrinas de demonios" ** {clase = verso}.

** ¿Qué pasará en los últimos días? ** {clase = pregunta} ** I Timoteo 4: 1 ** {clase = libroQ}  
** Ahora, el Espíritu declara expresamente que, en tiempos recientes, algunos apostatarán de la fe, por obedecer a espíritus engañosos y las enseñanzas de demonios. ** {class = versoQ} ** I Timoteo 4: 1 ** {class = bookVerse }  
...
** ¿Cómo nos engañan Satanás y sus agentes? ** {clase = pregunta} ** II Corintios 11: 14,15; Mateo 24: 23,24 ** {clase = libroQ}  
** Y no es de extrañar, porque el mismo Satanás se convierte en un ángel de luz. No es mucho, por tanto, que sus propios ministros se conviertan en ministros de justicia; y su fin será conforme a sus obras. ** {class = versoQ} ** II Corintios 11: 14,15 ** {class = bookVerse}  
** Entonces, si alguien te dice: ¡Aquí está el Cristo! O: ¡Aquí está! No creen; porque aparecerán falsos Cristos y falsos profetas, haciendo grandes señales y prodigios para engañar, si es posible, a los mismos elegidos. ** {class = versoQ} ** Mateo 24: 23,24 ** {class = bookVerse}  
...
** ¿Cuál será una de tus grandes señales para engañar al final de los tiempos? ** {clase = pregunta} ** Apocalipsis 13: 13-14 ** {clase = libroQ}  
** También opera grandes señales, de modo que incluso el fuego del cielo hace descender a la tierra, frente a los hombres. Seduce a los que viven en la tierra a causa de las señales que se le dio a realizar ante la bestia, diciéndoles a los que viven en la tierra que hagan una imagen de la bestia, el que, herido por la espada, sobrevivió; ** {class = versoQ} ** Apocalipsis 13: 13,14 ** {class = bookVerse}  
...
** ¿Cómo actuará Satanás justo antes de la segunda venida de Cristo? ** {clase = pregunta} ** II Tesalonicenses 2: 9,10 ** {clase = libroQ}  
** Ahora, la apariencia de los impíos es según la eficacia de Satanás, con todo poder, señales y prodigios de mentira, y con todo engaño de injusticia a los que perecen, porque no han aceptado el amor de la verdad para ser salvos. ** {class = versoQ} ** II Tesalonicenses 2: 9,10 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) Satanás obrará en nuestros días con todo su poder de engaño. (Ver también: ** Apocalipsis 12:12 ** {clase = libro}).   
b) Acogerá el amor a la verdad.   
c) Satanás hará que todos amen a Dios.   

## Viernes

A menudo, los posibles visitantes del mundo de los espíritus dan advertencias y advertencias que demuestran ser correctas. Luego, cuando ganan confianza, presentan doctrinas que socavan directamente la fe en las Escrituras. Con la apariencia de un profundo interés en el bienestar de sus amigos en la Tierra, insinúan los errores más peligrosos.

El hecho de que declaren ciertas verdades y, a veces, puedan predecir eventos futuros, da a sus declaraciones una apariencia de crédito; y sus falsas enseñanzas son tan fácilmente aceptadas por las multitudes, y tan implícitamente creídas, como si fueran las verdades más sagradas de la Biblia.
...
** ¿Qué nos advierte Jesús a través de Pedro? ** {class = question} ** I Peter 5: 8 ** {class = bookQ}   
** Sea sobrio y vigilante. El diablo, tu adversario, camina como un león rugiente buscando a alguien a quien devorar ** {class = versoQ} ** I Pedro 5: 8 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) Pedro dice que no beba bebidas fuertes.   
b) Dice que debemos estar atentos estudiando la Biblia y orando para que no seamos engañados por el enemigo.   
c) Dice que debemos salir y desafiar a Satanás para que lo avergüence frente a todos. Porque no representa ningún peligro para nadie más.   

** ¿Qué declarará Jesús a los que han guardado la verdad cuando venga por segunda vez? ** {clase = pregunta} ** Mateo 25:34 ** {clase = libroQ}  
** Entonces el Rey dirá a los de su derecha: ¡Venid, bendito de mi Padre! Entra en posesión del reino que ha sido preparado para ti desde la fundación del mundo. ** {class = versoQ} ** Mateo 25:34 ** {class = bookVerse}  

** Marque la respuesta correcta: **  
a) No dirás nada.   
b) Jesús dirá que los llevará al reino de su Padre, porque está listo.   
c) Dirá: quédate a mi derecha hasta la fundación del mundo.   
...
Es cierto que el espiritismo en su forma actual adquiere un aspecto cristiano, declarando aceptar a Cristo y la Sagrada Escritura, pero la Biblia se interpreta de una manera que agrada al corazón no regenerado, mientras que sus verdades solemnes y vitales son anuladas. Se preocupa por el amor como principal atributo de Dios, rebajándolo, sin embargo, hasta reducirlo al sentimentalismo, sin apenas distinguir entre el bien y el mal. La justicia de Dios, Su reprobación del pecado, los requisitos de Su santa ley, todo esto se deja de lado. Se enseña al pueblo a considerar el decálogo como letra muerta, Fábulas agradables y fascinantes, cautivan los sentidos, llevando a los hombres a rechazar las Sagradas Escrituras como fundamento de la fe. Cristo está tan verdaderamente negado como antes; pero Satanás ha cegado tanto al pueblo que no se puede discernir el engaño.

Muchos se aventuran por curiosidad a ponerlo bajo su influencia. No tiene la intención de creer o aceptar estas enseñanzas espirituales. Sin embargo, entran en terreno prohibido y el poderoso destructor ejerce su fuerza sobre ellos contra su voluntad. Una vez inducido a someter la mente a su dirección, los mantiene cautivos. Es imposible por su propia fuerza romper con el fascinante y seductor encanto. Nada más que el poder de Dios, concedido en respuesta a la ferviente oración de fe, podrá liberar a estas almas cautivas.

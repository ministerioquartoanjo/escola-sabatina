...
** 1) Come sarà il peculiare popolo di Dio sulla Terra appena prima del ritorno di Gesù? ** {class = question} ** Apocalisse 14: 1,4,5 ** {class = bookQ}  
...
** 9) Cosa c'era nel cortile, o anche chiamato atrio, del santuario? ** {class = question} ** Esodo 40: 29-33 ** {class = bookQ}  
...
** 20) Questo santuario terrestre è ancora in vigore oggi dopo la morte di Gesù Cristo? ** {class = question} ** Matteo 27: 50,51 ** {class = bookQ}  
...
** 6) Chi rappresentavano tutti i sacrifici dell'Antico Testamento? ** {class = question} ** Giovanni 1:29 ** {class = bookQ}  
...
** 17) Leggi attentamente e osserva il luogo del santuario celeste, a cui si riferiscono i seguenti passaggi biblici: ** {class = question}  
...
** 2) C'è anche una registrazione dei nostri peccati in cielo? ** {class = question} ** Isaia 65: 6,7 ** {class = bookQ}  
...
** 8) Dopo l'espiazione compiuta dalle persone nel Santissimo Sacramento, cosa fece il Sommo Sacerdote? ** {class = question} ** Levitico 16: 20,21 ** {class = bookQ}  
...
** 21) Di fronte al giudizio investigativo già in corso, cosa si consiglia di fare? ** {class = question} ** Apocalisse 14: 7 ** {class = bookQ}  
** Dicendo ad alta voce: Temi Dio e dagli gloria; perché l'ora del suo giudizio è venuta. E adora colui che ha creato il cielo, la terra, il mare e le fontane d'acqua. ** {class = versoQ} ** Apocalisse 14: 7 ** {class = bookVerse}
...
** 22) Quale serio avvertimento viene dato dall'apostolo Paolo? ** {class = question} ** Atti.17: 30,31 ** {class = bookQ}  
** Ma Dio, trascurando i tempi dell'ignoranza, ora annuncia a tutti gli uomini, e ovunque, che si pentono; Perché ha stabilito un giorno in cui giudicherà giustamente il mondo attraverso l'uomo che ha nominato; e che ha assicurato a tutti, resuscitandolo dai morti. ** {class = versoQ} ** Atti 17: 30-31 ** {class = bookVerse}  
...
!!! citazione Golden Back
    Continuai a guardare, finché non furono posizionati i troni e l'Antico dei Giorni si sedette; La sua veste era bianca come la neve e i capelli sulla sua testa erano come pura lana; Il suo trono era fiamme di fuoco e le sue ruote erano un fuoco ardente. Un fiume di fuoco scorreva e lo lasciava davanti; migliaia di migliaia Lo servirono, miriadi di miriadi erano davanti a Lui; il tribunale fu preparato e i libri furono aperti. ** Daniele 7: 9,10 ** {class = book}

## Domenica

Al profeta Daniele fu presentata la visione del grande e solenne giorno, quando i personaggi e le vite degli uomini sarebbero stati rivisti davanti al giudice di tutta la terra, perché l'uomo riceve il premio * "secondo le sue opere" *. L'Anziano dei Giorni è Dio Padre. Il salmista dice: ** Prima che le montagne nascessero e la terra e il mondo fossero formati, dall'eternità all'eternità, Tu sei Dio ** {class = versoQ} ** (Salmi 90 : 2) ** {class = bookVerse}. È Lui, la fonte di ogni essere, di tutta la legge, che deve presiedere al Giudizio. E i santi angeli, come ministri e testimoni, in numero di migliaia e migliaia, assistono a questa grande corte.

** 1) Cosa farà Dio nel giudizio? ** {class = question} ** Ecclesiaste 12:14 ** {class = bookQ}  
** Perché Dio consegnerà alla giustizia tutte le opere, anche quelle nascoste, buone o cattive che siano. ** {class = versoQ} ** Ecclesiaste 12:14 ** {class = bookVerse}  
...
** 2) Com'era la scena del giudizio? ** {class = question} ** Daniele 7: 9,10 ** {class = bookQ}  
** Ho continuato a guardare, finché non sono stati posizionati i troni e l'Antico dei Giorni si è seduto; la sua veste era bianca come la neve e i capelli sulla testa erano come pura lana; il suo trono erano fiamme di fuoco e le sue ruote erano un fuoco ardente. Un fiume di fuoco scorreva e se ne andava davanti a lui; migliaia e migliaia lo servirono e miriadi di miriadi stavano davanti a lui; il giudizio è stato risolto, e i libri sono stati aperti. ** {class = versoQ} ** Daniele 7: 9,10 ** {class = bookVerse}  
...
** 3) Chi è il giudice? ** {class = question} ** Giovanni 5:22; Atti 17:31 ** {class = bookQ}  
** E il Padre non giudica nessuno, ma il Figlio ha affidato ogni giudizio. ** {class = versoQ} ** Giovanni 5:22 ** {class = bookVerse}  
** Perché ha stabilito un giorno in cui giudicherà il mondo con giustizia, per mezzo di un uomo che ha predetto e creduto prima di tutto, resuscitandolo dai morti. ** {class = versoQ} ** Atti 17:31 * * {class = bookVerse}  
...
** 4) Chi sono i testimoni? ** {class = question} ** Apocalisse 5:11 ** {class = bookQ}  
** Ho visto e sentito una voce da molti angeli attorno al trono di esseri viventi e anziani, il cui numero era di milioni di milioni e migliaia di migliaia ... ** {class = versoQ} ** Apocalisse 5: 11 ** {class = bookVerse}  
...
** Stavo guardando nelle mie visioni della notte, ed ecco, uno è venuto con le nuvole del cielo come il Figlio dell'uomo, ed è andato all'Antico dei Giorni, e lo hanno portato a Lui. gloria, e il regno, affinché i popoli, le nazioni e gli uomini di tutte le lingue possano servirlo; Il suo dominio è un dominio eterno, che non passerà, e il suo regno non sarà mai distrutto ** {class = verse} ** Daniele 7: 13,14 ** {class = libro}.
...
** 5) Chi è il nostro avvocato difensore? ** {class = question} ** I Giovanni 2: 1 ** {class = bookQ}  
** Figli miei, queste cose vi scrivo affinché non pecchiate. Se, tuttavia, qualcuno pecca, abbiamo un avvocato presso il Padre, Gesù Cristo, il Giusto; ** {class = versoQ} ** I Giovanni 12: 1 ** {class = bookVerse}  
...
** 6) Chi è l'accusatore? ** {class = question} ** Apocalisse 12: 9-10 ** {class = bookQ}  
** E il grande drago, l'antico serpente, che è chiamato il diavolo e Satana, il seduttore del mondo intero, fu gettato, sì, fu gettato a terra, e con lui, i suoi angeli ... perché il accusando i nostri fratelli, lo stesso che li accusa giorno e notte, davanti al nostro Dio. ** {class = versoQ} ** Apocalisse 12: 9,10 ** {class = bookVerse}  
...
Nel tipico servizio svolto presso il santuario degli israeliti, solo coloro che erano apparsi davanti a Dio con la confessione e il pentimento e le cui trasgressioni, attraverso il sangue del sacrificio espiatorio, erano state trasferite al santuario, partecipavano al servizio del giorno dell'espiazione. Pertanto, nel grande giorno finale dell'espiazione prima di un giudizio investigativo, gli unici casi considerati sono quelli del popolo professo di Dio.

** 7) Quali sono i libri di giudizio? ** {class = question}

** Contrassegna le dichiarazioni con V se vere e F se false: **  
a) () Libro della vita - Ha il nome di tutti coloro che sono entrati al servizio di Cristo. ** E chiedo anche a te, mia vera compagna, di aiutare queste donne che hanno lavorato con me nel Vangelo, e con Clemente, e con gli altri collaboratori, i cui nomi sono nel libro della vita. ** {class = versoQ} * * Filippesi 624: 3 ** {class = book}  
b) () Memorial Book - Contiene la storia dei santi (vedere anche ** Isaia 65: 6,7 ** {class = book}). ** E vidi i morti, grandi e piccoli, che erano davanti a Dio, ei libri furono aperti; e un altro libro è stato aperto, che è il libro della vita. E i morti furono giudicati in base alle cose che erano scritte nei libri, secondo le loro opere. ** {class = versoQ} ** Apocalisse 20:12 ** {class = libro}  

!!! Nota ""
	 I libri dei registri in cielo, in cui sono iscritti i nomi e gli atti degli uomini, devono determinare le decisioni del Giudizio. Il profeta Daniele dice: * "La corte fu fissata ei libri furono aperti". * Giovanni, lo sviluppatore, descrivendo la stessa scena, aggiunge: ** Ancora un altro libro, il Libro della vita, è stato aperto. E i morti furono giudicati, secondo le opere, secondo quanto era scritto nei libri. ** {class = verse} ** Apocalisse 20:12 ** {class = libro}
...
Nel libro commemorativo sono scritte le buone opere di coloro che temono il Signore e per coloro che ricordano il Suo nome. Le tue parole di fede e atti d'amore sono posti lì. Ogni tentazione resistita, ogni male vinto, ogni parola di tenera pietà espressa, è fedelmente registrata. Come ogni atto di sacrificio, ogni sofferenza e tristezza sopportata a causa di Cristo è segnata lì. ** ... hai raccolto le mie lacrime nella tua pelle; Non sono scritti nel tuo libro? ** {class = versoQ} ** Salmo 56: 8 ** {class = book}. ** Perché Dio assicurerà alla giustizia tutte le opere, anche quelle nascoste, buone o cattive che siano ** {class = verse} ** Ecclesiaste 12; 14 ** {class = libro}. ** Ti dico che ogni parola frivola che gli uomini pronunciano, renderanno conto nel Giorno del Giudizio;  
Gli scopi segreti del cuore e le motivazioni compaiono nel racconto infallibile, poiché il Signore ** porterà alla luce le cose nascoste delle tenebre, ma manifesterà anche i disegni dei cuori ** {class = versoQ} ** I Corinzi 4: 5 * * {class = bookVerse}  

** 8) Quando è scritto il nome di qualcuno nel libro della vita? ** {class = question} ** Giovanni 5:24; Filippesi 4: 3 ** {class = bookQ}
** In verità, in verità ti dico: chi ascolta la mia parola e crede a colui che mi ha mandato ha la vita eterna, non entra in giudizio, ma è passato dalla morte alla vita. ** {class = versoQ} ** Giovanni 5 : 24 ** {class = bookVerse}  
** A te, fedele compagno del giogo, chiedo anche di aiutarli, perché insieme hanno lottato con me nel vangelo, anche con Clemente e con gli altri miei collaboratori, i cui nomi si trovano nel Libro della Vita. ** {class = versoQ} ** Filippesi 4: 3 ** {class = bookVerse}  
...
** 9) Chi sarà giudicato? ** {class = question} ** I Peter 4:17; II Corinzi 5:10 ** {class = bookQ}  
** Perché è giunto il momento di iniziare il giudizio nella casa di Dio; ora, se viene prima per noi, quale sarà la fine di coloro che non obbediscono al vangelo di Dio? ** {class = versoQ} ** I Pietro 4:17 ** {class = bookVerse}  
** Perché è importante che tutti noi compariamo davanti al tribunale di Cristo, in modo che ognuno possa ricevere secondo il bene o il male che ha fatto attraverso il corpo. ** {class = versoQ} ** II Corinzi 5:10 ** { class = bookVerse}  
...
** 10) Quelli che non credono in Gesù saranno giudicati in questa corte? ** {class = question} ** Giovanni 3: 18,19 ** {class = bookQ}  
** Chi crede in lui non è condannato; chi non crede è già condannato, perché non crede nel nome dell'unigenito Figlio di Dio. ** {class = versoQ} ** Giovanni 3: 18,19 ** {class = bookVerse}  
...
!!! Nota ""
	 Il salario del peccato è la morte. La morte passò a tutti gli uomini per questo ... tutti peccarono (** Romani 6; 23; 5:12 ** {class = book}). Quindi, a meno che non si sottomettano allo spirito guida di Gesù, sono condannati. Pertanto, non è necessario che i loro casi vengano valutati nel giudizio investigativo avviato nel 1844. La Bibbia rivela che il caso dei malvagi sarà affrontato in un'altra occasione, alla fine dei mille anni, dopo la venuta di Gesù.
...
Tutti coloro che si sono veramente pentiti del peccato e che, per fede, hanno reclamato il sangue di Gesù Cristo come sacrificio espiatorio, hanno avuto il perdono aggiunto (scommetto) al loro nome nei libri del Cielo; se diventano partecipi della giustizia di Cristo, e se il loro carattere è trovato in armonia con la legge di Dio, i loro peccati saranno cancellati e loro stessi saranno considerati degni della vita eterna.

** 11) Come viene emesso il giudizio? ** {class = question} ** Rivelazione 20:12 ** {class = bookQ}  
** Ho visto anche i morti, i grandi e i piccoli, in piedi davanti al trono. Quindi i libri sono stati aperti. Ancora un altro libro, il Libro della vita, è stato aperto. E i morti furono giudicati, secondo le loro opere, secondo quanto era scritto nei libri. ** {class = versoQ} ** Apocalisse 20:12 ** {class = bookVerse}  
...
!!! Nota ""
	 Ogni tribunale ha una legge in base alla quale vengono giudicati gli atti di coloro che sono sotto processo. La legge di Dio è lo standard con cui il carattere e la vita degli uomini saranno misurati in giudizio. L'uomo saggio dice: ** Temi Dio e osserva i suoi comandamenti; perché questo è il dovere di ogni uomo. Perché Dio porterà tutta l'opera al giudizio. ** {class = verse} ** Ecclesiaste 12: 13,14. ** {class = libro}

L'apostolo Giacomo ammonisce i suoi fratelli: ** Così parla, e così fa, come dovrebbero essere giudicati dalla legge della libertà. ** {class = versoQ} ** Giacomo 2:12 ** {class = bookVerse}  

** 12) Qual è lo standard di giudizio? ** {class = question} ** Giacomo 2: 10-12 ** {class = bookQ}  
** Per chi osserva l'intera legge, ma inciampa su un punto, diventa colpevole di tutti. Poiché colui che ha detto: "Non commettere adulterio", ha anche detto: "Non uccidere". Ora, se non commetti adulterio, ma uccidi, sarai un trasgressore della legge. Parla in modo e in modo tale da procedere come coloro che devono essere giudicati dalla legge della libertà. ** {class = versoQ} ** Giacomo 2: 10-12 ** {class = bookVerse}  
...
** 13) Se qualcuno ha accettato Cristo Gesù, ma non Gli ha permesso di fare una trasformazione nella propria vita, vincendo i propri peccati, cosa ne sarà della persona? ** {class = question} ** Esodo 32:33; Salmo 69: 27-28 ** {class = bookQ}  
** Quindi il Signore disse a Mosè, cancellerò dal mio libro chiunque pecca contro di me. ** {class = versoQ} ** Esodo 32:33 ** {class = bookVerse}  
** Aggiungi iniquità a iniquità e non goderti l'assoluzione. Essere cancellato dal Libro dei vivi e non avere record con i giusti. ** {class = versoQ} ** Salmo 69: 27,28 ** {class = bookVerse}  

** Spunta la risposta corretta: **  
a) Il tuo nome sarà cancellato dal Libro della Vita. Sarà messa a morte.  
...
** 14) Quale decreto viene emesso a conclusione della sentenza? ** {class = question} ** Apocalisse 22:11 ** {class = bookQ}  
** Conserva gli ingiusti facendo ingiustizia, mantieni l'impuro che è ancora impuro; i giusti continuano nella pratica della giustizia, e il santo continua a santificare se stesso. ** {class = versoQ} ** Apocalisse 22:11 ** {class = bookVerse}  
...
** 15) Quando è iniziato questo giudizio? ** {class = question} ** Daniel 8:14 ** {class = bookQ}  
** Mi ha detto: Fino a duemilatrecento pomeriggi e mattine; e il santuario sarà purificato. ** {class = versoQ} ** Daniele 8:14 ** {class = bookVerse}  
...
Finora abbiamo visto che abbiamo bisogno di un cuore puro per essere considerati idonei alla vita eterna nel Giudizio del Cielo, ma il fatto è che oggi gli uomini hanno un cuore sporco. E quando vedono il male diffondersi tra loro, molti arrivano al punto di dichiarare, come il patriarca Giobbe: ** Chi trarrà fuori il puro dall'impuro? Nessuno ** {class = verse} ** Giobbe 14: 4 ** {class = libro}. Ma ciò che è impossibile agli uomini è possibile a Dio.

** 16) Cosa ha promesso Dio di fare per coloro che si pentono dei loro peccati e si convertono? ** {class = question} ** Atti 3:19 ** {class = bookQ}  
** Pentiti, quindi, e convertiti, in modo che i tuoi peccati possano essere cancellati, e così possano venire momenti di ristoro alla presenza del Signore. ** {class = versoQ} ** Atti 3:19 ** {class = bookVerse}  
...
** 17) Qual era la richiesta di Davide quando confessò il suo peccato a Dio? ** {class = question} ** Salmo 51: 1 ** {class = bookQ}  
** Abbi pietà di me, o Dio, secondo la tua benignità; cancella le mie trasgressioni, secondo la moltitudine delle tue misericordie. ** {class = versoQ} ** Salmo 51: 1 ** {class = bookVerse}  
...
Gesù ci ha accolti da bambini. E come tale, si aspetta che lo confessiamo come il padre della nostra eternità, autore della nostra fede e ragione della nostra speranza. Se amiamo e crediamo in Lui, riconosceremo sicuramente la nostra connessione con Cristo davanti a tutte le persone con cui ci relazioniamo. E Gesù disse: ** tutti quelli che mi confessano davanti agli uomini, anch'io confesserò davanti al Padre mio che è nei cieli ** {class = versoQ} ** Matteo 10:32 ** {class = bookVerse}  

## Sabato

** Per meditare e studiare con la famiglia. **

Non siamo salvati dalle opere, siamo salvati dalla fede in ciò che Gesù ha fatto per noi e fa in noi. Ma siamo giudicati dalle opere che sono la conseguenza o il frutto della fede. Chi crede veramente obbedisce a Gesù. La fede non è solo la professione, dire * "Io credo" *, ma la fede radicata nel cuore, che spinge l'uomo a fare di Gesù la sua unica speranza e ad obbedire a tutto ciò che comanda. Con tale fede Gesù disse al cieco di lavarsi gli occhi nella vasca di Siloe e fu guarito. Credette alla parola, obbedì e Dio lo restaurò.

Il giudizio di Dio non cancella il Vangelo. Non cambia l'insegnamento che siamo salvati per fede, in esso verifica solo chi aveva vera fede per la salvezza, e in essa perseverò fino alla fine.

** 18) Che tipo di persone entreranno nel Regno dei Cieli? ** {class = question} ** Matteo 7:21 ** {class = bookQ}  
** Non tutti quelli che mi dicono: Signore, Signore! entrerà nel regno dei cieli, ma colui che fa la volontà del Padre mio che è nei cieli. ** {class = versoQ} ** Matteo 7:21 ** {class = bookVerse}  
...
!!! citazione Golden Back
    dicendo ad alta voce: Temi Dio e dagli gloria, poiché l'ora del suo giudizio è venuta; e adorate Colui che ha fatto il cielo e la terra e il mare e le sorgenti d'acqua. ** Rivelazione 14: 7 ** {class = book}

## Domenica


** 1) Quale tema implica l'ultimo avvertimento nel grande conflitto sulla terra? ** {class = question} ** Apocalisse 14: 7-9 ** {class = bookQ}  
** Dicendo ad alta voce: Temi Dio e dagli gloria, poiché l'ora del suo giudizio è venuta; e adorate Colui che ha fatto il cielo e la terra e il mare e le sorgenti d'acqua. Un altro angelo seguì, il secondo, dicendo: La grande Babilonia è caduta, è caduta, il che ha fatto bere a tutte le nazioni il vino dalla furia della loro prostituzione. Un altro angelo seguì, il terzo, dicendo ad alta voce: Se qualcuno adora la bestia e la sua immagine e riceve il suo marchio sulla fronte o sulla mano. ** {class = versoQ} ** Apocalisse 14 : 7-9 ** {class = bookVerse}  
...
** 2) Qual è il messaggio del primo angelo? ** {class = question} ** Apocalisse 14: 6,7 ** {class = bookQ}  
** Ho visto un altro angelo volare nel cielo, con un vangelo eterno da predicare a coloro che siedono sulla terra e ad ogni nazione, tribù, lingua e popolo, dicendo, ad alta voce, temete Dio e date - gloria a lui, perché l'ora del suo giudizio è venuta; e adorare Colui che ha fatto il cielo e la terra e il mare e le fontane d'acqua. ** {class = versoQ} ** Apocalisse 14: 6,7 ** {class = bookVerse}  
...
** 3) Cosa rappresenta il simbolo "" angelo "* nella profezia biblica? ** {class = question} ** Galati 4:14 ** {class = bookQ}  
** E poiché la mia malattia nella carne era per te una tentazione, tuttavia, non mi hai mostrato disprezzo o disgusto; piuttosto, mi hai ricevuto come un angelo di Dio, come Cristo Gesù stesso. ** {class = versoQ} ** Galati 4:14 ** {class = bookVerse}  
...
** 4) Qual è lo scopo del messaggio del Vangelo eterno? ** {class = question} ** Matteo 24:14 ** {class = bookQ}  
** E questo vangelo del regno sarà predicato in tutto il mondo, per testimonianza a tutte le nazioni. Allora verrà la fine. ** {class = versoQ} ** Matteo 24:14 ** {class = bookVerse}  
...
** 5) Cos'è l'Eterno Vangelo? ** {class = question} ** Romani 1:16 ** {class = bookQ}  
** Perché non mi vergogno del vangelo, perché è il potere di Dio per la salvezza di tutti coloro che credono, prima dell'ebreo e del greco. ** {class = versoQ} ** Romani 1:16 ** {class = bookVerse }  

** Spunta la risposta corretta: **  
a) Il vero Vangelo - l'Eterno Vangelo - è il potere di Dio per la nostra salvezza.  
b) L'Eternal Gospel è un nome semplice.  
c) L'Eterno Vangelo è il potere degli uomini per la nostra salvezza.  

** 6) Come capire l'espressione "grande voce"? ** {class = question} ** Luca 1: 41,42 ** {class = bookQ}  
** Udendo questo saluto di Maria, la bimba rabbrividì nel suo ventre; poi, Isabel era posseduta dallo Spirito Santo. Ed esclamò a gran voce: Benedetta sei tu fra le donne, e benedetto è il frutto del tuo grembo! ** {class = versoQ} ** Luca 1: 41,42 ** {class = bookVerse}  
...
** 7) Cosa significa temere Dio, secondo la Bibbia? ** {class = question} ** Ecclesiaste 12: 13,14 ** {class = bookQ}  
** Di tutto ciò che è stato ascoltato, la somma è: Temi Dio e osserva i suoi comandamenti; perché questo è il dovere di ogni uomo. Perché Dio consegnerà alla giustizia tutte le opere, anche quelle nascoste, buone o cattive che siano. ** {class = versoQ} ** Ecclesiaste 12: 13,14 ** {class = bookVerse}  
...
1. Cosa mangiamo e beviamo
	- ** Pertanto, sia che tu mangi o bevi, o fai qualcos'altro, fai tutto per la gloria di Dio. ** {class = versoQ} ** I Corinzi 10:31 ** {class = book}
1. Attraverso il nostro corpo (vita)
	- ** O non sapete che il vostro corpo è il tempio dello Spirito Santo, che dimora in voi, da Dio, e che non siete voi stessi? Perché sei stato comprato a buon prezzo; quindi glorifica Dio nel tuo corpo e nel tuo spirito, che appartengono a Dio. ** {class = versoQ} ** 1 Corinzi 6: 19,20 ** {class = libro}
1. Quando riconosciamo il sacrificio di Cristo
	- ** E quando Gesù gridò ad alta voce, disse: Padre, nelle tue mani consegno il mio spirito. E detto questo, è scaduto. E il centurione, vedendo cosa era successo, diede gloria a Dio, dicendo: In realtà, quest'uomo era giusto. ** {class = versoQ} ** Luca 23: 46-47 ** {class = book}
1. Quando portiamo buoni frutti
	- ** In questo è glorificato il Padre mio, che portiate molto frutto; e così sarete miei discepoli. ** {class = versoQ} ** Giovanni 15: 8 ** {class = book}
1. Quando facciamo la volontà di Dio per la nostra vita
	- ** Ti ho glorificato sulla terra, avendo portato a termine il lavoro che mi hai affidato. ** {class = versoQ} ** Giovanni 17: 4 ** {class = book}
1. Quando ci pentiamo dei nostri peccati
	- ** E gli uomini furono bruciati dal grande calore e bestemmiarono il nome di Dio, che ha potere su queste piaghe; e non si pentirono per dargli gloria. ** {class = versoQ} ** Apocalisse 16: 9 ** {class = libro}
1. Quando crediamo implicitamente in Dio
	- ** Chi, nella speranza, credette contro ogni speranza, tanto da diventare padre di molte nazioni, secondo quanto gli fu detto: Così sarà la tua discendenza. E non indebolendosi nella fede, non prestò attenzione al proprio corpo, già insensibile, da quando aveva quasi cento anni, né all'intorpidimento del ventre di Sara. E non dubitò della promessa di Dio per l'incredulità, ma fu rafforzato nella fede, dando gloria a Dio. ** {class = versoQ} ** Romani 4: 18-20 ** {class = book}
...
** 8) Chi è colui che siamo invitati ad adorare? ** {class = question} ** Apocalisse 14: 7 ** {class = bookQ}  
** Dicendo ad alta voce: Temi Dio e dagli gloria, poiché l'ora del suo giudizio è venuta; e adorare Colui che ha fatto il cielo e la terra e il mare e le fontane d'acqua. ** {class = versoQ} ** Apocalisse 14: 7 ** {class = bookVerse}  
...
** 9) Chi è il Creatore di tutte le cose? ** {class = question} ** Genesi 1: 1 ** {class = bookQ}  
** In principio, Dio creò i cieli e la terra. ** {class = versoQ} ** Genesi 1: 1 ** {class = bookVerse}  
...
** 11) Nelle parole di Cristo, chi è l'unico Dio? ** {class = question} ** Giovanni 17: 1,3 ** {class = bookQ}  
** Dette queste cose, Gesù alzò gli occhi al cielo e disse: Padre, l'ora è venuta; glorifica tuo Figlio, affinché il Figlio ti glorifichi. E la vita eterna è questa: fagli conoscere te, l'unico vero Dio, e Gesù Cristo, che hai mandato. ** {class = versoQ} ** Giovanni 17: 1,3 ** {class = bookVerse}  
...
** 12) Esiste davvero un solo Dio? ** {class = question} ** I Timoteo 1:17; 2: 5 ** {class = bookQ}  
** Così, all'eterno, immortale, Re invisibile, un solo Dio, onore e gloria nei secoli dei secoli. Amen! ** {class = versoQ} ** I Timoteo 1:17 ** {class = bookVerse}  
** Perché c'è un solo Dio e un solo Mediatore tra Dio e gli uomini, Cristo Gesù, uomo. ** {class = versoQ} ** I Timoteo 2: 5 ** {class = bookVerse}  
...
** 13) Cosa impariamo dal primo comandamento della Legge di Dio? ** {class = question} ** Esodo 20: 3 ** {class = bookQ}  
** Non avrai altri dei prima di Me. ** {class = versoQ} ** Esodo 20: 3 ** {class = bookVerse}  
...
** 14) Qual è la considerazione di Gesù del Padre nell'Apocalisse? ** {class = question} ** Apocalisse 3:12 ** {class = bookQ}  
** Al vincitore ne farò una colonna nel santuario del mio Dio, e di lì non partirà mai; Vi scriverò anche il nome del mio Dio, il nome della città del mio Dio, la nuova Gerusalemme che discende dal cielo, dal mio Dio, e il mio nuovo nome. ** {class = versoQ} ** Apocalisse 3 : 12 ** {class = bookVerse}  
...
** 15) Quando Gesù chiese ai discepoli cosa la gente pensava che fosse, cosa risposero? ** {class = question} ** Matteo 16:14 ** {class = bookQ}  
** E risposero: Alcuni dicono: Giovanni Battista; altri: Elias; e altri: Geremia o uno dei profeti. ** {class = versoQ} ** Matteo 16:14 ** {class = bookVerse}  

a) Giovanni Battista o Elia.  
b) Giovanni Battista, Elia o Geremia.  
c) Giovanni Battista, Elia, Geremia o qualche altro profeta.  

** 16) E quando Gesù chiese loro cosa pensavano che fosse, cosa risposero i discepoli? ** {class = question} ** Matteo 16:16 ** {class = bookQ}  
** Rispondendo a Simon Pietro, disse: Tu sei il Cristo, il Figlio del Dio vivente. ** {class = versoQ} ** Matteo 16:16 ** {class = bookVerse}  
...
** 17) Quale fu la risposta di Gesù a Pietro quando gli rispose? ** {class = question} ** Matteo 16:17 ** {class = bookQ}  
** Allora Gesù gli disse: Benedetto sei tu, Simon Barjonas, perché non sono stati carne e sangue a rivelarti, ma il Padre mio, che è nei cieli. ** {class = versoQ} ** Matteo 16:17 ** { class = bookVerse}  
...
** 18) Chi ha amato il mondo dandoci chi? ** {class = question} ** Giovanni 3:16 ** {class = bookQ}  
** Perché Dio ha tanto amato il mondo che ha dato il suo unigenito Figlio, in modo che chiunque crede in lui non muoia, ma abbia la vita eterna. ** {class = versoQ} ** Giovanni 3:16 ** {class = bookVerse}  
...
!!! Nota ""
	 Cristo è l'unico Figlio di Dio generato. La parola * "unigenito" * significa * "unico (uni) generato (genito)" * Cristo è il Figlio unigenito di Dio. Gli angeli e gli uomini sono esseri creati e non generati. (vedere ** Giovanni 3:18; 1 Giovanni 4: 9 ** {class = libro})

** Ed ecco una voce dal cielo, che dice: Questo è il mio amato Figlio, nel quale sono molto soddisfatto ** {class = verse} ** Matteo 3:17 ** {class = libro}.  
** Stava ancora parlando, quando una nuvola luminosa li avvolse; ed ecco, una voce venne dalla nuvola, dicendo: Questo è il mio diletto Figlio, nel quale mi sono compiaciuto; L'ho sentito ** {class = versoQ} ** Matteo 17: 5 ** {class = bookVerse}  

** 19) Chi è la saggezza di Dio? ** {class = question} ** I Corinzi 1:24 ** {class = bookQ}  
** Ma a coloro che sono chiamati, sia ebrei che greci, predichiamo Cristo, il potere di Dio e la saggezza di Dio. ** {class = versoQ} ** I Corinzi 1:24 ** {class = bookVerse}  
...
** 20) Cosa dice la Bibbia sulla nascita di Cristo - Sapienza di Dio, come fu generato in cielo? ** {class = question} ** Proverbi 8: 22-25 ** {class = bookQ}  
** Il Signore mi aveva all'inizio della sua opera, prima delle sue opere più antiche. Dall'eternità sono stato stabilito, dall'inizio, prima dell'inizio della terra. Prima che ci fossero abissi, io sono nato, e anche prima che ci fossero fontane cariche d'acqua. Prima che le montagne fossero stabilite, prima che ci fossero le colline, io sono nato. ** {class = versoQ} ** Proverbi 8: 22-25 ** {class = bookVerse}  

** Spunta la risposta corretta: **  
a) Cristo è sempre esistito perché è Dio.  
b) Cristo ha avuto un inizio, è stato generato da Dio prima che il mondo esistesse. Le sue origini risalgono ai "giorni dell'eternità" ** (Michea 5: 2). ** {class = book}  
c) Cristo è nato a Betlemme.  

** 21) Dopo aver detto che l'unico Dio è il Padre, cosa si dice che sia Gesù? ** {class = question} ** I Corinzi 8: 6 ** {class = bookQ}  
** Tuttavia, per noi c'è un solo Dio, il Padre, di cui tutte le cose sono e per il quale noi esistiamo; e un solo Signore, Gesù Cristo, per il quale sono tutte le cose, e anche noi per lui. ** {class = versoQ} ** I Corinzi 8: 6 ** {class = bookVerse}  

** Spunta la risposta corretta: **  
a) Anche Gesù è Dio.  
b) Gesù è Dio e Signore.  
c) Gesù Cristo è chiamato Signore dalla Parola di Dio. Il Signore è colui che governa la casa ** (Matteo 24: 45-46). ** {class = book} È il capo della chiesa ** (Efesini 5: 22-25). ** {class = libro}  

** 22) Gesù può essere adorato? ** {class = question} ** Ebrei 1: 6; Giovanni 5:23 ** {class = bookQ}  
** E ancora, quando introduce il Primogenito nel mondo, dice: E tutti gli angeli di Dio lo adorano. ** {class = versoQ} ** Ebrei 1: 6 ** {class = bookVerse}  
** In modo che tutti onorino il Figlio nel modo in cui onorano il Padre. Chi non onora il Figlio non onora il Padre che lo ha mandato. ** {class = versoQ} ** Giovanni 5:23 ** {class = bookVerse}  
...
** 23) Quale presenza vale la presenza di Gesù? ** {class = question} ** Giovanni 14: 9; 1:18 ** {class = bookQ}  
** Gesù gli disse: Filippo, io sono con te da tanto tempo e tu non mi conosci? Chi vede me vede il Padre; come si dice: mostraci il Padre? ** {class = versoQ} ** Giovanni 14: 9 ** {class = bookVerse}  
** Nessuno ha mai visto Dio; il Figlio unigenito, che è nel seno del Padre, è colui che lo ha rivelato. ** {class = versoQ} ** Giovanni 1:18 ** {class = bookVerse}  
...
** 24) Cristo è anche il Creatore? ** {class = question} ** Giovanni 1: 3 ** {class = bookQ}  
** Tutte le cose sono state fatte attraverso di lui, e senza di lui, niente di ciò che è stato fatto è stato fatto. ** {class = versoQ} ** Giovanni 1: 3 ** {class = bookVerse}  
...
La Bibbia ci dice che tutte le cose furono fatte tramite Cristo, cioè, il Padre è il Creatore e Gesù l'esecutore. (Vedi anche: ** Colossesi 1: 15-17; Atti 2:22; Giovanni 5:30; 6:38 ** {class = book})

** CHI O COSA È LO SPIRITO SANTO **

** 25) Da cosa è chiamato lo Spirito Santo? ** {class = question} ** Atti 2:38; 10:45 ** {class = bookQ}  
** Pietro rispose loro: "Pentitevi, e lasciate che ognuno di voi sia battezzato nel nome di Gesù Cristo per la remissione dei vostri peccati, e riceverete il dono dello Spirito Santo. ** {class = versoQ} ** Atti 2:38 ** {class = bookVerse}  
** E i fedeli che erano circoncisi, che venivano con Pietro, rimasero stupiti, perché il dono dello Spirito Santo fu versato anche sui Gentili. ** {class = versoQ} ** Atti 10:45 ** {class = bookVerse}  
...
** 26) Cosa ci viene dato tramite lo Spirito Santo? ** {class = question} ** Atti 1: 8 ** {class = bookQ}  
** Ma riceverai potenza quando lo Spirito Santo verrà su di te, e sarai mio testimone sia a Gerusalemme che in tutta la Giudea e Samaria e fino ai confini della terra. ** {class = versoQ} ** Atti 1: 8 ** {class = bookVerse}  
...
** 27) Quali sono le caratteristiche dello Spirito Santo? ** {class = question} ** Giovanni 14: 16-18 ** {class = bookQ}  
** E io pregherò il Padre, e ti darà un altro Consolatore, affinché rimanga con te per sempre, lo Spirito di verità, che il mondo non può ricevere, perché non lo vede né lo conosce; ma tu lo conosci, perché vive con te e sarà in te. Non vi lascerò orfani; Tornerò da te. ** {class = versoQ} ** Giovanni 14: 16-18 ** {class = bookVerse}  

** Contrassegna le dichiarazioni con V se vere e F se false. **

a) () Spirito di verità: Gesù è la verità. ** Gesù rispose loro: Io sono la via, la verità e la vita ... ** {class = versoQ} ** (Giovanni 14: 6) ** {class = libro}  
b) () Il mondo non sa: Il mondo non conosceva Gesù. ** La Parola era nel mondo, il mondo è stato creato per mezzo di Lui, ma il mondo non lo sapeva. ** {class = versoQ} ** (Giovanni 1:10) ** {class = libro}  
c) () Dimorava con i discepoli: Gesù viveva con loro a quel tempo. ** Il Verbo si fece carne e venne ad abitare in mezzo a noi ... ** {class = versoQ} ** (Giovanni 1:14) ** {class = libro}  
d) () Sarebbe stato in loro: Gesù disse che Lui stesso sarebbe stato nei discepoli. ** In quel giorno saprai che io sono nel Padre mio, e tu in me e io in te. ** {class = versoQ} ** (Giovanni 14:20) ** {class = libro}  

!!! Nota ""
	 Tutte le caratteristiche che Cristo ha dato riguardo allo Spirito Santo erano le caratteristiche di Se stesso.
<div class = 'page'> & nbsp; </div>

** 28) Di chi è lo Spirito lo Spirito? ** {class = question} ** I Pietro 1:11; Galati 4: 6; Romani 8:14 ** {class = bookQ}  
** Indagando attentamente, qual è l'occasione o quali sono le circostanze opportune, indicate dallo Spirito di Cristo, che era in esse ... ** {class = versoQ} ** I Pietro 1:11 ** {class = bookVerse}  
** E poiché siete figli, Dio ha mandato lo Spirito di suo Figlio nei nostri cuori, che grida: Abba, Padre! ** {class = versoQ} ** Galati 4: 6 ** {class = bookVerse} ** Per tutti coloro che sono guidati dallo Spirito di Dio sono figli di Dio. ** {class = verse} ** Romani 8:14 ** {class = bookVerse}  
** Spunta la risposta corretta: **  
...
** 29) In che modo Gesù comunicò lo Spirito Santo riguardo ai discepoli? ** {class = question} ** Giovanni 20:22 ** {class = bookQ}  
** E detto questo, soffiò su di loro e disse loro: Ricevi lo Spirito Santo. ** {class = versoQ} ** Giovanni 202: 22 ** {class = bookVerse}  
...
** 30) È un essere personale indipendente dal Padre e da Cristo? ** {class = question} ** Giovanni 15:26 ** {class = bookQ}  
** Quando, però, verrà il Consolatore, che ti manderò dal Padre, lo Spirito di verità, che procede da lui, renderà testimonianza di me; ** {class = versoQ} ** Giovanni 15:26 ** { class = bookVerse}  

** Barrare la risposta corretta: ** () Sì () No

** 31) Chi ci manda lo Spirito Santo? ** {class = question} ** Giovanni 16: 7 ** {class = bookQ}  
** Ma ti dico la verità: dovresti andare, perché se io non vado, il Consolatore non verrà per te; ma se vado, te lo mando. ** {class = versoQ} ** Giovanni 16: 7 ** {class = bookVerse}  
...
** 32) Chi è lo Spirito Santo? ** {class = question} ** II Corinzi 3:17 ** {class = bookQ}  
** Ora il Signore è lo Spirito; e dove c'è lo Spirito del Signore, c'è libertà. ** {class = versoQ} ** II Corinzi 3:17 ** {class = bookVerse}  

** Contrassegna le dichiarazioni con V se vere e F se false. **  
a) () Gesù è il nostro Signore (** I Corinzi 8: 6 ** {class = libro}), e la Parola dice che questo Signore è lo Spirito.  
b) () Tramite lo Spirito la vita di Cristo ci viene comunicata (** Efesini 3: 16-17 ** {class = libro}) e Cristo viene a vivere nei nostri cuori.  
...
!!! citazione Golden Back
    Un altro angelo seguì, il secondo, dicendo: La grande Babilonia è caduta, è caduta, che ha fatto bere a tutte le nazioni il vino dell'ira della sua prostituzione. ** Rivelazione 14: 6,7 ** {class = book}
...
Quando guardiamo al mondo cristiano oggi ci troviamo di fronte alla fede e all'accettazione di molte dottrine che non trovano alcun supporto biblico per la loro accettazione e insegnamento. E anche i protestanti che in un primo momento difendevano la purezza delle dottrine bibliche, oggi rifiutano molte dottrine fondamentali difese dalla Bibbia. Studiando questa verità biblica ne studieremo alcune e il modo in cui il Cielo, Dio e Suo figlio Gesù sono disonorati da questa confusione.

** 1) Cosa dice il messaggio del secondo angelo? ** {class = question} ** Apocalisse 14: 8; Isaia 21: 9 ** {class = bookQ}  
** Un altro angelo seguì, il secondo, dicendo: La grande Babilonia è caduta, è caduta, il che ha fatto bere tutte le nazioni dalla furia della loro prostituzione. ** {class = versoQ} ** Rivelazione 14: 8 * * {class = bookVerse}  
** Arriva una truppa di uomini, cavalieri di due a due. Poi alzò la voce e disse: Babilonia è caduta, è caduta; e tutte le immagini scultoree dei loro dei giacciono in frantumi al suolo ** {class = versoQ} ** Isaia 21: 9 ** {class = bookVerse}  
...
** 2) Chi è la moderna Babilonia o è anche chiamata Madre Babilonia? ** {class = question} ** Apocalisse 17: 4,5 ** {class = bookQ}  
** La donna era vestita di porpora e scarlatto, adornata d'oro, pietre preziose e perle, e reggeva una coppa d'oro traboccante di abomini e della sporcizia della sua prostituzione. Un nome, un mistero, era scritto sulla sua fronte: Babilonia la Grande, la madre delle prostitute e delle abominazioni del paese. ** {class = versoQ} ** Apocalisse 17: 4,5 ** {class = bookVerse }
...
** 3) Cosa rappresenta "donna" nelle profezie bibliche? ** {class = question} ** Efesini 5:24 ** {class = bookQ}  
** Come, tuttavia, la chiesa è sottomessa a Cristo, così anche le donne sono sottomesse in tutto e per tutto al marito. ** {class = versoQ} ** Efesini 5:24 ** {class = bookVerse}  
...
** 4) Cosa farebbe questa chiesa apostata? ** {class = question} ** Rivelazione 17: 6 ** {class = bookQ}  
** Poi ho visto la donna ubriaca del sangue dei santi e del sangue dei testimoni di Gesù; e quando l'ho vista sono rimasto sbalordito con grande stupore. ** {class = versoQ} ** Apocalisse 17: 6 ** {class = bookVerse}  
...
** 5) Dove si troverebbe la moderna Babilonia in futuro? ** {class = question} ** Apocalisse 17: 9 ** {class = bookQ}  
** Ecco il senso, che ha saggezza: le sette teste sono sette colli, sui quali è seduta la donna. ** {class = versoQ} ** Apocalisse 17: 9 ** {class = bookVerse}  
...
!!! Nota ""
	 Questa chiesa sarebbe stata * "seduta" * o situata in un luogo dove c'erano sette colline. La città di Roma è conosciuta come la "città dei sette colli". A Roma c'è la sede mondiale della Chiesa Cattolica Apostolica Romana - il Vaticano. Questa chiesa nel Medioevo, attraverso la cosiddetta "santa inquisizione", uccise più di cento milioni di cristiani che non volevano accettare i suoi dogmi.

** 6) Cosa disse Gesù del vino da comunione? ** {class = question} ** Luca 22:20 ** {class = bookQ}  
** Allo stesso modo, dopo cena, prese il calice, dicendo: Questo è il calice della nuova alleanza nel mio sangue versato per te. ** {class = versoQ} ** Luca 22:20 ** {class = bookVerse}  
...
** 7) Cosa ha fatto l'antica Babilonia a tutte le nazioni? ** {class = question} ** Geremia 51: 7 ** {class = bookQ}  
** Babilonia era una coppa d'oro nelle mani del SIGNORE, che inebriava tutta la terra; le nazioni bevevano del suo vino; quindi le nazioni sono impazzite. ** {class = versoQ} ** Jeremiah 51: 7 ** {class = bookVerse}  
...
** 8) Qual è stato l'effetto di questo atteggiamento di apostasia? ** {class = question} ** Geremia 51: 8 ** {class = bookQ}  
** Babilonia cadde in un attimo e fu rovinata; piangi per lei, prendi un balsamo per il suo dolore, forse guarirà. ** {class = versoQ} ** Jeremiah 51: 8 ** {class = bookVerse}  
...
** 9) Cosa ha promesso Dio che avrebbe fatto a Babilonia? ** {class = question} ** Geremia 51:24 ** {class = bookQ}  
** E ripagherò Babilonia, e tutti gli abitanti della Caldea, per tutta la malvagità che hanno fatto a Sion, ai tuoi occhi, dice il SIGNORE. ** {class = versoQ} ** Geremia 51:24 ** {class = bookVerse }  
...
** 10) Nelle visioni di Giovanni, quale interpretazione viene data alla donna che siede su molte acque? ** {class = question} ** Apocalisse17: 18 ** {class = bookQ}  
** E la donna che hai visto è la grande città che regna sui re della terra. ** {class = versoQ} ** Apocalisse 17:18 ** {class = bookVerse}  
...
** 11) In quella stessa profezia, come è la Chiesa di Roma, il papato, designata come simbolo dell'antica Babilonia? ** {class = question} ** Apocalisse 17: 5 ** {class = bookQ}  
** E sulla sua fronte era scritto il nome: Mistero, la grande Babilonia, la madre delle prostitute e degli abomini della terra. ** {class = versoQ} ** Apocalisse 17: 5 ** {class = bookVerse}  
...
** 12) Cosa fa la moderna profezia di Babilonia? ** {class = question} ** Rivelazione 17: 2 ** {class = bookQ}  
** Con cui si prostituirono i re del paese; e, con il vino della sua dissolutezza, quelli che vivono sulla terra si sono ubriacati. ** {class = versoQ} ** Apocalisse 17: 2 ** {class = bookVerse}  
...
!!! Nota ""
	 La Chiesa di Roma si chiama Babilonia e la sua religione era una restaurazione della religione dell'antica Babilonia. Il vino babilonese è qui rappresentato come il simbolo di falsi insegnamenti. La * "prostituzione" * descritta in ** Apocalisse 17: 2, ** {class = book} sono verità adulterate che confondono le persone inducendole ad adorare ciò che è falso. Tutte le chiese che esistono oggi e accettano dogmi e tradizioni cattoliche come la Trinità, l'osservanza della domenica e l'immortalità dell'anima, sono considerate dalla parola di Dio come * "figlie della meretrice" *.

## mercoledì

** 13) Cosa disse Gesù del vino da comunione? ** {class = question} ** Luca 22:20. ** {class = bookQ}  
** Allo stesso modo, ha preso il calice dopo cena, dicendo: Questo calice è il nuovo testamento nel mio sangue, che è versato per te. ** {class = versoQ} ** Luca 22:20 ** {class = bookVerse}  
...
** 14) Qual è l'insegnamento essenziale del Nuovo Patto? ** {class = question} ** Ebrei 8:10 ** {class = bookQ}  
** Perché questo è il patto che farò con la casa d'Israele dopo quei giorni, dice il Signore: Stamperò le mie leggi nella tua mente, le scriverò anche nel tuo cuore; e io sarò il loro Dio, e loro saranno il mio popolo. ** {class = versoQ} ** Ebrei 8:10 ** {class = bookVerse}  
...
** 16) Quale verità è confermata da Gesù? ** {class = question} ** Giovanni 6:63 ** {class = bookQ}  
** Lo spirito è ciò che dà la vita, la carne non usa nulla; le parole che ti ho detto sono spirito e vita. ** {class = versoQ} ** Giovanni 6:63 ** {class = bookVerse}  
...
** 17) Gli uomini, guidati da Satana, misero le dottrine e le tradizioni degli uomini al posto della parola di Dio? ** {class = question} ** Marco 7: 7-9 ** {class = bookQ}  
** E invano mi adorano, insegnando dottrine che sono i precetti degli uomini. Trascurando il comandamento di Dio, mantieni la tradizione degli uomini. E disse loro: "Stai giustamente rifiutando il precetto di Dio di mantenere la tua tradizione. ** {class = versoQ} ** Marco 7: 7-9 ** {class = bookVerse}  
...
!!! Nota ""
	 Esaltando le tradizioni, la Chiesa cattolica, o papato, fa esattamente quello che fa la moderna Babilonia: * "La Tradizione cattolica diventa come un fiume vivo che ci collega alle origini, il fiume vivo in cui le origini sono sempre presenti". * ** (Dichiarazione di Benedetto XVI, 2006) **

## Giovedi

Ci sono due calici presentati nella Parola di Dio: il calice del Signore e il calice di Babilonia. Il vino nel calice del Signore rappresenta la verità vivente, "come la verità è in Gesù"; il vino nella coppa di Babilonia rappresenta le sue false dottrine, la sostituzione della Parola vivente e della legge di Dio con la tradizione umana, e l'unione illecita che ha fatto tra la chiesa e il potere secolare (politico), per dare forza al suo insegnamento.

Proprio per questo, pur mantenendo una forma di pietà, ne nega tuttavia l'efficacia. La sostituzione della legge di Dio con la legge della chiesa, in adempimento della profezia di ** Daniele 7:25, ** {class = book} testimonia la completa subordinazione della Parola di Dio all'autorità della chiesa.
...
** 18) Che rapporto ha la Chiesa di Roma con le altre chiese apostate? ** {class = question} ** Apocalisse 17: 5 ** {class = bookQ}  
** E sulla sua fronte era scritto il nome: Mistero, la grande Babilonia, la madre delle prostitute e degli abomini della terra. ** {class = versoQ} ** Apocalisse 17: 5 ** {class = bookVerse}  
...
!!! Nota ""
	 Sebbene i leader del protestantesimo moderno non abbiano ufficialmente adottato il credo della Chiesa di Roma, e non facciano parte organica di questa corporazione, appartengono comunque alla stessa classe nel rifiutare l'autorità della Parola di Dio, accettando invece il loro prodotto argomenti. C'è tanta apostasia in un caso come nell'altro, ed entrambi devono quindi essere inclusi in Babilonia, ed entrambi si troveranno coinvolti, dopotutto, nella sua caduta.

## Venerdì

Nel senso più ampio del termine, Babilonia include tutte le false religioni; tutta l'apostasia. Il messaggio evangelico che annuncia la sua sovversione finale dovrebbe essere fonte di gioia per ogni amante della verità e della giustizia.

** 19) Fino a che punto dovrebbe spingersi l'apostasia? ** {class = question} ** Rivelazione 18: 2 ** {class = bookQ}  
** Poi ha esclamato con una voce potente, dicendo: Caduto! La Grande Babilonia cadde e divenne la dimora dei demoni, la tana di ogni tipo di spirito impuro e il nascondiglio di ogni tipo di uccello sporco e odioso. ** {class = versoQ} ** Rivelazione 18: 2 ** {class = bookVerse}  
...
c) Fino a quando gli uccelli sporchi non sono entrati nella chiesa.  

** 20) Quale ultimo invito fa Dio al Suo popolo a Babilonia? ** {class = question} ** Apocalisse 18: 4,5 ** {class = bookQ}  
** Udii un'altra voce dal cielo che diceva: Allontanati, popolo mio, per non essere complice dei suoi peccati e per non partecipare ai suoi flagelli; perché i suoi peccati si sono accumulati fino al cielo e Dio si è ricordato delle azioni malvagie che ha compiuto. ** {class = versoQ} ** Apocalisse 18: 4,5 ** {class = bookVerse}  

** Spunta la risposta corretta: **  
a) Dio ti chiede di amare Babilonia come te stesso.  
b) Dio invita tutti coloro che sono il Suo popolo a lasciare queste chiese cadute e unirsi al rimanente di Dio (** Apocalisse 12:17. ** {class = libro})  
c) Dio ci chiede di rovesciare questo falso sistema religioso.  

!!! Nota ""
	 Coloro che sono sfuggiti a questa confusione dottrinale hanno una caratteristica presentata in ** Apocalisse 14:12 ... ** {class = book} ** "osserva i suoi comandamenti". ** {class = verse} Rimani in queste chiese che predicano il menzogna, è correre il rischio di ricevere le ultime piaghe dell'ira di Dio.

** 21) Come sarà la caduta della moderna Babilonia? ** {class = question} ** Apocalisse 18:21 ** {class = bookQ}  
** Quindi un forte angelo sollevò una pietra come una grande macina da mulino e la gettò in mare, dicendo: Così, Babilonia, la grande città, sarà lanciata con audacia e non sarà mai trovata. ** {class = versoQ} ** Rivelazione 18:21 ** {class = bookVerse}  
...
** 22) Perché la profezia dice due volte che "cadde, cadde" questo sistema religioso apostata? ** {class = question} ** Rivelazione 14: 8; 18: 1-4 ** {class = bookQ}  
** Un altro angelo seguì, il secondo, dicendo: La grande Babilonia è caduta, è caduta, il che ha fatto bere tutte le nazioni dalla furia della loro prostituzione. ** {class = versoQ} ** Rivelazione 14: 8 * * {class = bookVerse}  
** E dopo queste cose vidi scendere dal cielo un altro angelo, che aveva un grande potere, e la terra fu illuminata con la sua gloria. E gridò ad alta voce, dicendo: La grande Babilonia è caduta, è caduta ed è diventata la dimora dei demoni, la tana di ogni spirito impuro e il nascondiglio di ogni uccello impuro e odioso. Poiché tutte le nazioni bevevano il vino dell'ira della loro prostituzione, e i re della terra si prostituivano con esso; ei mercanti del paese erano arricchiti dall'abbondanza delle loro delizie. E udii un'altra voce dal cielo, che diceva: Esci da esso, popolo mio, per non condividere i suoi peccati e per non affliggere le sue piaghe. ** {class = versoQ} ** Apocalisse 18: 1-4 * * {class = bookVerse}
...
!!! Nota ""
	 La profezia presenta questo autunno in due casi, poiché la prima chiesa a cadere nel concetto divino fu la Chiesa cattolica, poiché già nel 325 d.C. iniziò l'introduzione di false dottrine da parte di questa chiesa. E la ripetizione del termine * "caduto" * presenta un tempo nel futuro (il tempo che stiamo vivendo oggi) in cui le chiese in generale, accettando queste false dottrine, invaliderebbero i comandamenti di Dio e di conseguenza diventerebbero partecipi dei peccati della chiesa mamma.

!!! Nota ""
    * "La Chiesa cattolica è la madre di tutte le chiese cristiane. Pertanto, le altre chiese non dovrebbero essere considerate 'sorelle' della Chiesa cattolica." * Dichiarazione di Benedetto XVI ** (Fonte: Folha Online ** - www1.folha. uol.com.br/folha/mundo/ult94u82983.shtml)

## Sabato

Per meditare e studiare con la famiglia:

** 23) Quale consiglio e promessa ha lasciato Gesù a coloro che dovranno affrontare i pericoli della morte per la loro fede? ** {class = question} ** Apocalisse 2: 10,11; Matteo 10:28 ** {class = bookQ}
** Non temere nessuna di quelle cose che soffrirai. Ecco, il diavolo getterà alcuni di voi in prigione, affinché possiate essere tentati; e avrai una tribolazione di dieci giorni. Sii fedele fino alla morte e ti darò la corona della vita. Chi ha orecchi, ascolta quello che lo Spirito dice alle chiese: Chi vince non riceverà il danno della seconda morte. ** {class = versoQ} ** Apocalisse 2: 10,11 ** {class = bookVerse}  
** E non abbiate paura di coloro che uccidono il corpo e non possono uccidere l'anima; piuttosto temere chi può far morire l'anima e il corpo all'inferno. ** {class = versoQ} ** Matteo 10:28 ** {class = bookVerse}  
...
** 24) Quale canto di trionfo segue la caduta di Babilonia? ** {class = question} ** Apocalisse 19: 6,7 ** {class = bookQ}  
** E udii la voce di una grande folla, e la voce di molte acque, e la voce di un grande tuono, che diceva: Alleluia! perché il Signore Dio onnipotente regna. Rallegriamoci e rallegriamoci e diamogli gloria; perché il matrimonio dell'Agnello sta arrivando e sua moglie è già pronta. ** {class = versoQ} ** Apocalisse 19: 6,7 ** {class = bookVerse}  
...
!!! citazione Golden Back
    Questi furono seguiti da un altro angelo, il terzo, che diceva ad alta voce: Se qualcuno adora la bestia e la sua immagine e riceve il suo marchio sulla fronte o sulla mano ... ** Apocalisse 14: 9-12 * * {class = book}
...
Chi accetta il messaggio del primo angelo: * "l'ora del suo giudizio è venuta" *, cerca di temere Dio, che è osservare i suoi comandamenti. In tal modo, si rende conto che le corporazioni religiose cadute insegnano l'errore e per obbedire al vangelo che ha ricevuto, dovrà interrompere la sua connessione con loro.

Così si adempirà la raccomandazione del secondo angelo: * "Babilonia è caduta, è caduta!" *. * "La mia chiesa è caduta" * - dice. Per questo esempio, vediamo che l'esperienza di coloro che hanno compreso e risposto al messaggio del primo angelo porterà a comprendere e rispondere al messaggio del secondo angelo.
...
** 1) Come possiamo confrontare il messaggio dei tre angeli dato dalle profezie dell'Apocalisse? ** {class = question} ** II Pietro1: 19 ** {class = bookQ}  
** E abbiamo, molto fermamente, la parola dei profeti, a cui fai bene a prestare attenzione, come una luce che risplende in un luogo buio, finché spunta il giorno e la stella dell'aurora appare nei tuoi cuori. ** { class = versoQ} ** II Pietro 1:19 ** {class = bookVerse}  
...
** 2) Il messaggio del terzo angelo fa un solenne avvertimento contro quale apostasia? ** {class = question} ** Apocalisse 14: 9 ** {class = bookQ}  
** E il terzo angelo li seguì, dicendo ad alta voce: Se qualcuno adora la bestia e la sua immagine e riceve il marchio sulla fronte o nella mano, ** {class = versoQ} ** Apocalisse 14 : 9 ** {class = bookVerse}  
...
!!! Nota ""
	 Il messaggio del terzo angelo è l'ultima parte del vangelo inviato al mondo. La parola vangelo significa buona notizia. Il terzo angelo è incaricato di presentare la parte finale della buona novella del Cielo inviata al mondo. È come l'ultimo capitolo di un libro. Presenta il risultato di tutto e la soluzione del dramma. Annuncia quale sarà la fine di coloro che respingono la buona novella del Vangelo e dà la caratteristica che hanno nel tempo della fine coloro che accettano ammonimenti e buone notizie.

** 3) Quale sarà la caratteristica di coloro che obbediscono e accettano il vangelo eterno dato dai tre angeli? ** {class = question} ** Apocalisse 14:12 ** {class = bookQ}  
** Ecco la pazienza dei santi; ecco coloro che osservano i comandamenti di Dio e la fede in Gesù. ** {class = versoQ} ** Apocalisse 14:12 ** {class = bookVerse}  
...
** 4) Quale sarà la conseguenza dell'adorazione della bestia e della sua immagine e della ricezione del suo marchio? ** {class = question} ** Apocalisse 14:10 ** {class = bookQ}  
** Berrà anche il vino dell'ira di Dio, preparato, senza mescolarsi, dalla coppa della sua ira, e sarà tormentato con fuoco e zolfo, davanti ai santi angeli e alla presenza dell'Agnello. ** {class = versoQ} ** Rivelazione 14:10 ** {class = bookVerse}  
...
** 5) Cos'è il vino dell'ira di Dio? ** {class = question} ** Apocalisse 15: 1 ** {class = bookQ}  
** Ho visto un altro grande e mirabile segno in cielo: sette angeli che hanno gli ultimi sette flagelli, perché con loro si è consumata l'ira di Dio. ** {class = versoQ} ** Apocalisse 15: 1 ** {class = bookVerse}  
...
c) Il vino dell'ira di Dio, alla fine, sarà le ultime sette piaghe come risultato della scelta che hanno fatto. Facendo questa scelta, perderanno la protezione divina.  
...
** 6) Quale descrizione è fatta della Bestia? ** {class = question} ** Apocalisse 13: 1,2; Rivelazione 17: 3 ** {class = bookQ}
** Ho visto una bestia emergere dal mare che aveva dieci corna e sette teste e, sulle corna, dieci diademi e, sulle teste, nomi di bestemmia. ** {class = versoQ} ** Apocalisse 13: 1,2 ** {class = bookVerse}  
** L'angelo mi ha trasportato, in spirito, in un deserto e ho visto una donna a cavalcioni di una bestia scarlatta, una bestia piena di nomi di bestemmia, con sette teste e dieci corna. ** {class = versoQ} ** Apocalisse 17: 3 ** {class = bookVerse}  
...
** 7) Cosa rappresenta nella Bibbia l'animale nella profezia? ** {class = question} ** Daniele 7: 17,23 ** {class = bookQ}  
** Questi grandi animali, che sono quattro, sono quattro re, che sorgeranno dalla terra. ** {class = versoQ} ** Daniele 7:17 ** {class = bookVerse}  
** Ha detto così: Il quarto animale sarà il quarto regno sulla terra, che sarà diverso da tutti i regni; e lui divorerà l'intera terra, e la calpesterà sotto i suoi piedi e la farà a pezzi. ** {class = versoQ} ** Daniele 7:23 ** {class = bookVerse}  
...
!!! Nota ""
	 Animale nella Bibbia significa * "regno" * o * "re" * ** (Daniele 7: 17,23). ** {class = libro} La donna (Chiesa cattolica) è montata in questo regno, cioè lei lo governa . Il regno su cui governa la Chiesa cattolica è il Vaticano. Nell'Apocalisse troviamo alcune caratteristiche che ci permettono di identificarlo. Se è adorata, è un potere religioso. Gli fu permesso di fare la guerra ai santi e di vincerli ** (Apocalisse 13: 5). ** {class = book} Quindi comprendiamo che è un potere persecutorio dei santi di Dio. E gli fu data autorità su tutta la tribù, il popolo, la lingua e la nazione. ** Rivelazione 13: 7 ** {class = book}. La bestia aveva autorità sui re. Un solo potere soddisfa tutte le caratteristiche qui descritte; il papato medievale. Era un potere religioso che perseguitava e uccideva i santi, che chiamava * "eretici" *, e aveva autorità sui re. Il Papa ha sulla tiara l'iscrizione: "VICARIVS FILII DEI", che significa Vicario, o sostituto del Figlio di Dio. Afferma di essere il rappresentante divino sulla terra. Ma ordina di uccidere coloro che non accettano le sue dottrine. Non è così che procedette Cristo; al contrario, ha dato la vita per coloro che lo hanno rifiutato.
...
** 8) Cosa dicono le persone che adorano la bestia, i cui nomi non sono scritti nel libro della vita? ** {class = question} ** Rivelazione 13: 4 ** {class = bookQ}  
** E adoravano il drago perché aveva dato la sua autorità alla bestia; adorarono anche la bestia, dicendo: Chi è simile alla bestia? Chi può combatterlo? ** {class = versoQ} ** Apocalisse 13: 4 ** {class = bookVerse}  
...
** 9) Chi è il drago che ha dato potere e autorità alla bestia? ** {class = question} ** Apocalisse 12: 9 ** {class = bookQ}  
** E il grande dragone, l'antico serpente, chiamato il Diavolo, e Satana, che inganna il mondo intero, furono precipitati; fu precipitato sulla terra e i suoi angeli furono gettati con lui. ** {class = versoQ} ** Apocalisse 12: 9 ** {class = bookVerse}  
...
** 10) Il messaggio del terzo angelo avverte anche dell'adorazione di cosa? ** {class = question} ** Rivelazione 14: 9 ** {class = bookQ}  
** E il terzo angelo li seguì, dicendo ad alta voce: Se qualcuno adora la bestia e la sua immagine e riceve il marchio sulla fronte o nella mano. ** {class = versoQ} ** Apocalisse 14 : 9 ** {class = bookVerse}  
...
** 11) Cosa accadrà a coloro che adorano l'immagine della bestia? ** {class = question} ** Apocalisse 14: 9,10 ** {class = bookQ}  
...
!!! Nota ""
	 Dio ci avverte oggi di non seguire il sentiero delle chiese corrotte e cadute. Il messaggio dice di non adorare la bestia e la sua immagine. Possiamo essere sicuri che non stiamo adorando o adorando la bestia? La parola adorazione nella Bibbia è correlata all'adorazione. L'apostolo Paolo ci avverte che l'adorazione consiste nel presentare sacrifici a Dio e ci dice quale sacrificio dobbiamo offrire.
<div class = 'page'> & nbsp; </div>

** 12) Come dovrebbe essere la nostra adorazione o servizio razionale? ** {class = question} ** Romani 12: 1 ** {class = bookQ}  
** Vi prego quindi, fratelli, per la compassione di Dio, di presentare i vostri corpi in un sacrificio vivente, santo e gradito a Dio, che è la vostra adorazione razionale. ** {class = versoQ} ** Romani 12: 1 ** {class = bookVerse}  
...
!!! Nota ""
    Adorare la bestia e la sua immagine è correlato all'accettazione dell'adorazione che le chiese promuovono. Gesù frequentava la casa di culto a Dio il sabato: ** Arrivando a Nazaret, dove fu creato; entrò nella sinagoga di sabato, secondo la sua abitudine, e si alzò per leggere ** {class = verse} ** (Luca 4:16). ** {class = book} Il papato, al contrario, promuove il culto di domenica. Le chiese protestanti di oggi fanno lo stesso. Pertanto, adorare la bestia e la sua immagine è correlato al culto della domenica.

** 13) Qual è il giorno per tenere un servizio di adorazione, secondo la Parola di Dio? ** {class = question} ** Isaia 66:23 ** {class = bookQ}  
** E avverrà che da una luna nuova all'altra, e da un sabato all'altro, tutta la carne verrà ad adorare davanti a me, dice il SIGNORE. ** {class = versoQ} ** Isaia 66:23 ** { class = bookVerse}  
...
** 14) In che modo questo sistema religioso toglierà per qualche tempo l'onore che appartiene solo a Dio? ** {class = question} ** Geremia 10: 6 ** {class = bookQ}  
** Non c'è nessuno come te, o Signore; sei grande, e grande è il potere del tuo nome. ** {class = versoQ} ** Jeremiah 10: 6 ** {class = bookVerse}  

** Spunta la risposta corretta: **  
a) L'onore che appartiene solo a Dio viene rimosso e posto sulla bestia che adora le mode.  
b) Togli l'onore che appartiene solo a Dio e mettiti sulla bestia che adora il calcio.  
c) La Parola di Dio ci mostra che non c'è nessuno come Dio e che dobbiamo adorarlo. Gli adoratori della bestia, dicendo che non c'è nessuno come lui, stanno andando direttamente contro Dio. (Vedi anche: ** Salmo 71:19; Salmi; 86: 8; Salmi 89: 6-8 ** {class = libro})  

** 15) In che modo l'apostolo Paolo si riferisce alla bestia? ** {class = question} ** II Tessalonicesi 2: 3,4 ** {class = bookQ}
** Nessuno, in alcun modo, ti inganna, perché questo non avverrà senza apostasia prima e senza che venga rivelato l'uomo di iniquità, il figlio della perdizione, che si oppone e si ribella contro tutto ciò che è chiamato Dio o oggetto. di culto, al punto di sedersi nel santuario di Dio, vantandosi come se fosse Dio stesso. ** {class = versoQ} ** II Tessalonicesi 2: 3,4 ** {class = bookVerse}  
...
** 16) Cosa beveva Babilonia a tutte le nazioni? ** {class = question} ** Apocalisse 14: 8 ** {class = bookQ}  
** E un altro angelo lo seguì, dicendo: Babilonia cadde, quella grande città, che fece bere a tutte le nazioni il vino dell'ira della loro prostituzione. ** {class = versoQ} ** Apocalisse 14: 8 ** { class = bookVerse}  
...
** 17) Cosa avranno da bere coloro che accettano gli insegnamenti di Babilonia, rendendole così omaggio? ** {class = question} ** Apocalisse.14: 10 ** {class = bookQ}  
** Berrà anche il vino dell'ira di Dio, che giace, senza mescolarsi, nella coppa della sua ira; e sarà tormentato con fuoco e zolfo davanti ai santi angeli e davanti all'Agnello. ** {class = versoQ} ** Apocalisse 14:10 ** {class = bookVerse}  
...
** 18) Sotto quale minaccia è imposto il culto dell'immagine della bestia? ** {class = question} ** Apocalisse 13:15 ** {class = bookQ}  
** E gli fu data l'opportunità di comunicare il respiro all'immagine della bestia, in modo che non solo l'immagine parlasse, ma avrebbe anche indotto tutti quelli che non adoravano l'immagine della bestia. ** {class = versoQ} ** Apocalisse 13:15 ** {class = bookVerse}  
...
** 19) Quale misura universale verrà utilizzata per obbligare tutti a ricevere il segno della bestia? ** {class = question} ** Apocalisse 13: 16,17 ** {class = bookQ}  
** A tutti, piccoli e grandi, ricchi e poveri, liberi e schiavi, assicurati che venga dato loro un certo marchio sulla mano destra o sulla fronte, in modo che nessuno possa comprare o vendere, tranne colui che ha il marchio, il nome della bestia o il numero del suo nome. ** {class = versoQ} ** Apocalisse 13: 16,17 ** {class = bookVerse}  
...
** 20) Quale potere opera effettivamente attraverso la bestia che richiede adorazione? ** {class = question} ** Rivelazione 13: 2 ** {class = bookQ}  
** La bestia che ho visto era simile a un leopardo, con i piedi come un orso e la bocca come un leone. E il drago gli diede il suo potere, il suo trono e una grande autorità. ** {class = versoQ} ** Apocalisse 13: 2 ** {class = bookVerse}  
...
** 21) Chi è il drago? ** {class = question} ** Apocalisse 12: 9 ** {class = bookQ}  
** E il grande drago, l'antico serpente, che è chiamato il diavolo e Satana, il seduttore del mondo intero, fu scacciato, sì, fu gettato sulla terra, e con lui i suoi angeli. ** {class = versoQ } ** Rivelazione 12: 9 ** {class = bookVerse}  
...
** 22) Qual è stata la risposta di Gesù a Satana quando ci provò? ** {class = question} ** Luca 4: 8 ** {class = bookQ}  
** Ma Gesù gli rispose: Sta scritto: Adorerai e adorerai solo il Signore Dio tuo. ** {class = versoQ} ** Luca 4: 8 ** {class = bookVerse}  
...
** 23) Quanti cederanno alle affermazioni del culto sulla bestia? ** {class = question} ** Apocalisse 13: 8 ** {class = bookQ}  
** E tutti gli abitanti della terra l'adoreranno, quelli i cui nomi non erano scritti nel Libro della Vita dell'Agnello che fu ucciso sin dalla fondazione del mondo. ** {class = versoQ} ** Apocalisse 13: 8 ** {class = bookVerse}  

** Spunta la risposta corretta: **  
a) Solo i meno informati.  
b) Tutto cederà alle pretese del culto sulla bestia.  
c) Tutti coloro che non hanno veramente accettato che Gesù avesse i loro nomi scritti nel Libro della Vita, saranno ingannati dalla bestia.  

## Sabato

Per studiare e meditare con la famiglia:

** 24) Chi siamo chiamati ad adorare? ** {class = question} ** Apocalisse 14: 7 ** {class = bookQ}  
** Dicendo ad alta voce: Temi Dio e dagli gloria, poiché l'ora del suo giudizio è venuta; e adorare Colui che ha fatto il cielo e la terra e il mare e le fontane d'acqua. ** {class = versoQ} ** Apocalisse 14: 7 ** {class = bookVerse}  
...
** 25) Chi canterà il canto di Mosè e l'Agnello nel mare di vetro? ** {class = question} ** Apocalisse 15: 2-4 ** {class = bookQ}  
** Vidi come se un mare di vetro, mescolato al fuoco, ei vincitori della bestia, della sua immagine e del numero del suo nome, che stavano nel mare di vetro, con le arpe di Dio; ** {class = versoQ} ** Apocalisse 15: 2-4 ** {class = bookVerse}  
...
!!! citazione Golden Back
    Ecco la perseveranza dei santi, coloro che osservano i comandamenti di Dio e la fede di Gesù. ** Rivelazione 14:12 ** {class = book}
...
** 1) In chi si è manifestato l'amore di Dio per noi? ** {class = question} ** Giovanni 3:16 ** {class = bookQ}  
** Perché Dio ha tanto amato il mondo che ha dato il suo unigenito Figlio, in modo che chiunque crede in lui non muoia, ma abbia la vita eterna. ** {class = versoQ} ** Giovanni 3:16 ** {class = bookVerse}  
...
** 2) Come dovrebbe manifestarsi in noi questo amore? ** {class = question} ** I Giovanni 4: 19,20 ** {class = bookQ}  
** Ci piace perché ci ha amati per primo. Se qualcuno dice: Amo Dio e odio suo fratello, è un bugiardo; perché chi non ama suo fratello, che vede, non può amare Dio, che non vede. ** {class = versoQ} ** I Giovanni 4: 19,20 ** {class = bookVerse}  
...
** 3) Come possiamo ripagare l'amore di Dio? ** {class = question} ** Giovanni 14:15; I Giovanni 2: 4 ** {class = bookQ}  
** Se mi ami, manterrai i miei comandamenti. ** {class = versoQ} ** Giovanni 14:15 ** {class = bookVerse}  
** Chi dice: lo conosco e non osserva i suoi comandamenti è un bugiardo, e la verità non è in lui. ** {class = versoQ} ** I Giovanni 2: 4 ** {class = bookVerse}  
...
** 4) Qual è il comandamento di Dio, secondo Gesù? ** {classes = question} ** Giovanni 12:50 ** {class = bookQ}  
** E so che il tuo comandamento è la vita eterna. Le cose di cui parlo, come mi ha detto il Padre, così parlo. ** {class = versoQ} ** Giovanni 12:50 ** {class = bookVerse}  
...
** 5) Cosa esprime la legge o il comando di Dio? ** {class = question} ** Romani 7:12 ** {class = bookQ}  
** Pertanto, la legge è santa; e il comandamento, santo, giusto e buono. ** {class = versoQ} ** Romani 7:12 ** {class = bookVerse}  
...
Questo lavoro deve ancora fare. Nella vita di Cristo i principi della legge diventano evidenti; e, toccando lo Spirito Santo di Dio nel cuore, rivelando la luce di Cristo agli uomini il bisogno che hanno del Suo sangue purificatore e della Sua giustizia giustificatrice, la legge è ancora uno strumento per portarci a Cristo per essere giustificati per fede . * "La legge del Signore è perfetta e ristora l'anima". *

** 6) Perché dovremmo essere santi e perfetti? ** {class = question} ** Matteo 5:48; Levitico 19: 2 ** {class = bookQ}  
** Pertanto, sii perfetto come è perfetto il tuo Padre celeste. ** {class = versoQ} ** Matteo 5:48 ** {class = bookVerse}  
** Parla a tutta la congregazione dei figli d'Israele e di 'loro:' Sarai santo, perché io, il Signore tuo Dio, sono santo. ** {class = versoQ} ** Levitico 19: 2 ** {class = bookVerse }  
...
** 7) Come saremo perfetti davanti a Dio? ** {class = question} ** Genesi 17: 1; 5: 22-24 ** {class = bookQ}  
** Quando Abram raggiunse l'età di novantanove anni, il Signore gli apparve e gli disse: Io sono l'Iddio Onnipotente; cammina alla mia presenza e sii perfetto. ** {class = versoQ} ** Genesi 17: 1 ** {class = bookVerse}  
** Enoch camminò con Dio ... e non lo era più, perché Dio lo prese per sé. ** {class = versoQ} ** Genesi 5: 22-24 ** {class = bookVerse}  
...
** 8) Per cosa era stata data la legge? ** {class = question} ** Romani 3:20; 7: 7 ** {class = bookQ}  
** Poiché nessuno sarà giustificato davanti a lui con le opere della legge, perché dalla legge viene la piena conoscenza del peccato. ** {class = versoQ} ** Romani 3:20 ** {class = bookVerse}  
** Cosa dovremmo dire allora? La legge è un peccato? Affatto! Ma non avrei conosciuto il peccato, se non attraverso la legge; perché non avrei conosciuto l'avidità se la legge non avesse detto: Non desiderare. ** {class = versoQ} ** Romani 7: 7 ** {class = bookVerse}
...
** 9) Possiamo piacere a Dio vivendo secondo i nostri desideri? ** {class = question} ** Romani 8: 7,8 ** {class = bookQ}  
** Pertanto, l'inclinazione della carne è inimicizia contro Dio, perché non è soggetta alla legge di Dio, né può nemmeno esserlo. Pertanto, coloro che sono nella carne non possono piacere a Dio. ** {class = versoQ} ** Romani 8: 7,8 ** {class = bookVerse}  
...
Poiché la legge, la legge del Signore, è perfetta, qualsiasi cambiamento in essa deve essere malvagio. Coloro che disobbediscono ai comandamenti di Dio e insegnano ad altri a farlo, sono condannati da Cristo.

** 10) Qual è il potere che dobbiamo ottenere per essere obbedienti alla Legge di Dio? ** {class = question} ** Romani 1: 4,5; 3: 26.31 ** {class = bookQ}  
** ... Gesù Cristo, per mezzo del quale siamo venuti a ricevere la grazia e l'apostolato per amore del suo nome, per l'obbedienza per fede, tra tutti i pagani. ** {class = versoQ} ** Romani 1: 4,5 ** {class = bookVerse}  
** In vista della manifestazione della sua giustizia nel tempo presente, per se stesso essere giusto e il giustificatore di colui che ha fede in Gesù. ** {class = versoQ} ** Romani 3:26 ** {class = bookVerse}  
** Annulliamo quindi la legge per fede? No, per niente! Piuttosto, confermiamo la legge. ** {class = versoQ} ** Romani 3:31 ** {class = bookVerse}
...
** 11) Qual è la base per osservare i comandamenti dell'Antico e del Nuovo Testamento? ** {class = question} ** Genesi 15: 6 ** {class = bookQ}  
** Credeva nel Signore, e gli era stato imputato per giustizia. ** {class = versoQ} ** Genesi 15: 6 ** {class = bookVerse}  
...
!!! Nota ""
	 La giustizia di Dio fu imputata (data) ad Abrahamo non a causa di qualsiasi buon lavoro che aveva fatto, ma perché credeva, aveva fede che Dio era in grado di fare ciò che aveva chiesto. La giustizia è osservare i comandamenti di Dio (** Salmo 119: 172 ** {class = book}). Abrahamo divenne obbediente perché credeva, aveva fede in Dio. (Vedi anche: ** Genesi 17: 1,2; Deuteronomio 6: 5, Romani 1:17; 9: 32,33 ** {class = libro})

** 12) Qual è la Nuova Alleanza che Cristo vuole fare con noi? ** {class = question} ** Ebrei 10: 15,16 ** {class = bookQ}  
** E anche lo Spirito Santo rende testimonianza a questo; perché, dopo aver detto: Questa è l'alleanza che farò con loro dopo quei giorni, dice il Signore: Metterò le mie leggi nei loro cuori e le scriverò nelle loro menti. ** {class = versoQ} ** Ebrei 10: 15.16 ** {class = bookVerse}  
...
** 13) Abbiamo ricevuto la legge quando abbiamo ricevuto Cristo? ** {class = question} ** Salmo 40: 7.8 ** {class = bookQ}  
** Allora ho detto: eccomi qui, sul rotolo del libro c'è scritto di me; Amo fare la tua volontà, mio ​​Dio; la tua legge è nel mio cuore. ** {class = versoQ} ** Salmo 40: 7.8 ** {class = bookVerse}  

** Spunta la risposta corretta: **  
a) No, la legge è una cosa e Gesù è un'altra.  
b) Sì, Gesù aveva la Legge nel suo cuore. Lui stesso dice: ** "Ho osservato i comandamenti del Padre mio" ** {class = verse} ** (Giovanni 15:10). ** {class = book} Se permettiamo a Gesù di vivere in noi, porteremo al nostro la sua obbedienza alla vita.  
c) No, perché osserveremo solo la legge di Dio in cielo.  

** 14) Cosa succede quando Cristo vive in noi? ** {class = question} ** Romani 8: 10,14 ** {class = bookQ}  
** Se, tuttavia, Cristo è in te, il corpo è effettivamente morto a causa del peccato, ma lo spirito è vita, a causa della giustizia. "" Poiché tutti coloro che sono guidati dallo Spirito di Dio sono figli di Dio. ** {class = versoQ} ** Romani 8: 10,14 ** {class = bookVerse}  

** Spunta la risposta corretta: **  
a) Se Cristo dimora in noi, siamo semidei.  
...
** 15) Come viene a vivere Cristo in noi? ** {class = question} ** Efesini 3: 16,17; Rivelazione 3:20 ** {class = bookQ}  
** Affinché, secondo la ricchezza della sua gloria, ti conceda di essere rafforzato con potenza, attraverso il suo Spirito nell'uomo interiore; e quindi lascia che Cristo dimori nel tuo cuore per fede, essendo radicato e fondato nell'amore. ** {class = versoQ} ** Efesini 3: 16,17 ** {class = bookVerse}  
** Ecco, io sono alla porta e busso; se qualcuno sente la mia voce e apre la porta, entrerò in casa sua e cenerò con lui, e lui con me. ** {class = versoQ} ** Apocalisse 3:20 ** {class = bookVerse}  
...
** 16) Cos'è la vera fede? ** {class = question} ** Apocalisse 14:12 ** {class = bookQ}  
** Ecco la perseveranza dei santi, coloro che osservano i comandamenti di Dio e la fede di Gesù. ** {class = versoQ} ** Apocalisse 14:12 ** {class = bookVerse}  
...
** 17) Come si manifestò la fede di Gesù? ** {class = question} ** Giovanni 15:10; 6:38 ** {class = bookQ}  
** Se osservi i miei comandamenti, rimarrai nel mio amore; proprio come ho osservato i comandamenti di mio Padre e rimango nel suo amore. ** {class = versoQ} ** Giovanni 15:10 ** {class = bookVerse}  
** Perché sono disceso dal cielo, non per fare la mia volontà, ma la volontà di colui che mi ha mandato. ** {class = versoQ} ** Giovanni 6:38 ** {class = bookVerse}  

** Spunta la risposta corretta: **  
a) La fede di Gesù si manifesta nei doni della guarigione.  
b) La fede di Gesù si manifestò in obbedienza a tutti i comandamenti della Legge di Dio (Matteo 5: 17-18). Gesù non è venuto nel mondo per fare la sua volontà, ma la volontà di Dio. Quando, infatti, possediamo Cristo, lo sarà anche la nostra vita.  
c) La fede di Gesù si manifesta nel dono della profezia.  

## Giovedi

** 18) Cosa disse Gesù di se stesso? ** {class = question} ** Giovanni 6: 57.63 ** {class = bookQ}  
** Proprio come il Padre, che vive, mi ha mandato, e anch'io vivo per il Padre, così chi si nutre di me vivrà. ** {class = versoQ} ** Giovanni 6:57 ** {class = bookVerse}  
** Lo spirito è ciò che accelera; la carne non usa nulla; le parole che ti ho detto sono spirito e sono vita. ** {class = versoQ} ** Giovanni 6:63 ** {class = bookVerse}  

** Spunta la risposta corretta: **  
a) Abbiamo bisogno di nutrire Gesù ogni giorno per vivere per Lui. Studiando le parole di Gesù nella Bibbia, impareremo.  
...
** 19) Per cosa Gesù ci comunica la sua vita? ** {class = question} ** Efesini 2:10 ** {class = bookQ}  
** Perché noi siamo la sua opera, creata in Cristo Gesù per le buone opere, che Dio ha preparato in anticipo per farci entrare. ** {class = versoQ} ** Efesini 2:10 ** {class = bookVerse}  
...
** 20) Cosa ha visto Giovanni in cielo? ** {class = question} ** Apocalisse 11:19 ** {class = bookQ}  
** Quindi il santuario di Dio, che è in cielo, fu aperto e l'Arca dell'Alleanza fu vista nel suo santuario, e si accesero fulmini, voci, tuoni, terremoti e una grande raffica. ** {class = versoQ} ** Rivelazione 11:19 ** {class = bookVerse}  
...
** 21) Cosa c'era dentro l'Arca dell'Alleanza? ** {class = question} ** Esodo 25:21; Deuteronomio 10: 4,5 ** {class = bookQ}  
** Posizionerai il propiziatorio in cima all'arca; e ci metterai la Testimonianza, che ti darò. ** {class = versoQ} ** Esodo 25:21 ** {class = bookVerse}  
** Quindi il Signore scrisse sulle tavole, secondo la prima scrittura, i dieci comandamenti che ti aveva detto il giorno della congregazione, sul monte, in mezzo al fuoco; e il Signore me l'ha dato. Mi voltai e scesi dal monte e misi le assi nell'arca che avevo fatto; ed eccoli lì, come il SIGNORE mi ha comandato. ** {class = versoQ} ** Deuteronomio10: 4,5 ** {class = bookVerse}  
...
** 22) Da chi furono scritti i Dieci Comandamenti? ** {class = question} ** Esodo 31:18; Deuteronomio 4: 13 ** {class = bookQ}  
** E dopo aver finito di parlargli sul monte Sinai, diede a Mosè le due tavole della Testimonianza, tavolette di pietra, scritte dal dito di Dio. ** {class = versoQ} ** Esodo 31:18 ** {class = bookVerse}  
** Poi ti ha annunciato la sua alleanza, che ha prescritto per te, i Dieci Comandamenti, e li ha scritti su due tavole di pietra. ** {class = versoQ} ** Deuteronomio4: 13 ** {class = bookVerse}  
...
** 23) Cosa dice la legge di Dio? ** {class = question} ** Esodo 20: 3-17 ** {class = bookQ}  

3. ** Non avrai altri dei prima di me. ** {class = verse}
4. ** Non farai una scultura per te stesso, né alcuna somiglianza con ciò che è in alto nei cieli, o in basso sulla terra, o nelle acque sotto la terra. ** {class = verse}
5. ** Non inchinarti o servirli; perché io, il Signore tuo Dio, sono un Dio zelante, che visito l'iniquità dei genitori nei loro figli, fino alla terza e quarta generazione di coloro che mi odiano. ** {class = verse}
6. ** E do misericordia a migliaia di coloro che mi amano ea coloro che osservano i miei comandamenti. ** {class = verse}
7. ** Non prendere il nome del Signore tuo Dio invano; perché il Signore non riterrà innocente per prendere il suo nome invano. ** {class = verse}
8. ** Ricorda il giorno di sabato, per santificarlo. ** {class = verse}
9. ** Sei giorni lavorerai e farai tutto il tuo lavoro. ** {class = verse}
10. ** Ma il settimo giorno è il sabato del Signore tuo Dio; non farai alcun lavoro, né tu, né tuo figlio, né tua figlia, né il tuo servo, né il tuo servo, né il tuo animale, né il tuo straniero, che è dentro le tue porte. ** {class = verse}
11. ** Poiché in sei giorni il Signore ha fatto i cieli e la terra, il mare e ogni cosa in essi, e si è riposato il settimo giorno; perciò il Signore ha benedetto il giorno di sabato e lo ha mantenuto santo. ** {class = verse}
12. ** Onora tuo padre e tua madre, in modo che i tuoi giorni possano essere prolungati nella terra che il Signore tuo Dio ti sta dando. ** {class = verse}
13. ** Non ucciderai. ** {class = verse}
14. ** Non commetterai adulterio. ** {class = verse}
15. ** Non ruberai. ** {class = verse}
16. ** Non dirai falsa testimonianza contro il tuo vicino. ** {class = verse}
17. ** Non desiderare la casa del tuo vicino, non desiderare la moglie del tuo vicino, né il suo servo, né la sua serva, né il suo bue, né il suo asino, né nulla del tuo prossimo. ** { class = verse}

** Esodo 20: 3-17 ** {class = book}
...
** 25) Qual è l'atteggiamento di Gesù verso la validità della legge di Dio? ** {class = question} ** Matteo 5: 17,18; 19:17 ** {class = bookQ}  
** Non pensare che io sia venuto per abrogare la Legge o i Profeti; Non sono venuto per revocare, sono venuto per adempiere. In verità, vi dico, finché il cielo e la terra non saranno passati, né una i né una tilde passeranno mai la Legge, finché tutto non sarà adempiuto. ** {class = versoQ} ** Matteo 5: 17,18 ** { class = bookVerse}  
** Gesù gli rispose: Perché mi chiedi cosa è buono? Beh, ce n'è solo uno. Tuttavia, se vuoi entrare nella vita, osserva i comandamenti. ** {class = versoQ} ** Matteo 19:17 ** {class = bookVerse}  
...
** 26) Dio permette cambiamenti nella Sua parola o nei suoi comandamenti? ** {class = question} ** Salmo 89:34 ** {class = bookQ}  
** Non violerò la mia alleanza né cambierò ciò che hanno detto le mie labbra. ** {class = versoQ} ** Salmo 89:34 ** {class = bookVerse}  
...
** 27) Cosa scrisse Paolo sui comandamenti di Dio? ** {class = question} ** Romani 3:31; 7:12 ** {class = bookQ}  
** Rendiamo quindi nulla la legge per fede? No, per niente! Piuttosto, confermiamo la legge. ** {class = versoQ} ** Romani 3:31 ** {class = bookVerse}  
** Pertanto, la legge è santa e il comandamento è santo, giusto e buono. ** {class = versoQ} ** Romani 7:12 ** {class = bookVerse}  
...
** 28) Cosa accadrebbe in futuro, secondo la Bibbia, con la legge di Dio? ** {class = question} ** Daniele 8:12; 7:25 ** {class = bookQ}  
** Gli fu consegnato l'esercito, con il diario, a causa delle trasgressioni; e ha buttato giù la verità; e quello che ha fatto ha avuto successo. ** {class = versoQ} ** Daniel 8:12 ** {class = bookVerse}  
** Dirà parole contro l'Altissimo, ferirà i santi dell'Altissimo e cambierà i tempi e la legge; e i santi ti saranno consegnati, per una volta, due volte e mezza. ** {class = versoQ} ** Daniele 7:25 ** {class = bookVerse}  

** Spunta la risposta corretta: **  
a) La Legge di Dio sarebbe stata rispettata e osservata da tutti.  
b) Sorgerebbe un potere che comporterebbe un audace cambiamento nella Legge di Dio, senza avere l'autorizzazione a farlo.  
c) Dio darebbe il permesso di apportare modifiche alla Sua Legge.  

## Sabato

** 29) Cosa hanno fatto gli uomini con la verità di Dio? ** {class = question} ** Romani 1:25 ** {class = bookQ}  
** Poiché hanno cambiato la verità di Dio in una menzogna, adorando e servendo la creatura invece del Creatore, che è benedetto per sempre. Amen! ** {class = versoQ} ** Romani 1:25 ** {class = bookVerse}  
...
** 30) Cosa seguono molti al posto dei comandamenti di Dio? ** {class = question} ** Marco 7: 6-9 ** {class = bookQ}  
** Egli rispose loro: Isaia ha profetizzato di voi ipocriti, come sta scritto: Queste persone mi onorano con le loro labbra, ma il loro cuore è lontano da me. E invano mi adorano, insegnando dottrine che sono i precetti degli uomini. Trascurando il comandamento di Dio, mantieni la tradizione degli uomini. E disse loro: "Stai giustamente rifiutando il precetto di Dio di mantenere la tua tradizione. ** {class = versoQ} ** Marco 7: 6-9 ** {class = bookVerse}  
...
** 31) Possiamo osservare un comandamento e rifiutarne un altro? ** {class = question} ** Giacomo 2: 10-12 ** {class = bookQ}  
** Per chi osserva l'intera legge, ma inciampa su un punto, diventa colpevole di tutti. Poiché colui che ha detto: "Non commettere adulterio", ha anche detto: "Non uccidere". Ora, se non commetti adulterio, ma uccidi, sarai un trasgressore della legge. Parla in modo e in modo tale da procedere come coloro che devono essere giudicati dalla legge della libertà. ** {class = versoQ} ** Giacomo 2: 10-12 ** {class = bookVerse}  

** Spunta la risposta corretta: **  
a) Non ha senso osservare nove comandamenti e dimenticarne uno. Dio richiede obbedienza completa. La Legge di Dio sarà lo standard di giudizio in cielo.  
...
** 32) Qual è la caratteristica del popolo di Dio al tempo della fine? ** {class = question} ** Rivelazione 14:12 ** {class = bookQ}  
** Ecco la perseveranza dei santi, coloro che osservano i comandamenti di Dio e la fede di Gesù. ** {class = versoQ} ** Apocalisse 14:12 ** {class = bookVerse}  

** Spunta la risposta corretta: **  
a) Dio chiama il suo popolo per dire che Gesù salva.  
b) Dio dice che il suo popolo nel tempo della fine osserverà i suoi comandamenti con il potere di Gesù, perché perseverava nel seguirlo.  
c) Dio non fa alcuna chiamata al suo popolo.  

** 33) Cosa implica il "timore di Dio" di Rivelazione 14: 7? ** {class = question} ** Ecclesiaste 12:13 ** {class = bookQ}  
** Di tutto ciò che è stato ascoltato, la somma è: Temi Dio e osserva i suoi comandamenti; perché questo è il dovere di ogni uomo. ** {class = versoQ} ** Ecclesiaste 12:13 ** {class = bookVerse}  
...
** 34) Cos'è più importante per Dio? ** {class = question} ** Atti 5:29, Tito 1:14 ** {class = bookQ}
** Quindi Pietro e gli altri apostoli dissero: È più importante obbedire a Dio degli uomini. ** {class = versoQ} ** Atti 5:29 ** {class = bookVerse}  
** E non preoccuparti delle favole ebraiche, né dei comandamenti degli uomini deviati dalla verità. ** {class = versoQ} ** Tito 1:14 ** {class = bookVerse}  
...
!!! citazione Golden Back
    Parli dunque ai figli d'Israele, dicendo: Sicuramente osserverete i miei sabati; perché questo è un segno tra te e me nelle vostre generazioni; affinché tu sappia che io sono il Signore, che ti santifica ** Esodo 31:13 ** {class = libro}
...
** 2) Quando Dio ha istituito il settimo giorno di riposo? ** {class = question} ** Genesi 2: 2-4 ** {class = bookQ}  
** E quando Dio terminò il lavoro che aveva fatto il settimo giorno, si riposò il settimo giorno di tutta la sua opera, che aveva fatto. E Dio benedisse il settimo giorno e lo santificò; perché in lui si riposò da tutta la sua opera che Dio aveva creato e compiuto. Queste sono le origini del cielo e della terra, quando furono creati; nel giorno in cui il Signore Dio creò la terra e i cieli. ** {class = versoQ} ** Genesi 2: 2-4 ** {class = bookVerse}  
...
** 4) Perché Dio ha stabilito il sabato? ** {class = question} ** Marco 2: 27,28 ** {class = bookQ}  
** E aggiunse: Il sabato è stato stabilito a causa dell'uomo, e non l'uomo a causa del sabato; quindi il Figlio dell'uomo è il Signore del sabato. ** {class = versoQ} ** Marco 2: 27,28 ** {class = bookVerse}  
...
** 5) Il sabato veniva dato solo agli ebrei? ** {class = question} ** Isaia 56: 6,7 ** {class = bookQ}  
** Agli stranieri che vengono al Signore, per servirlo e per amare il nome del Signore, essendo così suoi servi, sì, tutti coloro che osservano il sabato, non lo profanano e abbracciano la mia alleanza, anch'io li porterò al la mia santa montagna e mi rallegrerò nella mia casa di preghiera ... ** {class = versoQ} ** Isaia 56: 6,7 ** {class = bookVerse}  
...
** 6) Che il sabato era un segno? ** {class = question} ** Ezechiele 20: 12.20 ** {class = bookQ}  
** Ho anche dato loro i miei sabati perché servissero come segno tra me e loro, in modo che sapessero che io sono il Signore che li santifica. ** {class = versoQ} ** Ezechiele 20:12 ** {class = bookVerse}  
** Santifica i miei Sabbath, perché serviranno da segno tra me e te, affinché tu possa sapere che io sono il Signore tuo Dio. ** {class = versoQ} ** Ezechiele 20:20 ** {class = bookVerse}  
...
** 8) Qual era la missione del Messia riguardo alla legge di Dio? ** {class = question} ** Isaia 42:21, Matteo 5:17 ** {class = bookQ}  
** Era il piacere del SIGNORE, per amore della sua giustizia, allargare la legge e renderla gloriosa. ** {class = versoQ} ** Isaia 42:21 ** {class = bookVerse}  
** Non pensare che io sia venuto per abrogare la Legge o i Profeti; Non sono venuto per revocare, sono venuto per adempiere. ** {class = versoQ} ** Matteo 5:17 ** {class = bookVerse}  
...
** 9) Che giorno stava guardando Gesù? ** {class = question} ** Luca 4:16 ** {class = bookQ}  
** Andando a Nazareth, dove è cresciuto, è entrato nella sinagoga di sabato, secondo il suo costume, e si è alzato per leggere. ** {class = versoQ} ** Luca 4:16 ** {class = bookVerse}  
...
** 10) In che giorno osservavano i seguaci di Gesù? ** {class = question} ** Luca 23: 54-56 ** {class = bookQ}  
** Era il giorno della preparazione e iniziò il sabato. Le donne venute dalla Galilea con Gesù, lo seguirono, videro la tomba e come vi era stato deposto il corpo. Poi, si sono ritirati per preparare aromi e balsami. E sabato si sono riposati secondo il comandamento. ** {class = versoQ} ** Luca 23: 54-56 ** {class = bookVerse}  
...
** 11) Cosa guarderà il popolo di Dio alla fine? ** {class = question} ** Rivelazione 14:12 ** {class = bookQ}  
** Ecco la perseveranza dei santi, coloro che osservano i comandamenti di Dio e la fede di Gesù. ** {class = versoQ} ** Apocalisse 14:12 ** {class = bookVerse}  
...
** 12) Cosa dice la Parola di Dio di colui che ignora la legge o solo uno dei comandamenti in essa contenuti? ** {class = domanda} ** Giacomo 2:10; I Giovanni 2: 4 ** {class = bookQ}  
** Per chi osserva l'intera legge, ma inciampa su un punto, diventa colpevole di tutto. ** {class = versoQ} ** Giacomo 2:10 ** {class = bookVerse}  
** Chi dice: lo conosco e non osserva i suoi comandamenti è un bugiardo, e la verità non è in lui. ** {class = versoQ} ** I Giovanni 2: 4 ** {class = bookVerse}  
...
L'opera di riforma del sabato da svolgere in tempi recenti è predetta nella profezia di Isaia: ** "Così dice il Signore: osserva il tuo giudizio e fai giustizia, perché la mia salvezza sta per venire, e la mia giustizia da manifestare. Beato l'uomo che fa questo, e il figlio dell'uomo che ne fa uso; che si trattiene dal profanare il sabato e impedisce alla sua mano di fare qualsiasi male. "** {class = verse} ** Isaia 56: 1,2 ** {class = book}. ** "Ai figli degli stranieri che vengono al Signore per servirlo e per amare il nome del Signore, essendo così suoi servi, tutti coloro che osservano il sabato, non lo profanano, e anche coloro che abbracciano la mia alleanza Ti porterò al Mio monte santo e ti celebrerò nella Mia casa di preghiera. "** {class = verse} ** Isaia 56: 6,7 ** {class = libro}. Queste parole si applicano all'era cristiana, come si vede dal contesto: ** Così dice il Signore Geova, che raduna gli dispersi d'Israele: Ne raccoglierò ancora altri a coloro che si sono già uniti a lui. ** {class = verse} ** (Isaia 56: 8). ** { class = book} Ecco la prefigurazione del raduno dei Gentili tramite il Vangelo. E su coloro che poi onorano il sabato, viene pronunciata una benedizione.

Dimostrando così che il dovere relativo al quarto comandamento si estende attraverso la crocifissione, la risurrezione e l'ascensione di Cristo, fino al tempo in cui i Suoi servitori dovevano predicare il messaggio della lieta notizia a tutte le nazioni.

** 13) Qual è l'ordine dato da Dio in Isaia al Suo popolo? ** {class = question} ** Isaia.58: 1 ** {class = bookQ}  
** Grida ad alta voce, non fermarti, alza la voce come una tromba e annuncia la tua trasgressione al mio popolo e i tuoi peccati alla casa di Giacobbe. ** {class = versoQ} ** Isaia 58: 1 * * {class = bookVerse}  
...
!!! Nota ""
	 Dio manda un rimprovero al suo popolo e non ai malvagi, perché nonostante la loro disobbedienza continuano a: ** "Tuttavia, mi cercano ogni giorno, si divertono a conoscere le mie vie, come un popolo che fa giustizia, e non lo fa lascia l'ordinanza del Suo Dio. "** {class = verse} ** Isaia 58: 2 ** {class = libro}

** 14) Leggi attentamente il testo di seguito. ** {class = question}

** E quelli che procedono da te costruiranno le antiche rovine; e solleverai le fondamenta di generazione in generazione; e ti chiameranno riparatore di rotture e restauratore di sentieri da vivere. Se distogli il piede dal sabato, dal fare la tua volontà nel mio santo giorno, e chiami il sabato delizioso e il santo giorno del Signore, degno di onore, e onoralo non seguendo le tue vie, né con l'intenzione di crearne una tua. non pronuncerai le tue parole, allora ti delizerai nell'Eterno, e ti farò cavalcare sulle alture della terra, e ti sosterrò con l'eredità di tuo padre Giacobbe; perché la bocca del SIGNORE l'ha detto ** {class = versoQ} ** Isaia 58: 12-14 ** {class = bookVerse}  
...
** 15) Cosa ha fatto Dio il settimo giorno? ** {class = question} ** Genesi 2: 3 ** {class = bookQ}  
** E Dio benedisse il settimo giorno e lo santificò; perché in lui si riposava da tutto il lavoro che, come Creatore, aveva fatto. ** {class = versoQ} ** Genesi 2: 3 ** {class = bookVerse}  
...
** 16) Quando inizia il sabato? ** {class = question} ** Levitico 23:32 ** {class = bookQ}  
** Sabato di solenne riposo sarà tuo; allora affliggerai la tua anima; alle nove del mese, da un pomeriggio all'altro, celebrerai il tuo sabato. ** {class = versoQ} ** Levitico 23:32 ** {class = bookVerse}  
...
** 17) Cosa significa "tardi" nella Bibbia? ** {class = question} ** Deuteronomio 16: 6 ** {class = bookQ}  
** Se non nel luogo in cui il Signore tuo Dio sceglie per far abitare il suo nome, lì sacrificherai la Pasqua nel pomeriggio, al tramonto, nel momento in cui hai lasciato l'Egitto. ** {class = versoQ} * * Deuteronomio 16: 6 ** {class = bookVerse}  
...
** 18) Qual è il giorno speciale di preparazione per la domenica? ** {class = question} ** Marco 15:42 ** {class = bookQ}  
** Al tramonto, dato che è il giorno della preparazione, cioè la vigilia del sabato. ** {class = versoQ} ** Marco 15:42 ** {class = bookVerse}  
...
** 20) In quale giorno Gesù e le donne che stavano per seppellirlo ripresero le loro attività? ** {class = question} ** Marco 16: 1-6 ** {class = bookQ}  
** Dopo sabato, Maria Madalena, Maria, la madre di Tiago e Salomé, hanno acquistato degli aromi per andare a imbalsamarlo. E, molto presto, il primo giorno della settimana, quando il sole sorse, andarono alla tomba. ** {class = versoQ} ** Marco 16: 1-6 ** {class = bookVerse}  
...
** 21) Va bene trattare qualsiasi tipo di commercio nel giorno del Signore? ** {class = question} ** Neemia 13: 16,17 ** {class = bookQ}  
** Anche i Tiri vivevano a Gerusalemme che portavano pesce e ogni sorta di merci, che il sabato vendevano ai figli di Giuda ea Gerusalemme. Ho litigato con i nobili di Giuda e ho detto loro: cos'è questo male che fai, profanando il giorno del sabato? ** {class = versoQ} ** Neemia 13: 16,17 ** {class = bookVerse}
...
!!! Nota ""
	 Il commercio del sabato, anche del cibo, è condannato dalla Parola di Dio. Se lo shopping è necessario, dovremmo farlo entro venerdì. Fare acquisti o fare qualsiasi tipo di commercio di sabato significa dissacrarlo. (Vedi anche: ** Geremia 17: 24-27 ** {class = book})

** 22) Cosa dovremmo avere di sabato? ** {class = question} ** Levitico 23: 3 ** {class = bookQ}  
** Sei giorni lavorerai, ma il settimo sarà il sabato di riposo solenne, santa convocazione; non lavorerai; è il sabato del SIGNORE in tutte le tue dimore. ** {class = versoQ} ** Levitico 23: 3 ** {class = bookVerse}  

** Spunta la risposta corretta: **  
a) Adorazione e adorazione di Dio.  
b) Lavori ordinari come tutti i giorni.  
c) Acquisti sul mercato, riparazioni abbigliamento, coltivazione di orti e giardini.  
...
** 23) In che giorno Gesù andò in chiesa (sinagoga)? ** {class = question} ** Luca 4: 16,31 ** {class = bookQ}  
** Andato a Nazaré, dove era cresciuto, un sabato entrò nella sinagoga, secondo il suo costume, e si alzò per leggere. E andò a Cafarnao, una città della Galilea, e insegnò loro il sabato. ** {class = versoQ} ** Luca 4: 16,31 ** {class = bookVerse}
...
!!! Nota ""
	 Gesù si riuniva con il popolo di Dio di sabato. Fu quel giorno in un modo speciale che insegnò la parola ** Luca 4: 17-21 ** {classe = libro}.

** 24) Qual era l'altro tipo di attività che Gesù compiva di sabato e che dovremmo svolgere anche noi? ** {class = question} ** Giovanni 9:14 ** {class = bookQ}  
** Ed era sabato quando Gesù creò il fango e aprì gli occhi. ** {class = versoQ} ** Giovanni 9:14 ** {class = bookVerse}  
...
c) Gesù discusse con i dirigenti della chiesa i suoi errori dottrinali.  

** 25) Che tipo di lavoro dovremmo fare sabato? ** {class = question} ** Matteo 12:12 ** {class = bookQ}  
** Ora, quanto è meglio un uomo di una pecora? Pertanto, è lecito, il sabato, fare del bene. ** {class = versoQ} ** Matteo 12:12 ** {class = bookVerse}
...
** 26) In che giorno è Gesù Signore? ** {class = question} ** Matteo 12: 8 ** {class = bookQ}  
** Perché il Figlio dell'uomo è il signore del sabato ** {class = versoQ} ** Matteo 12: 8 ** {class = bookVerse}  
...
** 27) Cosa facevano gli apostoli in giorno di sabato? ** {class = question}

** Contrassegna le dichiarazioni con V se vere e F se false **  
a) () Predicavano la parola - ** Il sabato successivo, quasi tutta la città venne ad ascoltare la parola di Dio. ** {class = versoQ} ** Atti 13: 14-15,27,42,44 ** { class = book}  
b) () Hanno cercato di essere in mezzo alla natura - ** Sabato, abbiamo lasciato la città vicino al fiume, dove sembrava esserci un luogo di preghiera ... ** {class = versoQ} ** Atti 16:13 ** {class = book}  
c) () Si sono presi del tempo per pregare e predicare - ** Sabato, abbiamo lasciato la città lungo il fiume, dove sembrava esserci un luogo di preghiera ... ** {class = versoQ} ** Atti 16:13 ** {class = book}  
d) () Hanno comprato e venduto.  

** 28) Come dovrebbe essere santificato il sabato? ** {class = question} ** Isaia 58:13 ** {class = bookQ}  
** Se distogli il piede dal dissacrare il sabato e dal prenderti cura dei tuoi interessi nel mio santo giorno; se chiami il sabato un giorno delizioso e santo del Signore, degno di onore, e onoralo non seguendo le tue vie, non intendendo fare la tua volontà o pronunciando parole vane. ** {class = versoQ} ** Isaia 58:13 ** {class = bookVerse}  

** Contrassegna le dichiarazioni con V se vere e F se false **  
a) () Sottomettere la nostra volontà a Dio in questo giorno.  
b) () Il giorno del riposo è stato messo da parte da Dio per prendersi cura degli interessi del cielo, a beneficio della sua causa.  
...
!!! Nota ""
	 La domenica dobbiamo disconnetterci dalle nostre attività secolari per dedicarci esclusivamente a Dio. Chi è fedele non sarà disoccupato, perché il comando di Dio dice * "sei giorni lavorerai" *, cioè avremo lavoro per i sei giorni se decidiamo di essere fedeli al sabato.

** 30) Per quanto tempo sarà osservato il sabato? ** {class = question} ** Isaia 66: 22,23 ** {class = bookQ}  
** Poiché come i nuovi cieli e la nuova terra, che io farò, saranno dinanzi a me, dice il Signore, così saranno la tua posterità e il tuo nome. E avverrà che, da un New Moon Party a un altro e da sabato a sabato, tutta la carne verrà ad adorare davanti a me, dice il Signore. ** {class = versoQ} ** Isaia 66: 22,23 ** { class = bookVerse}  
...
!!! citazione Golden Back
    Se qualcuno adora la bestia e la sua immagine e riceve il suo marchio sulla fronte o sulla mano, anche lui berrà il vino dell'ira di Dio, preparato, senza mescolarsi, dalla coppa della sua ira. ** Apocalisse 14: 9,10 ** {class = book}

## Domenica


** 1) Cosa presenta la Bibbia come obiettivo di un segno o di un sigillo? ** {class = question} ** Daniele 6: 8 ** {class = bookQ}  
** Ora dunque, o re, conferma il divieto e firma l'editto, affinché non venga modificato, secondo la legge dei Medi e dei Persiani, che non può essere revocata. ** {class = versoQ} ** Daniele 6 : 8 ** {class = bookVerse}  
...
!!! Nota ""
	 Quando un decreto è stato firmato dal re, ha avuto autorità ed è entrato in vigore. Era consuetudine, in passato, che i re indossassero un anello per questo scopo, che conteneva il loro nome, le iniziali o il monogramma. La moglie di Achab Jezebel ** "scrisse lettere in nome di Achab e le sigillò con il suo sigillo" ** {class = verse} (** 1 Re 21: 8 ** {class = book}). Si dice del decreto promulgato da Assuero, per l'uccisione di tutti gli ebrei dell'impero persiano, che ** "fu scritto il nome del re Assuero, e con l'anello del re fu sigillato" ** {class = verse} ** Ester 3:12 ** {class = book}
...
** 2) A cosa è collegato il sigillo di Dio? ** {class = question} ** Isaia. 8:16 ** {class = bookQ}  
** Accendi la testimonianza, suggella la legge tra i miei discepoli. ** {class = versoQ} ** Isaia 8:16 ** {class = bookVerse}  
...
** 3) Il primo comandamento mostra chi è l'autore della legge? ** {class = question} ** Esodo 20: 3 ** {class = bookQ}  
** Non avrai altri dei prima di me. ** {class = versoQ} ** Esodo 20: 3 ** {class = bookVerse}  
...
** 4) Indica il secondo, terzo, quinto, sesto, settimo, ottavo, nono o decimo comandamento, chi è l'autore del Decalogo? ** {class = question} ** Esodo 20: 4 ; 7.22 ** {class = bookQ}  
** Non farai una scultura per te stesso, né alcuna somiglianza con ciò che è in alto nei cieli, né in basso sulla terra, né nelle acque sotto la terra. Non ti inchinerai davanti a loro e non li servirai; poiché io, l'Eterno, il tuo Dio, sono un Dio zelante, che visito l'iniquità dei genitori nei loro figli, anche la terza e la quarta generazione di coloro che mi odiano. E do misericordia a migliaia di coloro che mi amano ea coloro che osservano i miei comandamenti. Non prendere il nome del Signore tuo Dio invano; perché il SIGNORE non manterrà il suo nome invano innocente. ** {class = versoQ} ** Esodo 20: 4-7 ** {class = bookVerse}  
** E il SIGNORE disse a Mosè: Così dirai ai figli d'Israele: Avete visto che vi ho parlato dal cielo ** {class = versoQ} ** Esodo 20:22 ** {class = bookVerse}  

** Barrare la risposta corretta: ** () Sì () No

!!! Nota ""
	 Nessuno dei comandamenti rilevati indica l'autore del Decalogo. Il secondo vieta l'adorazione delle immagini, o addirittura la loro realizzazione, ma non rivela in se stesso chi è il vero Dio. Il terzo dice di non prendere invano il nome del Signore Dio tuo, ma come il precedente non dice chi sia veramente questo Signore. L'adoratore del sole potrebbe affermare di aver osservato questo comandamento, poiché non ha menzionato a quale dio si riferisce. Lo stesso accade con gli altri precetti menzionati. Negli ultimi cinque comandamenti, nemmeno il nome di Dio è menzionato.

## Lunedi

** 5) Qual è l'unico comandamento del Decalogo che rivela il nome, l'autorità e il dominio dell'Autore di questa legge? ** {class = question} ** Esodo 20: 8-11 ** {class = bookQ}  
** Ricorda il giorno del sabato, per mantenerlo santo. Sei giorni lavorerai e farai tutto il tuo lavoro. Ma il settimo giorno è il sabato dell'Eterno, del tuo Dio; non farai alcun lavoro, né tu, né tuo figlio, né tua figlia, né il tuo servo, né il tuo servo, né il tuo animale, né il tuo forestiero che è dentro le tue porte. Poiché in sei giorni l'Eterno ha fatto i cieli e la terra, il mare e ogni cosa in essi, e si è riposato il settimo giorno; perciò il Signore ha benedetto il giorno del sabato e lo ha mantenuto santo. ** {class = versoQ} ** Esodo 20: 8-11 ** {class = bookVerse}  
...
** 6) La Bibbia dice che il sabato è un segno eterno tra Dio e il suo popolo, perché? ** {class = question} ** Esodo 31:17 ** {class = bookQ}  
** Tra me ei figli d'Israele sarà un segno per sempre; poiché in sei giorni il SIGNORE creò il cielo e la terra, e il settimo giorno si riposò e fu restaurato. ** {class = versoQ} ** Esodo 31:17 ** {class = bookVerse}  
...
** 7) Il sabato è un segno ... ** {class = question} ** Ezechiele 20:20; Esodo 31:13. ** {class = bookQ}  
** Parli dunque ai figli d'Israele, dicendo: Sicuramente osserverai i miei sabati; perché questo è un segno tra me e te nelle vostre generazioni; affinché tu possa sapere che io sono il Signore, che ti santifica. ** {class = versoQ} ** Esodo 31:13 ** {class = bookVerse}  
** E osserva i miei sabati santi, e saranno un segno tra me e te, così che tu possa sapere che io sono il Signore tuo Dio. ** {class = versoQ} ** Ezechiele 20:20 ** {class = bookVerse}  
...
!!! Nota ""
	 La creazione o redenzione manifesta il potere creativo di Dio. La redenzione è creazione o ricreazione, creazione di nuovo. Occorre la stessa forza per redimere che per creare. "Siamo stati creati in Cristo Gesù per le buone opere". ** Efesini 2:10. ** {class = book}
...
** 9) L'apostolo Giovanni vide questi servitori che in seguito furono suggellati con l'Agnello. Cosa avevano sulla fronte? ** {class = question} ** Apocalisse 14: 1 ** {class = bookQ}  
** E guardai, ed ecco, l'Agnello era sul monte Sion, e con lui centoquarantaquattromila, che avevano scritto il nome del Padre loro sulla fronte. ** {class = versoQ} ** Apocalisse 14: 1 ** {class = bookVerse}  
...
** 11) Come viene descritta la chiesa del Residuo? ** {class = question} ** Apocalisse 14:12 ** {class = bookQ}  
** Ecco la pazienza dei santi; ecco coloro che osservano i comandamenti di Dio e la fede in Gesù. ** {class = versoQ} ** Apocalisse 14:12 ** {class = bookVerse}  
...
** 12) Quali sono le tre cose in cui l'angelo di Apocalisse 14 avverte gli uomini? ** {class = question} ** Apocalisse 14: 9 ** {class = bookQ}  
** E il terzo angelo li seguì, dicendo ad alta voce: Se qualcuno adora la bestia e la sua immagine e riceve il marchio sulla fronte o nella mano. ** {class = versoQ} ** Apocalisse 14 : 9 ** {class = bookVerse}  
...
** 13) Quali sono le caratteristiche speciali di coloro che sono presentati nel messaggio del Terzo Angelo in contrasto con gli adoratori della bestia e della sua immagine? ** {class = question} ** Apocalisse 14:12 ** {class = bookQ}  
** Ecco la pazienza dei santi; ecco coloro che osservano i comandamenti di Dio e la fede in Gesù. ** {class = versoQ} ** Apocalisse 14:12 ** {class = bookVerse}  
...
** 14) Quale audace cambiamento descrive il profeta Daniele che sarebbe stato fatto dalla bestia nella Legge di Dio? ** {class = question} ** Daniele 7:25 ** {class = bookQ}  
** Dirà parole contro l'Altissimo, ferirà i santi dell'Altissimo e cambierà i tempi e la legge; e i santi ti saranno consegnati, per una volta, due volte e mezza. ** {class = versoQ} ** Daniele 7:25 ** {class = bookVerse}  
...
!!! Nota ""
	 La Parola di Dio ci rivela che il potere papale cambierà la Legge di Dio e il combattimento finale coinvolgerà coloro che non accettano il cambiamento e decideranno di essere fedeli a Dio contro coloro che accettano il cambiamento e lo vogliono imporre.
...
| 5 ° Non uccidere | 5 ° Rispetto se tuo padre e tua madre |
...
!!! Nota ""
	 Il secondo comandamento della Legge di Dio che parla dell'adorazione delle immagini, il papato lo ha tolto affermando che è già incluso nel primo, e il quarto comandamento è stato cambiato da * "Sabato" * a * "Domenica" *. Notate che Daniele aveva detto che sarebbe stato fatto un coraggioso cambiamento nella Legge di Dio. Il comandamento cambiato era quello che ordina di osservare il sabato come giorno di riposo.

## Giovedi

** 15) Cosa non hanno gli adoratori della bestia e la sua immagine? ** {class = question} ** Rivelazione 14:11 ** {class = bookQ}  
** Il fumo del loro tormento sale attraverso i secoli e non c'è riposo, né giorno né notte, per gli adoratori della bestia e della sua immagine e per chiunque riceva il marchio del suo nome. ** {class = versoQ} ** Rivelazione 14:11 ** {class = bookVerse}  
...
** 16) Qual è il resto che gli adoratori della bestia e della sua immagine non hanno? ** {class = question} ** Ebrei 4: 4,10; Esodo 20: 8-10 ** {class = bookQ}  
** Perché, in un certo luogo, lo disse, riguardo al settimo giorno: E Dio si riposò, il settimo giorno, da tutte le opere che aveva fatto. ** {class = versoQ} ** Ebrei 4: 4 ** {class = bookVerse}  
** Perché colui che è entrato nel resto di Dio, si è anche riposato dalle sue opere, come Dio dalle sue. ** {class = versoQ} ** Ebrei 4:10 ** {class = bookVerse}  
** Ricorda il giorno del sabato, per mantenerlo santo. Sei giorni lavorerai e farai tutto il tuo lavoro. Ma il settimo giorno è il sabato del Signore tuo Dio; non farai alcun lavoro, né tu, né tuo figlio, né tua figlia, né il tuo servo, né il tuo servo, né il tuo animale, né lo straniero delle tue porte all'interno; ** {class = versoQ} * * Esodo 20: 8-10 ** {class = bookVerse}  
...
** 17) Che cosa dice la bestia è il suo segno di autorità? ** {class = question}
...
Il papato considera il suo cambiamento del sabato dal quarto comandamento come il suo segno di autorità ** (Esodo 20: 8) ** {class = libro} alla domenica. Una legge sull'osservanza della domenica sarà imposta negli Stati Uniti d'America e più tardi nel mondo ** (Apocalisse 13: 11-17), ** {class = book} e tutti saranno tenuti a osservare la domenica come segno dell'autorità del Papa .

** 18) Se il segno della bestia è l'orologio della domenica, quale sarebbe il segno di Dio? ** {class = question} ** Ezechiele 20: 12,20 ** {class = bookQ}  
** Ho anche dato loro i miei sabati, come segno tra me e loro, in modo che sapessero che io sono il Signore che li santifica ** {class = versoQ} ** Ezechiele 20:12 ** {class = bookVerse}  
** Santifica i miei sabati, perché saranno un segno in mezzo a me in te, così che tu possa sapere che io sono il Signore tuo Dio. ** {class = versoQ} ** Ezechiele 20:20 ** {class = bookVerse}  
...
!!! Nota ""
	 Il sabato è stato dato dalla creazione del mondo per l'uomo (vedere ** Genesi 2: 1-3 ** {class = libro}), è stato osservato da Abrahamo (** Genesi. 26: 5 ** {classe = libro }), ed è stato dato come un patto perpetuo (per sempre) tra Dio e il Suo popolo (** Esodo 31: 16-17 ** {class = libro}).

** 19) Contro cosa mette in guardia gli uomini l'angelo di Apocalisse 14? ** {class = question} ** Apocalisse 14: 9 ** {class = bookQ}  
** E il terzo angelo li seguì, dicendo ad alta voce: Se qualcuno adora la bestia e la sua immagine e riceve il marchio sulla fronte o nella mano ** {class = versoQ} ** Apocalisse 14: 9 ** {class = bookVerse}  
...
** 20) Quale potere dovrebbe imporre questo marchio? ** {class = question} ** Apocalisse 13: 11,16 ** {class = bookQ}  
** E vidi un'altra bestia sorgere dalla terra, e aveva due corna simili a quelle di un agnello; e parlava come il drago. ** {class = versoQ} ** Apocalisse 13:11 ** {class = bookVerse}  
** E fare in modo che tutti, piccoli e grandi, ricchi e poveri, liberi e servi, abbiano un segno sulla mano destra o sulla fronte ** {class = versoQ} ** Apocalisse 13:16 ** { class = bookVerse}  
...
!!! Nota ""
	 Questo animale a due corna rappresenta: gli Stati Uniti d'America. Ripudiando quella nazione i principi della libertà civile e religiosa da imporre in risposta alle richieste delle chiese protestanti ed evangeliche, la guardia del primo giorno della settimana, la domenica. Diventerà una potenza persecutoria, o una bestia e altre nazioni seguiranno il suo esempio, opprimendo coloro che rifiutano di lasciare la loro fedeltà a Dio.

** 21) Quale sarà l'atteggiamento del drago verso il popolo di Dio, il popolo rimanente, che osserva i comandamenti di Dio e ha la testimonianza di Gesù? ** {class = domanda} ** Apocalisse 12:17 ** { class = bookQ}  
** E il dragone si adirò con la donna e andò a fare guerra con il rimanente del suo seme, coloro che osservano i comandamenti di Dio e hanno la testimonianza di Gesù Cristo. ** {class = versoQ} ** Apocalisse 12: 17 ** {class = bookVerse}  
...
** 22) Come verranno imposti questo falso culto e marchio? ** {class = question} ** Apocalisse 13: 15-17 ** {class = bookQ}  
** E gli fu concesso di dare spirito all'immagine della bestia, in modo che anche l'immagine della bestia parlasse e facesse uccidere tutti coloro che non adoravano l'immagine della bestia. E assicurati che tutti, piccoli e grandi, ricchi e poveri, liberi e servi, abbiano un segno sulla mano destra, o sulla fronte, in modo che nessuno possa comprare o vendere, tranne quello con il segno, o il il nome della bestia, o il numero del suo nome. ** {class = versoQ} ** Apocalisse 13: 15-17 ** {class = bookVerse}  
...
** 23) Su cosa ottiene finalmente la vittoria il popolo di Dio? ** {class = question} ** Rivelazione 15: 2 ** {class = bookQ}  
** E ne ho visto uno come un mare di vetro misto a fuoco; e quelli che uscirono vittoriosi dalla bestia, e dalla sua immagine, dal suo segno e dal numero del suo nome, che erano presso il mare di vetro e avevano le arpe di Dio. ** {class = versoQ} ** Rivelazione 15: 2 ** {class = bookVerse}  
...
** 24) Coloro che hanno il segno di Dio saranno colpiti dalle ultime piaghe? ** {class = question} ** Ezechiele 9: 6; Apocalisse 9: 4 ** {class = bookQ}  
** Uccidere anziani, giovani uomini e vergini, bambini e donne, finché non saranno sterminati; ma non avvicinarti a nessun uomo che abbia il segno; inizia dal mio Santuario. ** {class = versoQ} ** Ezechiele 9: 6 ** {class = bookVerse}  
** E fu detto loro di non danneggiare l'erba della terra, né nulla di verde, né alcun albero, e solo agli uomini che non avevano il segno di Dio sulla fronte. ** {class = versoQ} ** Rivelazione 9: 4 ** {class = bookVerse}  

** Spunta la risposta corretta: **  
a) Sì b) No c) Non lo so.  

!!! Nota ""
	 Su coloro che sono fedeli al Signore e al santo Sabato del Signore riposa la promessa data in ** Salmo 91:10 ** {class = book} - ** "nessuna piaga verrà alla tua tenda". ** {class = verse}
...
!!! citazione Golden Back
    Sappi che chi converte il peccatore nel modo sbagliato salverà la sua anima dalla morte e coprirà una moltitudine di peccati. ** Giacomo 5:20 ** {class = book}

## Domenica

Spesso ci chiediamo cosa succede dopo la morte. Vediamo molte teorie dette e predicate, e spesso sembra difficile discernere tra ciò che è vero e ciò che è falso. La nostra sicurezza è cercare quella verità nella Bibbia: la Parola di Dio. Questo argomento sulla morte è poco studiato nell'ambiente cristiano, tuttavia, bisogna capirlo a fondo, perché all'interno di questo tema troviamo la prima menzogna predicata da Satana su questa Terra, e su questo tema il nemico delle anime concentra uno dei suoi ultimi errori nei giorni prima che Gesù venisse su questa terra per cercare i suoi.
...
** 1) In che modo Dio ha creato l'uomo? ** {class = question} ** Genesi 2: 7 ** {class = bookQ}  
** Quindi il Signore Dio formò l'uomo dalla polvere della terra e gli soffiò nelle narici il respiro della vita, e l'uomo divenne un'anima vivente. ** {class = versoQ} ** Genesi 2: 7 ** {class = bookVerse}  
...
!!! Nota ""
	 Si noti che il testo non dice che l'uomo * "HA" * un'anima, ma che "È" un'anima vivente. Un'anima è formata dall'unione del corpo (polvere della terra) con il respiro della vita. Guarda com'è l'equazione che forma l'anima: `POLVERE DELLA TERRA (CORPO) + FOLEGO DE VIDA = ANIMA VIVENTE`

Quindi, dire che abbiamo un'anima è sbagliato, poiché siamo un'anima finché il soffio di Dio rimane in noi.

** 2) Dio ha fatto sì che l'uomo morisse o vivesse per sempre? ** {class = question} ** Genesi 2: 16,17 ** {class = bookQ}  
** E il Signore Dio gli diede questo comando: Mangerai liberamente di ogni albero del giardino, ma non mangerai dell'albero della conoscenza del bene e del male; perché il giorno in cui ne mangerai, morirai sicuramente. ** {class = versoQ} ** Genesi 2: 16,17 ** {class = bookVerse}  
...
** 3) Quale menzogna introdusse Satana, il seduttore del mondo? ** {class = question} ** Genesi 3: 4; Rivelazione 12: 9 ** {class = bookQ}  
** Allora il serpente disse alla donna: Certamente non morirai. ** {class = versoQ} ** Genesi 3: 4 ** {class = bookVerse}  
** E il grande drago, l'antico serpente, che è chiamato il diavolo e Satana, il seduttore del mondo intero, fu scacciato, sì, fu gettato sulla terra, e con lui i suoi angeli. ** {class = versoQ } ** Rivelazione 12: 9 ** {class = bookVerse}  

** Spunta la risposta corretta: **  
a) Il serpente ha detto alla donna che sarebbe sempre stata bella.  
b) Il serpente disse alla donna che se le avesse disobbedito non sarebbe morta.  
c) Il serpente non ha detto nulla alla donna perché il serpente non parla.  

!!! Nota ""
	 Se Eva avesse evitato di discutere con il tentatore, sarebbe stata al sicuro; ma si azzardò a parlargli e cadde vittima dei suoi errori. Ecco quanti sono ancora sconfitti. Dubitano e discutono sui precetti di Dio; e, invece di obbedire ai comandi divini, accettano teorie umane, che nascondono solo le trappole di Satana. Il primo sermone predicato da Satana (il serpente) era che l'uomo sarebbe stato immortale anche nella disobbedienza. Fin dall'inizio vuole condurci a credere nell'immortalità in una vita di peccato.

** 4) Cosa ha perso Adamo quando peccò? ** {class = question} ** Romani 5:12 ** {class = bookQ}  
** Pertanto, proprio come il peccato è entrato nel mondo tramite il peccato e la morte tramite il peccato, così la morte è passata a tutti gli uomini, perché tutti hanno peccato. ** {class = versoQ} ** Romani 5:12 ** {class = bookVerse}  
...
** 5) Cosa afferma la Parola di Dio di essere il salario del peccato? ** {class = question} ** Romani 6:23 ** {class = bookQ}  
** Perché il salario del peccato è la morte, ma il dono gratuito di Dio è la vita eterna, per mezzo di Cristo Gesù nostro Signore. ** {class = versoQ} ** Romani 6:23 ** {class = bookVerse}  
...
La parola * "spirito" * di ** Ecclesiaste 12: 7 ** {class = libro} nella lingua originale della Bibbia è * "ruash" *, che significa * "soffio di vita" *, respiro, aria. Quando Dio ci toglie il respiro (ci toglie il respiro), quel respiro che ci aveva restituito a Lui, mentre il corpo che emergeva dalla polvere, ritorna alla polvere.

** 6) Cosa succede alla persona (anima vivente) quando muore? ** {class = question} ** Genesi 3:19; Ecclesiaste 12: 7; Salmo 104: 29 ** {class = bookQ}  
** Con il sudore della tua faccia mangerai il tuo pane, finché non tornerai alla terra, perché ne eri formato; perché sei polvere e in polvere tornerai. ** {class = versoQ} ** Genesi 3:19 ** {class = bookVerse}  
** E la polvere ritorna alla terra, per così dire, e lo spirito ritorna a Dio, che l'ha data. ** {class = versoQ} ** Ecclesiaste 12: 7 ** {class = bookVerse}  
** Se nascondi la tua faccia, sono disturbati; se tolgono il fiato, muoiono e tornano alla loro polvere. ** {class = versoQ} ** Salmo 104: 29 ** {class = bookVerse}  
...
** 7) Dove va la persona (anima vivente) dopo la morte? ** {class = question} ** Ecclesiaste 9:10; Lavoro 7: 9,10 ** {class = bookQ}  
** Tutto ciò che ti viene in mente di fare, fallo secondo le tue forze, perché nella tomba, dove stai andando, non c'è lavoro, nessun progetto, nessuna conoscenza, nessuna saggezza. ** {class = versoQ} * * Ecclesiaste 9:10 ** {class = bookVerse}  
** Mentre la nuvola si schiarisce e se ne va, chi discende nella tomba non risorgerà mai più. Non tornerà mai a casa sua, né il luogo in cui vive lo conoscerà mai. ** {class = versoQ} ** Giobbe 7: 9,10 ** {class = bookVerse}  
...
Ma come comprese Adamo dopo il suo peccato, il significato delle parole: * "Il giorno in cui ne mangerai, sicuramente morirai"? * Pensavi che significassero, come Satana lo aveva indotto a credere, che avrebbe dovuto essere portato in una condizione superiore? dell'esistenza? In tal caso, ci sarebbe, infatti, un grande bene da guadagnare con la trasgressione, e Satana si sarebbe dimostrato un benefattore della razza. Ma Adamo non pensava che questo fosse il significato della sentenza divina. Dio dichiarò che, come punizione per il suo peccato, l'uomo sarebbe tornato sulla terra da cui era stato tratto: ** "Tu sei polvere, e in polvere diventerai" ** {class = verse} ** (Genesi 3:19). ** { class = book} Le parole di Satana: * "... i tuoi occhi saranno aperti", * {class = verse} erano vere solo in questo senso: dopo che Adamo ed Eva disubbidirono a Dio, i loro occhi furono aperti per discernere la sua follia;

L'immortalità, promessa all'uomo a condizione di obbedienza, fu persa per trasgressione ... L'unico che promise ad Adamo la vita in disobbedienza fu il grande ingannatore. E la dichiarazione del serpente a Eva, in Eden - ** "Non morirai certamente" ** {class = verse} - fu il primo sermone predicato sull'immortalità dell'anima. Tuttavia, questa dichiarazione, che si basa solo sull'autorità di Satana, riecheggia dai pulpiti della cristianità e viene ricevuta dalla maggior parte dell'umanità con la stessa facilità con cui lo fu dai nostri primi genitori.

** 8) Gli uomini (anime viventi) sono immortali? ** {class = question} ** Ezechiele 18: 4,20; Isaia 51:12 ** {class = bookQ}  
** Ecco, tutte le anime sono mie; come l'anima del padre, così è l'anima del figlio; l'anima che pecca, morirà. ** {class = versoQ} ** Ezechiele 18: 4 ** {class = bookVerse}  
** L'anima che pecca, morirà; il figlio non accetterà l'iniquità del padre, né il padre prenderà l'iniquità del figlio; la giustizia dei giusti sarà su di lui, e la malvagità dei malvagi cadrà su di lui. ** {class = versoQ} ** Ezechiele 18:20 ** {class = bookVerse}  
** "Io, io sono quello che ti consola; allora chi sei tu, che temi l'uomo, che è mortale, o il figlio dell'uomo, che non è altro che erba? ** {class = versoQ} ** Isaia 51:12 ** {class = bookVerse}  

** Spunta la risposta corretta: **  
a) Sì, gli uomini sono come gli angeli.  
b) No, dopo che Adamo peccò, l'uomo divenne un essere mortale.  
c) Sì, gli uomini sono semidei, immortali.  

** 9) Cosa sanno i morti? ** {class = question} ** Ecclesiaste 9: 5.6 ** {class = bookQ}  
** Perché i vivi sanno che moriranno, ma i morti non sanno nulla, né avranno una ricompensa, perché la loro memoria giace nell'oblio. L'amore, l'odio e l'invidia per loro sono già periti; per sempre non hanno parte in tutto ciò che viene fatto sotto il sole. ** {class = versoQ} ** Ecclesiaste 9: 5,6 ** {class = bookVerse}  
...
** 10) Chi ha solo l'immortalità? ** {class = question} ** I Timoteo 6:16 ** {class = bookQ}  
** L'unico che ha l'immortalità, che vive in una luce inaccessibile, che nessun uomo ha mai visto, né è in grado di vedere. A lui onore e potere eterno. Amen! ** {class = versoQ} ** I Timoteo 6:16 ** {class = bookVerse}  
...
** 11) Come può un uomo mortale diventare di nuovo immortale? ** {class = question} ** Giovanni 3:16; 17: 3 ** {class = bookQ}  
** Perché Dio ha tanto amato il mondo da dare il suo unigenito Figlio, in modo che chiunque crede in lui non muoia ma abbia la vita eterna ** {class = verse} ** Giovanni 3:16 ** {class = libro} 
** E questa è la vita eterna: fagli conoscere te, l'unico vero Dio, e Gesù Cristo, che hai mandato. ** {class = versoQ} ** Giovanni 17: 3 ** {class = bookVerse}  
...
** 12) Quando l'essere umano ha di nuovo il diritto alla vita eterna? ** {class = question} ** Giovanni 5:24 ** {class = bookQ}  
** In verità, in verità ti dico: chi ascolta la mia parola e crede a colui che mi ha mandato ha la vita eterna, non entra in giudizio, ma è passato dalla morte alla vita. ** {class = versoQ} ** Giovanni 5 : 24 ** {class = bookVerse}  
...
** 13) Quando Gesù darà questa vita eterna a coloro che credono? ** {class = question} ** I Corinzi 15: 21-23 ** {class = bookQ}  
** Poiché la morte è venuta da un uomo, anche da un uomo è avvenuta la risurrezione dei morti. Perché proprio come tutti muoiono in Adamo, così tutti saranno vivificati in Cristo. Ciascuno, tuttavia, nel suo ordine: Cristo, la primizia; quindi, quelli che sono di Cristo alla sua venuta. ** {class = versoQ} ** I Corinzi 15: 21-23 ** {class = bookVerse}  
...
** 15) Mentre Gesù non viene, dove sono i morti? ** {class = question} ** Daniele 12: 2 ** {class = bookQ}  
** Molti di coloro che dormono nella polvere della terra risorgeranno, alcuni alla vita eterna e altri alla vergogna e all'orrore eterno .; ** {class = versoQ} ** Daniele 12: 2 ** {class = bookVerse}  

** Spunta la risposta corretta: **  
a) E la morte è paragonata da Cristo al sonno, così i morti dormono nella tomba.  
b) I morti, fino alla venuta di Gesù, aspetteranno in cielo.  
...
La Parola di Dio insegna che coloro che sono morti in Cristo, tutti coloro che Gli erano fedeli, stanno dormendo nelle loro tombe finché Gesù non ritorna su questa terra per dare loro la vita eterna. L'immortalità tanto sognata ci sarà data quando Gesù ritornerà se saremo fedeli a Lui. Allora e solo allora l'uomo diventerà immortale. Gli altri morti risorgeranno dopo i mille anni in Cielo, per ricevere la condanna del lago di fuoco - la morte eterna. Vedi anche ** Apocalisse 20: 5,14,15. ** {class = book}

** 16) Per quanto tempo i morti in Cristo rimarranno a dormire nella tomba? ** {class = question} ** Giovanni 5: 28,29; I Tessalonicesi 4:16 ** {class = bookQ}  
** Non meravigliarti di questo, perché viene l'ora in cui tutti quelli che sono nelle tombe udranno la sua voce e usciranno: quelli che hanno fatto il bene, per la risurrezione della vita; e coloro che hanno fatto il male, per la risurrezione del giudizio. ** {class = versoQ} ** Giovanni 5: 28,29 ** {class = bookVerse}  
** Perché il Signore stesso, dato il suo comando, udì la voce dell'arcangelo e la tromba di Dio risuonò, scenderà dal cielo e i morti in Cristo risorgeranno per primi; ** {class = versoQ} ** I Tessalonicesi 4:16 ** {class = bookVerse}  

** Spunta la risposta corretta: **  
a) Fino a quando Gesù non ritorna e li risveglia, cioè li risuscita.  
b) Finché Gesù vuole.  
c) Dopo che le piaghe sono cadute sulla terra.  

** 17) Quale sarà la ricompensa di coloro che partecipano alla risurrezione dei giusti? ** {class = question} ** I Corinzi 15: 51-53 ** {class = bookQ}  
** Ecco, ti dico un mistero: non tutti dormiremo, ma trasformati saremo tutti, in un attimo, in un batter d'occhio, quando risuonerà l'ultima tromba. La tromba suonerà, i morti risorgeranno incorruttibili e noi saremo cambiati. Perché è necessario che questo corpo corruttibile si rivesta incorruttibilità e che il corpo mortale si rivesta immortale. ** {class = versoQ} ** I Corinzi 15: 51-53 ** {class = bookVerse}  
...
Satana ha il potere di trasfigurare se stesso per ingannare le persone. Quindi con lui ha usato il serpente per parlare con Eva e ingannarla nel giardino dell'Eden, oggi finge di essere parenti o amici defunti con manifestazioni che non sono altro che l'azione di Satana stesso e dei suoi angeli malvagi che lavorano sui segni per cercare di aiutarci. trucco.

** 18) Quali sono le manifestazioni dello spiritismo moderno in cui i morti appaiono e parlano alle persone? ** {class = question} ** II Corinzi 11:14 ** {class = bookQ}  
** E non c'è da stupirsi, perché Satana stesso diventa un angelo di luce. ** {class = versoQ} ** II Corinzi 11:14 ** {class = bookVerse}  
...
** 19) Quale sarà l'ultimo grande errore di Satana prima del ritorno di Gesù? ** {class = question} ** Apocalisse 16: 13,14; 18:23 ** {class = bookQ}  
** Poi vidi tre sudici spiriti simili a rane uscire dalla bocca del drago, la bocca della bestia e la bocca del falso profeta; perché sono spiriti di demoni, operatori di segni, e si rivolgono ai re di tutto il mondo per riunirli per la battaglia del grande Giorno di Dio Onnipotente. ** {class = versoQ} ** Apocalisse 16: 13.14 ** {class = bookVerse}  
** Né la luce della lampada brillerà su di te; né la voce di uno sposo o di una sposa sarà mai udita in te, perché i tuoi mercanti erano i più grandi del paese, perché tutte le nazioni sono state sedotte dalla tua stregoneria. ** {class = versoQ} ** Apocalisse 18:23 ** {class = bookVerse}  
...
!!! citazione Golden Back
    Quando ti dicono: consulta i negromanti e gli indovini, che cinguettano e mormorano, il popolo non consulterà il loro Dio? I morti saranno consultati per i vivi? ** Isaia 8:19 ** {class = book}

## Domenica

La relazione del mondo visibile con il mondo invisibile, il ministero degli angeli di Dio e il funzionamento degli spiriti maligni, sono chiaramente rivelati nella Scrittura e inseparabilmente mescolati con la storia umana. C'è una tendenza crescente a non credere nell'esistenza degli spiriti maligni, mentre i santi angeli che ** "assistono coloro che erediteranno la salvezza" ** {class = verse} ** (Ebrei 1:14), ** {class = book} sono considerati da molti gli spiriti dei morti.

Prima della creazione dell'uomo, gli angeli esistevano già, perché quando furono gettate le fondamenta della terra, ** le stelle del mattino cantavano lodi e tutti i figli di Dio si rallegrarono ** {class = verse} ** Giobbe: 38: 7 * * {class = book}. Dopo la caduta dell'uomo, gli angeli furono mandati a custodire l'albero della vita, e questo, prima che qualsiasi essere umano fosse morto. Gli angeli sono superiori all'uomo in natura, poiché il salmista dice che l'uomo è stato creato ** leggermente meno degli angeli ** {class = verse} ** (Salmo 8: 5) ** {class = libro}.
...
!!! Nota ""
    ** Cos'è lo spiritismo? ** Secondo il Dizionario è: Una dottrina i cui sostenitori intendono comunicare con gli spiriti dei morti tramite un intermediario che chiamano medium.

** 1) Questa dottrina esisteva nei tempi antichi? ** {class = question} ** Levitico 19:31 ** {class = bookQ}  
** Non ti rivolgerai a negromanti o indovini; non cercare che siano contaminati da loro. Io sono il SIGNORE tuo Dio. ** {class = versoQ} ** Levitico 19:31 ** {class = bookVerse}  
...
** 2) Su chi cadranno i giudizi di Dio? ** {class = question} ** Malachia 3: 5 ** {class = bookQ}  
** Verrò da te per il giudizio; Sarò rapido testimone contro stregoni e adulteri e contro coloro che giurano il falso e contro coloro che frodano il salario dello strillone, opprimono la vedova e l'orfano, e distorcono i diritti degli stranieri e mi temono, dice. il Signore degli eserciti. ** {class = versoQ} ** Malachia 3: 5 ** {class = bookVerse}  
...
I teologi popolari moderni insegnano che i morti sono ammessi alla presenza di Dio e dei santi angeli e sono favoriti con una conoscenza che supera di gran lunga quella che avevano in precedenza. E, mentre si librano sui loro amici sulla Terra, perché non dovrebbero essere autorizzati a comunicare con lui per metterli in guardia contro il male o per confortarli nella tristezza? E come possono coloro che credono nello stato cosciente dei morti rifiutare ciò che arriva loro come luce divina trasmessa da spiriti glorificati?
...
** 3) Dobbiamo ascoltare gli insegnamenti di stregoni e incantatori? ** {class = question} ** Geremia 27: 9,10 ** {class = bookQ}  
** Non ascoltare i tuoi profeti e i tuoi indovini, i tuoi sognatori, i tuoi presagi e i tuoi incantatori, che ti parlano ... Perché ti profetizzano bugie per mandarti via dalla tua terra, e così io espellere e perire. ** {class = versoQ} ** Jeremiah 27: 9,10 ** {class = bookVerse}  

** Spunta la risposta corretta: **  
a) No. L'obiettivo di Satana tramite stregoni e incantatori è impedirci di entrare nella terra promessa - la nuova Terra.  
b) Dovremmo, ma solo a volte, quando non sappiamo quale decisione prendere.  
c) Sì.  

** 4) Quali istruzioni mandò Dio, tramite Mosè, agli israeliti prima di entrare in Canaan? ** {class = question} ** Deuteronomio 18: 9-12 ** {class = bookQ}  
** Quando entrerai nella terra che il Signore tuo Dio ti dà, non imparerai a fare secondo le abominazioni di quei popoli. Chiunque faccia passare suo figlio o sua figlia attraverso il fuoco, non si troverà tra voi né un indovino, né un pronosticatore, né un presagio, né uno stregone; né affascinante, né negromante, né mago, né chiunque consulti i morti; poiché chiunque fa una cosa simile è un abominio per il Signore; e per queste abominazioni il Signore tuo Dio le ha gettate davanti a te. ** {class = versoQ} ** Deuteronomio 18: 9-12 ** {class = bookVerse}  

** Spunta la risposta corretta: **  
a) Dio ha dichiarato che consultare i morti è un abominio.  
b) Dio proibì agli Israeliti di associarsi ai Cananei.  
c) Dio avrebbe cacciato il popolo d'Israele da Canaan.  

## martedì

Dio ha espressamente vietato qualsiasi presunta comunicazione con gli spiriti dei morti. Ai giorni degli ebrei c'era una classe di persone che intendeva, come gli spiritualisti di oggi, mantenere la comunicazione con i morti. Ma * "spiriti familiari", * come vengono chiamati questi visitatori provenienti da altri mondi, sono dichiarati nella Bibbia "" spiriti demoniaci ". * Il lavoro di relazionarsi con spiriti familiari fu dichiarato un abominio per il Signore, e fu solennemente bandito pena la morte.

** 5) Qual è l'ordine di Dio riguardo a stregoni e indovini? ** {class = question} ** Esodo 22:18; Levitico 20:27 ** {class = bookQ}  
** La strega non ti lascerà vivere. ** {class = versoQ} ** Esodo 22:18 ** {class = bookVerse}  
** L'uomo o la donna che è un negromante o uno stregone verrà ucciso; saranno lapidati; il loro sangue cadrà su di loro. ** {class = versoQ} ** Levitico 20:27 ** {class = bookVerse}  
...
** 7) Chi non erediterà il Regno di Dio? ** {class = question} ** Galati 5: 20,21 ** {class = bookQ}  
** Idolatria, stregoneria, inimicizia, conflitto, gelosia, rabbia, discordia, dissenso, fazioni, invidia, ubriachezza, gola e simili, di cui dichiaro, come ti avevo avvertito una volta, che non erediterai il regno di Dio coloro che praticano tali cose. ** {class = versoQ} ** Galati 5: 20,21 ** {class = bookVerse}  
...
** 8) Cosa dovremmo fare quando siamo invitati a consultare spiriti e indovini? ** {class = question} ** Isaia 8:19 ** {class = bookQ}  
** Quando ti dicono: consulta i negromanti e gli indovini, che cinguettano e mormorano, il popolo non consulterà il loro Dio? I morti saranno consultati per i vivi? ** {class = versoQ} ** Isaia 8:19 ** {class = bookVerse}  
...
** 9) Quali istruzioni ci ha dato Dio, tramite Giovanni, a riguardo? ** {class = question} ** I Giovanni 4: 1 ** {class = bookQ}  
** Amati, non dare credito a nessuno spirito; piuttosto, prova gli spiriti se provengono da Dio, perché molti falsi profeti sono usciti nel mondo. ** {class = versoQ} ** I Giovanni 4: 1 ** {class = bookVerse}  
...
** 10) Come dovremmo provare gli spiriti? ** {class = question} ** Isaia 8:20 ** {class = bookQ}  
** Alla legge e alla testimonianza! Se non parlano così, non vedranno mai l'alba. ** {class = versoQ} ** Isaia 8:20 ** {class = bookVerse}
...
Gli spiritualisti professati dichiarano virtualmente: ** Chiunque fa il male passa per il bene agli occhi del Signore, ed è da questi che si compiace; o, dov'è il Dio del giudizio ** {class = verse} ** Malachia 2:17. ** {class = libro}  

La Parola di Dio dice: ** Guai a coloro che chiamano il male buono e il bene cattivo; che rendono l'oscurità luce e luce, l'oscurità! ** {class = versoQ} ** Isaia 5:20 ** {class = bookVerse}  

** 11) Quando un profeta o un sognatore si alza tra il popolo di Dio dando un segno o un prodigio e dicendo di adorare un altro * "dio" *, cosa dobbiamo fare? ** {class = question} ** Deuteronomio 13 : 1-4 ** {class = bookQ}  
** Quando un profeta o un sognatore si alza in mezzo a te e ti annuncia un segno o un prodigio, e il segno o il prodigio di cui ti ho parlato accade, e dice: Andiamo dietro ad altri dèi, che non conoscevi, e servili, non ascolterai le parole di quel profeta o sognatore; perché il SIGNORE tuo Dio ti sta mettendo alla prova per vedere se ami il SIGNORE tuo Dio con tutto il tuo cuore e con tutta la tua anima. ** {class = versoQ} ** Deuteronomio 13: 1-4 ** { class = bookVerse}  
...
** 12) I morti sanno qualcosa? ** {class = question} ** Ecclesiaste 9: 5 ** {class = bookQ}  
** Perché i vivi sanno che moriranno, ma i morti non sanno nulla, né avranno una ricompensa, perché la loro memoria giace nell'oblio ** {class = versoQ} ** Ecclesiaste 9: 5 ** {class = bookVerse}  
...
Vedi anche: ** Giobbe 14: 20-21; Salmo 146: 4 ** {class = book}

** 13) I morti tornano per comunicare con i vivi? ** {class = question} ** Ecclesiaste 9: 6 ** {class = bookQ}  
** Amore, odio e invidia per loro sono già periti; per sempre non hanno parte in nulla che venga fatto sotto il sole. ** {class = versoQ} ** Ecclesiaste 9: 6 ** {class = bookVerse}  

** Spunta la risposta corretta: **  
a) Sì b) No c) Non lo so.  

** 14) Se i morti non comunicano con i vivi, chi esegue i segni attribuiti ai nostri amici defunti? ** {class = question} ** Apocalisse 16:14 ** {class = bookQ}  
** Perché sono spiriti demoniaci, operatori di segni e si rivolgono ai re di tutto il mondo per radunarli per la battaglia del grande Giorno di Dio Onnipotente. ** {class = versoQ} ** Apocalisse 16:14 ** {class = bookVerse}  
...
** 16) In che modo Satana ei suoi agenti ci ingannano? ** {class = question} ** II Corinzi 11: 14,15; Matteo 24: 23,24 ** {class = bookQ}  
** E non c'è da stupirsi, perché Satana stesso diventa un angelo di luce. Non è molto, quindi, che i vostri stessi ministri diventino ministri della giustizia; e la loro fine sarà secondo le loro opere. ** {class = versoQ} ** II Corinzi 11: 14,15 ** {class = bookVerse}  
** Quindi se qualcuno ti dice: ecco il Cristo! Oppure: eccolo qui! Non credere; perché appariranno falsi cristi e falsi profeti, operando grandi segni e prodigi per ingannare, se possibile, gli eletti stessi. ** {class = versoQ} ** Matteo 24: 23,24 ** {class = bookVerse}  
...
Il fatto che dichiarino alcune verità e talvolta possano prevedere eventi futuri, conferisce alle loro dichiarazioni un'apparenza di merito; ei loro falsi insegnamenti sono così prontamente accettati dalle moltitudini, e così implicitamente creduti, come se fossero le verità più sacre della Bibbia.
...
** 19) Cosa ci avverte Gesù tramite Pietro? ** {class = question} ** I Peter 5: 8 ** {class = bookQ}  
** Sii sobrio e vigile. Il diavolo, il tuo avversario, va in giro, come un leone ruggente alla ricerca di qualcuno da divorare ** {class = versoQ} ** I Peter 5: 8 ** {class = bookVerse}  
...
** 20) Cosa dichiarerà Gesù a coloro che hanno osservato la verità quando verrà la seconda volta? ** {class = question} ** Matteo 25:34 ** {class = bookQ}  
** Allora il Re dirà a quelli alla sua destra: Vieni, benedetto dal Padre mio! Entra nel regno che è stato preparato per te sin dalla fondazione del mondo. ** {class = versoQ} ** Matteo 25:34 ** {class = bookVerse}  

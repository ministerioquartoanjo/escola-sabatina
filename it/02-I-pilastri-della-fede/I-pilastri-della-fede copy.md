...
** Come sarà il peculiare popolo di Dio sulla Terra appena prima del ritorno di Gesù? ** {class = question} ** Apocalisse 14: 1,4,5 ** {class = bookQ}  
...
** Cosa rappresenta il simbolo * "donna" * nella profezia? ** {class = question} ** Efesini 5: 22-25 ** {class = bookQ}   
...
** Chi è la casa di Cristo, e come dovrebbe essere stabilita questa casa? ** {class = question} ** Ebrei 3: 6 ** {class = bookQ}  
...
** A cosa confronta la Bibbia con Cristo? ** {class = question} ** I Corinzi 1: 24,30 ** {class = bookQ}  
** Ma ai chiamati, sia ebrei che greci, predichiamo Cristo, il potere di Dio e la saggezza di Dio. ** {class = versoQ} ** I Corinzi 1: 24,30 ** {class = bookVerse}
...
** Quanti pilastri ci sono nella casa o nella chiesa di Dio? ** {class = question} ** Proverbi 9: 1 ** {class = bookQ}  
...
** Cosa comandò Dio al popolo di Israele tramite Mosè? ** {class = question} ** Esodo 25: 8,9,40 ** {class = bookQ}  
...
** Come e dove viene mostrato il modello a Mosè sul monte in modo che possa fare lo stesso? ** {class = question} ** Ebrei 9:24 ** {class = bookQ}  
...
** Cosa veniva offerto al Santuario? ** {class = question} ** Ebrei 9: 9 ** {class = bookQ}   
** Questa è una parabola per il tempo presente; e, secondo questo, vengono offerti sia doni che sacrifici, sebbene questi, in termini di coscienza, siano inefficaci nel perfezionare l'adoratore. ** {class = versoQ} ** Ebrei 9: 9 ** {class = bookVerse}
...
** Cosa c'era nel cortile, o anche chiamato atrio, del santuario? ** {class = question} ** Esodo 40: 29-33 ** {class = bookQ}   
...
** Oltre al cortile, quante parti c'erano in questo santuario? ** {class = question} ** Ebrei 9: 2,3 ** {class = bookQ}  
...
** Cosa c'era nel luogo santo? ** {class = question} ** Esodo 40: 22-26 ** {class = bookQ}   
...
** Cosa c'era nel luogo santissimo del santuario? ** {class = question} ** Ebrei 9: 3-5 ed Esodo 26:33 ** {class = bookQ}  
...
** Cosa c'era dentro l'arca dell'alleanza, sotto il propiziatorio? ** {class = question} ** Deuteronomio 10: 4,5 ** {class = bookQ}  
...
** Come si chiamava la copertina dell'Arca dell'Alleanza? ** {class = question} ** Esodo 25:21 ** {class = bookQ}  
...
** Chi è entrato nel Luogo Sacro e quando? ** {class = question} ** Ebrei 9: 6 ** {class = bookQ}  
...
** Chi è entrato solo nel Santissimo Sacramento e quando? ** {class = question} ** Ebrei 9: 7 ** {class = bookQ}  
...
** Quali servizi o cerimonie si tenevano lì nel santuario? ** {class = question} ** Levitico 4: 2,27-30; Numeri 28: 3,4; Levitico 16: 29,30,34; Numeri 28: 3-4 ** {class = bookQ}  
** Parla ai figli d'Israele, dicendo: Quando un'anima pecca, per ignoranza, contro alcuni dei comandamenti del SIGNORE, su ciò che non dovrebbe essere fatto, e procedi contro qualcuno di loro; ** {class = versoQ} ** Levitico 4 : 2 ** {class = bookVerse}  
...
** Il perdono dei peccati richiedeva un sacrificio per i peccati? ** {class = question}
...
** Il giorno dell'espiazione il santuario fu purificato o ripulito da cosa? ** {class = question} ** Levitico 16:16, 29,30,34. ** {class = bookQ}  
...
** Questo santuario terrestre è ancora in vigore oggi dopo la morte di Gesù Cristo? ** {class = question} ** Matteo 27: 50,51 ** {class = bookQ}  
...
** Cosa vide Giovanni in cielo? ** {class = question} ** Rivelazione 11:19; 15: 8 ** {class = bookQ}  
** Quindi il santuario di Dio, che è nei cieli, fu aperto e l'Arca dell'Alleanza fu vista nel suo santuario, e si accesero fulmini, voci, tuoni, terremoti e una grande raffica. ** {class = versoQ} ** Rivelazione 11:19 ** {class = bookVerse}   
...
** Il lavoro svolto dai Sacerdoti nel santuario terreno era un esempio di cosa? ** {class = question} ** Ebrei 8: 5 ** {class = bookQ}   
...
** Chi è il Sommo Sacerdote, ministro di questo vero tabernacolo? ** {classe = domanda} ** Ebrei 8: 1,2; 4:14 ** {class = bookQ}  
...
** Chi è la vittima o l'agnello nel santuario del paradiso? ** {class = question} ** Ebrei 7:27 ** {class = bookQ}   
...
** C'era qualche relazione tra il Santuario della Terra dell'Antico Testamento e i suoi servizi con il Santuario del Cielo? ** {class = question} ** Esodo 25: 8,9,40 ** {class = bookQ}   
...
** Per chi rappresentavano tutti i sacrifici dell'Antico Testamento? ** {class = question} ** Giovanni 1:29 ** {class = bookQ}   
...
** Dove entrò Gesù dopo la sua morte? ** {class = question} ** Ebrei 8: 1,2 ** {class = bookQ}  
** Ora, l'essenza delle cose che abbiamo detto è che abbiamo un tale sommo sacerdote, che sedeva alla destra del trono della Maestà in cielo, come ministro del santuario e del vero tabernacolo eretto dal Signore, non uomo. ** { class = versoQ} ** Ebrei 8: 1,2 ** {class = bookVerse}
...
** In quale scompartimento Gesù stava ministrando quando Giovanni ebbe le visioni dell'Apocalisse? ** {class = question} ** Apocalisse 1: 12,13 ** {class = bookQ}  
...
** Perché Gesù entrò nel Santuario celeste? ** {class = question} ** Ebrei 9:24; 7:25 ** {class = bookQ}
...
** Quali due cose fa Gesù quando confessiamo i nostri peccati? ** {class = question} ** I Giovanni 1: 9 ** {class = bookQ}  
...
** Cos'altro fa Gesù in noi? ** {class = question} ** Romani 6:22 ** {class = bookQ}  
...
** Che invito ci viene fatto? ** {class = question} ** Ebrei 4:16 ** {class = bookQ}  
...
** Leggi attentamente il brano biblico e rispondi a quale scompartimento del santuario si riferisce? ** {class = question} ** Apocalisse 11:19 ** {class = bookQ}  
** Quindi il santuario di Dio, che è nei cieli, fu aperto e l'Arca dell'Alleanza fu vista nel suo santuario, e si accesero fulmini, voci, tuoni, terremoti e una grande raffica. ** {class = versoQ} ** Rivelazione 11:19 ** {class = bookVerse}  
...
** ... Ecco l'uomo il cui nome è Renovo; germoglierà dal suo posto e costruirà il tempio del Signore. Egli stesso costruirà il tempio del Signore, porterà gloria, si siederà e regnerà sul suo trono, sarà sacerdote sul suo trono e il consiglio di pace sarà tra loro. ** {class = verse} * * Zaccaria 6: 12,13 ** {class = book}  
...
** Qual è il motivo per cui non dovremmo aver paura di venire davanti alla presenza di Dio? ** {class = question} ** I Giovanni 2: 1 ** {class = bookQ}  
...
** Quando è stata fatta l'offerta per il peccato, cosa è stato fatto con il sangue dell'offerta? ** {class = question} ** Levitico 4: 17,30 ** {class = bookQ}  
...
** C'è anche una registrazione dei nostri peccati in cielo? ** {class = question} ** Isaia 65: 6,7 ** {class = bookQ}  
...
** Per un anno, i peccati furono accumulati lì. Quale cerimonia si teneva il decimo giorno del settimo mese di ogni anno? ** {class = question} ** Levitico 16: 29,30 ** {class = bookQ}  
** Questo sarà per te lo status perpetuo: nel settimo mese, il 10 del mese, affliggerai la tua anima e non farai lavoro, né il naturale né lo straniero che vaga tra di te. Per quel giorno sarà fatta per te l'espiazione per purificarti; e sarai purificato da tutti i tuoi peccati davanti al Signore. ** {class = versoQ} ** Levitico 16: 29,30 ** {class = bookVerse}  
...
** In quale scompartimento del santuario si teneva la cerimonia nel Giorno dell'Espiazione? ** {class = question} ** Ebrei 9: 7; Levitico 16: 2 ** {class = bookQ}  
** Ma nel secondo [velo], il sommo sacerdote, lui solo, una volta all'anno, non senza sangue, che offre per sé e per i peccati di ignoranza del popolo. ** {class = versoQ} ** Ebrei 9: 7 ** {class = bookVerse}  
...
** Come verrebbe purificato il santuario e cosa succederebbe alla fine con i peccati delle persone depositate lì? ** {class = question} ** Levitico 16: 9,10 ** {class = bookQ}  
...
** Cosa è stato fatto con il sangue di capra su cui cadde la sorte del Signore? ** {class = question} ** Levitico 16:15 ** {class = bookQ}  
...
** Perché era necessario fare questa espiazione e come dovrebbero essere le persone oggi? ** {class = question} ** Levitico 16:16 ** {class = bookQ}  
** Così farà l'espiazione per il santuario a causa delle contaminazioni dei figli d'Israele, delle loro trasgressioni e di tutti i loro peccati. Allo stesso modo, farà per la tenda del convegno, che è con loro in mezzo alle loro impurità. ** {class = versoQ} ** Levitico 16:16 ** {class = bookVerse}   
...
** Dopo aver compiuto l'espiazione per le persone nel Santissimo Sacramento, cosa ha fatto il Sommo Sacerdote? ** {class = question} ** Levitico 16: 20,21 ** {class = bookQ}  
...
** Che fine hanno fatto i peccati del popolo? ** {class = question} ** Levitico 16:22 ** {class = bookQ}  
...
** Cosa voleva dire il capro espiatorio per essere portato nel deserto? ** {class = question} ** Apocalisse 20: 1,2 ** {class = bookQ}  
...
** Cos'era questo santuario terreno e la sua serie di cerimonie? ** {class = question} ** Ebrei 9: 9,11 ** {class = bookQ}  
...
** Quando è scaduto il santuario della terra? ** {class = question} ** Matteo 27: 50,51 ** {class = bookQ}  
...
** Con quale paragone mostra che il santuario celeste sarà purificato? ** {class = question} ** Ebrei 9:23 ** {class = bookQ}  
...
** Quale decreto verrà emesso quando Cristo terminerà la sua opera di mediazione nel santuario celeste? ** {class = question} ** Apocalisse 22:11 ** {class = bookQ}  
...
** Dopo che Cristo avrà terminato la Sua opera nel Santuario Celeste, cosa farà? ** {class = question} ** Apocalisse 22:12; Atti 3: 19,20 ** {class = bookQ}   
...
** Pentiti, dunque, e convertiti, affinché i tuoi peccati possano essere cancellati, e che possano venire tempi di ristoro alla presenza del Signore, e mandalo a Gesù Cristo, che ti è stato predicato prima. ** { class = versoQ} ** Atti 3: 19,20 ** {class = bookVerse}
...
** Quale evento è direttamente collegato alla cancellazione del peccato e al ristoro finale della presenza di Dio? ** {class = question} ** Atti 3: 19-21 ** {class = bookQ}  
...
** Qual è il tempo per la purificazione del santuario? ** {class = question} ** Daniele 8:14 ** {class = bookQ}  
...
** Questo santuario sarebbe il santuario terrestre? ** {class = question} ** Daniele 8:17 ** {class = bookQ}  
...
** Quale dovrebbe essere l'atteggiamento delle persone durante il giorno dell'espiazione? ** {class = question} ** Levitico 23:29. ** {class = bookQ}  
...
** Con l'avvicinarsi del momento della liberazione dalla prigionia, cosa fece Daniel allora? ** {class = question} ** Daniel 9: 3 ** {class = bookQ}  
...
** A cosa interessava particolarmente il profeta? ** {class = question} ** Daniele 9:17 ** {class = bookQ}  
...
** Quando Daniel terminò la preghiera, Gabriel arrivò e gli diede una certezza, qual era quella certezza? ** {class = question} ** Daniel 9: 21-23 ** {class = bookQ}  
...
** Quale istruzione precedente, relativa alla visione di Daniele 8, veniva quindi eseguita più ampiamente? ** {class = question} ** Daniele 8: 14-16 ** {class = bookQ}  
...
** Perché erano necessarie ulteriori istruzioni riguardo a questa visualizzazione? ** {class = question} ** Daniel 8:27 ** {class = bookQ}  
...
** Gabriel ha indirizzato l'attenzione di Daniel sull'argomento che lo riguardava. Qual era questo argomento? ** {class = question} ** Daniel 9:23 ** {class = bookQ}  
** All'inizio delle tue suppliche è uscito l'ordine, e io sono venuto a dichiararlo, perché sei molto amato; quindi considera la parola e comprendi la visione. ** {class = versoQ} ** Daniele 9:23 ** {class = bookVerse}  
...
** A che ora dovrebbe essere purificato il Santuario? ** {class = question} ** Daniele 8:14 ** {class = bookQ}  
** Mi ha detto: Fino a duemilatrecento pomeriggi e mattine; e il santuario sarà purificato. ** {class = versoQ} ** Daniele 8:14 ** {class = bookVerse}  
...
** A che ora, disse l'angelo, apparteneva la visione? ** {class = question} ** Daniele 8: 19,26 ** {class = bookQ}  
...
** Cosa rappresentano "pomeriggio e mattina" nella Bibbia? ** {class = question} ** Genesi 1: 5 ** {class = bookQ}  
...
** Cosa rappresenta un giorno in un simbolo profetico? ** {class = question} ** Numeri 14:34 ** {class = bookQ}  
...
** Come appariva Daniele quando vide il popolo di Dio perseguitato e la città desolata e il santuario? ** {class = question} ** Daniele 8:27 ** {class = bookQ}  
...
** Cosa disse l'angelo di Dio a Daniele alla fine della sua preghiera? ** {class = question} ** Daniele 9:22 ** {class = bookQ}  
...
** Quali ulteriori istruzioni dalla visione di Daniele 8 venivano ora fornite? ** {class = question} ** Daniele 8:26 ** {class = bookQ}  
** La visione del pomeriggio e del mattino, che è stato detto, è vera; tu, però, conserva la visione, perché si riferisce a giorni ancora molto lontani. ** {class = versoQ} ** Daniele 8:26 ** {class = bookVerse}  
...
** Quale parte o porzione dei 2300 giorni (anni) è stata data al popolo ebraico? ** {class = question} ** Daniele 9:24 ** {class = bookQ}  
** Settanta settimane sono determinate sul tuo popolo e sulla tua città santa, per fermare la trasgressione, per porre fine ai peccati, per espiare l'iniquità, per portare giustizia eterna, per suggellare la visione e la profezia e per ungere il Sancta Sanctorum. ** {class = versoQ} ** Daniele 9:24 ** {class = bookVerse}  
...
** Cosa dovrebbe accadere alla fine delle settanta settimane? ** {class = question} ** Daniel 9:24 ** {class = bookQ}  
** Settanta settimane sono determinate sul tuo popolo e sulla tua città santa, per fermare la trasgressione, per porre fine ai peccati, per espiare l'iniquità, per portare giustizia eterna, per suggellare la visione e la profezia e per ungere il Sancta Sanctorum. ** {class = versoQ} ** Daniele 9:24 ** {class = bookVerse}  
...
** Quale parte di quel periodo dovrebbe andare a Cristo, il Messia o l'Unto? ** {class = question} ** Daniele 9:25 ** {class = bookQ}  
...
** Quando sono iniziate le settanta settimane? ** {class = question} ** Daniel 9:25 ** {class = bookQ}  
** Conosce e comprende: dalla partenza dell'ordine di restaurare e costruire Gerusalemme, all'Unto, al Principe, sette settimane e sessantadue settimane; le piazze e i cancelli saranno ricostruiti, ma in tempi difficili. ** {class = versoQ} ** Daniele 9:25 ** {class = bookVerse}  
...
** Quando è entrato in vigore questo ordine? ** {class = question} ** Esdra 7: 8,13,14 ** {class = bookQ}  
...
** Cosa disse l'angelo che sarebbe successo al popolo di Israele fino alla fine del tempo? ** {class = question} ** Daniele 9:26 ** {class = bookQ}  
...
** Come viene accentuata l'importanza del messaggio dell'ora del giudizio? ** {class = question} ** Apocalisse 14: 6,7 ** {class = bookQ}  
...
** Di fronte al giudizio investigativo già in corso, cosa si consiglia di fare? ** {class = question} ** Apocalisse 14: 7 ** {class = bookQ}  
...
** Quale serio avvertimento viene dato dall'apostolo Paolo? ** {class = question} ** Atti.17: 30,31 ** {class = bookQ}  
...
** Cosa farà Dio nel giudizio? ** {class = question} ** Ecclesiaste 12:14 ** {class = bookQ}  
...
** Com'era la scena del giudizio? ** {class = question} ** Daniel 7: 9,10 ** {class = bookQ}  
...
** Chi è il giudice? ** {class = question} ** Giovanni 5:22; Atti 17:31 ** {class = bookQ}  
...
** Chi sono i testimoni? ** {class = question} ** Apocalisse 5:11 ** {class = bookQ}  
...
** Chi è il nostro avvocato difensore? ** {class = question} ** I John 2: 1 ** {class = bookQ}  
...
** Chi è l'accusatore? ** {class = question} ** Apocalisse 12: 9-10 ** {class = bookQ}  
...
** Quali sono i libri di giudizio? ** {class = question}
...
** Quand'è che il nome di qualcuno è scritto nel libro della vita? ** {class = question} ** Giovanni 5:24; Filippesi 4: 3 ** {class = bookQ}
** In verità, in verità vi dico: chi ascolta la mia parola e crede a colui che mi ha mandato ha la vita eterna, non entra in giudizio, ma è passato dalla morte alla vita. ** {class = versoQ} ** Giovanni 5 : 24 ** {class = bookVerse}  
...
** Chi sarà giudicato? ** {class = question} ** I Peter 4:17; II Corinzi 5:10 ** {class = bookQ}  
...
** Quelli che non credono in Gesù saranno giudicati in questa corte? ** {class = question} ** Giovanni 3: 18,19 ** {class = bookQ}  
...
** Come viene emesso il giudizio? ** {class = question} ** Apocalisse 20:12 ** {class = bookQ}  
...
** Qual è lo standard di giudizio? ** {class = question} ** Giacomo 2: 10-12 ** {class = bookQ}  
...
** Se qualcuno ha accettato Cristo Gesù ma non Gli ha permesso di fare una trasformazione nella propria vita, superando i propri peccati, cosa ne sarà della persona? ** {class = question} ** Esodo 32:33; Salmo 69: 27-28 ** {class = bookQ}  
** Allora il SIGNORE disse a Mosè, cancellerò dal mio libro chiunque pecca contro di me. ** {class = versoQ} ** Esodo 32:33 ** {class = bookVerse}  
** Aggiungi iniquità a iniquità e non goderti l'assoluzione. Essere cancellato dal Libro dei vivi e non avere precedenti con i giusti. ** {class = versoQ} ** Salmo 69: 27,28 ** {class = bookVerse}  
...
** Quale decreto viene emesso a conclusione della sentenza? ** {class = question} ** Apocalisse 22:11 ** {class = bookQ}  
** Conserva gli ingiusti facendo ingiustizia, mantieni l'impuro che è ancora impuro; i giusti continuano nella pratica della giustizia, e il santo continua a santificare se stesso. ** {class = versoQ} ** Apocalisse 22:11 ** {class = bookVerse}  
...
** Quando è iniziato questo giudizio? ** {class = question} ** Daniel 8:14 ** {class = bookQ}  
** Mi ha detto: Fino a duemilatrecento pomeriggi e mattine; e il santuario sarà purificato. ** {class = versoQ} ** Daniele 8:14 ** {class = bookVerse}  
...
** Cosa ha promesso Dio di fare per coloro che si pentono dei loro peccati e si convertono? ** {class = question} ** Atti 3: 19 ** {class = bookQ}  
...
** Qual era la richiesta di Davide quando confessò il suo peccato a Dio? ** {class = question} ** Salmo 51: 1 ** {class = bookQ}  
...
** Quale classe di persone entrerà nel Regno dei Cieli? ** {class = question} ** Matteo 7:21 ** {class = bookQ}  
...
** Su quale tema coinvolge l'ultimo avvertimento nel grande conflitto sulla terra? ** {class = question} ** Apocalisse 14: 7-9 ** {class = bookQ}  
...
** Qual è il messaggio del primo angelo? ** {class = question} ** Apocalisse 14: 6,7 ** {class = bookQ}  
...
** Cosa rappresenta il simbolo "" angelo "* nella profezia biblica? ** {class = question} ** Galati 4:14 ** {class = bookQ}  
...
** Fino a dove arriva il messaggio del Vangelo eterno? ** {class = question} ** Matteo 24:14 ** {class = bookQ}  
...
** Cos'è l'Eternal Gospel? ** {class = question} ** Romani 1:16 ** {class = bookQ}  
** Perché non mi vergogno del vangelo, perché è il potere di Dio per la salvezza di tutti coloro che credono, prima dell'ebreo e anche del greco. ** {class = versoQ} ** Romani 1:16 ** {class = bookVerse}  
...
** Come capire l'espressione "grande voce"? ** {class = question} ** Luca 1: 41,42 ** {class = bookQ}  
...
** Cos'è temere Dio, secondo la Bibbia? ** {class = question} ** Ecclesiaste 12: 13,14 ** {class = bookQ}  
...
1. Quando facciamo la volontà di Dio per la nostra vita
	- ** Ti ho glorificato sulla terra, avendo compiuto il lavoro che mi hai dato da fare. ** {class = versoQ} ** Giovanni 17: 4 ** {class = book}
...
** Chi è colui che siamo invitati ad adorare? ** {class = question} ** Apocalisse 14: 7 ** {class = bookQ}  
...
** Chi è il Creatore di tutte le cose? ** {class = question} ** Genesi 1: 1 ** {class = bookQ}  
...
** Quanti dei ci sono? ** {class = question} ** I Corinzi 8: 5,6 ** {class = bookQ}  
...
** Nelle parole di Cristo, chi è l'unico Dio? ** {class = question} ** Giovanni 17: 1,3 ** {class = bookQ}  
...
** Esiste davvero un solo Dio? ** {class = question} ** I Timoteo 1:17; 2: 5 ** {class = bookQ}  
...
** Cosa impariamo dal primo comandamento della Legge di Dio? ** {class = question} ** Esodo 20: 3 ** {class = bookQ}  
...
** Qual è la considerazione di Gesù del Padre in Apocalisse? ** {class = question} ** Apocalisse 3:12 ** {class = bookQ}  
** Al vincitore ne farò una colonna nel santuario del mio Dio, e di lì non partirà mai; Inciderò anche su di lui il nome del mio Dio, il nome della città del mio Dio, la nuova Gerusalemme che discende dal cielo, dal mio Dio, e il mio nuovo nome. ** {class = versoQ} ** Rivelazione 3:12 ** {class = bookVerse}  
...
** Quando Gesù chiese ai discepoli cosa la gente pensava che fosse, cosa risposero? ** {class = question} ** Matteo 16:14 ** {class = bookQ}  
...
** E quando Gesù chiese loro cosa pensavano che fosse, cosa risposero i discepoli? ** {class = question} ** Matteo 16:16 ** {class = bookQ}  
...
** Qual è stata la risposta di Gesù a Pietro quando gli ha risposto? ** {class = question} ** Matteo 16:17 ** {class = bookQ}  
...
** Chi ha amato il mondo dando chi a noi? ** {class = question} ** Giovanni 3:16 ** {class = bookQ}  
** Perché Dio ha tanto amato il mondo da dare il suo Figlio unigenito, in modo che chiunque crede in lui non muoia, ma abbia la vita eterna. ** {class = versoQ} ** Giovanni 3:16 ** {class = bookVerse}  
...
!!! Nota ""
	 Cristo è l'unico Figlio di Dio generato. La parola * "unigenito" * significa * "solo (uni) generato (genito)" * Cristo è l'unico Figlio di Dio generato. Gli angeli e gli uomini sono esseri creati e non generati. (vedere ** Giovanni 3:18; 1 Giovanni 4: 9 ** {class = libro})
...
** Chi è la saggezza di Dio? ** {class = question} ** I Corinzi 1:24 ** {class = bookQ}  
** Ma ai chiamati, sia ebrei che greci, predichiamo Cristo, la potenza di Dio e la saggezza di Dio. ** {class = versoQ} ** I Corinzi 1:24 ** {class = bookVerse}  
...
** Cosa dice la Bibbia sulla nascita di Cristo - Sapienza di Dio, come è stata generata in cielo? ** {class = question} ** Proverbi 8: 22-25 ** {class = bookQ}   
...
** Dopo aver detto che l'unico Dio è il Padre, cosa si dice che sia Gesù? ** {class = question} ** I Corinzi 8: 6 ** {class = bookQ}  
...
** Si può adorare Gesù? ** {class = question} ** Ebrei 1: 6; Giovanni 5:23 ** {class = bookQ}  
...
** In modo che tutti onorino il Figlio come onorano il Padre. Chi non onora il Figlio non onora il Padre che lo ha mandato. ** {class = versoQ} ** Giovanni 5:23 ** {class = bookVerse }  
...
** Di chi è la presenza che vale la presenza di chi? ** {class = question} ** Giovanni 14: 9; 1:18 ** {class = bookQ}  
...
** Nessuno ha mai visto Dio; il Figlio unigenito, che è nel seno del Padre, è quello che lo ha rivelato. ** {class = versoQ} ** Giovanni 1:18 ** {class = bookVerse}  
...
** Cristo è anche il Creatore? ** {class = question} ** Giovanni 1: 3 ** {class = bookQ}  
...
** Da cosa è chiamato lo Spirito Santo? ** {class = question} ** Atti 2:38; 10:45 ** {class = bookQ}  
...
** E i fedeli che erano stati circoncisi, che venivano con Pietro, rimasero stupiti, perché il dono dello Spirito Santo fu versato anche sui pagani. ** {class = versoQ} ** Atti 10:45 ** {class = bookVerse}  
...
** Cosa ci viene dato tramite lo Spirito Santo? ** {class = question} ** Atti 1: 8 ** {class = bookQ}  
** Ma riceverai potenza quando lo Spirito Santo verrà su di te, e mi sarai testimone sia a Gerusalemme che in tutta la Giudea e Samaria e fino alle estremità della terra. ** {class = versoQ} ** Atti 1: 8 ** {class = bookVerse}  
...
** Quali sono le caratteristiche dello Spirito Santo? ** {class = question} ** Giovanni 14: 16-18 ** {class = bookQ}  
...
d) () Sarebbe stato in loro: Gesù disse che Lui stesso sarebbe stato nei discepoli. ** Quel giorno saprai che io sono nel Padre mio, e tu in me e io in te. ** {class = versoQ} ** (Giovanni 14:20) ** {class = libro}   

!!! Nota ""
	 Tutte le caratteristiche che Cristo ha dato riguardo allo Spirito Santo erano le caratteristiche di Se stesso.

** Di chi è lo Spirito Santo? ** {class = question} ** 1 Pietro 1:11; Galati 4: 6; Romani 8:14 ** {class = bookQ}  
** Indagando attentamente, qual è l'occasione o quali sono le circostanze appropriate, indicate dallo Spirito di Cristo, che era in esse ... ** {class = versoQ} ** I Pietro 1:11 ** {class = bookVerse}  
...
** In che modo Gesù comunicò lo Spirito Santo riguardo ai discepoli? ** {class = question} ** Giovanni 20:22 ** {class = bookQ}  
** E detto questo, soffiò su di loro e disse loro: Ricevete lo Spirito Santo. ** {class = versoQ} ** Giovanni 202: 22 ** {class = bookVerse}  
...
** È un essere personale indipendente dal Padre e da Cristo? ** {class = question} ** Giovanni 15:26 ** {class = bookQ}  
...
** Chi ci manda lo Spirito Santo? ** {class = question} ** Giovanni 16: 7 ** {class = bookQ}  
...
** Chi è lo Spirito Santo? ** {class = question} ** II Corinzi 3:17 ** {class = bookQ}  
...
** Cosa dice il messaggio del secondo angelo? ** {class = question} ** Apocalisse 14: 8; Isaia 21: 9 ** {class = bookQ}  
...
** Chi è la moderna Babilonia o è anche chiamata Madre Babilonia? ** {class = question} ** Apocalisse 17: 4,5 ** {class = bookQ}  
** La donna era vestita di porpora e scarlatto, e adornata d'oro, pietre preziose e perle; e in suo fratello avevo una coppa d'oro di abomini e la notizia della sua fornicazione; E sulla sua fronte c'era scritto il nome: Mistero, la grande Babilonia, la madre delle prostitute e degli abomini della terra. ** {class = versoQ} ** Apocalisse 17: 4,5 ** {class = bookVerse}
...
** Cosa rappresenta "donna" nelle profezie bibliche? ** {class = question} ** Efesini 5:24 ** {class = bookQ}  
...
** Cosa farebbe questa chiesa apostata? ** {class = question} ** Apocalisse 17: 6 ** {class = bookQ}  
...
** Dove si troverebbe la moderna Babilonia in futuro? ** {class = question} ** Apocalisse 17: 9 ** {class = bookQ}  
...
** Cosa ha detto Gesù del vino da comunione? ** {class = question} ** Luca 22:20 ** {class = bookQ}  
...
** Cosa ha fatto l'antica Babilonia a tutte le nazioni? ** {class = question} ** Geremia 51: 7 ** {class = bookQ}  
...
** Qual è stato l'effetto di questo atteggiamento di apostasia? ** {class = question} ** Geremia 51: 8 ** {class = bookQ}  
...
** Cosa ha promesso Dio che avrebbe fatto a Babilonia? ** {class = question} ** Geremia 51:24 ** {class = bookQ}  
** E ripagherò Babilonia, e tutti gli abitanti della Caldea, per tutta la malvagità che hanno commesso a Sion, ai tuoi occhi, dice il Signore. ** {class = versoQ} ** Geremia 51:24 ** {class = bookVerse }  
...
** Nelle visioni di Giovanni, quale interpretazione viene data alla donna che siede su molte acque? ** {class = question} ** Apocalisse17: 18 ** {class = bookQ}  
...
** In quella stessa profezia, cos'è la Chiesa di Roma, il papato, designata come simbolo dell'antica Babilonia? ** {class = question} ** Apocalisse 17: 5 ** {class = bookQ}  
...
** Cosa fa la Babilonia moderna nella profezia? ** {class = question} ** Apocalisse 17: 2 ** {class = bookQ}  
...
** Cosa disse Gesù del vino di comunione? ** {class = question} ** Luca 22:20. ** {class = bookQ}  
...
** Qual è l'insegnamento essenziale del Nuovo Patto? ** {class = question} ** Ebrei 8:10 ** {class = bookQ}  
...
** Quando Cristo ministra così la legge nel cuore, cosa diventa? ** {class = question} ** Romani 8: 2-4 ** {class = bookQ}  
...
** Quale verità è confermata da Gesù? ** {class = question} ** Giovanni 6:63 ** {class = bookQ}  
...
** Gli uomini, guidati da Satana, misero le dottrine e le tradizioni degli uomini al posto della parola di Dio? ** {class = question} ** Marco 7: 7-9 ** {class = bookQ}  
...
** Che rapporto ha la Chiesa di Roma con altre chiese apostate? ** {class = question} ** Apocalisse 17: 5 ** {class = bookQ}  
** E sulla sua fronte era scritto il nome: Mistero, la grande Babilonia, la madre delle prostitute e degli abomini della terra. ** {class = versoQ} ** Apocalisse 17: 5 ** {class = bookVerse}  
...
** Fino a che punto dovrebbe spingersi l'apostasia? ** {class = question} ** Apocalisse 18: 2 ** {class = bookQ}  
** Poi ha esclamato con una voce potente, dicendo: Caduto! La Grande Babilonia cadde e divenne la casa dei demoni, la tana di ogni tipo di spirito impuro e il nascondiglio di ogni tipo di uccello sporco e odioso. ** {class = versoQ} ** Apocalisse 18: 2 ** {class = bookVerse}  
...
** Quale ultimo invito fa Dio al Suo popolo a Babilonia? ** {class = question} ** Rivelazione 18: 4,5 ** {class = bookQ}  
...
** Come sarà la caduta della moderna Babilonia? ** {class = question} ** Apocalisse 18:21 ** {class = bookQ}  
...
** Perché la profezia dice due volte che "cadde, cadde" questo sistema religioso apostata? ** {class = question} ** Rivelazione 14: 8; 18: 1-4 ** {class = bookQ}  
** Un altro angelo seguì, il secondo, dicendo: La grande Babilonia è caduta, è caduta, il che ha fatto bere tutte le nazioni dalla furia della loro prostituzione. ** {class = versoQ} ** Rivelazione 14: 8 * * {class = bookVerse}  
...
** Quale consiglio e promessa ha lasciato Gesù a coloro che dovranno affrontare i pericoli della morte per la loro fede? ** {class = question} ** Apocalisse 2: 10,11; Matteo 10:28 ** {class = bookQ}
...
** E non abbiate paura di chi uccide il corpo e non può uccidere l'anima; piuttosto temere chi può far morire l'anima e il corpo all'inferno. ** {class = versoQ} ** Matteo 10:28 ** {class = bookVerse}  
...
** Quale canzone di trionfo segue la caduta di Babilonia? ** {class = question} ** Apocalisse 19: 6,7 ** {class = bookQ}  
...
** Come possiamo confrontare il messaggio dei tre angeli dato dalle profezie dell'Apocalisse? ** {class = question} ** II Pietro1: 19 ** {class = bookQ}  
...
** Il messaggio del terzo angelo fa un solenne avvertimento contro quale apostasia? ** {class = question} ** Apocalisse 14: 9 ** {class = bookQ}  
...
** Quale sarà la caratteristica di coloro che obbediscono e accettano il vangelo eterno dato dai tre angeli? ** {class = question} ** Apocalisse 14:12 ** {class = bookQ}  
...
** Quale sarà la conseguenza dell'adorazione della bestia e della sua immagine e della ricezione del suo marchio? ** {class = question} ** Apocalisse 14:10 ** {class = bookQ}  
...
** Cos'è il vino dell'ira di Dio? ** {class = question} ** Apocalisse 15: 1 ** {class = bookQ}  
...
** Quale descrizione è fatta della Bestia? ** {class = question} ** Apocalisse 13: 1,2; Rivelazione 17: 3 ** {class = bookQ}
...
** L'angelo mi portò in spirito in un deserto e vidi una donna che cavalcava una bestia scarlatta, una bestia piena di nomi di bestemmia, con sette teste e dieci corna. ** {class = versoQ} ** Apocalisse 17: 3 ** {class = bookVerse}  
...
** Cosa rappresenta l'animale nella profezia nella Bibbia? ** {class = question} ** Daniele 7: 17,23 ** {class = bookQ}  
...
** Ha detto così: Il quarto animale sarà il quarto regno sulla terra, che sarà diverso da tutti i regni; e divorerà l'intera terra, la calpesterà sotto i suoi piedi e la farà a pezzi. ** {class = versoQ} ** Daniele 7:23 ** {class = bookVerse}  
...
** Cosa dicono le persone che adorano la bestia, i cui nomi non sono scritti nel libro della vita? ** {class = question} ** Apocalisse 13: 4 ** {class = bookQ}  
...
** Chi è il drago che ha dato potere e autorità alla bestia? ** {class = question} ** Apocalisse 12: 9 ** {class = bookQ}  
...
** Il messaggio del terzo angelo avverte anche dell'adorazione di cosa? ** {class = question} ** Apocalisse 14: 9 ** {class = bookQ}  
** E il terzo angelo li seguì, dicendo ad alta voce: Se qualcuno adora la bestia e la sua immagine e riceve il marchio sulla fronte o nella mano. ** {class = versoQ} ** Apocalisse 14 : 9 ** {class = bookVerse}  
...
** Cosa accadrà a coloro che adorano l'immagine della bestia? ** {class = question} ** Apocalisse 14: 9,10 ** {class = bookQ}  
...
** Come dovrebbe essere la nostra adorazione o servizio razionale? ** {class = question} ** Romani 12: 1 ** {class = bookQ}  
...
** 13. In che giorno abbiamo un servizio di adorazione secondo la Parola di Dio? ** {class = question} ** Isaia 66:23 ** {class = bookQ}  
** E avverrà che da un novilunio all'altro, e da un sabato all'altro, tutta la carne verrà ad adorare davanti a me, dice il Signore. ** {class = versoQ} ** Isaia 66:23 ** { class = bookVerse}  
...
** In che modo questo sistema religioso toglierà l'onore che appartiene solo a Dio? ** {class = question} ** Geremia 10: 6 ** {class = bookQ}  
...
** In che modo l'apostolo Paolo si riferisce alla bestia? ** {class = question} ** II Tessalonicesi 2: 3,4 ** {class = bookQ}
...
** Cosa ha dato da bere Babilonia a tutte le nazioni? ** {class = question} ** Rivelazione 14: 8 ** {class = bookQ}  
...
** Cosa avranno da bere coloro che accettano gli insegnamenti di Babilonia, rendendole così omaggio? ** {class = question} ** Apocalisse.14: 10 ** {class = bookQ}  
...
** Sotto quale minaccia viene imposto il culto dell'immagine della bestia? ** {class = question} ** Apocalisse 13:15 ** {class = bookQ}  
** E gli fu data l'opportunità di comunicare il respiro all'immagine della bestia, in modo che non solo l'immagine parlasse, ma facesse anche morire coloro che non adoravano l'immagine della bestia. ** {class = versoQ} ** Apocalisse 13:15 ** {class = bookVerse}  
...
** Quale misura universale verrà utilizzata per costringere tutti a ricevere il segno della bestia? ** {class = question} ** Apocalisse 13: 16,17 ** {class = bookQ}  
** Tutti, piccoli e grandi, ricchi e poveri, liberi e schiavi, si assicurano che venga dato loro un certo marchio sulla mano destra o sulla fronte, in modo che nessuno possa comprare o vendere, tranne colui che ha il marchio, il nome della bestia o il numero del suo nome. ** {class = versoQ} ** Apocalisse 13: 16,17 ** {class = bookVerse}  
...
** Quale potere opera effettivamente attraverso la bestia che richiede l'adorazione? ** {class = question} ** Rivelazione 13: 2 ** {class = bookQ}  
...
** Chi è il drago? ** {class = question} ** Apocalisse 12: 9 ** {class = bookQ}  
...
** Qual è stata la risposta di Gesù a Satana quando ci provò? ** {class = question} ** Luca 4: 8 ** {class = bookQ}  
** Ma Gesù gli rispose: Sta scritto: Al Signore tuo Dio adorerai e adorerai Lui solo. ** {class = versoQ} ** Luca 4: 8 ** {class = bookVerse}  
...
** Quanti si arrenderanno alle affermazioni sull'adorazione delle bestie? ** {class = question} ** Apocalisse 13: 8 ** {class = bookQ}   
...
** Chi siamo chiamati ad adorare? ** {class = question} ** Apocalisse 14: 7 ** {class = bookQ}  
** Dicendo ad alta voce: Temi Dio e dagli gloria, poiché l'ora del suo giudizio è venuta; e adorare Colui che ha fatto il cielo e la terra e il mare e le fontane d'acqua. ** {class = versoQ} ** Apocalisse 14: 7 ** {class = bookVerse}  
...
** Chi canterà la canzone di Mosè e l'Agnello nel mare di vetro? ** {class = question} ** Apocalisse 15: 2-4 ** {class = bookQ}  
** Ho visto come se un mare di vetro, mescolato con il fuoco, ei vincitori della bestia, della sua immagine e del numero del suo nome, che stavano in piedi nel mare di vetro, con le arpe di Dio; ** {class = versoQ} ** Apocalisse 15: 2-4 ** {class = bookVerse}  
...
** In chi si è manifestato l'amore di Dio per noi? ** {class = question} ** Giovanni 3:16 ** {class = bookQ}  
** Perché Dio ha tanto amato il mondo da dare il suo Figlio unigenito, in modo che chiunque crede in lui non muoia, ma abbia la vita eterna. ** {class = versoQ} ** Giovanni 3:16 ** {class = bookVerse}  
...
** Come dovrebbe manifestarsi in noi questo amore? ** {class = question} ** I Giovanni 4: 19,20 ** {class = bookQ}  
...
** Come possiamo ripagare l'amore di Dio? ** {class = question} ** Giovanni 14:15; I Giovanni 2: 4 ** {class = bookQ}  
...
** Qual è il comandamento di Dio, secondo Gesù? ** {class = question} ** Giovanni 12:50 ** {class = bookQ}  
...
** Cosa esprime la legge o il comando di Dio? ** {class = question} ** Romani 7:12 ** {class = bookQ}  
...
** Perché dovremmo essere santi e perfetti? ** {class = question} ** Matteo 5:48; Levitico 19: 2 ** {class = bookQ}  
...
** Come saremo perfetti davanti a Dio? ** {class = question} ** Genesi 17: 1; 5: 22-24 ** {class = bookQ}  
...
** Enoc camminava con Dio ... e non lo era più, perché Dio lo prese per sé. ** {class = versoQ} ** Genesi 5: 22-24 ** {class = bookVerse}  
...
** A cosa serviva la legge? ** {class = question} ** Romani 3:20; 7: 7 ** {class = bookQ}  
...
** Possiamo piacere a Dio vivendo secondo la nostra volontà? ** {class = question} ** Romani 8: 7,8 ** {class = bookQ}  
...
** Quale potere dobbiamo ottenere per essere obbedienti alla Legge di Dio? ** {class = question} ** Romani 1: 4,5; 3: 26.31 ** {class = bookQ}  
...
** In considerazione della manifestazione della sua giustizia nel tempo presente, per se stesso essere giusto e il giustificatore di colui che ha fede in Gesù. ** {class = versoQ} ** Romani 3:26 ** {class = bookVerse}  
...
** Qual è la base per osservare i comandamenti dell'Antico e del Nuovo Testamento? ** {class = question} ** Genesi 15: 6 ** {class = bookQ}  
...
** Qual è la Nuova Alleanza che Cristo vuole fare con noi? ** {class = question} ** Ebrei 10: 15,16 ** {class = bookQ}  
...
** Abbiamo ricevuto la legge quando abbiamo ricevuto Cristo? ** {class = question} ** Salmo 40: 7.8 ** {class = bookQ}  
** Allora ho detto: eccomi qui, sul rotolo del libro c'è scritto di me; Mi piace fare la tua volontà, mio ​​Dio; la tua legge è nel mio cuore. ** {class = versoQ} ** Salmo 40: 7.8 ** {class = bookVerse}  

** Spunta la risposta corretta: **  
a) No, la legge è una cosa e Gesù è un'altra.   
b) Sì, Gesù aveva la Legge nel suo cuore. Lui stesso dice: ** "Ho osservato i comandamenti del Padre mio" ** {class = verse} ** (Giovanni 15:10). ** {class = book} Permettendo a Gesù di vivere in noi, porteremo la nostra vita la sua obbedienza.   
c) No, perché osserveremo solo la legge di Dio in cielo.   

** Cosa succede quando Cristo vive in noi? ** {class = question} ** Romani 8: 10,14 ** {class = bookQ}  
...
** Come viene Cristo a vivere in noi? ** {class = question} ** Efesini 3: 16,17; Rivelazione 3:20 ** {class = bookQ}  
...
** Cos'è la vera fede? ** {class = question} ** Apocalisse 14:12 ** {class = bookQ}  
...
** Come si manifestò la fede di Gesù? ** {class = question} ** Giovanni 15:10; 6:38 ** {class = bookQ}  
...
** Cosa disse Gesù di se stesso? ** {class = question} ** Giovanni 6: 57.63 ** {class = bookQ}  
...
** Per cosa Gesù ci comunica la sua vita? ** {class = question} ** Efesini 2:10 ** {class = bookQ}  
** Perché noi siamo la sua opera, creata in Cristo Gesù per le buone opere, che Dio ha preparato in anticipo per farci camminare in esse. ** {class = versoQ} ** Efesini 2:10 ** {class = bookVerse}  
...
** Cosa ha visto Giovanni in cielo? ** {class = question} ** Apocalisse 11:19 ** {class = bookQ}  
** Quindi il santuario di Dio, che è nei cieli, fu aperto e l'Arca dell'Alleanza fu vista nel suo santuario, e si accesero fulmini, voci, tuoni, terremoti e una grande raffica. ** {class = versoQ} ** Rivelazione 11:19 ** {class = bookVerse}  
...
** Cosa c'era dentro l'Arca dell'Alleanza? ** {class = question} ** Esodo 25:21; Deuteronomio 10: 4,5 ** {class = bookQ}  
...
** Da chi furono scritti i Dieci Comandamenti? ** {class = question} ** Esodo 31:18; Deuteronomio 4: 13 ** {class = bookQ}  
...
** Poi ti ha annunciato la sua alleanza, che ha prescritto per te, i Dieci Comandamenti, e li ha scritti su due tavolette di pietra. ** {class = versoQ} ** Deuteronomio4: 13 ** {class = bookVerse}  
...
** Cosa dice la legge di Dio? ** {class = question} ** Esodo 20: 3-17 ** {class = bookQ}  
...
** Qual è l'atteggiamento di Gesù verso la validità della legge di Dio? ** {class = question} ** Matteo 5: 17,18; 19:17 ** {class = bookQ}  
...
** Dio permette cambiamenti nella Sua parola o nei suoi comandamenti? ** {class = question} ** Salmo 89:34 ** {class = bookQ}  
...
** Cosa scrisse Paolo sui comandamenti di Dio? ** {class = question} ** Romani 3:31; 7:12 ** {class = bookQ}  
** Quindi invalidiamo la legge per fede? No, assolutamente! Piuttosto, confermiamo la legge. ** {class = versoQ} ** Romani 3:31 ** {class = bookVerse}  
...
** Cosa accadrebbe in futuro, secondo la Bibbia, con la legge di Dio? ** {class = question} ** Daniele 8:12; 7:25 ** {class = bookQ}  
...
** Cosa hanno fatto gli uomini con la verità di Dio? ** {class = question} ** Romani 1:25 ** {class = bookQ}  
...
** Cosa seguono molti al posto dei comandamenti di Dio? ** {class = question} ** Marco 7: 6-9 ** {class = bookQ}  
...
** Possiamo osservare un comandamento e rifiutarne un altro? ** {class = question} ** Giacomo 2: 10-12 ** {class = bookQ}  
** Per chi osserva l'intera legge, ma inciampa su un punto, diventa colpevole di tutti. Poiché colui che ha detto: "Non commettere adulterio", ha anche detto: "Non uccidere". Ora, se non commetti adulterio, ma uccidi, sarai un trasgressore della legge. Parla in modo e in modo tale da procedere come coloro che saranno giudicati dalla legge della libertà. ** {class = versoQ} ** Giacomo 2: 10-12 ** {class = bookVerse}  
...
** Qual è la caratteristica del popolo di Dio al tempo della fine? ** {class = question} ** Rivelazione 14:12 ** {class = bookQ}  
** Ecco la perseveranza dei santi, coloro che osservano i comandamenti di Dio e la fede di Gesù. ** {class = versoQ} ** Apocalisse 14:12 ** {class = bookVerse}  
...
** Cosa implica il "timore di Dio" di Rivelazione 14: 7? ** {class = question} ** Ecclesiaste 12:13 ** {class = bookQ}  
...
** Cos'è più importante per Dio? ** {class = question} ** Atti 5:29, Tito 1:14 ** {class = bookQ}
...
!!! quote Back Ground
    Parli dunque ai figli d'Israele, dicendo: Sicuramente osserverete i miei sabati; perché questo è un segno tra me e te nelle vostre generazioni; affinché tu sappia che io sono il Signore, che ti santifica ** Esodo 31:13 ** {class = libro}
...
** Nel creare il mondo, cosa ha fatto Dio? ** {class = question} ** Genesi 2: 1-3 ** {class = bookQ}  
...
** Quando Dio ha istituito il settimo giorno di riposo? ** {class = question} ** Genesi 2: 2-4 ** {class = bookQ}  
...
** Qual è il quarto comandamento della Legge di Dio? ** {class = question} ** Esodo 20: 8-10 ** {class = bookQ}  
...
** Perché Dio ha stabilito il sabato? ** {class = question} ** Marco 2: 27,28 ** {class = bookQ}  
...
** Il sabato veniva dato solo agli ebrei? ** {class = question} ** Isaia 56: 6,7 ** {class = bookQ}  
...
** Che il sabato era un segno? ** {class = question} ** Ezechiele 20: 12.20 ** {class = bookQ}  
...
** Ci sono tre caratteristiche del sigillo di Dio che troviamo nei Dieci Comandamenti. ** {class = question} ** Esodo 20: 8-11 ** {class = bookQ}  
...
** Qual era la missione del Messia riguardo alla legge di Dio? ** {class = question} ** Isaia 42:21, Matteo 5:17 ** {class = bookQ}   
...
** Che giorno stava guardando Gesù? ** {class = question} ** Luca 4:16 ** {class = bookQ}  
...
** In che giorno osservavano i seguaci di Gesù? ** {class = question} ** Luca 23: 54-56 ** {class = bookQ}  
...
** Cosa guarderà il popolo di Dio alla fine? ** {class = question} ** Apocalisse 14:12 ** {class = bookQ}  
** Ecco la perseveranza dei santi, coloro che osservano i comandamenti di Dio e la fede di Gesù. ** {class = versoQ} ** Apocalisse 14:12 ** {class = bookVerse}  
...
** Cosa dice la Parola di Dio di colui che disprezza la legge o solo uno dei comandamenti in essa contenuti? ** {class = question} ** Giacomo 2:10; I Giovanni 2: 4 ** {class = bookQ}  
...
** Qual è l'ordine dato da Dio in Isaia al Suo popolo? ** {class = question} ** Isaia.58: 1 ** {class = bookQ}  
...
** Cosa ha fatto Dio il settimo giorno? ** {class = question} ** Genesi 2: 3 ** {class = bookQ}  
...
** Quando inizia il sabato? ** {class = question} ** Levitico 23:32 ** {class = bookQ}  
** Sabato di solenne riposo sarà tuo; allora affliggerai la tua anima; alle nove del mese, dal pomeriggio al pomeriggio, celebrerai il tuo sabato. ** {class = versoQ} ** Levitico 23:32 ** {class = bookVerse}  
...
** Cosa significa "tardi" nella Bibbia? ** {class = question} ** Deuteronomio 16: 6 ** {class = bookQ}  
...
** Qual è il giorno di preparazione speciale per sabato? ** {class = question} ** Marco 15:42 ** {class = bookQ}  
...
** In quale giorno dovrebbe essere preparato il cibo del sabato? ** {class = question} ** Esodo 16: 22-26 ** {class = bookQ}  
...
** In quale giorno Gesù e le donne che stavano per seppellirlo ripresero le loro attività? ** {class = question} ** Marco 16: 1-6 ** {class = bookQ}  
...
** Va bene trattare qualsiasi tipo di scambio di sabato? ** {class = question} ** Nehemiah 13: 16,17 ** {class = bookQ}  
...
** Cosa dovremmo avere sabato? ** {class = question} ** Levitico 23: 3 ** {class = bookQ}  
...
** In che giorno Gesù andò in chiesa (sinagoga)? ** {class = question} ** Luca 4: 16,31 ** {class = bookQ}  
** Andato a Nazaré, dove era cresciuto, un sabato entrò nella sinagoga, secondo il suo costume, e si alzò per leggere. E scese a Cafarnao, una città della Galilea, e insegnò loro il sabato. ** {class = versoQ} ** Luca 4: 16,31 ** {class = bookVerse}
...
** Qual era l'altro tipo di attività che Gesù compiva di sabato e che dovremmo fare anche noi? ** {class = question} ** Giovanni 9:14 ** {class = bookQ}  
...
** Che tipo di lavoro dovremo fare sabato? ** {class = question} ** Matteo 12:12 ** {class = bookQ}  
...
** Quale giorno è Gesù, Signore? ** {class = question} ** Matteo 12: 8 ** {class = bookQ}  
...
** Cosa facevano gli apostoli in giorno di sabato? ** {class = question}
...
c) () Hanno riservato del tempo per pregare e predicare - ** Sabato, abbiamo lasciato la città vicino al fiume, dove sembrava esserci un luogo di preghiera ... ** {class = versoQ} ** Atti 16:13 ** {class = book}  
d) () Hanno comprato e venduto.   

** Come dovrebbe essere santificato il sabato? ** {class = question} ** Isaia 58:13 ** {class = bookQ}  
...
** Cosa dovremmo fare sabato? ** {class = question} ** Esodo 20: 8-11 ** {class = bookQ}  
...
** Per quanto tempo sarà osservato il sabato? ** {class = question} ** Isaia 66: 22,23 ** {class = bookQ}  
...
** Cosa presenta la Bibbia come obiettivo di un segno o di un sigillo? ** {class = question} ** Daniele 6: 8 ** {class = bookQ}  
...
!!! Nota ""
	 Quando un decreto è stato firmato dal re, ha avuto autorità ed è entrato in vigore. Era consuetudine, in passato, che i re indossassero un anello per questo scopo, che conteneva il loro nome, le iniziali o il monogramma. La moglie di Achab Jezebel ** "scrisse lettere in nome di Achab e le sigillò con il suo sigillo" ** {class = verse} (** 1 Re 21: 8 ** {class = book}). Si dice del decreto promulgato da Assuero, per l'uccisione di tutti gli ebrei nell'impero persiano, che ** "fu scritto nel nome del re Assuero, e con l'anello del re fu sigillato" ** {class = verse} ** Ester 3:12 ** {class = book}
...
** A cosa è collegato il sigillo di Dio? ** {class = question} ** Isaia. 8:16 ** {class = bookQ}  
...
** Il primo comandamento mostra chi è l'autore della legge? ** {class = question} ** Esodo 20: 3 ** {class = bookQ}  
** Non avrai altri dei prima di me. ** {class = versoQ} ** Esodo 20: 3 ** {class = bookVerse}  
...
** Il secondo, terzo, quinto, sesto, settimo, ottavo, nono o decimo comandamento indica chi è l'autore del decalogo? ** {class = question} ** Esodo 20: 4; 7.22 ** {class = bookQ}  
...
** Qual è l'unico comandamento del Decalogo che rivela il nome, l'autorità e il dominio dell'Autore di questa legge? ** {class = question} ** Esodo 20: 8-11 ** {class = bookQ}  
...
** La Bibbia dice che il sabato è un segno eterno tra Dio e il suo popolo, perché? ** {class = question} ** Esodo 31:17 ** {class = bookQ}  
...
** Il sabato è un segno ... ** {class = question} ** Ezechiele 20:20; Esodo 31:13. ** {class = bookQ}   
...
** E santifica i miei sabati, e saranno un segno tra me e te, affinché tu possa sapere che io sono il SIGNORE tuo Dio. ** {class = versoQ} ** Ezechiele 20:20 ** {class = bookVerse}  
...
** L'apostolo Giovanni vide questi servitori che in seguito furono suggellati con l'Agnello. Cosa avevano sulla fronte? ** {class = question} ** Apocalisse 14: 1 ** {class = bookQ}  
...
** Cosa si dice del carattere di coloro che sono menzionati? ** {class = question} ** Apocalisse 14: 5 ** {class = bookQ}  
...
** Come viene descritta la chiesa del Residuo? ** {class = question} ** Apocalisse 14:12 ** {class = bookQ}  
** Ecco la pazienza dei santi; ecco coloro che osservano i comandamenti di Dio e la fede in Gesù. ** {class = versoQ} ** Apocalisse 14:12 ** {class = bookVerse}  
...
** Contro quali tre cose l'angelo di Apocalisse 14 mette in guardia gli uomini? ** {class = question} ** Apocalisse 14: 9 ** {class = bookQ}  
** E il terzo angelo li seguì, dicendo ad alta voce: Se qualcuno adora la bestia e la sua immagine e riceve il marchio sulla fronte o nella mano. ** {class = versoQ} ** Apocalisse 14 : 9 ** {class = bookVerse}  
...
** Quali sono le caratteristiche speciali di coloro che sono presentati nel messaggio del Terzo Angelo in contrasto con gli adoratori della bestia e la sua immagine? ** {class = question} ** Apocalisse 14:12 ** {class = bookQ}  
** Ecco la pazienza dei santi; ecco coloro che osservano i comandamenti di Dio e la fede in Gesù. ** {class = versoQ} ** Apocalisse 14:12 ** {class = bookVerse}  
...
** Quale audace cambiamento descrive il profeta Daniele che sarebbe stato fatto dalla bestia nella Legge di Dio? ** {class = question} ** Daniele 7:25 ** {class = bookQ}  
** Dirà parole contro l'Altissimo, ferirà i santi dell'Altissimo e cambierà i tempi e la legge; e i santi ti saranno consegnati, per una volta, due volte e mezza. ** {class = versoQ} ** Daniele 7:25 ** {class = bookVerse}  
...
** Cosa non hanno gli adoratori della bestia e la sua immagine? ** {class = question} ** Apocalisse 14:11 ** {class = bookQ}  
...
** Che riposo mancano agli adoratori della bestia e della sua immagine? ** {class = question} ** Ebrei 4: 4,10; Esodo 20: 8-10 ** {class = bookQ}  
** Perché, in un certo luogo, disse così, riguardo al settimo giorno: E Dio si riposò, il settimo giorno, da tutte le opere che aveva fatto. ** {class = versoQ} ** Ebrei 4: 4 ** {class = bookVerse}  
** Perché colui che è entrato nel resto di Dio, egli stesso si è riposato dalle sue opere, come Dio dalle sue. ** {class = versoQ} ** Ebrei 4:10 ** {class = bookVerse}   
** Ricorda il giorno del sabato, per mantenerlo santo. Sei giorni lavorerai e farai tutto il tuo lavoro. Ma il settimo giorno è il sabato del Signore tuo Dio; non farai alcun lavoro, né tu, né tuo figlio, né tua figlia, né il tuo servo, né il tuo servo, né il tuo animale, né lo straniero delle tue porte all'interno; ** {class = versoQ} * * Esodo 20: 8-10 ** {class = bookVerse}  
...
** Che cosa dice la bestia è il suo segno di autorità? ** {class = question}
...
** Se il segno della bestia è l'orologio della domenica, quale sarebbe il segno di Dio? ** {class = question} ** Ezechiele 20: 12,20 ** {class = bookQ}  
...
** Santifica i miei sabati, perché serviranno da segno tra me in te, così che tu possa sapere che io sono il Signore tuo Dio. ** {class = versoQ} ** Ezechiele 20:20 ** {class = bookVerse}  
...
** Contro cosa avverte gli uomini l'angelo di Apocalisse 14? ** {class = question} ** Apocalisse 14: 9 ** {class = bookQ}  
** E il terzo angelo li seguì, dicendo ad alta voce: Se qualcuno adora la bestia e la sua immagine e riceve il marchio sulla fronte o nella mano ** {class = versoQ} ** Apocalisse 14: 9 ** {class = bookVerse}  
...
** Quale potere dovrebbe imporre questo marchio? ** {class = question} ** Apocalisse 13: 11,16 ** {class = bookQ}  
** E vidi un'altra bestia sorgere dalla terra, e aveva due corna come un agnello; e parlava come il drago. ** {class = versoQ} ** Apocalisse 13:11 ** {class = bookVerse}  
...
** Quale sarà l'atteggiamento del drago verso il popolo di Dio, il popolo rimanente, che osserva i comandamenti di Dio e ha la testimonianza di Gesù? ** {class = domanda} ** Apocalisse 12:17 ** {class = bookQ}  
...
** Come verranno imposti questo falso culto e marchio? ** {class = question} ** Apocalisse 13: 15-17 ** {class = bookQ}  
** E gli fu concesso di dare spirito all'immagine della bestia, in modo che anche l'immagine della bestia parlasse e facesse uccidere tutti coloro che non adoravano l'immagine della bestia. E fate che tutti, piccoli e grandi, ricchi e poveri, liberi e servi, si mettano un segno sulla mano destra, o sulla fronte, in modo che nessuno possa comprare o vendere, tranne quello con il segno, o il il nome della bestia, o il numero del suo nome. ** {class = versoQ} ** Apocalisse 13: 15-17 ** {class = bookVerse}  
...
** In che cosa ottiene finalmente la vittoria il popolo di Dio? ** {class = question} ** Rivelazione 15: 2 ** {class = bookQ}  
** E ne ho visto uno come un mare di vetro misto a fuoco; e anche quelli che uscirono vittoriosi dalla bestia, e dalla sua immagine, dal suo segno e dal numero del suo nome, che erano presso il mare di vetro e avevano le arpe di Dio. ** {class = versoQ} ** Rivelazione 15: 2 ** {class = bookVerse}  
...
** Coloro che hanno il segno di Dio saranno colpiti dalle piaghe finali? ** {class = question} ** Ezechiele 9: 6; Apocalisse 9: 4 ** {class = bookQ}  
...
** In che modo Dio ha creato l'uomo? ** {class = question} ** Genesi 2: 7 ** {class = bookQ}  
...
** Dio ha creato l'uomo per morire o per vivere per sempre? ** {class = question} ** Genesi 2: 16,17 ** {class = bookQ}  
...
** 3. Quale bugia introdusse Satana, il seduttore del mondo? ** {class = question} ** Genesi 3: 4; Rivelazione 12: 9 ** {class = bookQ}  
...
** Cosa ha perso Adamo quando ha peccato? ** {class = question} ** Romani 5:12 ** {class = bookQ}  
...
** Qual è il salario del peccato secondo la Parola di Dio? ** {class = question} ** Romani 6:23 ** {class = bookQ}  
...
La parola * "spirito" * di ** Ecclesiaste 12: 7 ** {class = libro} nella lingua originale della Bibbia è * "ruash" *, che significa * "soffio di vita" *, respiro, aria. Quando Dio ci toglie il respiro (ci toglie il respiro), quel respiro che ci aveva restituito a Lui, mentre il corpo emerso dalla polvere, ritorna alla polvere.

** Cosa succede alla persona (anima vivente) quando muore? ** {class = question} ** Genesi 3:19; Ecclesiaste 12: 7; Salmo 104: 29 ** {class = bookQ}  
** Con il sudore della tua faccia mangerai il tuo pane, finché tornerai a terra, perché ne eri formato; perché sei polvere e in polvere tornerai. ** {class = versoQ} ** Genesi 3:19 ** {class = bookVerse}  
** E la polvere ritorna alla terra, com'era, e lo spirito ritorna a Dio, che l'ha data. ** {class = versoQ} ** Ecclesiaste 12: 7 ** {class = bookVerse}  
...
** Dove va la persona (anima vivente) dopo la morte? ** {class = question} ** Ecclesiaste 9:10; Lavoro 7: 9,10 ** {class = bookQ}  
...
** Mentre la nuvola si schiarisce e se ne va, colui che scende nella tomba non risorgerà mai più. Non tornerà mai a casa sua, né conoscerà mai il luogo in cui vive. ** {class = versoQ} ** Giobbe 7: 9,10 ** {class = bookVerse}  
...
L'immortalità, promessa all'uomo a condizione di obbedienza, fu persa per trasgressione ... L'unico che promise ad Adamo la vita in disobbedienza fu il grande ingannatore. E la dichiarazione del serpente a Eva, in Eden - ** "Certamente non morirai" ** {class = verse} - fu il primo sermone predicato sull'immortalità dell'anima. Tuttavia, questa affermazione, che si basa solo sull'autorità di Satana, riecheggia dai pulpiti della cristianità ed è ricevuta dalla maggior parte dell'umanità con la stessa facilità con cui lo era dai nostri primi genitori.

** Gli uomini (anime viventi) sono immortali? ** {class = question} ** Ezechiele 18: 4,20; Isaia 51:12 ** {class = bookQ}  
...
** Cosa sanno i morti? ** {class = question} ** Ecclesiaste 9: 5,6 ** {class = bookQ}  
...
** Chi ha solo l'immortalità? ** {class = question} ** I Timoteo 6:16 ** {class = bookQ}  
...
** Come può un uomo mortale diventare di nuovo immortale? ** {class = question} ** Giovanni 3:16; 17: 3 ** {class = bookQ}  
** Perché Dio ha tanto amato il mondo da dare il suo unigenito Figlio, in modo che chiunque crede in lui non perisca ma abbia la vita eterna ** {class = verse} ** Giovanni 3:16 ** {class = libro} 
** E questa è la vita eterna: che possano conoscere te, l'unico vero Dio, e Gesù Cristo, che hai mandato. ** {class = versoQ} ** Giovanni 17: 3 ** {class = bookVerse}  
...
** Quando l'essere umano ha di nuovo diritto alla vita eterna? ** {class = question} ** Giovanni 5:24 ** {class = bookQ}  
** In verità, in verità vi dico: chi ascolta la mia parola e crede a colui che mi ha mandato ha la vita eterna, non entra in giudizio, ma è passato dalla morte alla vita. ** {class = versoQ} ** Giovanni 5 : 24 ** {class = bookVerse}  
...
** Quando Gesù darà questa vita eterna a coloro che credono? ** {class = question} ** I Corinzi 15: 21-23 ** {class = bookQ}  
** Poiché la morte è venuta da un uomo, anche da un uomo è avvenuta la risurrezione dei morti. Perché proprio come in Adamo tutti muoiono, così tutti saranno resi vivi in ​​Cristo. Ciascuno, tuttavia, nel suo ordine: Cristo, la primizia; poi quelli che sono di Cristo alla sua venuta. ** {class = versoQ} ** I Corinzi 15: 21-23 ** {class = bookVerse}  
...
** A cosa paragonò Gesù la morte? ** {class = question} ** Giovanni 11: 11-14 ** {class = bookQ}   
...
** Mentre Gesù non viene, dove sono i morti? ** {class = question} ** Daniele 12: 2 ** {class = bookQ}  
...
** Per quanto tempo i morti in Cristo rimarranno addormentati nella tomba? ** {class = question} ** Giovanni 5: 28,29; I Tessalonicesi 4:16 ** {class = bookQ}  
...
** Quali sono le manifestazioni dello spiritualismo moderno in cui i morti appaiono e parlano alle persone? ** {class = question} ** II Corinzi 11:14 ** {class = bookQ}  
...
** Quale sarà l'ultimo grande inganno di Satana prima del ritorno di Gesù? ** {class = question} ** Apocalisse 16: 13,14; 18:23 ** {class = bookQ}  
...
!!! quote Back Ground
    Quando ti dicono: consulta i negromanti e gli avventurieri, che cinguettano e mormorano, il popolo non consulterà il loro Dio? I morti saranno consultati per i vivi? ** Isaia 8:19 ** {class = book}
...
** Questa dottrina esisteva nei tempi antichi? ** {class = question} ** Levitico 19:31 ** {class = bookQ}  
...
** Su chi cadranno i giudizi di Dio? ** {class = question} ** Malachia 3: 5 ** {class = bookQ}  
...
** Dobbiamo ascoltare gli insegnamenti di stregoni e incantatori? ** {class = question} ** Geremia 27: 9,10 ** {class = bookQ}  
...
** Quali istruzioni mandò Dio, tramite Mosè, agli israeliti prima di entrare in Canaan? ** {class = question} ** Deuteronomio 18: 9-12 ** {class = bookQ}  
...
** Qual è l'ordine di Dio riguardo a stregoni e indovini? ** {class = question} ** Esodo 22:18; Levitico 20:27 ** {class = bookQ}  
...
** Chi non erediterà il Regno di Dio? ** {class = question} ** Galati 5: 20,21 ** {class = bookQ}  
...
** Cosa dovremmo fare quando ci invitano a consultare spiriti e indovini? ** {class = question} ** Isaia 8:19 ** {class = bookQ}  
** Quando ti dicono: consulta i negromanti e gli indovini, che cinguettano e mormorano, le persone non consulteranno il loro Dio? I morti saranno consultati per i vivi? ** {class = versoQ} ** Isaia 8:19 ** {class = bookVerse}  
...
** Quali istruzioni ci ha dato Dio, tramite Giovanni, a riguardo? ** {class = question} ** I Giovanni 4: 1 ** {class = bookQ}  
** Amati, non date credito a nessuno spirito; piuttosto, prova gli spiriti se provengono da Dio, perché molti falsi profeti sono usciti nel mondo. ** {class = versoQ} ** I Giovanni 4: 1 ** {class = bookVerse}  
...
** Come dovremmo provare gli spiriti? ** {class = question} ** Isaia 8:20 ** {class = bookQ}  
...
Gli spiritualisti professi dichiarano virtualmente: ** Chiunque fa il male passa per il bene agli occhi del Signore, ed è da questi che si compiace; o, dov'è il Dio del giudizio ** {class = verse} ** Malachia 2:17. ** {class = libro}  
...
** Quando un profeta o un sognatore si alza tra il popolo di Dio dando un segno o un prodigio e dicendo di adorare un altro * "dio" *, cosa dovremmo fare? ** {class = question} ** Deuteronomio 13: 1 -4 ** {class = bookQ}  
...
** I morti sanno qualcosa? ** {class = question} ** Ecclesiaste 9: 5 ** {class = bookQ}  
...
** I morti tornano per comunicare con i vivi? ** {class = question} ** Ecclesiaste 9: 6 ** {class = bookQ}  
** Amore, odio e invidia per loro sono già periti; per sempre non hanno parte in tutto ciò che viene fatto sotto il sole. ** {class = versoQ} ** Ecclesiaste 9: 6 ** {class = bookVerse}  

** Spunta la risposta corretta: **  
a) Sì b) No c) Non lo so.   

** Se i morti non comunicano con i vivi, chi esegue i segni attribuiti ai nostri amici defunti? ** {class = question} ** Apocalisse 16:14 ** {class = bookQ}  
...
** Cosa succederà negli ultimi giorni? ** {class = question} ** I Timothy 4: 1 ** {class = bookQ}  
...
** In che modo Satana ei suoi agenti ci ingannano? ** {class = question} ** II Corinzi 11: 14,15; Matteo 24: 23,24 ** {class = bookQ}  
...
** Quale sarà uno dei tuoi grandi segni per ingannare alla fine dei tempi? ** {class = question} ** Apocalisse 13: 13-14 ** {class = bookQ}  
...
** Come agirà Satana subito prima della seconda venuta di Cristo? ** {class = question} ** II Tessalonicesi 2: 9,10 ** {class = bookQ}  
...
** Cosa ci avverte Gesù tramite Pietro? ** {class = question} ** I Peter 5: 8 ** {class = bookQ}   
...
** Cosa dichiarerà Gesù a coloro che hanno osservato la verità quando verrà la seconda volta? ** {class = question} ** Matteo 25:34 ** {class = bookQ}  
** Allora il Re dirà a quelli alla sua destra: Vieni, benedetto dal Padre mio! Entra in possesso del regno che è stato preparato per te sin dalla fondazione del mondo. ** {class = versoQ} ** Matteo 25:34 ** {class = bookVerse}  

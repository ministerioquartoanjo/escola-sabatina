FILE="$1"
FILE="02-I-pilastri-della-fede/I-pilastri-della-fede.md"
cp -f "02-I-pilastri-della-fede/I-pilastri-della-fede copy.md" $FILE

# Generico
CLASS="classe|clase|class"
sed -ri "s/\*[ ]{0,2}\*[ ]{0,2}\{[ ]{0,2}($CLASS)[ ]{0,2}=[ ]{0,2}([a-z_ ]+)[ ]{0,2}\}/**{class=\2}/gi" $FILE

sed -ri "s/\{class=(domanda|question)[ ]{0,1}\}[ ]{0,1}\*\*[ ]+/{class=questao}** /gi" $FILE
...
# ( ) Sí No
sed -ri 's/[ ]{1,}Si[ ]{1,}No/ Si  ( ) No/i' $FILE
